...
public interface BruteForceProtector extends Provider {
    ...
    boolean isTemporarilyDisabled(IAMShieldSession session, RealmModel realm, UserModel user);

    boolean isPermanentlyLockedOut(IAMShieldSession session, RealmModel realm, UserModel user);
     ...
     * @param user
     */
    void cleanUpPermanentLockout(IAMShieldSession session, RealmModel realm, UserModel user);
}

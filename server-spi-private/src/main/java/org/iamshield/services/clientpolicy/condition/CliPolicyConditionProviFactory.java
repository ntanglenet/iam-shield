 ...
 */
public interface CliPolicyConditionProviFactory extends ProviderFactory<ClientPolicyConditionProvider>, ConfiguredProvider, EnvironmentDependentProviderFactory {
     ...
     */
    default void validateConfiguration(IAMShieldSession session, RealmModel realm, ClientPolicyConditionRepresentation conditionRepresentation) throws ClientPolicyException {
    }
}

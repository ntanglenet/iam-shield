...
package org.iamshield.services.cors;
...
public interface Cors extends Provider {
    ...
    Cors allowedOrigins(IAMShieldSession session, ClientModel client);
    ...
    /**
     * Add the CORS headers to the current {@link org.iamshield.http.HttpResponse}.
     */
    void add();

    /**
     * <p>Add the CORS headers to the current server {@link org.iamshield.http.HttpResponse} and returns a {@link Response} based

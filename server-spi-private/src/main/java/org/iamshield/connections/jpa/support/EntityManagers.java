...
package org.iamshield.connections.jpa.support;
...
public class EntityManagers {
    ...
    static void forEachEntityManager(IAMShieldSession session, Consumer<EntityManager> op) {
        try {
    ...
    static Stream<EntityManagerProxy> getEntityManagerProxies(IAMShieldSession session) {
     ...
     */
    public static void flush(IAMShieldSession session, boolean clear) {
     ...
     */
    public static void runInBatch(IAMShieldSession session, Runnable runnable, boolean nestedEntityManagers) {

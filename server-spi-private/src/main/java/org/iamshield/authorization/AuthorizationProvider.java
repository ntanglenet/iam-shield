...
import org.iamshield.authorization.permission.evaluator.Evaluators;
...
/**
 * <p>The main contract here is the creation of {@link org.iamshield.authorization.permission.evaluator.PermissionEvaluator} instances.  Usually
 * an application has a single {@link AuthorizationProvider} instance and threads servicing client requests obtain {@link org.iamshield.authorization.permission.evaluator.PermissionEvaluator}
 ...
 *
 * <p>Once created, {@link org.iamshield.authorization.permission.evaluator.PermissionEvaluator} instances can be obtained from the {@link #evaluators()} method:
 *
 * <pre>
...
public final class AuthorizationProvider implements Provider {
    ...
    private final IAMShieldSession keycloakSession;
    private final RealmModel realm;

    public AuthorizationProvider(IAMShieldSession session, RealmModel realm, PolicyEvaluator policyEvaluator) {
    ...
    /**
     * Returns a {@link Evaluators} instance from where {@link org.iamshield.authorization.policy.evaluation.PolicyEvaluator} instances
     * can be obtained.
     *
    ...
    public Stream<PolicyProviderFactory> getProviderFactoriesStream() {
        return keycloakSession.getIAMShieldSessionFactory().getProviderFactoriesStream(PolicyProvider.class)
    ...
    public PolicyProviderFactory getProviderFactory(String type) {
        return (PolicyProviderFactory) keycloakSession.getIAMShieldSessionFactory().getProviderFactory(PolicyProvider.class, type);
    }

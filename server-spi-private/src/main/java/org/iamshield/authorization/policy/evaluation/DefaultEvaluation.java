...
package org.iamshield.authorization.policy.evaluation;
...
import org.iamshield.authorization.Decision;
    ...
    private Realm createRealm() {
        return new Realm() {
            ...
            public boolean isUserInGroup(String id, String groupId, boolean checkParent) {
                ...
                GroupModel group = IAMShieldModelUtils.findGroupByPath(session, realm, groupId);
            ...
            private UserModel getUser(String id, IAMShieldSession session) {
            ...
            public boolean isGroupInRole(String id, String role) {
                IAMShieldSession session = authorizationProvider.getIAMShieldSession();
                RealmModel realm = session.getContext().getRealm();
                GroupModel group = IAMShieldModelUtils.findGroupByPath(session, realm, id);
            ...
            public List<String> getUserRealmRoles(String id) {
                return getUser(id, authorizationProvider.getIAMShieldSession()).getRoleMappingsStream()
            ...
            public List<String> getUserGroups(String id) {
                return getUser(id, authorizationProvider.getIAMShieldSession()).getGroupsStream()
            ...
            public Map<String, List<String>> getUserAttributes(String id) {
                return Collections.unmodifiableMap(getUser(id, authorizationProvider.getIAMShieldSession()).getAttributes());
            }
        };
    }

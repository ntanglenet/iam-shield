 ...
 * {@link org.iamshield.common.Profile.Feature#ADMIN_FINE_GRAINED_AUTHZ} feature.
 */
public interface PartialEvaluationPolicyProvider {
     ...
     */
    Stream<Policy> getPermissions(IAMShieldSession session, ResourceType resourceType, UserModel subject);
     ...
     */
    boolean evaluate(IAMShieldSession session, Policy policy, UserModel subject);
}

...
package org.iamshield.authorization.fgap.evaluation.partial;

import static org.iamshield.authorization.fgap.AdminPermissionsSchema.isSkipEvaluation;
...
public final class PartialEvaluator {
    ...
    public List<Predicate> getPredicates(IAMShieldSession session, ResourceType resourceType, PartialEvaluationStorageProvider storage, RealmModel realm, CriteriaBuilder builder, CriteriaQuery<?> queryBuilder, Path<?> path) {
    ...
    private PartialEvaluationContext runEvaluation(IAMShieldSession session, UserModel adminUser, ResourceType resourceType, PartialEvaluationStorageProvider storage, CriteriaBuilder builder, CriteriaQuery<?> queryBuilder, Path<?> path) {
    ...
    private PartialEvaluationContext createEvaluationContext(IAMShieldSession session, ResourceType resourceType, Set<String> allowedResources, Set<String> deniedResources, PartialEvaluationStorageProvider storage, CriteriaBuilder builder, CriteriaQuery<?> queryBuilder, Path<?> path, UserModel adminUser) {
    ...
    private List<PartialEvaluationPolicyProvider> getPartialEvaluationPolicyProviders(IAMShieldSession session) {
    ...
    private boolean shouldSkipPartialEvaluation(IAMShieldSession session, UserModel user, ResourceType resourceType) {
        if (user == null) {
            return true;
        }
    ...
    private ClientModel getRealmManagementClient(IAMShieldSession session) {

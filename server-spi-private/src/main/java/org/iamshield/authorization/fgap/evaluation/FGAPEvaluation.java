...
import static org.iamshield.authorization.fgap.AdminPermissionsSchema.SCHEMA;
...
import org.iamshield.authorization.policy.evaluation.Realm;
...
class FGAPEvaluation implements Evaluation {
    ...
    private Resource getResourceTypeResource(Policy policy, String resourceType) {
        return SCHEMA.getResourceTypeResource(getAuthorizationProvider().getIAMShieldSession(), policy.getResourceServer(), resourceType);
    }
}

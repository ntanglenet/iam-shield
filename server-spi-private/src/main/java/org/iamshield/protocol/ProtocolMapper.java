...
public interface ProtocolMapper extends Provider, ProviderFactory<ProtocolMapper>,ConfiguredProvider {
     ...
     */
    default void validateConfig(IAMShieldSession session, RealmModel realm, ProtocolMapperContainerModel client, ProtocolMapperModel mapperModel) throws ProtocolMapperConfigException {
    };
     ...
     */
    default ProtocolMapperModel getEffectiveModel(IAMShieldSession session, RealmModel realm, ProtocolMapperModel protocolMapperModel) {

...
public interface ArtifactResolver extends Provider {
     ...
     *
     * @param session IAMShieldSession for searching for client corresponding client
     ...
     */
    ClientModel selectSourceClient(IAMShieldSession session, String artifact) throws ArtifactResolverProcessingException;

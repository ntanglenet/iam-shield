 ...
 * accessing the attribute set of a user is based on the configuration (see {@link org.iamshield.representations.userprofile.config.UPConfig})
...
public interface UserProfile {
     ...
     * the same from the {@link UserModel} as they are based on the configurations set in the {@link org.iamshield.representations.userprofile.config.UPConfig} and

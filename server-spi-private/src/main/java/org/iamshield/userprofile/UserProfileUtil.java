...
import org.iamshield.representations.idm.UserProfileAttributeGroupMetadata;
...
public class UserProfileUtil {
     ...
     */
    public static AttributeGroupMetadata lookupUserMetadataGroup(IAMShieldSession session) {
    ...
    public static org.iamshield.representations.idm.UserProfileMetadata createUserProfileMetadata(IAMShieldSession session, UserProfile profile) {
        ...
        return new org.iamshield.representations.idm.UserProfileMetadata(attributes, groups);
    }

    private static UserProfileAttributeMetadata toRestMetadata(AttributeMetadata am, IAMShieldSession session, UserProfile profile) {
        String group = null;
    ...
    private static Map<String, Map<String, Object>> toValidatorMetadata(AttributeMetadata am, IAMShieldSession session){

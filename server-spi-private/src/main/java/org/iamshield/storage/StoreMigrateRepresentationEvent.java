...
public class StoreMigrateRepresentationEvent implements ProviderEvent {
    ...
    public StoreMigrateRepresentationEvent(IAMShieldSession session, RealmModel realm, RealmRepresentation rep, boolean skipUserDependent) {
    ...
    public static void fire(IAMShieldSession session, RealmModel realm, RealmRepresentation rep, boolean skipUserDependent) {
        session.getIAMShieldSessionFactory().publish(new StoreMigrateRepresentationEvent(session, realm, rep, skipUserDependent));
    }

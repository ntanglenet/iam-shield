...
public class PartialImportRealmFromRepresentationEvent implements ProviderEvent {
    ...
    public PartialImportRealmFromRepresentationEvent(IAMShieldSession session, PartialImportRepresentation rep, RealmModel realm) {
        this.session = session;
        this.rep = rep;
        this.realm = realm;
    }

    public static PartialImportResults fire(IAMShieldSession session, PartialImportRepresentation rep, RealmModel realm) {

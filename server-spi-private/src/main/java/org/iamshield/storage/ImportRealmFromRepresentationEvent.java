...
public class ImportRealmFromRepresentationEvent implements ProviderEvent {
    ...
    public ImportRealmFromRepresentationEvent(IAMShieldSession session, RealmRepresentation realmRepresentation) {
        this.session = session;
        this.realmRepresentation = realmRepresentation;
    }

    public static RealmModel fire(IAMShieldSession session, RealmRepresentation rep) {

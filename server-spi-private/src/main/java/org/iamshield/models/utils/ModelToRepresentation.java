...
import org.iamshield.authentication.otp.OTPApplicationProvider;
...
import org.iamshield.events.admin.AuthDetails;
import org.iamshield.models.*;
...
import org.iamshield.representations.account.CredentialMetadataRepresentation;
import org.iamshield.representations.account.LocalizedMessage;
import org.iamshield.representations.idm.*;
import org.iamshield.representations.idm.authorization.*;
...
public class ModelToRepresentation {
    ...
    public static String buildGroupPath(GroupModel group) {
        return IAMShieldModelUtils.buildGroupPath(group);
    }
    ...
    @Deprecated
    public static Stream<GroupRepresentation> toGroupHierarchy(IAMShieldSession session, RealmModel realm, boolean full) {
    ...
    public static UserRepresentation toRepresentation(IAMShieldSession session, RealmModel realm, UserModel user) {
        return toRepresentation(session, realm, user, new UserRepresentation(), true);
    }

    public static UserRepresentation toRepresentation(IAMShieldSession session, RealmModel realm, UserModel user, UserRepresentation rep, boolean setUserAttributes) {
    ...
    public static RealmRepresentation toRepresentation(IAMShieldSession session, RealmModel realm, boolean internal) {
        return toRepresentation(session, realm, internal, false);
    }

    public static RealmRepresentation toRepresentation(IAMShieldSession session, RealmModel realm, boolean internal, boolean export) {
        RealmRepresentation rep = new RealmRepresentation();
        rep.setId(realm.getId());
        rep.setRealm(realm.getName());
        rep.setDisplayName(realm.getDisplayName());
    ...
    public static void exportGroups(IAMShieldSession session, RealmModel realm, RealmRepresentation rep) {
        rep.setGroups(toGroupHierarchy(session, realm, true).collect(Collectors.toList()));
    }

    public static void exportAuthenticationFlows(IAMShieldSession session, RealmModel realm, RealmRepresentation rep) {
    ...
    public static ClientRepresentation toRepresentation(ClientModel clientModel, IAMShieldSession session) {
    ...
    private static boolean isRealmClient(String clientId, RealmModel realm, IAMShieldSession session) {
    ...
    public static AuthenticationFlowRepresentation toRepresentation(IAMShieldSession session, RealmModel realm, AuthenticationFlowModel model) {
    ...
    public static AuthenticationExecutionExportRepresentation toRepresentation(IAMShieldSession session, RealmModel realm, AuthenticationExecutionModel model) {
    ...
    public static ComponentRepresentation toRepresentation(IAMShieldSession session, ComponentModel component, boolean internal) {
    ...
    public static ResourceServerRepresentation toResourceServerRepresentation(IAMShieldSession session, ClientModel client) {
        AuthorizationProviderFactory providerFactory = (AuthorizationProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(AuthorizationProvider.class);

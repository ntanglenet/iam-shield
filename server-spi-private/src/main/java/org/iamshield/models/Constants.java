...
public final class Constants {
    ...
    public static final String DEFAULT_WEBAUTHN_POLICY_RP_ENTITY_NAME = "iamshield";
    ...
    /**
     * If set as an attribute in the {@link IAMShieldSession}, indicates that the storage should batch write operations.
     */
    public static final String STORAGE_BATCH_ENABLED = "org.iamshield.storage.batch_enabled";

    /**
     * If {@code #STORAGE_BATCH_ENABLED} is set, indicates the batch size.
     */
    public static final String STORAGE_BATCH_SIZE = "org.iamshield.storage.batch_size";
    ...
    public static final String SESSION_NOTE_LIGHTWEIGHT_USER = "iamshield.userModel";

...
import static org.iamshield.models.AdminRoles.IMPERSONATION;
...
public class ImpersonationConstants {
    ...
    public static void setupMasterRealmRole(RealmProvider model, RealmModel realm) {
        ...
        ClientModel realmAdminApp = adminRealm.getClientByClientId(IAMShieldModelUtils.getMasterRealmAdminManagementClientId(realm.getName()));
    ...
    public static void setupImpersonationService(IAMShieldSession session, RealmModel realm) {

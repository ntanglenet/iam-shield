...
public interface Authenticator extends Provider {
     ...
     * @return
     */
    boolean configuredFor(IAMShieldSession session, RealmModel realm, UserModel user);

    /**
     * Set actions to configure authenticator
     *
     */
    void setRequiredActions(IAMShieldSession session, RealmModel realm, UserModel user);

    /**
     * Overwrite this if the authenticator is associated with
     * @return
     */
    default List<RequiredActionFactory> getRequiredActions(IAMShieldSession session) {
     ...
     * @return
     */
    default boolean areRequiredActionsEnabled(IAMShieldSession session, RealmModel realm) {

 ...
 *
 * This interface is for verifying client credentials from request. On the adapter side, you must also implement org.iamshield.protocol.oidc.client.authentication.ClientCredentialsProvider , which is supposed
 * to add the client credentials to the request, which will ClientAuthenticator verify on server side
 *
 * @see org.iamshield.authentication.authenticators.client.ClientIdAndSecretAuthenticator
 * @see org.iamshield.authentication.authenticators.client.JWTClientAuthenticator
 *

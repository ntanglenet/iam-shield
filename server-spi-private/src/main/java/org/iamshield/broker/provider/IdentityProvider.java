...
public interface IdentityProvider<C extends IdentityProviderModel> extends Provider {
    ...
    interface AuthenticationCallback {
         ...
         * Assumption is that authenticationSession is set in the {@link org.iamshield.models.IAMShieldContext} when this method is called
         *
    ...
    void preprocessFederatedIdentity(IAMShieldSession session, RealmModel realm, BrokeredIdentityContext context);
    void authenticationFinished(AuthenticationSessionModel authSession, BrokeredIdentityContext context);
    void importNewUser(IAMShieldSession session, RealmModel realm, UserModel user, BrokeredIdentityContext context);
    void updateBrokeredUser(IAMShieldSession session, RealmModel realm, UserModel user, BrokeredIdentityContext context);
 ...
 *                    identity provider.
     ...
     * @return
     */
    Response retrieveToken(IAMShieldSession session, FederatedIdentityModel identity);

    void backchannelLogout(IAMShieldSession session, UserSessionModel userSession, UriInfo uriInfo, RealmModel realm);
     ...
     */
    Response keycloakInitiatedBrowserLogout(IAMShieldSession session, UserSessionModel userSession, UriInfo uriInfo, RealmModel realm);

...
package org.iamshield.broker.provider.util;
...
import org.iamshield.connections.httpclient.SafeInputStream;
...
public class SimpleHttp {
    ...
    public static SimpleHttp doDelete(String url, IAMShieldSession session) {
    ...
    public static SimpleHttp doGet(String url, IAMShieldSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doPost(String url, IAMShieldSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doPut(String url, IAMShieldSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doHead(String url, IAMShieldSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);
    ...
    public static SimpleHttp doPatch(String url, IAMShieldSession session) {
        HttpClientProvider provider = session.getProvider(HttpClientProvider.class);

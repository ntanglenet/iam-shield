...
public class AuthenticationRequest {
    ...
    public AuthenticationRequest(IAMShieldSession session, RealmModel realm, AuthenticationSessionModel authSession, HttpRequest httpRequest, UriInfo uriInfo, IdentityBrokerState state, String redirectUri) {

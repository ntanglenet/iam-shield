...
public class TracingProviderUtil {
    ...
    public static TracingProvider getTracingProvider(IAMShieldSession session) {
    ...
    public static TracingProvider getTracingProvider() {
        var session = IAMShieldSessionUtil.getIAMShieldSession();
        if (session == null) {

...
public class IAMShieldModelUtilsTest {
    ...
    public void testGenerateId() {
        ...
        final String shortId = IAMShieldModelUtils.generateShortId(UUID.fromString(id));
    ...
    public void testGenerateShortId() {
        final String shortId = IAMShieldModelUtils.generateShortId();
        final UUID uuid = fromShortId(shortId);
        Assert.assertEquals(shortId, IAMShieldModelUtils.generateShortId(uuid));
    }

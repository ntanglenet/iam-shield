...
A good test to start looking at is org.iamshield.testsuite.forms.LoginTest. It is reasonable straightforward to understand
this test.
...
APIs as well as access data that is not exposed. For an example on how to do this look at org.iamshield.testsuite.runonserver.RunOnServerTest.

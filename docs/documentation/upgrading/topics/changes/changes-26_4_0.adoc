...
[source]
----
https://ntanglenet.com/iamshield/realms/{realm}/.well-known/oauth-authorization-server
----
...
[source]
----
https://ntanglenet.com/.well-known/oauth-authorization-server/iamshield/realms/{realm}
----

# Changing the Default *iamshield-subsystem* Configuration

If you need to make a change to the default iamshield-subsystem 
configuration that is packaged with our distributions, you will need to edit this file:
https://github.com/iamshield/iamshield/blob/main/wildfly/server-subsystem/src/main/config/default-server-subsys-config.properties
...
https://github.com/iamshield/iamshield/blob/main/wildfly/server-subsystem/src/main/resources/cli/default-iamshield-subsys-config.cli

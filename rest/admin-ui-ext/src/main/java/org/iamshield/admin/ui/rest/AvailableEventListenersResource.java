...
import org.iamshield.admin.ui.rest.model.EventListener;
import org.iamshield.admin.ui.rest.model.ProviderMapper;
...
public class AvailableEventListenersResource {
    ...
    public AvailableEventListenersResource(IAMShieldSession session, AdminPermissionEvaluator auth) {
    ...
    public final List<EventListener> listAvailableEventListeners() {
        ...
        session.getIAMShieldSessionFactory().getProviderFactoriesStream(EventListenerProvider.class).forEach(
               providerFactory -> {

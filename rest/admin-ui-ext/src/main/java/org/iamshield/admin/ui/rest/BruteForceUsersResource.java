...
import org.iamshield.admin.ui.rest.model.BruteUser;
...
public class BruteForceUsersResource {
    ...
    public BruteForceUsersResource(IAMShieldSession session, RealmModel realm, AdminPermissionEvaluator auth) {
        this.realm = realm;
        this.auth = auth;
    ...
    public boolean isTemporarilyDisabled(IAMShieldSession session, RealmModel realm, UserRepresentation user) {

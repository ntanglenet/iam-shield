...
import static org.iamshield.admin.ui.rest.model.RoleMapper.convertToModel;

public class EffectiveRoleMappingResource extends RoleMappingResource {
    public EffectiveRoleMappingResource(IAMShieldSession session, RealmModel realm, AdminPermissionEvaluator auth) {

...
import org.iamshield.it.junit5.extension.DistributionType;
...
public class ManagementDistTest {
    ...
    void testManagementDisabled(LaunchResult result, IAMShieldDistribution distribution) {
        CLIResult cliResult = (CLIResult) result;
        cliResult.assertNoMessage("Management interface listening on");
    ...
    void testManagementDifferentPort(LaunchResult result, IAMShieldDistribution distribution) {
        CLIResult cliResult = (CLIResult) result;
    ...
    void testManagementRootRedirects(LaunchResult result, IAMShieldDistribution distribution) {
        assertRelativePath(result, "/management");

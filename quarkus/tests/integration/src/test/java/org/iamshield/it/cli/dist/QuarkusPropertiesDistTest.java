...
import org.iamshield.it.junit5.extension.KeepServerAlive;
...
public class QuarkusPropertiesDistTest {
    ...
    void testSmallRyeKeyStoreConfigSource(CLIResult cliResult) {
        // keytool -importpass -alias kc.log-level -keystore keystore -storepass secret -storetype PKCS12 -v (with "org.iamshield.timer:debug" as the stored password)
        cliResult.assertNoMessage("DEBUG [org.iamshield.services");
        cliResult.assertMessage("DEBUG [org.iamshield.timer");
    ...
    public static class AddConsoleHandlerFromQuarkusProps implements Consumer<IAMShieldDistribution> {
        @Override
    ...
    public static class UpdateConsoleHandlerFromKeycloakConf implements Consumer<IAMShieldDistribution> {
    ...
    public static class UpdateConsoleHandlerFromQuarkusProps implements Consumer<IAMShieldDistribution> {
    ...
    public static class UpdateHibernateMetricsFromQuarkusProps implements Consumer<IAMShieldDistribution> {
    ...
    public static class ForceRebuild implements Consumer<IAMShieldDistribution> {

...
public class ProxyHostnameV2DistTest {
    ...
    @Test
    void testTrustedProxiesWithoutProxyHeaders(IAMShieldDistribution distribution) {
    ...
    @Test
    void testTrustedProxiesWithInvalidAddress(IAMShieldDistribution distribution) {

...
public class ExportDistTest {
    ...
    @Test
    void testExport(IAMShieldDistribution dist) {
    ...
    @Test
    void testExportRealmFGAPEnabled(IAMShieldDistribution dist) {
    ...
    @Test
    void testExportNonExistent(IAMShieldDistribution dist) {
        CLIResult cliResult = dist.run("build");

...
public class HealthDistTest {
    ...
    @Test
    @Launch({ "start-dev" })
    void testHealthEndpointNotEnabled(IAMShieldDistribution distribution) {
    ...
    void testHealthEndpoint(IAMShieldDistribution distribution) {
        when().get("/health").then()
                .statusCode(200);
    ...
    void testHealthEndpointOnMain(IAMShieldDistribution distribution) {
        distribution.setRequestPort(8080);

...
public class CustomJpaEntityProviderDistTest {
    ...
    @Test
    void dbKindSpecifiedInBuildTime(IAMShieldDistribution dist) {
    ...
    @Test
    @Launch({"start-dev", "--db=dev-file", "--log-level=org.hibernate.jpa.internal.util.LogHelper:debug,org.iamshield.quarkus.deployment.KeycloakProcessor:debug", "--db-kind-new-user-store=dev-mem", "--db-kind-client-store=dev-file", "--db-kind-pu-without-dialect-store=dev-mem"})

...
import org.iamshield.it.junit5.extension.Storage;
...
public class ClusterConfigDistTest {
    ...
    @Test
    @Launch({ "start", "--cache=ispn", "--log-level=info,org.iamshield.connections.infinispan:debug", "--http-enabled=true", "--hostname-strict=false"})
    ...
    public static class ConfigureCacheUsingAsyncEncryption implements Consumer<IAMShieldDistribution> {
    ...
    public static class ConfigureCustomCache implements Consumer<IAMShieldDistribution> {

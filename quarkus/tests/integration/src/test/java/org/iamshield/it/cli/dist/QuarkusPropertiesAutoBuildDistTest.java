...
public class QuarkusPropertiesAutoBuildDistTest {
    ...
    public static class EnableAdditionalConsoleHandler implements Consumer<IAMShieldDistribution> {
        @Override
    ...
    public static class DisableAdditionalConsoleHandler implements Consumer<IAMShieldDistribution> {
    ...
    public static class AddAdditionalDatasource implements Consumer<IAMShieldDistribution> {
        @Override
        public void accept(IAMShieldDistribution distribution) {
    ...
    public static class AddAdditionalDatasource2 implements Consumer<IAMShieldDistribution> {
        @Override
        public void accept(IAMShieldDistribution distribution) {
    ...
    public static class AddNonXADatasource implements Consumer<IAMShieldDistribution> {
        @Override
        public void accept(IAMShieldDistribution distribution) {
    ...
    public static class ChangeAdditionalDatasourceUsername implements Consumer<IAMShieldDistribution> {
        @Override
        public void accept(IAMShieldDistribution distribution) {
    ...
    public static class ChangeAdditionalDatasourceDbKind implements Consumer<IAMShieldDistribution> {
        @Override
        public void accept(IAMShieldDistribution distribution) {
            distribution.setProperty("db-kind-user-store", "dev-mem");
        }
    ...
    public static class SetDatabaseKind implements Consumer<IAMShieldDistribution> {
        @Override
        public void accept(IAMShieldDistribution distribution) {

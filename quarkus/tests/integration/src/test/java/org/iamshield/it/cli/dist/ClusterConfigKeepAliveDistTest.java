...
import org.iamshield.it.resource.realm.TestRealmResourceTestProvider;
...
public class ClusterConfigKeepAliveDistTest {
    ...
    void testMaxCountApplied(IAMShieldDistribution dist) {
        int maxCount = 100;
    ...
    @Test
    @TestProvider(TestRealmResourceTestProvider.class)
    void testNumOwnersWithPersistentSessions(IAMShieldDistribution dist) {
        doNumOwnerTest(dist, false);
    }

    @Test
    @TestProvider(TestRealmResourceTestProvider.class)
    void testNumOwnersWithVolatileSessions(IAMShieldDistribution dist) {
        doNumOwnerTest(dist, true);
    }

    @Test
    @TestProvider(TestRealmResourceTestProvider.class)
    void testCheckMinimumNumOwners(IAMShieldDistribution dist) {
    ...
    private void doNumOwnerTest(IAMShieldDistribution dist, boolean volatileSessions) {
        final int owners = 5;
        List<String> args = new ArrayList<>();
        args.add("start-dev");
        args.add("--cache=ispn");

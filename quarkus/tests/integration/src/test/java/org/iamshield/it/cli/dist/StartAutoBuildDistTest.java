...
import org.iamshield.it.junit5.extension.TestProvider;
...
public class StartAutoBuildDistTest {
    ...
    void testStartAutoBuild(CLIResult cliResult) {
        ...
        cliResult.assertMessage(IAMShieldDistribution.SCRIPT_CMD + " --verbose start --http-enabled=true --hostname-strict=false " + OPTIMIZED_BUILD_OPTION_LONG);
    ...
    @Order(10)
    void testSpiAutoBuild(IAMShieldDistribution dist) {
    ...
    @Test
    @Order(11)
    void testLogLevelNotPeristed(IAMShieldDistribution dist) {
    ...
    @Test
    @Order(12)
    void testLogLevelWildcardNotPeristed(IAMShieldDistribution dist) {

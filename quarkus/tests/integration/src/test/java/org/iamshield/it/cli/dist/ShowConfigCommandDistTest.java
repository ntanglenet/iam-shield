...
public class ShowConfigCommandDistTest {
    ...
    void testShowConfigPicksUpRightConfigDependingOnCurrentMode(IAMShieldDistribution distribution) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    void testShowConfigCommandHidesCredentialsInProfiles(IAMShieldDistribution distribution) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    void testSmallRyeKeyStoreConfigSource(IAMShieldDistribution distribution) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    void testConfigSourceNames(IAMShieldDistribution distribution) {

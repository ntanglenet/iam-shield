...
public class MetricsDistTest {
    ...
    @Test
    @Launch({ "start-dev" })
    void testMetricsEndpointNotEnabled(IAMShieldDistribution distribution) {
    ...
    void testMetricsEndpointWithCacheMetricsHistogramsAndExemplars(IAMShieldDistribution distribution) {
    ...
    void testMetricsEndpointWithUserEventMetrics(IAMShieldDistribution distribution) {
        runClientCredentialGrantWithUnknownClientId(distribution);
    ...
    void testMetricsEndpointWithoutUserEventMetrics(IAMShieldDistribution distribution) {
        runClientCredentialGrantWithUnknownClientId(distribution);
    ...
    private static void runClientCredentialGrantWithUnknownClientId(IAMShieldDistribution distribution) {
        distribution.setRequestPort(8080);
    ...
    @Test
    void testUsingRelativePath(IAMShieldDistribution distribution) {
    ...
    @Test
    void testMultipleRequests(IAMShieldDistribution distribution) throws Exception {

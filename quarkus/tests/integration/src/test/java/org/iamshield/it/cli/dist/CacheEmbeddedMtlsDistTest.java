...
public class CacheEmbeddedMtlsDistTest {
    ...
    public void testCacheEmbeddedMtlsDisabled(IAMShieldDistribution dist) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsFileValidation(IAMShieldDistribution dist) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsFileExistsValidation(IAMShieldDistribution dist) throws IOException {
        var result = dist.run(
              "start-dev",
              "--cache=ispn",
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsValidation(IAMShieldDistribution dist) {
    ...
    @Test
    @RawDistOnly(reason = "Containers are immutable")
    public void testCacheEmbeddedMtlsEnabled(IAMShieldDistribution dist) {
    ...
    private void doFileAndPasswordValidation(IAMShieldDistribution dist, Option<String> fileOption, Option<String> passwordOption) {

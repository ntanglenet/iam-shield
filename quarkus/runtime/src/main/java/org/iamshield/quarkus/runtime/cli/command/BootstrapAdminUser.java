...
public class BootstrapAdminUser extends AbstractNonServerCommand {
    ...
    @Override
    public void onStart(QuarkusIAMShieldApplication application) {
        //BootstrapAdmin bootstrap = spec.commandLine().getParent().getCommand();
        IAMShieldSessionFactory sessionFactory = IAMShieldApplication.getSessionFactory();
        IAMShieldModelUtils.runJobInTransaction(sessionFactory, session -> application

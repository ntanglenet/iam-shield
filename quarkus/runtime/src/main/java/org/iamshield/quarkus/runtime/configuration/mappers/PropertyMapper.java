...
import static org.iamshield.quarkus.runtime.configuration.Configuration.toCliFormat;
import static org.iamshield.quarkus.runtime.configuration.Configuration.toEnvVarFormat;
...
import org.iamshield.quarkus.runtime.cli.ShortErrorMessageHandler;
import org.iamshield.quarkus.runtime.configuration.ConfigArgsConfigSource;
import org.iamshield.quarkus.runtime.configuration.KcEnvConfigSource;
...
public class PropertyMapper<T> {
    ...
    PropertyMapper(Option<T> option, String to, BooleanSupplier enabled, String enabledWhen,
        ...
        this.option = option;
        this.from = from == null ? NS_IAMSHIELD_PREFIX + this.option.getKey() : from;
    ...
    ConfigValue getConfigValue(String name, ConfigSourceInterceptorContext context) {
        ...
        if (mapFrom != null && (config == null || config.getValue() == null)) {
            ...
            String mapFromWithPrefix = NS_IAMSHIELD_PREFIX + mapFrom;
    ...
    String getOptionAndSourceMessage(ConfigValue configValue) {
        ...
        return String.format("'%s' in %s", getFrom(),
                IAMShieldConfigSourceProvider.getConfigSourceDisplayName(configValue.getConfigSourceName()));
    }

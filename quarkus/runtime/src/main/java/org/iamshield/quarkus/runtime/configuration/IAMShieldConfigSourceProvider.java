...
public class IAMShieldConfigSourceProvider implements ConfigSourceProvider, ConfigBuilder {
    ...
    public IAMShieldConfigSourceProvider() {
    ...
    private static void initializeSources() {
        ...
        IAMShieldPropertiesConfigSource.InFileSystem inFileSystem = new IAMShieldPropertiesConfigSource.InFileSystem();

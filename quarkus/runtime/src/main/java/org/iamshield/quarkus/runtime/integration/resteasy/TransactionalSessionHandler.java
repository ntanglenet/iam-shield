...
public final class TransactionalSessionHandler implements ServerRestHandler, org.iamshield.quarkus.runtime.transaction.TransactionalSessionHandler {

    @Override
    public void handle(ResteasyReactiveRequestContext requestContext) {
        requestContext.requireCDIRequestScope();
        IAMShieldSession currentSession = Arc.container().instance(IAMShieldSession.class).get();
        ...
        if (IAMShieldSessionUtil.setIAMShieldSession(currentSession) == null) {

...
import org.iamshield.config.HostnameV2Options;
...
import org.iamshield.config.ProxyOptions;
...
public final class HostnameV2PropertyMappers implements PropertyMapperGrouping {
    ...
    public static void validateConfig(Consumer<String> warn) {
        ...
        boolean isProd = Environment.PROD_PROFILE_VALUE.equals(org.iamshield.common.util.Environment.getProfile());

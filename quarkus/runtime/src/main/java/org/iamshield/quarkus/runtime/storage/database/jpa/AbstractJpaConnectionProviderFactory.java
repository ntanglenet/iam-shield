...
import org.iamshield.connections.jpa.DefaultJpaConnectionProvider;
...
public abstract class AbstractJpaConnectionProviderFactory implements JpaConnectionProviderFactory {
    ...
    protected EntityManager createEntityManager(EntityManagerFactory emf, IAMShieldSession session, boolean sessionManaged) {

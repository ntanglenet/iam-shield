...
import org.iamshield.common.util.NetworkUtils;
import org.iamshield.quarkus.runtime.configuration.Configuration;

public final class Environment {

    public static final String IAMSHIELD_CONFIG_REBUILD_CHECK = "iamshield.config.rebuild-check";
    public static final String IAMSHIELD_CONFIG_BUILT = "iamshield.config.built";
    private static final String IAMSHIELD_HOME_DIR = "iamshield.home.dir";
    public static final String NON_SERVER_MODE = "nonserver";
    public static final String PROFILE ="iamshield.profile";
    public static final String ENV_PROFILE ="IAMSHIELD_PROFILE";
    ...
    public static final String LAUNCH_MODE = "iamshield.launch.mode";
    ...
    public static String getHomeDir() {
        return System.getProperty(IAMSHIELD_HOME_DIR);
    }
    ...
    public static void setProfile(String profile) {
        System.setProperty(org.iamshield.common.util.Environment.PROFILE, profile);
    ...
    public static boolean isDevMode() {
        if (org.iamshield.common.util.Environment.isDevMode()) {
            return true;
        }

        return org.iamshield.common.util.Environment.DEV_PROFILE_VALUE.equals(Configuration.getNonPersistedConfigValue(org.iamshield.common.util.Environment.PROFILE).getValue());
    }

    public static boolean isDevProfile(){
        return Optional.ofNullable(org.iamshield.common.util.Environment.getProfile()).orElse("").equalsIgnoreCase(org.iamshield.common.util.Environment.DEV_PROFILE_VALUE);
    }

    public static boolean isNonServerMode() {
        return NON_SERVER_MODE.equalsIgnoreCase(org.iamshield.common.util.Environment.getProfile());
    }
    ...
    public static void forceDevProfile() {
        setProfile(org.iamshield.common.util.Environment.DEV_PROFILE_VALUE);
    }
     ...
     */
    public static String getIAMShieldModeFromProfile(String profile) {
    ...
    public static boolean isRebuildCheck() {
        return Boolean.getBoolean(IAMSHIELD_CONFIG_REBUILD_CHECK);
    }

    public static void setRebuildCheck() {
        System.setProperty(IAMSHIELD_CONFIG_REBUILD_CHECK, "true");
    }

    public static boolean isRebuilt() {
        return Boolean.getBoolean(IAMSHIELD_CONFIG_BUILT);
    }

    public static void setHomeDir(Path path) {
        System.setProperty(IAMSHIELD_HOME_DIR, path.toFile().getAbsolutePath());
    }
    ...
    public static void removeHomeDir() {
        System.getProperties().remove(IAMSHIELD_HOME_DIR);
    }

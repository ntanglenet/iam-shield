...
import static org.iamshield.quarkus.runtime.cli.Picocli.NO_PARAM_LABEL;
...
@Command(name = "iamshield",
        header = {
                "IAMShield - Open Source Identity and Access Management",
                "",
                "Find more information at: https://www.iamshield.org/docs/latest"
        },
        description = {
                "%nUse this command-line tool to manage your IAMShield cluster."
        },
...
public final class Main {
    ...
    @Option(names = { CONFIG_FILE_SHORT_NAME, CONFIG_FILE_LONG_NAME },
            arity = "1",
            description = "Set the path to a configuration file. By default, configuration properties are read from the \"iamshield.conf\" file in the \"conf\" directory.",
            paramLabel = "file")
    public void setConfigFile(String path) {
        ...
        System.setProperty(IAMShieldPropertiesConfigSource.KEYCLOAK_CONFIG_FILE_PROP, path);
    }
}

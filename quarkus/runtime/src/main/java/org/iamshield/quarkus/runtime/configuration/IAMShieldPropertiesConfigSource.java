...
/**
 * A configuration source for {@code iamshield.conf}.
 */
public class IAMShieldPropertiesConfigSource extends AbstractLocationConfigSourceLoader {

    public static final int PROPERTIES_FILE_ORDINAL = 475;

    private static final String KEYCLOAK_CONFIG_FILE_ENV = "KC_CONFIG_FILE";
    private static final String IAMSHIELD_CONF_FILE = "iamshield.conf";
    public static final String KEYCLOAK_CONFIG_FILE_PROP = NS_IAMSHIELD_PREFIX + "config.file";
    ...
    public static class InFileSystem extends IAMShieldPropertiesConfigSource implements ConfigSourceProvider {
        ...
        public Path getConfigurationFile() {
            ...
            if (filePath == null) {
                ...
                if (homeDir != null) {
                    File file = Paths.get(homeDir, "conf", IAMShieldPropertiesConfigSource.IAMSHIELD_CONF_FILE).toFile();
    ...
    private static Map<String, String> transform(Map<String, String> properties) {
        ...
        properties.entrySet().forEach(entry -> {
            result.put(MicroProfileConfigProvider.NS_IAMSHIELD_PREFIX + entry.getKey(), entry.getValue());
        });

...
import org.iamshield.quarkus.runtime.integration.resteasy.QuarkusIAMShieldContext;
...
public final class QuarkusIAMShieldSession extends DefaultIAMShieldSession {

    public QuarkusIAMShieldSession(DefaultIAMShieldSessionFactory factory) {
        super(factory);
    }

    @Override
    protected DefaultIAMShieldContext createIAMShieldContext(IAMShieldSession session) {
        return new QuarkusIAMShieldContext(session);
    }
}

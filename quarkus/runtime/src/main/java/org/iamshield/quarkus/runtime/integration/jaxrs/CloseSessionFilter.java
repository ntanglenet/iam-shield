...
@PreMatching
@Priority(1)
public class CloseSessionFilter implements ContainerResponseFilter, org.iamshield.quarkus.runtime.transaction.TransactionalSessionHandler {
    ...
    private void closeSession() {
        close(IAMShieldSessionUtil.getIAMShieldSession());
    }
}

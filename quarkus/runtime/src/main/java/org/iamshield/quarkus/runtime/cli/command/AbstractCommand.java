...
import static org.iamshield.quarkus.runtime.Messages.cliExecutionError;
...
public abstract class AbstractCommand implements Callable<Integer> {
    ...
    public String getInitProfile() {
        String configuredProfile = org.iamshield.common.util.Environment.getProfile();
        ...
        return Optional.ofNullable(this.getDefaultProfile())
                .or(() -> Optional.ofNullable(
                        PersistedConfigSource.getInstance().getValue(org.iamshield.common.util.Environment.PROFILE)))

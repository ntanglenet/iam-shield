...
public final class Messages {
    ...
    public static String httpsConfigurationNotSet() {
        ...
        if (!org.iamshield.common.util.Environment.DEV_PROFILE_VALUE.equals(org.iamshield.common.util.Environment.getProfile())) {
    ...
    public static String devProfileNotAllowedError(String cmd) {
        return String.format("You can not '%s' the server in %s mode. Please re-build the server first, using 'kc.sh build' for the default production mode.%n", cmd, Environment.getIAMShieldModeFromProfile(org.iamshield.common.util.Environment.DEV_PROFILE_VALUE));
    }
    ...
    public static String invalidLogCategoryFormat(String category) {
        return "Invalid log category format: " + category + ". The format is 'category:level' such as 'org.iamshield:debug'.";
    }

...
public class MicroProfileConfigProvider implements Config.ConfigProvider {
    ...
    public static final String NS_IAMSHIELD = "kc";
    public static final String NS_IAMSHIELD_PREFIX = NS_IAMSHIELD + ".";
    public static final String SPI_PREFIX = NS_IAMSHIELD_PREFIX + "spi" + OPTION_PART_SEPARATOR;
    ...
    public class MicroProfileScope implements Config.Scope {
        ...
        private <T> T getValue(String key, Class<T> clazz, T defaultValue) {
            if (NS_IAMSHIELD_PREFIX.equals(separatorPrefix)) {
        ...
        @Override
        public Scope root() {
            return new MicroProfileScope(NS_IAMSHIELD_PREFIX);
        }

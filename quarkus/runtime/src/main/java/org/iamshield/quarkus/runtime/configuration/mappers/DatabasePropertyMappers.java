...
import org.iamshield.config.OptionBuilder;
...
import static org.iamshield.config.DatabaseOptions.Datasources.OPTIONS_DATASOURCES;
import static org.iamshield.config.DatabaseOptions.Datasources.getDatasourceOption;
import static org.iamshield.config.DatabaseOptions.Datasources.getKeyForDatasource;
import static org.iamshield.quarkus.runtime.configuration.MicroProfileConfigProvider.NS_IAMSHIELD_PREFIX;
import static org.iamshield.quarkus.runtime.configuration.mappers.DatabasePropertyMappers.Datasources.appendDatasourceMappers;
...
final class DatabasePropertyMappers implements PropertyMapperGrouping {
    ...
    private static String transformMinPoolSize(String database, ConfigSourceInterceptorContext context) {
        Supplier<String> getParentPoolMinSize = () -> Optional.ofNullable(context.proceed(NS_IAMSHIELD_PREFIX + DatabaseOptions.DB_POOL_MIN_SIZE.getKey()))

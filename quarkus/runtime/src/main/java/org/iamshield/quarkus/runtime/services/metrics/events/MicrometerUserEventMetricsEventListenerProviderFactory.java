...
package org.iamshield.quarkus.runtime.services.metrics.events;
...
public class MicrometerUserEventMetricsEventListenerProviderFactory implements EventListenerProviderFactory, EnvironmentDependentProviderFactory {
    ...
    private static final String DESCRIPTION_OF_EVENT_METER = "IAMShield user events";
    // Micrometer naming convention that separates lowercase words with a . (dot) character.
    private static final String IAMSHIELD_METER_NAME_PREFIX = "iamshield.";
    private static final String USER_EVENTS_METER_NAME = IAMSHIELD_METER_NAME_PREFIX + "user";

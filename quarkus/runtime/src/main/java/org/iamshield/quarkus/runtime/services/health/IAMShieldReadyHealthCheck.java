...
@Readiness
@ApplicationScoped
public class IAMShieldReadyHealthCheck implements AsyncHealthCheck {
    ...
    public Uni<HealthCheckResponse> call() {
        HealthCheckResponseBuilder builder = HealthCheckResponse.named("IAMShield database connections async health check").up();

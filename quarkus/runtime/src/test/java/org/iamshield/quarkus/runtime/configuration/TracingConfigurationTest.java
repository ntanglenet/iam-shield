...
public class TracingConfigurationTest extends AbstractConfigurationTest {
    ...
    public void defaultValues() {
        ...
        assertConfig("tracing-service-name", "iamshield");

        assertExternalConfig(Map.of(
                "quarkus.otel.enabled", "false",
                "quarkus.otel.service.name", "iamshield",
    ...
    public void differentValues() {
        ...
        putEnvVars(Map.of(
                "KC_TRACING_SERVICE_NAME", "iamshield-42",
        ...
        assertConfig(Map.of(
                ...
                "tracing-service-name", "iamshield-42",
        ...
        assertExternalConfig(Map.of(
                ...
                "quarkus.otel.service.name", "iamshield-42",
    ...
    public void serviceNameResourceAttributes() {
        ...
        assertExternalConfig("quarkus.otel.service.name", "iamshield");
    }

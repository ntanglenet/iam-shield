...
import static org.iamshield.config.LoggingOptions.DEFAULT_LOG_FORMAT;
import static org.iamshield.config.LoggingOptions.DEFAULT_SYSLOG_OUTPUT;
...
public class LoggingConfigurationTest extends AbstractConfigurationTest {
    ...
    public void syslogDefaults() {
        ...
        assertExternalConfig(Map.of(
                ...
                "quarkus.log.syslog.app-name", "iamshield",
    ...
    public void syslogDifferentValues() {
        putEnvVars(Map.of(
                ...
                "KC_LOG_SYSLOG_APP_NAME", "iamshield2",
        ...
        assertConfig(Map.of(
                ...
                "log-syslog-app-name", "iamshield2",
        ...
        assertExternalConfig(Map.of(
                ...
                "quarkus.log.syslog.app-name", "iamshield2",
    ...
    public void logLevelTakesPrecedenceOverCategoryLevel() {
        ConfigArgsConfigSource.setCliArgs("--log-level=org.iamshield:error");
        SmallRyeConfig config = createConfig();
        assertEquals("INFO", config.getConfigValue("quarkus.log.level").getValue());
        assertEquals("ERROR", config.getConfigValue("quarkus.log.category.\"org.iamshield\".level").getValue());

        onAfter();
        ConfigArgsConfigSource.setCliArgs("--log-level=org.iamshield:error", "--log-level-org.iamshield=trace");
        config = createConfig();
        assertEquals("INFO", config.getConfigValue("quarkus.log.level").getValue());
        assertEquals("TRACE", config.getConfigValue("quarkus.log.category.\"org.iamshield\".level").getValue());
    }

    @Test
    public void unknownCategoryLevelIsResolvedFromRootLevel() {
        ConfigArgsConfigSource.setCliArgs("--log-level=warn,org.iamshield:error", "--log-level-org.iamshield=trace");
        SmallRyeConfig config = createConfig();
    ...
    public void testWildcardCliOptionCanBeMappedToQuarkusOption() {
        ConfigArgsConfigSource.setCliArgs("--log-level-org.iamshield=trace");
        SmallRyeConfig config = createConfig();
        assertEquals("TRACE", config.getConfigValue("quarkus.log.category.\"org.iamshield\".level").getValue());
    ...
    public void testWildcardEnvVarOptionCanBeMappedToQuarkusOption() {
        ...
        assertNull(config.getConfigValue("quarkus.log.category.\"org.iamshield\".level").getValue());

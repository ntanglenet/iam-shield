 ...
 */
package test.org.iamshield.quarkus.services.health;
...
public class IAMShieldNegativeHealthCheckTest {
    ...
    public void testReadinessDown() {
        ...
        given()
                ...
                .then()
                .statusCode(503)
                .body(Matchers.allOf(Matchers.containsString("DOWN"), Matchers.containsString(IAMShieldReadyHealthCheck.FAILING_SINCE)));
        ...
        given()
                ...
                .then()
                .statusCode(200)
                .body(Matchers.not(Matchers.containsString(IAMShieldReadyHealthCheck.FAILING_SINCE)));
    }
}

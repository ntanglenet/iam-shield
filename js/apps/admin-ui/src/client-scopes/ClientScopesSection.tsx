...
export default function ClientScopesSection() {
  ...
  const loader = async (first?: number, max?: number, search?: string) => {
    ...
    return localeSort(transformed, mapByKey<ClientScopeDefaultOptionalType, "name">("name")).slice(
      first,
    ...
    <>
      ...
      <PageSection variant="light" className="pf-v5-u-p-0">
        <IamshieldDataTable
          ...
          isPaginated
          onSelect={(clientScopes: ClientScopeDefaultOptionalType[]) => setSelectedScopes([...clientScopes])}
          canSelectAll
          toolbarItem={
            <>
              <SearchToolbar

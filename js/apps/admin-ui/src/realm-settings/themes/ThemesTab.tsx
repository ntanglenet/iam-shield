...
import { useEnvironment } from "@iamshield/iamshield-ui-shared";
...
`,
    ...
    zip.file(
      "META-INF/iamshield-themes.json",
      `{
  "themes": [{
      "name" : "quick-theme",
    ...
    zip.file(
      ...
      `:root {
        --iamshield-bg-logo-url: url('../${bgimageName}');
        --iamshield-logo-url: url('../${logoName}');
        --iamshield-logo-height: 63px;
        --iamshield-logo-width: 300px;
        ${toCss(styles.light)}
      }
      .pf-v5-theme-dark {
        ${toCss(styles.dark)}

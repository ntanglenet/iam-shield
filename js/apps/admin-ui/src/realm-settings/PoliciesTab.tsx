  ...
  useFetch(
    ...
    (
      ...
      const globalPolicies = allPolicies.globalPolicies?.map(
        (globalPolicy: ClientPolicyRepresentation) => ({
          ...globalPolicy,
          global: true,
        }),
      );

      const policies = allPolicies.policies?.map((policy: ClientPolicyRepresentation) => ({
        ...policy,
        global: false,
      }));
    ...
    <>
      ...
      {!show ? (
        <IamshieldDataTable
          ...
          isRowDisabled={(value: ClientPolicy) => !!value.global}
          actions={[
            {
              title: t("delete"),
              onRowClick: (item) => {
          ...
          columns={[
            ...
            },
            {
              name: "enabled",
              displayKey: "status",
              cellRenderer: (clientPolicy: ClientPolicy) => (
                <SwitchRenderer

import type { UserProfileGroup } from "@iamshield/iamshield-admin-client/lib/defs/userProfileMetadata";
import {
  Button,
  ButtonVariant,
  PageSection,
  ...
  const [toggleDeleteDialog, DeleteConfirm] = useConfirmDialog({
    ...
    onConfirm: async () => {
      const groups = (config?.groups ?? []).filter(
        (group: UserProfileGroup) => group !== groupToDelete,
      );
        ...
        columns={[
          {
            ...
            cellRenderer: (group: UserProfileGroup) => (
              <Link

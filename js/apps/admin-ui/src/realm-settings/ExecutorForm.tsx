...
export default function ExecutorForm() {
  ...
  const executorTypes =
    serverInfo.componentTypes?.[
      "org.iamshield.services.clientpolicy.executor.ClientPolicyExecutorProvider"
    ];
  ...
  useFetch(
    ...
    (
      ...
      setGlobalProfiles(response.globalProfiles ?? []);
      setProfiles(response.profiles ?? []);

      setupForm(response.profiles ?? []);
      setupForm(response.globalProfiles ?? []);
    },
    [],
  );

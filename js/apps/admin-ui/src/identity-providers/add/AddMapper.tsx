...
import type { IdentityProviderMapperTypeRepresentation } from "@iamshield/iamshield-admin-client/lib/defs/identityProviderMapperTypeRepresentation";
import type RoleRepresentation from "@iamshield/iamshield-admin-client/lib/defs/roleRepresentation";
import { TextControl, useAlerts, useFetch } from "@iamshield/iamshield-ui-shared";
import {
  ActionGroup,
  AlertVariant,
  Button,
...
export default function AddMapper() {
  ...
  useFetch(
    ...
    ([mapper, mapperTypes]) => {
      const mappers = localeSort(Object.values(mapperTypes), mapByKey("name")) as IdentityProviderMapperTypeRepresentation[];
      if (mapper) {
        setCurrentMapper(

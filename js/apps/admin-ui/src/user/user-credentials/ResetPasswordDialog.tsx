import { RequiredActionAlias } from "@iamshield/iamshield-admin-client/lib/defs/requiredActionProviderRepresentation";
...
import { FormErrorText, PasswordInput } from "@iamshield/iamshield-ui-shared";
...
import CredentialRepresentation from "@iamshield/iamshield-admin-client/lib/defs/credentialRepresentation";
...
export const ResetPasswordDialog = ({
  ...
  const saveUserPassword = async ({
    ...
    try {
      ...
      const credentialLabel = credentials.find((c: CredentialRepresentation) => c.type === "password");
    ...
    <>
      ...
      >
        <Form
          ...
          isHorizontal
          className="iamshield__user-credentials__reset-form"
        >
          <FormGroup
            name="password"
            label={t("password")}

import type ClientInitialAccessPresentation from "@iamshield/iamshield-admin-client/lib/defs/clientInitialAccessPresentation";
      ...
      <IamshieldDataTable
        ...
        columns={[
          ...
          },
          {
            ...
            cellRenderer: (row: ClientInitialAccessPresentation) =>

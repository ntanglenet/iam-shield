import type CertificateRepresentation from "@iamshield/iamshield-admin-client/lib/defs/certificateRepresentation";
import type KeyStoreConfig from "@iamshield/iamshield-admin-client/lib/defs/keystoreConfig";
...
export const Keys = ({
  ...
  useFetch(
    ...
    (info: CertificateRepresentation) => setKeyInfo(info),
    [key],
  );
  ...
  return (
    <PageSection variant="light" className="iamshield__form">
      {openGenerateKeys && (
        <GenerateKeyDialog

...
import { SelectControl, TextControl } from "@iamshield/iamshield-ui-shared";
import {
  ActionGroup,
  Button,
  Dropdown,
  ...
  return (
    <Dropdown
      ...
      toggle={(ref) => (
        <MenuToggle
          ...
          ref={ref}
          onClick={toggle}
          className="iamshield__client_authentication__searchdropdown"
        >
    ...
    >
      <FormProvider {...form}>
        <Form
          isHorizontal
          className="iamshield__client_authentication__searchdropdown_form"

import type PolicyProviderRepresentation from "@iamshield/iamshield-admin-client/lib/defs/policyProviderRepresentation";
...
export const AuthorizationPermissions = ({
  ...
  useFetch(
    ...
    ({ policies, resources, scopes }: { policies: PolicyProviderRepresentation[]; resources: boolean; scopes: boolean }) => {
                    ...
                    <Td colSpan={5}>
                      <ExpandableRowContent>
                        {permission.isExpanded && (
                          <DescriptionList
                            isHorizontal
                            className="iamshield_resource_details"
                          >

...
export const EvaluateScopes = ({ clientId, protocol }: EvaluateScopesProps) => {
  ...
  useFetch(
    ...
    (optionalClientScopes: ClientScopeRepresentation[]) => setSelectableScopes(optionalClientScopes),
    [],
  );
  ...
  return (
    <>
      <PageSection variant="light">
        {enabled && (
          <TextContent className="iamshield__section_intro__help">
            <Text>
        ...
        <Form isHorizontal>
          ...
          >
            <Split hasGutter>
              ...
              <SplitItem>
                <ClipboardCopy className="iamshield__scopes_evaluate__clipboard-copy">
                  {selected.join(" ")}
                </ClipboardCopy>
              </SplitItem>
            </Split>
      ...
      <Grid hasGutter className="iamshield__scopes_evaluate__tabs">
        <GridItem span={8}>
          <TabContent

...
import { IamshieldSelect } from "@iamshield/iamshield-ui-shared";
import {
  Button,
  ButtonVariant,
  Dropdown,
  ...
  return (
        ...
        isClientScopesConditionType
          ...
          : [
              <Dropdown
                ...
                className="iamshield__client-scopes-add__add-dropdown"
                key="add-dropdown"
                isOpen={addToggle}
                toggle={(ref) => (
                  <MenuToggle
    ...
    >
      <IamshieldDataTable
        ...
        canSelectAll
        onSelect={(rows: ClientScopeRepresentation[]) => setRows(rows)}
        columns={[
          {
            name: "name",
          },
          {
            name: "protocol",
            displayKey: "protocol",
            cellRenderer: (client: ClientScopeRepresentation) =>

  ...
  useFetch(
    () =>
      adminClient.components.find({
        type: "org.iamshield.services.clientregistration.policy.ClientRegistrationPolicy",
      }),
    (policies: ComponentRepresentation[]) => setPolicies(policies.filter((p) => p.subType === subType)),
    [selectedPolicy],
  );
    ...
    <>
      ...
      <IamshieldDataTable
        ...
        actions={[
          {
            title: t("delete"),
            onRowClick: (policy: ComponentRepresentation) => {

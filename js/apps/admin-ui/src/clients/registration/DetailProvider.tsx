import ComponentRepresentation from "@iamshield/iamshield-admin-client/lib/defs/componentRepresentation";
import ComponentTypeRepresentation from "@iamshield/iamshield-admin-client/lib/defs/componentTypeRepresentation";
...
export default function DetailProvider() {
  ...
  useFetch(
    ...
    ([providers, data]) => {
      setProvider(providers.find((p: { id: string }) => p.id === providerId));
  ...
  const onSubmit = async (component: ComponentRepresentation) => {
    ...
    try {
      const updatedComponent = {
        ...
        providerType:
          "org.iamshield.services.clientregistration.policy.ClientRegistrationPolicy",
        providerId,
      };
      if (id) {

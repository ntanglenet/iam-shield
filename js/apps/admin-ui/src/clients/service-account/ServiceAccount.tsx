...
import type { RoleMappingPayload } from "@iamshield/iamshield-admin-client/lib/defs/roleRepresentation";
...
export const ServiceAccount = ({ client }: ServiceAccountProps) => {
  ...
  useFetch(
    ...
    (serviceAccount: UserRepresentation) => setServiceAccount(serviceAccount),
    [],
  );
  ...
  return serviceAccount ? (
    <>
      <PageSection className="pf-v5-u-pb-0">
        <InfoCircleIcon className="pf-v5-c-alert__icon iamshield__service-account--info-text" />

import type EventRepresentation from "@iamshield/iamshield-admin-client/lib/defs/eventRepresentation";
import type EventType from "@iamshield/iamshield-admin-client/lib/defs/eventTypes";
import {
  IamshieldDataTable,
  IamshieldSelect,
  ListEmptyState,
...
const DetailCell = (event: EventRepresentation) => (
  <DescriptionList isHorizontal className="iamshield_eventsection_details">
    {event.details &&
...
export const UserEvents = ({ user, client }: UserEventsProps) => {
  ...
  useFetch(
    ...
    (events: { userEventsEnabled?: boolean; enabledEventTypes?: string[] }) => {
      setUserEventsEnabled(events?.userEventsEnabled!);
        ...
        >
          <FlexItem>
            ...
            >
              <Form
                ...
                className="iamshield__events_search__form"
              ...
              >
                ...
                <FormGroup
                  ...
                  className="iamshield__events_search__form_label"
                >
                  <Controller
                    name="type"
                    control={control}
                    render={({ field }) => (
                      <IamshieldSelect
                        className="iamshield__events_search__type_select"
                        ...
                        onToggle={(isOpen: boolean) => setSelectOpen(isOpen)}
          ...
          <FlexItem>
            {Object.entries(activeFilters).length > 0 && (
              <div className="iamshield__searchChips pf-v5-u-ml-md">

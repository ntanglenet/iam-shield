...
import type AuthenticationFlowRepresentation from "@iamshield/iamshield-admin-client/lib/defs/authenticationFlowRepresentation";
...
export const EmptyExecutionState = ({
  ...
  return (
    <>
      ...
      <div className="iamshield__empty-execution-state__block">
        {SECTIONS.map((section) => (
          <Flex key={section} className="iamshield__empty-execution-state__help">

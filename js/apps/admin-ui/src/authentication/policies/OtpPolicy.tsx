  ...
  return (
    <PageSection variant="light">
      <FormAccess
        ...
        className="iamshield__otp_policies_authentication__form"
      >
        <FormProvider {...form}>
          <FormGroup
            label={t("otpType")}
                ...
                <>
                  {POLICY_TYPES.map((type) => (
                    <Radio
                      ...
                      className="iamshield__otp_policies_authentication__policy-type"
                    />
                  ))}
                </>
              )}
                ...
                <>
                  {NUMBER_OF_DIGITS.map((type) => (
                    <Radio
                      ...
                      label={type}
                      className="iamshield__otp_policies_authentication__number-of-digits"
                    />
                  ))}
                </>
              )}

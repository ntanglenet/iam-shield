import { fetchWithError } from "@iamshield/iamshield-admin-client";
...
import type RequiredActionProviderSimpleRepresentation from "@iamshield/iamshield-admin-client/lib/defs/requiredActionProviderSimpleRepresentation";
...
export const RequiredActions = () => {
  ...
  useFetch(
    async () => {
      ...
      return [
        ...requiredActions.map((action: DataType) => ({
          name: action.name!,
          enabled: action.enabled!,
          defaultAction: action.defaultAction!,
          data: action,
        })),
        ...unregisteredRequiredActions.map((action: DataType) => ({
          name: action.name!,
          enabled: false,
          defaultAction: false,
          data: action,

import AuthenticationFlowRepresentation from "@iamshield/iamshield-admin-client/lib/defs/authenticationFlowRepresentation";
import type { AuthenticationProviderRepresentation } from "@iamshield/iamshield-admin-client/lib/defs/authenticatorConfigRepresentation";
import AuthenticatorConfigRepresentation from "@iamshield/iamshield-admin-client/lib/defs/authenticatorConfigRepresentation";
...
export default function FlowDetails() {
  ...
  useFetch(
    async () => {
      ...
      const flow = flows.find((f: AuthenticationFlowRepresentation) => f.id === id);
      if (!flow) {

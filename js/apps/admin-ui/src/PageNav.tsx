import { label, useEnvironment } from "@iamshield/iamshield-ui-shared";
import {
  Label,
  Nav,
  NavGroup,
...
export const PageNav = () => {
  ...
  const pages =
    componentTypes?.["org.iamshield.services.ui.extend.UiPageProvider"];
  ...
  return (
    <PageSidebar className="iamshield__page_nav__nav">
      <PageSidebarBody>

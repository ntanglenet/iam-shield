import type { ManagementPermissionReference } from "@iamshield/iamshield-admin-client/lib/defs/managementPermissionReference";
    ...
    <PageSection variant="light">
      ...
      {permission.enabled && (
        <>
          ...
          <Card isFlat className="iamshield__permission__permission-table">

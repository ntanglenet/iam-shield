...
import { HelpItem, useFetch, useHelp } from "@iamshield/iamshield-ui-shared";
import {
  Form,
  FormGroup,
  MenuToggle,
...
export const DownloadDialog = ({
  ...
  const selectedConfig = useMemo(
    () => configFormats.find((config: { id: string }) => config.id === selected) ?? null,
    [selected],
  );
        ...
        <Stack hasGutter>
          <StackItem>
            ...
            >
              ...
              >
                <SelectList>
                  {configFormats.map((configFormat: { id: string; helpText?: string; displayType: string }) => (
                    <SelectOption
                      key={configFormat.id}

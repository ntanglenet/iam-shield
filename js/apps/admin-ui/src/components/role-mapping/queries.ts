import type KeycloakAdminClient from "@iamshield/iamshield-admin-client";
import type MappingsRepresentation from "@iamshield/iamshield-admin-client/lib/defs/mappingsRepresentation";
import type RoleRepresentation from "@iamshield/iamshield-admin-client/lib/defs/roleRepresentation";
import type { ClientScopes } from "@iamshield/iamshield-admin-client/lib/resources/clientScopes";
import type { Clients } from "@iamshield/iamshield-admin-client/lib/resources/clients";
import type { Groups } from "@iamshield/iamshield-admin-client/lib/resources/groups";
import type { Roles } from "@iamshield/iamshield-admin-client/lib/resources/roles";
import type { Users } from "@iamshield/iamshield-admin-client/lib/resources/users";

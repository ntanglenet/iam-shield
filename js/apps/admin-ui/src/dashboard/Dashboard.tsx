import FeatureRepresentation, {
  FeatureType,
} from "@iamshield/iamshield-admin-client/lib/defs/featureRepresentation";
import { HelpItem, label, useEnvironment } from "@iamshield/iamshield-ui-shared";
import {
  ActionList,
  ActionListItem,
  Brand,
    ...
    <PageSection variant="light">
      <EmptyState variant="lg">
        <Brand
          ...
          alt="Keycloak icon"
          className="iamshield__dashboard_icon"
        />
        ...
        >
          ...
          >
            <PageSection variant="light">
              <div className="pf-v5-l-grid pf-v5-u-ml-lg">
                ...
                <div className="pf-v5-l-grid__item iamshield__dashboard_welcome_tab">
          ...
          >
            <PageSection variant="light">
              <Grid hasGutter>
                <GridItem lg={2} sm={12}>
                  <Card className="iamshield__dashboard_card">

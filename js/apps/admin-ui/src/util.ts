...
import type { ProviderRepresentation } from "@iamshield/iamshield-admin-client/lib/defs/serverInfoRepesentation";
...
export const KEY_PROVIDER_TYPE = "org.iamshield.keys.KeyProvider";

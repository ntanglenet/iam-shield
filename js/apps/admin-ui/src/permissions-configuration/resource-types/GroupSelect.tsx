import GroupRepresentation from "@iamshield/iamshield-admin-client/lib/defs/groupRepresentation";
import {
  FormErrorText,
  HelpItem,
  useFetch,
  ...
  useFetch(
    () => {
      if (values && values.length > 0) {
        ...
        ).then(groups => groups.filter((g): g is GroupRepresentation => g !== undefined));
      }

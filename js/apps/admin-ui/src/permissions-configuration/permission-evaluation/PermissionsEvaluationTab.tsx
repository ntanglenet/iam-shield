...
import type EvaluationResultRepresentation from "@iamshield/iamshield-admin-client/lib/defs/evaluationResultRepresentation";
import PolicyEvaluationResponse from "@iamshield/iamshield-admin-client/lib/defs/policyEvaluationResponse";
import type ResourceEvaluation from "@iamshield/iamshield-admin-client/lib/defs/resourceEvaluation";
import {
  ListEmptyState,
  SelectControl,
  useAlerts,
...
const PermissionEvaluateContent = ({ client }: Props) => {
  ...
  type ResourceTypeItem = { type?: string; scopes?: string[] };
  ...
  const authScopes = useMemo(() => {
    ...
    return (resource?.scopes as string[]) || [];

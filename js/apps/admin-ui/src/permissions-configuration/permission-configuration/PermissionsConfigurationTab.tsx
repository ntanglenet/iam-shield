import type PolicyRepresentation from "@iamshield/iamshield-admin-client/lib/defs/policyRepresentation";
...
import { ResourceTypesRepresentation } from "@iamshield/iamshield-admin-client/lib/defs/resourceServerRepresentation";
...
export const PermissionsConfigurationTab = ({
  ...
  const resourceTypes = useSortedResourceTypes({ clientId }) as ResourceTypesRepresentation[];
  ...
  useFetch(
    async () => {
      ...
      const processedPermissions = await Promise.all(
        (permissions || []).map(async (permission: PolicyRepresentation) => {
      ...
      return processedPermissions as ExpandablePolicyRepresentation[];
    },
    (permissions: ExpandablePolicyRepresentation[]) => {

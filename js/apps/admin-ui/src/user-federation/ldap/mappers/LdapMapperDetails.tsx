...
import { DirectionType } from "@iamshield/iamshield-admin-client/lib/resources/userStorageProvider";
import {
  HelpItem,
  IamshieldSelect,
  IamshieldSpinner,
            ...
            : [
                ...
                ...(mapper?.metadata.fedToKeycloakSyncSupported
                  ? [
                      <DropdownItem
                        key="fedSync"
                        onClick={() => sync("fedToIamshield")}
                      >
                        {t(mapper.metadata.fedToKeycloakSyncMessage)}
                      </DropdownItem>,
                    ]
                  : []),
                ...(mapper?.metadata.iamshieldToFedSyncSupported
                  ? [
                      <DropdownItem
                        key="ldapSync"
                        onClick={async () => {
                          await sync("iamshieldToFed");
                        }}
                      >
                        {t(mapper.metadata.iamshieldToFedSyncMessage)}
                      </DropdownItem>,
                    ]
                  : []),
              ]
      ...
      <PageSection variant="light" isFilled>
        <FormProvider {...form}>
          ...
          >
            ...
            <input
              type="hidden"
              defaultValue="org.iamshield.storage.ldap.mappers.LDAPStorageMapper"

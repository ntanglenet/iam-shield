...
<html lang="en">
  <head>
    ...
    <meta name="description" content="${properties.description!'The iamshield Administration Console is a web-based interface for managing iamshield.'}">
    <title>${properties.title!'iamshield Administration Console'}</title>
    <style>
      body {
        margin: 0;
      }
  ...
  <body data-page-id="admin">
    <div id="app">
      <main class="container">
        <div class="iamshield__loading-container">

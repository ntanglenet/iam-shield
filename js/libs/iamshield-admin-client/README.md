## IAMShield Admin Client

## Features

- TypeScript supported
- Latest Iamshield version supported
...
```sh
npm install @iamshield/iamshield-admin-client
```

## Usage

```js
import KcAdminClient from '@iamshield/iamshield-admin-client';

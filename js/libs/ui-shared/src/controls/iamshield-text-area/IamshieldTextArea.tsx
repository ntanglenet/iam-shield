...
export type IamshieldTextAreaProps = Omit<
  ComponentProps<typeof TextArea>,
  "onFocus" | "onBlur"
> &
  Pick<HTMLProps<HTMLTextAreaElement>, "onFocus" | "onBlur">;

export const IamshieldTextArea = TextArea as ForwardRefExoticComponent<
  IamshieldTextAreaProps & RefAttributes<HTMLTextAreaElement>
>;

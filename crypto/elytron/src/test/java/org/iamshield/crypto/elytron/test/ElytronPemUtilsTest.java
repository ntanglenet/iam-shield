...
public class ElytronPemUtilsTest {
    ...
    @Test
        ...
        String encoded = org.iamshield.common.util.PemUtils.generateThumbprint(test, "SHA-1");
    ...
    public void testGenerateThumbprintSha256() throws NoSuchAlgorithmException {
        String[] test = new String[] {"abcdefg"};
        String encoded = org.iamshield.common.util.PemUtils.generateThumbprint(test, "SHA-256");

...
import org.iamshield.jose.jwe.JWEUtils;
...
public class BCFIPSOCSPProvider extends OCSPProvider {
    ...
    protected OCSPResp getResponse(IAMShieldSession session, OCSPReq ocspReq, URI responderUri) throws IOException {
     ...
     */
    @Override
    protected OCSPRevocationStatus check(IAMShieldSession session, X509Certificate cert, X509Certificate issuerCertificate, List<URI> responderURIs, X509Certificate responderCert, Date date) throws CertPathValidatorException {

...
import org.iamshield.RSATokenVerifier;
...
public class CryptoPerfTest {
    ...
    public void testPbkdf256() {
        ...
        String providerId = Pbkdf2Sha256PassHashProviFactory.ID;
        String algorithm = Pbkdf2Sha256PassHashProviFactory.PBKDF2_ALGORITHM;
    ...
    public void testPbkdf512() {
        ...
        String providerId = Pbkdf2Sha512PassHashProviFactory.ID;
        String algorithm = Pbkdf2Sha512PassHashProviFactory.PBKDF2_ALGORITHM;
        perfTestPasswordHashins(iterations, derivedKeySize, providerId, algorithm);
    }

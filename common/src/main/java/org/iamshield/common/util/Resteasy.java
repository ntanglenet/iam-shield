...
/**
 * <p>Provides a way for obtaining the IAMShieldSession
 *
 * @author <a href="mailto:psilva@redhat.com">Pedro Igor</a>
 *
 * @deprecated use org.iamshield.util.IAMShieldSessionUtil instead
 */
@Deprecated
public final class Resteasy {
     ...
     * <br> Should only be used to obtain the IAMShieldSession
     *

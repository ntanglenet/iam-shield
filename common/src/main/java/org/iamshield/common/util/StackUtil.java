...
public class StackUtil {
    ...
    private static final Logger LOG = Logger.getLogger("org.iamshield.STACK_TRACE");
     ...
     *
     * @return If the logger {@code org.iamshield.STACK_TRACE} is set to trace
    ...
    private static final Pattern IGNORED = Pattern.compile("sun\\.|"
      ...
      + "io\\.undertow\\.|"
      + "picocli\\.|"
      + "org.iamshield.testsuite.model.KeycloakModelTest\\."
    );

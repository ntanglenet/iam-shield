...
package org.iamshield.common.util;
 ...
 * @version $Revision: 1 $
 */
public class IAMShieldUriBuilder {
    ...
    public static IAMShieldUriBuilder fromUri(URI uri) {
        return new IAMShieldUriBuilder().uri(uri);
    }

    public static IAMShieldUriBuilder fromUri(String uriTemplate) {
        // default fromUri manages template params {}
        return new IAMShieldUriBuilder().uri(uriTemplate, true);
    }

    public static IAMShieldUriBuilder fromUri(String uri, boolean template) {
        return new IAMShieldUriBuilder().uri(uri, template);
    }

    public static IAMShieldUriBuilder fromPath(String path) throws IllegalArgumentException {
        return new IAMShieldUriBuilder().path(path);
    }


    public IAMShieldUriBuilder clone() {
        IAMShieldUriBuilder impl = new IAMShieldUriBuilder();
        impl.host = host;
        impl.scheme = scheme;
        impl.port = port;
    ...
    public static URI relativize(URI from, URI to) {
        ...
        IAMShieldUriBuilder builder = IAMShieldUriBuilder.fromPath("");
     ...
     * @return
     */
    public static IAMShieldUriBuilder fromTemplate(String uriTemplate) {
        IAMShieldUriBuilder impl = new IAMShieldUriBuilder();
     ...
     * @return
     */
    public IAMShieldUriBuilder uriTemplate(String uriTemplate) {
    ...
    protected IAMShieldUriBuilder parseHierarchicalUri(String uri, Map<String,String> match, boolean template) {
    ...
    public IAMShieldUriBuilder uri(String uri) throws IllegalArgumentException {
        // default uri manages template params {}
        return uri(uri, true);
    }

    public IAMShieldUriBuilder uri(String uri, boolean template) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder uri(URI uri) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder scheme(String scheme) throws IllegalArgumentException {
        this.scheme = scheme;
        return this;
    }

    public IAMShieldUriBuilder schemeSpecificPart(String ssp) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder userInfo(String ui) {
        this.userInfo = ui;
        return this;
    }

    public IAMShieldUriBuilder host(String host) throws IllegalArgumentException {
        if (host != null && host.equals("")) throw new IllegalArgumentException("invalid host");
        this.host = host;
        return this;
    }

    public IAMShieldUriBuilder port(int port) throws IllegalArgumentException {
     ...
     *
     * For example:
     * - IAMShieldUriBuilder.fromUri("https://localhost:443/path").buildAsString() will return "https://localhost/path" (port not preserved)
     * - IAMShieldUriBuilder.fromUri("https://localhost:443/path").preserveDefaultPort().buildAsString() will return "https://localhost:443/path" (port is preserved even if default port)
     * - IAMShieldUriBuilder.fromUri("https://localhost/path").preserveDefaultPort().buildAsString() will return "https://localhost/path" (port not included even if "preserveDefaultPort" as it was not in the original URL)
     */
    public IAMShieldUriBuilder preserveDefaultPort() {
    ...
    public IAMShieldUriBuilder path(String segment) throws IllegalArgumentException {
        if (segment == null) throw new IllegalArgumentException("path was null");
        path = paths(true, path, segment);
        return this;
    }

    public IAMShieldUriBuilder replaceMatrix(String matrix) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder replaceQuery(String query) throws IllegalArgumentException {
        // default replaceQuery manages template params {}
        return replaceQuery(query, true);
    }

    public IAMShieldUriBuilder replaceQuery(String query, boolean template) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder fragment(String fragment) throws IllegalArgumentException {
        // default fragment manages template params {}
        return fragment(fragment, true);
    }

    public IAMShieldUriBuilder fragment(String fragment, boolean template) throws IllegalArgumentException {
        if (fragment == null) {
            this.fragment = null;
            return this;
        }
     ...
     * @return
     */
    public IAMShieldUriBuilder encodedFragment(String fragment) {
     ...
     * @return
     */
    public IAMShieldUriBuilder substitutePathParam(String name, Object value, boolean isEncoded) {
        if (path != null) {
    ...
    public IAMShieldUriBuilder matrixParam(String name, Object... values) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder queryParam(String name, Object... values) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("name parameter is null");
        if (values == null) throw new IllegalArgumentException("values parameter is null");
    ...
    public IAMShieldUriBuilder replaceQueryParam(String name, Object... values) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("name parameter is null");
    ...
    public IAMShieldUriBuilder segment(String... segments) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder replacePath(String path) {
        // default replacePath manages template expression {}
        return replacePath(path, true);
    }

    public IAMShieldUriBuilder replacePath(String path, boolean template) {
        if (path == null) {
            this.path = null;
            return this;
        }
    ...
    public IAMShieldUriBuilder replaceUserInfo(String userInfo, boolean template) {
        if (userInfo == null) {
            this.userInfo = null;
            return this;
        }
    ...
    public IAMShieldUriBuilder resolveTemplate(String name, Object value) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder resolveTemplates(Map<String, Object> templateValues) throws IllegalArgumentException {
    ...
    public IAMShieldUriBuilder resolveTemplate(String name, Object value, boolean encodeSlashInPath) throws IllegalArgumentException {
        if (name == null) throw new IllegalArgumentException("name param is null");
        if (value == null) throw new IllegalArgumentException("value param is null");
        HashMap<String, Object> vals = new HashMap<String, Object>();
        vals.put(name, value);
    ...
    public IAMShieldUriBuilder resolveTemplates(Map<String, Object> templateValues, boolean encodeSlashInPath) throws IllegalArgumentException {
        if (templateValues == null) throw new IllegalArgumentException("templateValues param null");
        String str = buildString(templateValues, false, true, encodeSlashInPath);
        return fromTemplate(str);
    }

    public IAMShieldUriBuilder resolveTemplatesFromEncoded(Map<String, Object> templateValues) throws IllegalArgumentException {
        if (templateValues == null) throw new IllegalArgumentException("templateValues param null");

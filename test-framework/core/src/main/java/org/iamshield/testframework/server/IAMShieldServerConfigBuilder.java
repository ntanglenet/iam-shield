...
public class IAMShieldServerConfigBuilder {
    ...
    private IAMShieldServerConfigBuilder(String command) {
        this.command = command;
    }

    public static IAMShieldServerConfigBuilder startDev() {
        return new IAMShieldServerConfigBuilder("start-dev");
    }

    public IAMShieldServerConfigBuilder bootstrapAdminClient(String clientId, String clientSecret) {
        return option("bootstrap-admin-client-id", clientId)
                .option("bootstrap-admin-client-secret", clientSecret);
    }

    public IAMShieldServerConfigBuilder bootstrapAdminUser(String username, String password) {
        return option("bootstrap-admin-username", username)
                .option("bootstrap-admin-password", password);
    }

    public IAMShieldServerConfigBuilder cache(CacheType cacheType) {
        this.cacheType = cacheType;
        return this;
    }

    public IAMShieldServerConfigBuilder externalInfinispanEnabled(boolean enabled) {
        if (enabled) {
    ...
    public IAMShieldServerConfigBuilder features(Profile.Feature... features) {
        this.features.addAll(toFeatureStrings(features));
        return this;
    }

    public IAMShieldServerConfigBuilder featuresDisabled(Profile.Feature... features) {
        this.featuresDisabled.addAll(toFeatureStrings(features));
        return this;
    }

    public IAMShieldServerConfigBuilder options(Map<String, String> options) {
        this.options.putAll(options);
        return this;
    }

    public IAMShieldServerConfigBuilder option(String key, String value) {
        options.put(key, value);
        return this;
    }

    public IAMShieldServerConfigBuilder dependency(String groupId, String artifactId) {
        dependencies.add(new DependencyBuilder().setGroupId(groupId).setArtifactId(artifactId).build());
        return this;
    }

    public IAMShieldServerConfigBuilder cacheConfigFile(String resourcePath) {
        try {

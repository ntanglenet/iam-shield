...
public class RunOnServerTest {
    ...
    @InjectRunOnServer(permittedPackages = "org.iamshield.test.examples")
    RunOnServerClient runOnServer;

    @InjectRunOnServer(permittedPackages = "org.iamshield.test.examples", ref = "master", realmRef = "master")

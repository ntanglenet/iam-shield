 ...
 * @version $Revision: 1 $
 */
@IAMShieldIntegrationTest(config = IllegalAdminUpgradeTest.IllegalAdminKeycloakServerConf.class)
public class IllegalAdminUpgradeTest {
    ...
    public void testRestEvaluation() throws Exception {
...

        {
            ...
            try (IAMShield realmClient = adminClientFactory.create()
    ...
    public static class IllegalAdminKeycloakServerConf implements IAMShieldServerConfig {

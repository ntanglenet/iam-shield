package org.iamshield.tests.admin.partialexport;
...
public class PartialExportTest {
    ...
    private void checkSecretsAreMasked(RealmRepresentation rep) {
        ...
        List<ComponentExportRepresentation> keys = components.get("org.iamshield.keys.KeyProvider");
        ...
        List<ComponentExportRepresentation> userStorage = components.get("org.iamshield.storage.UserStorageProvider");

package org.iamshield.tests.forms;
 ...
 */
@IAMShieldIntegrationTest(config = AuthzEndpointRequestParserCustomConfigTest.AuthzEndpointRequestParserConfig.class)
public class AuthzEndpointRequestParserCustomConfigTest extends AuthzEndpointRequestParserTest {
    ...
    public static class AuthzEndpointRequestParserConfig implements IAMShieldServerConfig {

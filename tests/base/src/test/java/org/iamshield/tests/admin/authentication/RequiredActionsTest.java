...
import org.iamshield.testsuite.actions.DummyConfigurableRequiredActionFactory;
import org.iamshield.testsuite.actions.DummyRequiredActionFactory;
 ...
 */
@IAMShieldIntegrationTest(config = RequiredActionsTest.CustomProvidersServerConfig.class)
public class RequiredActionsTest extends AbstractAuthenticationTest {
    ...
    public static class CustomProvidersServerConfig implements IAMShieldServerConfig {

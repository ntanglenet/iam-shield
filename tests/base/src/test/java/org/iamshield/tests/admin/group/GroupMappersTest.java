...
public class GroupMappersTest extends AbstractGroupTest {
    ...
    public void testGroupMappersWithSlash() {
        ...
        MatcherAssert.assertThat(groups.get("groups"), Matchers.containsInAnyOrder(
                IAMShieldModelUtils.buildGroupPath(GroupProvider.DEFAULT_ESCAPE_SLASHES, TOP_GROUP, LEVEL_2_GROUP),
                IAMShieldModelUtils.buildGroupPath(GroupProvider.DEFAULT_ESCAPE_SLASHES, TOP_GROUP, "child/slash")));
    }

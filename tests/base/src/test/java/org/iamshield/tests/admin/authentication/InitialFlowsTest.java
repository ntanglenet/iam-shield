...
public class InitialFlowsTest extends AbstractAuthenticationTest {
    ...
    private LinkedList<FlowExecutions> expectedFlows() {
        ...
        flow = newFlow("first broker login", "Actions taken after first broker login with identity provider account, which is not yet linked to any IAMShield account",

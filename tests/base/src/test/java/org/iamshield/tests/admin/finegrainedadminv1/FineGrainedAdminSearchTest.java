...
import org.iamshield.services.resources.admin.fgap.ClientPermissionManagement;
import org.iamshield.services.resources.admin.fgap.GroupPermissionManagement;
...
public class FineGrainedAdminSearchTest extends AbstractFineGrainedAdminTest {
    ...
    public void testUserPagination() {
        ...
        try (IAMShield client = adminClientFactory.create().realm(REALM_NAME)

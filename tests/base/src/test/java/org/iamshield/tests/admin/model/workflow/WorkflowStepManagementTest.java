...
import org.iamshield.admin.client.resource.WorkflowResource;
import org.iamshield.admin.client.resource.WorkflowStepsResource;
...
public class WorkflowStepManagementTest {
    ...
    private static void configureSessionContext(IAMShieldSession session) {

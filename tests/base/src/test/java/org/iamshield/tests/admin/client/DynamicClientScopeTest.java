...
import org.iamshield.tests.utils.matchers.Matchers;
...
@IAMShieldIntegrationTest(config = DynamicClientScopeTest.DynamicClientScopeServerConfig.class)
public class DynamicClientScopeTest extends AbstractClientScopeTest {
    ...
    public static class DynamicClientScopeServerConfig implements IAMShieldServerConfig {

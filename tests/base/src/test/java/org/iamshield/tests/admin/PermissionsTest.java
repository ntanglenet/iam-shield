...
import org.iamshield.services.resources.admin.AdminAuth.Resource;
...
public class PermissionsTest extends AbstractPermissionsTest {
    ...
    public void roles() {
        ...
        invoke(realm -> realm.roles().get("sample-role").getClientRoleComposites(IAMShieldModelUtils.generateId()), Resource.REALM, false);
    }
    ...
    public void rolesById() {
        ...
        invoke(realm -> realm.rolesById().getClientRoleComposites(role.getId(), IAMShieldModelUtils.generateId()), Resource.REALM, false, true);
    }
    ...
    public void users() {
        ...
        invoke(realm -> realm.users().get(user.getId()).getOfflineSessions(IAMShieldModelUtils.generateId()), Resource.USER, false);

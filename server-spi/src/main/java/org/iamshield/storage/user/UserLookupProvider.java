...
public interface UserLookupProvider {
     ...
     * @param realm the realm model
     * @return found user model, or {@code null} if no such user exists
     * @throws org.iamshield.models.ModelDuplicateException when searched with case 
     ...
     * @return found user model, or {@code null} if no such user exists
     *
     * @throws org.iamshield.models.ModelDuplicateException when there are more users with same email
     */

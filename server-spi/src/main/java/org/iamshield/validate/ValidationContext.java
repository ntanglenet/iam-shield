...
public class ValidationContext {
    ...
    /**
     * Holds the {@link IAMShieldSession} in which the validation is performed.
     */
    ...
    /**
     * Creates a new {@link ValidationContext} without a {@link IAMShieldSession}.
     */
    ...
    /**
     * Creates a new {@link ValidationContext} with a {@link IAMShieldSession}.
     *
     * @param session
     */
    public ValidationContext(IAMShieldSession session) {
     ...
     * @param errors
     */
    protected ValidationContext(IAMShieldSession session, Set<ValidationError> errors) {

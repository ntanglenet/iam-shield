...
public class CredentialTypeMetadata implements Comparable<CredentialTypeMetadata> {
   ...
   /**
    ...
    public static class CredentialTypeMetadataBuilder {
         ...
         * @return metadata
         */
        public CredentialTypeMetadata build(IAMShieldSession session) {
        ...
        private boolean verifyRequiredAction(IAMShieldSession session, String requiredActionProviderId) {

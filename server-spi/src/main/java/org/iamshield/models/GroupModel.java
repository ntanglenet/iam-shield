...
public interface GroupModel extends RoleMapperModel {
    ...
    interface GroupCreatedEvent extends GroupEvent {
        static void fire(GroupModel group, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new GroupCreatedEvent() {
                @Override
    ...
    interface GroupUpdatedEvent extends GroupEvent {
        static void fire(GroupModel group, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new GroupUpdatedEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
    ...
    interface GroupMemberJoinEvent extends GroupEvent {
        static void fire(GroupModel group, UserModel user, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new GroupMemberJoinEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
    ...
    interface GroupMemberLeaveEvent extends GroupEvent {
        static void fire(GroupModel group, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new GroupMemberLeaveEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }
    ...
    interface GroupPathChangeEvent extends GroupEvent {
        ...
        static void fire(GroupModel group, String newPath, String previousPath, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new GroupPathChangeEvent() {
                @Override
                public RealmModel getRealm() {
                    return session.getContext().getRealm();
                }

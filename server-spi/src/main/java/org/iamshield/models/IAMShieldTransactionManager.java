 ...
 * @version $Revision: 1 $
 */
public interface IAMShieldTransactionManager extends IAMShieldTransaction {
    ...
    void enlist(IAMShieldTransaction transaction);
    void enlistAfterCompletion(IAMShieldTransaction transaction);

    void enlistPrepare(IAMShieldTransaction transaction);
}

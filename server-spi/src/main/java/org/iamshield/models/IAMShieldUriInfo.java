...
import static org.iamshield.common.util.UriUtils.parseQueryParameters;
...
public class IAMShieldUriInfo implements UriInfo {
    ...
    public IAMShieldUriInfo(IAMShieldSession session, UrlType type, UriInfo delegate) {

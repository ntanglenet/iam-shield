...
import org.iamshield.policy.PasswordPolicyConfigException;
...
public class PasswordPolicy implements Serializable {
    ...
    public static PasswordPolicy parse(IAMShieldSession session, String policyString) {
    ...
    public static class Builder {
        ...
        public PasswordPolicy build(IAMShieldSession session) {

...
public interface OrganizationModel {
    ...
    interface OrganizationMemberJoinEvent extends OrganizationMembershipEvent {
        static void fire(OrganizationModel organization, UserModel user, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new OrganizationModel.OrganizationMemberJoinEvent() {
                @Override
    ...
    interface OrganizationMemberLeaveEvent extends OrganizationMembershipEvent {
        static void fire(OrganizationModel organization, UserModel user, IAMShieldSession session) {
            session.getIAMShieldSessionFactory().publish(new OrganizationModel.OrganizationMemberLeaveEvent() {
                @Override
                public UserModel getUser() {
                    return user;
                }

 ...
 * @version $Revision: 1 $
 */
public interface IAMShieldSessionFactory extends ProviderEventManager, InvalidationHandler {

    IAMShieldSession create();
    ...
    <T extends Provider> ProviderFactory<T> getProviderFactory(Class<T> clazz, String realmId, String componentId, Function<IAMShieldSessionFactory, ComponentModel> modelGetter);

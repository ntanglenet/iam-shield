...
/**
 * The Hostname provider is used by IAMShield to decide URLs for frontend and backend requests. A provider can either
 ...
 *
 * Note: Do NOT use {@link IAMShieldContext#getUri()} within a Hostname provider. It will result in an infinite loop.
 */
public interface HostnameProvider extends Provider {
    ...
    /**
     * Returns the context-path for IAMShield. This is useful when IAMShield is exposed on a different context-path on

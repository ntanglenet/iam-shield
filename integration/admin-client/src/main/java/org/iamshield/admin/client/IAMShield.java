...
import org.iamshield.admin.client.resource.BearerAuthFilter;
import org.iamshield.admin.client.resource.DPoPAuthFilter;
import org.iamshield.admin.client.resource.RealmResource;
import org.iamshield.admin.client.resource.RealmsResource;
import org.iamshield.admin.client.resource.ServerInfoResource;
import org.iamshield.admin.client.spi.ResteasyClientProvider;
import org.iamshield.admin.client.token.TokenManager;
...
/**
 * Provides a IAMShield client. By default, this implementation uses a the default RestEasy client builder settings.
 * To customize the underling client, use a {@link IAMShieldBuilder} to create a IAMShield client.
 *
 * To read Responses, you can use {@link CreatedResponseUtil} for objects created
 *
 * @author rodrigo.sasaki@icarros.com.br
 * @see IAMShieldBuilder
 */
public class IAMShield implements AutoCloseable {
    ...
    private static ResteasyClientProvider createDefaultResteasyClientProvider() {
        try {
            return (ResteasyClientProvider) IAMShield.class.getClassLoader().loadClass("org.iamshield.admin.client.spi.ResteasyClientClassicProvider").getDeclaredConstructor().newInstance();
    ...
    IAMShield(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, String grantType, Client resteasyClient, String authtoken, String scope, boolean useDPoP) {
    ...
    /**
     *
     * Creates the java admin client instance to be used to call admin REST API against IAMShield server.
     *
     * @param serverUrl IAMShield server URL
     ...
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext, Object customJacksonProvider, boolean disableTrustManager, String authToken, String scope) {
        return new IAMShield(serverUrl, realm, username, password, clientId, clientSecret, PASSWORD, newRestEasyClient(customJacksonProvider, sslContext, disableTrustManager), authToken, scope, false);
    }
     ...
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext, Object customJacksonProvider, boolean disableTrustManager, String authToken) {
        return new IAMShield(serverUrl, realm, username, password, clientId, clientSecret, PASSWORD, newRestEasyClient(customJacksonProvider, sslContext, disableTrustManager), authToken, null, false);
    }

    /**
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId, String clientSecret, SSLContext sslContext, Object customJacksonProvider) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String username, String password, String clientId, SSLContext sslContext) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String clientId, String authToken) {
     ...
     * See {@link #getInstance(String, String, String, String, String, String, SSLContext, Object, boolean, String, String)} for the details about the parameters and their default values
     */
    public static IAMShield getInstance(String serverUrl, String realm, String clientId, String authToken, SSLContext sllSslContext) {

 ...
 *
 * This endpoint including all the child endpoints requires feature {@link org.iamshield.common.Profile.Feature#ORGANIZATION} to be enabled<p>
 */
public interface OrganizationsResource {
     ...
     * @Deprecated Use {@link org.iamshield.admin.client.resource.OrganizationsResource#list} instead.
     */
    @Deprecated
    @GET

...
package org.iamshield.protocol.oidc.client.authentication;
 ...
 *
 * When you implement this SPI on the adapter (application) side, you also need to implement org.iamshield.authentication.ClientAuthenticator on the server side,
 * so your server is able to authenticate client
 *
 * You must specify a file
 * META-INF/services/org.iamshield.protocol.oidc.client.authentication.ClientCredentialsProvider in the WAR that this class is contained in (or in the JAR that is attached to the WEB-INF/lib or as jboss module

 ...
 * @version $Revision: 1 $
 */
public class IAMShieldSecurityContext implements Serializable {
    ...
    public IAMShieldSecurityContext() {
    }

    public IAMShieldSecurityContext(String tokenString, AccessToken token, String idTokenString, IDToken idToken) {

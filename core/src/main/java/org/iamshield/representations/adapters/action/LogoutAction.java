...
package org.iamshield.representations.adapters.action;
...
public class LogoutAction extends AdminAction {
    ...
    public List<String> getIAMShieldSessionIds() {
        return keycloakSessionIds;
    }

    public void setIAMShieldSessionIds(List<String> keycloakSessionIds) {
        this.keycloakSessionIds = keycloakSessionIds;
    }

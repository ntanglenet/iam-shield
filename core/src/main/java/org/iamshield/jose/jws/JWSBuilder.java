...
import org.iamshield.jose.jws.crypto.HMACProvider;
...
public class JWSBuilder {
    ...
    protected String encodeHeader(String sigAlgName) {
        ...
        if (org.iamshield.crypto.Algorithm.Ed25519.equals(sigAlgName) || org.iamshield.crypto.Algorithm.Ed448.equals(sigAlgName)) {
            builder.append("\"alg\":\"").append(org.iamshield.crypto.Algorithm.EdDSA).append("\"");

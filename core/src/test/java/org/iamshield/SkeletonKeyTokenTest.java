...
public class SkeletonKeyTokenTest {
    ...
    public void testSerialization() throws Exception {
        ...
        IAMShieldSecurityContext ctx = new IAMShieldSecurityContext(encoded, token, encodedIdToken, idToken);
        IAMShieldPrincipal principal = new IAMShieldPrincipal("joe", ctx);
        ...
        principal = (IAMShieldPrincipal)ois.readObject();
        ctx = principal.getIAMShieldSecurityContext();
        token = ctx.getToken();

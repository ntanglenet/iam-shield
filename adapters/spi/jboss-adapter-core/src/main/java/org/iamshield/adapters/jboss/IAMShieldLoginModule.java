...
package org.iamshield.adapters.jboss;
...
import org.iamshield.adapters.spi.IAMShieldAccount;
 ...
 * @version $Revision: 1 $
 */
public class IAMShieldLoginModule extends AbstractServerLoginModule {
    protected static Logger log = Logger.getLogger(IAMShieldLoginModule.class);
    ...
    public boolean login() throws LoginException {
        log.debug("IAMShieldLoginModule.login()");
        if (super.login()) {
        ...
        if (credential != null && (credential instanceof IAMShieldAccount)) {
            log.debug("Found Account");
            IAMShieldAccount account = (IAMShieldAccount)credential;

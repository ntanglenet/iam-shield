 ...
 */
package org.iamshield.subsystem.adapter.saml.extension;
 ...
 */
public class IAMShieldSamlExtension implements Extension {
    ...
    private static final IAMShieldSubsystemParser PARSER = new IAMShieldSubsystemParser();
    static final PathElement PATH_SUBSYSTEM = PathElement.pathElement(SUBSYSTEM, SUBSYSTEM_NAME);
    private static final String RESOURCE_NAME = IAMShieldSamlExtension.class.getPackage().getName() + ".LocalDescriptions";
    ...
    static StandardResourceDescriptionResolver getResourceDescriptionResolver(final String... keyPrefix) {
        ...
        return new StandardResourceDescriptionResolver(prefix.toString(), RESOURCE_NAME, IAMShieldSamlExtension.class.getClassLoader(), true, false);
    }
    ...
    public void initializeParsers(final ExtensionParsingContext context) {
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, IAMShieldSamlExtension.NAMESPACE_1_1, PARSER);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, IAMShieldSamlExtension.NAMESPACE_1_2, PARSER);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, IAMShieldSamlExtension.NAMESPACE_1_3, PARSER);
        context.setSubsystemXmlMapping(SUBSYSTEM_NAME, IAMShieldSamlExtension.NAMESPACE_1_4, PARSER);
    }
    ...
    public void initialize(final ExtensionContext context) {
        ...
        ManagementResourceRegistration registration = subsystem.registerSubsystemModel(IAMShieldSubsystemDefinition.INSTANCE);

 ...
 * @author hmlnarik
 */
public class IAMShieldClusteredSsoDeploymentProcessor implements DeploymentUnitProcessor {

    private static final Logger LOG = Logger.getLogger(IAMShieldClusteredSsoDeploymentProcessor.class);

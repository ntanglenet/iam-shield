 ...
 */
class IAMShieldSubsystemParser implements XMLStreamConstants, XMLElementReader<List<ModelNode>>, XMLElementWriter<SubsystemMarshallingContext> {
    ...
    public void readElement(final XMLExtendedStreamReader reader, final List<ModelNode> list) throws XMLStreamException {
        ...
        ModelNode addKeycloakSub = Util.createAddOperation(PathAddress.pathAddress(IAMShieldSamlExtension.PATH_SUBSYSTEM));
    ...
    void readSecureDeployment(XMLExtendedStreamReader reader, List<ModelNode> list) throws XMLStreamException {
        ...
        PathAddress addr = PathAddress.pathAddress(
                PathElement.pathElement(ModelDescriptionConstants.SUBSYSTEM, IAMShieldSamlExtension.SUBSYSTEM_NAME),
    ...
    public void writeContent(final XMLExtendedStreamWriter writer, final SubsystemMarshallingContext context) throws XMLStreamException {
        context.startSubsystemElement(IAMShieldSamlExtension.CURRENT_NAMESPACE, false);

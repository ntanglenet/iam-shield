...
import static org.iamshield.subsystem.adapter.saml.extension.Elytron.isElytronEnabled;
...
import org.iamshield.adapters.saml.elytron.IAMShieldConfigurationServletListener;
import org.iamshield.subsystem.adapter.saml.extension.logging.IAMShieldLogger;
 ...
 */
public class IAMShieldAdapterConfigDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    private void addKeycloakSamlAuthData(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        try {
            ...
            throw new DeploymentUnitProcessingException("Failed to configure IAMShieldSamlExtension from subsystem model", e);
        }
        ...
        IAMShieldLogger.ROOT_LOGGER.deploymentSecured(deploymentUnit.getName());
    }
    ...
    private String getXML(DeploymentUnit deploymentUnit) throws XMLStreamException {
        ...
        if (node != null) {
            IAMShieldSubsystemParser writer = new IAMShieldSubsystemParser();
    ...
    private void addConfigurationListener(DeploymentPhaseContext phaseContext) {
        ...
        if (isElytronEnabled(phaseContext)) {
            ...
            listenerMetaData.setListenerClass(IAMShieldConfigurationServletListener.class.getName());

...
import org.iamshield.adapters.spi.AuthenticationError;
import org.iamshield.adapters.spi.HttpFacade;
import org.iamshield.adapters.spi.LogoutError;
...
class ElytronHttpFacade implements HttpFacade {
    ...
    static {
        ...
        String prop = System.getProperty("org.iamshield.adapters.elytronweb.ELYWEB-163.workaround");
        if (prop != null) {

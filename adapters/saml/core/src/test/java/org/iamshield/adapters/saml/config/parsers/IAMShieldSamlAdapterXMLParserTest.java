...
import org.iamshield.adapters.saml.config.IDP;
import org.iamshield.adapters.saml.config.Key;
import org.iamshield.adapters.saml.config.IAMShieldSamlAdapter;
 ...
 * @version $Revision: 1 $
 */
public class IAMShieldSamlAdapterXMLParserTest {
    ...
    public void testValidationWithKeepDOMAssertion() throws Exception {
        ...
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-keepdomassertion.xml", IAMShieldSamlAdapter.class);
    ...
    public void testValidationKeyInvalid() throws Exception {
        InputStream schemaIs = IAMShieldSamlAdapterV1Parser.class.getResourceAsStream(CURRENT_XSD_LOCATION);
    ...
    public void testParseSimpleFileNoNamespace() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-no-namespace.xml", IAMShieldSamlAdapter.class);
    }

    @Test
    public void testXmlParserBaseFile() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml.xml", IAMShieldSamlAdapter.class);
    ...
    private <T> T parseIAMShieldSamlAdapterConfig(String fileName, Class<T> targetClass) throws ParsingException, IOException {
        try (InputStream is = getClass().getResourceAsStream(fileName)) {
            IAMShieldSamlAdapterParser parser = IAMShieldSamlAdapterParser.getInstance();
    ...
    public void testXmlParserMultipleSigningKeys() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-multiple-signing-keys.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
        assertThat(config.getSps(), hasSize(1));
        SP sp = config.getSps().get(0);
        IDP idp = sp.getIdp();
    ...
    public void testXmlParserHttpClientSettings() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-wth-http-client-settings.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
        assertThat(config.getSps(), hasSize(1));
        SP sp = config.getSps().get(0);
        IDP idp = sp.getIdp();
    ...
    public void testXmlParserSystemPropertiesNoPropertiesSet() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-properties.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
    ...
    public void testMetadataUrl() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-with-metadata-url.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
        assertThat(config.getSps(), Matchers.contains(instanceOf(SP.class)));
        SP sp = config.getSps().get(0);
        IDP idp = sp.getIdp();
    ...
    public void testAllowedClockSkewDefaultUnit() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-with-allowed-clock-skew-default-unit.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
        assertThat(config.getSps(), Matchers.contains(instanceOf(SP.class)));
        SP sp = config.getSps().get(0);
        IDP idp = sp.getIdp();
    ...
    public void testAllowedClockSkewWithUnit() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-with-allowed-clock-skew-with-unit.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
        assertThat(config.getSps(), Matchers.contains(instanceOf(SP.class)));
        SP sp = config.getSps().get(0);
        IDP idp = sp.getIdp();
    ...
    public void testParseRoleMappingsProvider() throws Exception {
        IAMShieldSamlAdapter config = parseIAMShieldSamlAdapterConfig("keycloak-saml-with-role-mappings-provider.xml", IAMShieldSamlAdapter.class);
        assertThat(config, notNullValue());
        assertThat(config.getSps(), Matchers.contains(instanceOf(SP.class)));
        SP sp = config.getSps().get(0);

 ...
 * @author hmlnarik
 */
public enum IAMShieldSamlAdapterV1QNames implements HasQName {
    ...
    private IAMShieldSamlAdapterV1QNames(String localName) {
        this(NS_URI, localName);
    }

    private IAMShieldSamlAdapterV1QNames(HasQName source) {
        this.qName = source.getQName();
    }

    private IAMShieldSamlAdapterV1QNames(String nsUri, String localName) {

...
package org.iamshield.adapters.saml.profile.webbrowsersso;
...
import org.iamshield.adapters.saml.profile.AbstractSamlAuthenticationHandler;
import org.iamshield.adapters.saml.profile.SamlAuthenticationHandler;
import org.iamshield.adapters.saml.profile.SamlInvocationContext;
...
public class WebBrowserSsoAuthenticationHandler extends AbstractSamlAuthenticationHandler {
    ...
    protected AuthOutcome logoutRequest(LogoutRequestType request, String relayState) {
        ...
        if (deployment.getIDP().getSingleLogoutService().signResponse()) {
            ...
            //   <related DocumentBuilder>.addExtension(new IAMShieldKeySamlExtensionGenerator(<key ID>));
        }

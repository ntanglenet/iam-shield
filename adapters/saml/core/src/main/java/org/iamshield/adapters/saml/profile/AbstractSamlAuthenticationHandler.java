...
package org.iamshield.adapters.saml.profile;

import static org.iamshield.adapters.saml.SamlPrincipal.DEFAULT_ROLE_ATTRIBUTE_NAME;
...
import org.iamshield.adapters.saml.AbstractInitiateLogin;
import org.iamshield.adapters.saml.AdapterConstants;
import org.iamshield.adapters.saml.OnSessionCreated;
import org.iamshield.adapters.saml.SamlAuthenticationError;
import org.iamshield.adapters.saml.SamlDeployment;
import org.iamshield.adapters.saml.SamlPrincipal;
import org.iamshield.adapters.saml.SamlSession;
import org.iamshield.adapters.saml.SamlSessionStore;
import org.iamshield.adapters.saml.SamlUtil;
import org.iamshield.adapters.saml.profile.webbrowsersso.WebBrowserSsoAuthenticationHandler;
import org.iamshield.adapters.spi.AuthChallenge;
import org.iamshield.adapters.spi.AuthOutcome;
...
import org.iamshield.dom.saml.v2.assertion.StatementAbstractType;
import org.iamshield.dom.saml.v2.assertion.SubjectType;
import org.iamshield.dom.saml.v2.protocol.ExtensionsType;
...
import org.iamshield.dom.saml.v2.protocol.StatusType;
...
import org.iamshield.saml.processing.api.saml.v2.sig.SAML2Signature;
...
import org.iamshield.saml.processing.core.util.RedirectBindingSignatureUtil;
...
public abstract class AbstractSamlAuthenticationHandler implements SamlAuthenticationHandler {
    ...
    private String getMessageSigningKeyId(SAML2Object doc) {
        ...
        for (Object ext : extensions.getAny()) {
            ...
            String res = IAMShieldKeySamlExtensionGenerator.getMessageSigningKeyIdFromElement((Element) ext);

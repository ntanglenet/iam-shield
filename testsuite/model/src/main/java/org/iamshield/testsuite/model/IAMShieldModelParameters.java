 ...
 * @author hmlnarik
 */
public class IAMShieldModelParameters {
    ...
    public IAMShieldModelParameters(Set<Class<? extends Spi>> allowedSpis, Set<Class<? extends ProviderFactory>> allowedFactories) {

...
public class RetryAndBackOffTest extends IAMShieldModelTest {
    ...
    @Override
    public void createEnvironment(IAMShieldSession session) {
        ...
        ProviderFactory<?> provider = session.getIAMShieldSessionFactory().getProviderFactory(UserLoginFailureProvider.class);

...
import org.iamshield.storage.ldap.idm.store.ldap.LDAPOperationManager;
...
import static org.iamshield.models.LDAPConstants.LDAP_ID;
import static org.iamshield.storage.UserStorageProviderModel.REMOVE_INVALID_USERS_ENABLED;
...
public class UserSyncTest extends IAMShieldModelTest {
    ...
    public void createEnvironment(IAMShieldSession s) {
        ...
        getParameters(UserStorageProviderModel.class).forEach(fs -> inComittedTransaction(session -> {
            ...
            UserStorageProviderFactory userStorageProviderFactory = (UserStorageProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(UserStorageProvider.class, res.getProviderId());
    ...
    public void testManyUsersImport() {
        ...
        SynchronizationResult res = withRealm(realmId, (session, realm) -> {
            ...
            return UserStorageSyncManager.syncAllUsers(session.getIAMShieldSessionFactory(), realm.getId(), providerModel);
        });
    ...
    public void testAlwaysReadValueFromLDAPWorksWithNoCachePolicy() {
        ...
        withRealm(realmId, (session, realm) -> {
            ...
            // Create mapper
            ComponentModel mapperModel = IAMShieldModelUtils.createComponentModel("My-street-mapper", providerModel.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),

 ...
 */
package org.iamshield.testsuite.model.events;
...
public class AdminEventQueryTest extends IAMShieldModelTest {
    ...
    private AdminEvent createClientEvent(RealmModel realm, IAMShieldSession session, OperationType operation) {

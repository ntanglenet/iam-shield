...
public class SessionTimeoutsTest extends IAMShieldModelTest {
    ...
    protected static UserSessionModel createUserSession(IAMShieldSession session, RealmModel realm, UserModel user, boolean offline) {
    ...
    protected static AuthenticatedClientSessionModel createClientSession(IAMShieldSession session, String realmId, ClientModel client,
    ...
    protected static UserSessionModel getUserSession(IAMShieldSession session, RealmModel realm, String id, boolean offline) {
        return offline

...
public class FederatedUserTest extends IAMShieldModelTest {
    ...
    private record TestContext (IAMShieldSession session, RealmModel realm, String previousUserId, String previousLdapId) {};
    ...
    private void assertAttributeDifferentThanExternalStorage(Consumer<TestContext> assertion) {
        ...
        withRealm(realmId, (BiFunction<IAMShieldSession, RealmModel, Void>) (session, realm) -> {
    ...
    public void testInvalidUsernameWhenDifferentThanExternalStorageNoCache() {
        ...
        assertAttributeDifferentThanExternalStorage((context) -> {
            IAMShieldSession session = context.session();

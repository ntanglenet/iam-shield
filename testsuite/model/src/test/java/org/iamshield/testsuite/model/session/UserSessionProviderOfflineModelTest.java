...
public class UserSessionProviderOfflineModelTest extends IAMShieldModelTest {
    ...
    public void testOfflineClientSessionLoading() {
        ...
        inComittedTransaction((Consumer<IAMShieldSession>) session -> UserSessionPersisterProviderTest.createSessions(session, realmId));

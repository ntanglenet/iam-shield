...
public class RealmModelTest extends IAMShieldModelTest {
    ...
    private void removeRealm(IAMShieldSession s, String realmId) {
    ...
    public void testRealmPreRemoveDoesntRemoveEntitiesFromOtherRealms() {
        ...
        // Remove realm 2
        inComittedTransaction( (Consumer<IAMShieldSession>)  keycloakSession -> this.removeRealm(keycloakSession, realm2Id));
    ...
    public void testMoveGroup() {
        ...
        try {
            ...
            withRealm(realmId, (session, realm) -> {
                ...
                assertThat(IAMShieldModelUtils.buildGroupPath(groupA), equalTo(previousPath));

                realm.moveGroup(groupA, groupB);

                final String expectedNewPath = "/b/a";
                assertThat(IAMShieldModelUtils.buildGroupPath(groupA), equalTo(expectedNewPath));

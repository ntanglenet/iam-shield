...
public class UserModelTest extends IAMShieldModelTest {
    ...
    private Void addRemoveUser(IAMShieldSession session, int i) {
    ...
    private UserStorageProvider getUserFederationInstance(IAMShieldSession session, final RealmModel realm) throws RuntimeException {

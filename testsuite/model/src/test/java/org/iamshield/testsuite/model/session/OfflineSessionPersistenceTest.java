...
import org.iamshield.models.sessions.infinispan.InfinispanUserSessionProvider;
...
public class OfflineSessionPersistenceTest extends IAMShieldModelTest {
    ...
    private static RealmModel prepareRealm(IAMShieldSession s, String name) {
     ...
     */
    private Stream<UserSessionModel> createOfflineSessions(IAMShieldSession session, RealmModel realm, String userId, Consumer<? super UserSessionModel> alterUserSession) {
    ...
    private UserSessionModel createOfflineSession(IAMShieldSession session, RealmModel realm, String userId, int sessionIndex) {

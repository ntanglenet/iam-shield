...
class BatchTaskRunner {
    ...
    static void runInBatches(int first, int count, int batchCount, IAMShieldSessionFactory sessionFactory, BatchTask batchTask) {
    ...
    public interface BatchTask {
        ...
        void run(IAMShieldSession session, int firstInThisIteration, int countInThisIteration);

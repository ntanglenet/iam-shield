...
public class RoleCommands {
    ...
    public static class CreateRoles extends AbstractCommand {
        ...
        protected void doRunCommand(IAMShieldSession session) {
            ...
            BatchTaskRunner.runInBatches(first, count, batchCount, session.getIAMShieldSessionFactory(), (IAMShieldSession bathcSession, int firstInThisIteration, int countInThisIteration) -> {
        ...
        private void createRolesInBatch(IAMShieldSession session, String roleContainer, String rolePrefix, int first, int count) {
        ...
        private RoleContainerModel getRoleContainer(IAMShieldSession session, String roleContainer) {

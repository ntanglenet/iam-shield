...
public class TestCacheUtils {
    ...
    public static void cacheRealmWithEverything(IAMShieldSession session, String realmName) {
    ...
    private static void cacheRoles(IAMShieldSession session, RealmModel realm, RoleContainerModel roleContainer) {

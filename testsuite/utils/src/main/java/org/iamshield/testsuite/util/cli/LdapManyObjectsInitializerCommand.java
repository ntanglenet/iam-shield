...
public class LdapManyObjectsInitializerCommand extends AbstractCommand {
    ...
    protected void doRunCommand(IAMShieldSession session) {
        ...
        BatchTaskRunner.runInBatches(startOffsetUsers, countUsers, batchCount, session.getIAMShieldSessionFactory(),
                (IAMShieldSession kcSession, int firstIt, int countInIt) -> {
        ...
        // Create groups
        BatchTaskRunner.runInBatches(startOffsetGroups, countGroups, batchCount, session.getIAMShieldSessionFactory(),
                (IAMShieldSession kcSession, int firstIt, int countInIt) -> {

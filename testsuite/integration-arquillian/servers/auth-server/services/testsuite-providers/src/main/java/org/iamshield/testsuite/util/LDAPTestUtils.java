...
import org.iamshield.storage.ldap.LDAPConfig;
import org.iamshield.storage.ldap.LDAPStorageProviderFactory;
import org.iamshield.storage.ldap.LDAPUtils;
import org.iamshield.storage.ldap.idm.model.LDAPDn;
...
import org.iamshield.storage.ldap.mappers.HardcodedLDAPGroupStorageMapper;
import org.iamshield.storage.ldap.mappers.HardcodedLDAPGroupStorageMapperFactory;
import org.iamshield.storage.ldap.mappers.HardcodedLDAPRoleStorageMapper;
import org.iamshield.storage.ldap.mappers.HardcodedLDAPRoleStorageMapperFactory;
...
import org.iamshield.storage.ldap.mappers.membership.LDAPGroupMapperMode;
import org.iamshield.storage.ldap.mappers.membership.group.GroupLDAPStorageMapper;
import org.iamshield.storage.ldap.mappers.membership.group.GroupLDAPStorageMapperFactory;
import org.iamshield.storage.ldap.mappers.membership.group.GroupMapperConfig;
import org.iamshield.storage.ldap.mappers.membership.role.RoleLDAPStorageMapper;
import org.iamshield.storage.ldap.mappers.membership.role.RoleLDAPStorageMapperFactory;
import org.iamshield.storage.ldap.mappers.membership.role.RoleMapperConfig;
...
public class LDAPTestUtils {
    ...
    public static UserModel addLocalUser(IAMShieldSession session, RealmModel realm, String username, String email, String password) {
    ...
    public static void addLdapUser(IAMShieldSession session, RealmModel appRealm, LDAPStorageProvider ldapFedProvider, String username, String password, Consumer<UserModel> userCustomizer) {
    ...
    public static LDAPStorageProvider getLdapProvider(IAMShieldSession keycloakSession, ComponentModel ldapFedModel) {
    ...
    public static ComponentModel addUserAttributeMapper(RealmModel realm, ComponentModel providerModel, String mapperName, String userModelAttributeName, String ldapAttributeName) {
        ComponentModel mapperModel = IAMShieldModelUtils.createComponentModel(mapperName, providerModel.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateRoleLDAPMappers(RealmModel realm, ComponentModel providerModel, LDAPGroupMapperMode mode) {
        ...
        if (mapperModel != null) {
            ...
            mapperModel = IAMShieldModelUtils.createComponentModel("realmRolesMapper", providerModel.getId(), RoleLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
        ...
        if (mapperModel != null) {
            ...
            String baseDn = providerModel.getConfig().getFirst(LDAPConstants.BASE_DN);
            mapperModel = IAMShieldModelUtils.createComponentModel("financeRolesMapper", providerModel.getId(), RoleLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateHardcodedGroupMapper(RealmModel realm, ComponentModel providerModel, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            mapperModel = IAMShieldModelUtils.createComponentModel("hardcodedGroupsMapper", providerModel.getId(),
    ...
    public static void addOrUpdateGroupMapper(String mapperName, RealmModel realm, ComponentModel providerModel, LDAPGroupMapperMode mode, String descriptionAttrName, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            String baseDn = providerModel.getConfig().getFirst(LDAPConstants.BASE_DN);
            mapperModel = IAMShieldModelUtils.createComponentModel(mapperName, providerModel.getId(), GroupLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateHardcodedRoleMapper(RealmModel realm, ComponentModel providerModel, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            mapperModel = IAMShieldModelUtils.createComponentModel("hardcodedRolesMapper", providerModel.getId(), HardcodedLDAPRoleStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void addOrUpdateRoleMapper(RealmModel realm, ComponentModel providerModel, LDAPGroupMapperMode mode, String... otherConfigOptions) {
        ...
        if (mapperModel != null) {
            ...
            String baseDn = providerModel.getConfig().getFirst(LDAPConstants.BASE_DN);
            mapperModel = IAMShieldModelUtils.createComponentModel("rolesMapper", providerModel.getId(), RoleLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public static void removeAllLDAPRoles(IAMShieldSession session, RealmModel appRealm, ComponentModel ldapModel, String mapperName) {
    ...
    public static void removeAllLDAPGroups(IAMShieldSession session, RealmModel appRealm, ComponentModel ldapModel, String mapperName) {
        ComponentModel mapperModel = getSubcomponentByName(appRealm, ldapModel, mapperName);
        LDAPStorageProvider ldapProvider = LDAPTestUtils.getLdapProvider(session, ldapModel);
    ...
    public static void createLDAPRole(IAMShieldSession session, RealmModel appRealm, ComponentModel ldapModel, String mapperName, String roleName) {
        ComponentModel mapperModel = getSubcomponentByName(appRealm, ldapModel, mapperName);
        LDAPStorageProvider ldapProvider = LDAPTestUtils.getLdapProvider(session, ldapModel);
        getRoleMapper(mapperModel, ldapProvider, appRealm).createLDAPRole(roleName);
    }

    public static LDAPObject createLDAPGroup(IAMShieldSession session, RealmModel appRealm, ComponentModel ldapModel, String groupName, String... additionalAttrs) {
        return createLDAPGroup("groupsMapper", session, appRealm, ldapModel, groupName, additionalAttrs);
    }

    public static LDAPObject createLDAPGroup(String mapperName, IAMShieldSession session, RealmModel appRealm, ComponentModel ldapModel, String groupName, String... additionalAttrs) {
        ComponentModel mapperModel = getSubcomponentByName(appRealm, ldapModel, mapperName);
        LDAPStorageProvider ldapProvider = LDAPTestUtils.getLdapProvider(session, ldapModel);
    ...
    public static LDAPObject getLdapGroupByName(IAMShieldSession session, RealmModel realm, String mapperName, String groupName) {
    ...
    public static LDAPObject updateLDAPGroup(IAMShieldSession session, RealmModel appRealm, ComponentModel ldapModel, LDAPObject ldapObject) {

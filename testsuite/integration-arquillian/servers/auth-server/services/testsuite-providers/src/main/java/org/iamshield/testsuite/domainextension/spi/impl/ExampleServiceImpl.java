...
package org.iamshield.testsuite.domainextension.spi.impl;
...
import org.iamshield.testsuite.domainextension.CompanyRepresentation;
import org.iamshield.testsuite.domainextension.jpa.Company;
import org.iamshield.testsuite.domainextension.spi.ExampleService;
...
public class ExampleServiceImpl implements ExampleService {
    ...
    public ExampleServiceImpl(IAMShieldSession session) {
    ...
    public CompanyRepresentation addCompany(CompanyRepresentation company) {
        ...
        String id = company.getId()==null ?  IAMShieldModelUtils.generateId() : company.getId();
        entity.setId(id);

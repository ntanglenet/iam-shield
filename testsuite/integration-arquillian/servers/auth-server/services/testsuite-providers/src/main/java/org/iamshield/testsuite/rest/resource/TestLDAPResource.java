...
public class TestLDAPResource {
    ...
    public TestLDAPResource(IAMShieldSession session, RealmModel realm) {
    ...
    public void prepareGroupsLDAPTest() {
        ...
        realm.addDefaultGroup(IAMShieldModelUtils.findGroupByPath(session, realm, "/defaultGroup1/defaultGroup11"));
        realm.addDefaultGroup(IAMShieldModelUtils.findGroupByPath(session, realm, "/defaultGroup1/defaultGroup12"));

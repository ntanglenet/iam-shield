...
import org.iamshield.common.enums.HostnameVerificationPolicy;
import org.iamshield.common.profile.PropertiesProfileConfigResolver;
import org.iamshield.common.util.HtmlUtils;
...
import org.iamshield.events.EventQuery;
...
import org.iamshield.events.admin.AdminEventQuery;
...
import org.iamshield.representations.idm.AuthDetailsRepresentation;
...
import org.iamshield.storage.datastore.PeriodicEventInvalidation;
import org.iamshield.testsuite.components.amphibian.TestAmphibianProvider;
import org.iamshield.testsuite.events.TestEventsListenerProvider;
import org.iamshield.testsuite.federation.DummyUserFederationProviderFactory;
import org.iamshield.testsuite.forms.PassThroughAuthenticator;
import org.iamshield.testsuite.forms.PassThroughClientAuthenticator;
import org.iamshield.testsuite.model.infinispan.InfinispanTestUtil;
import org.iamshield.testsuite.rest.representation.AuthenticatorState;
import org.iamshield.testsuite.rest.resource.TestCacheResource;
import org.iamshield.testsuite.rest.resource.TestLDAPResource;
import org.iamshield.testsuite.rest.resource.TestingExportImportResource;
import org.iamshield.testsuite.runonserver.FetchOnServer;
import org.iamshield.testsuite.runonserver.RunOnServer;
import org.iamshield.testsuite.runonserver.SerializationUtil;
import org.iamshield.testsuite.util.FeatureDeployerUtil;
import org.iamshield.timer.TimerProvider;
import org.iamshield.truststore.FileTruststoreProvider;
import org.iamshield.truststore.FileTruststoreProviderFactory;
...
public class TestingResourceProvider implements RealmResourceProvider {
    ...
    public TestingResourceProvider(IAMShieldSession session, TestingResourceProviderFactory factory, Map<String, TimerProvider.TimerTaskContext> suspendedTimerTasks) {
    ...
    public UserRepresentation getUserByUsernameFromFedProviderFactory(@QueryParam("realmName") String realmName,
                                                                      @QueryParam("userName") String userName) {
        RealmModel realm = getRealmByName(realmName);
        DummyUserFederationProviderFactory factory = (DummyUserFederationProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(UserStorageProvider.class, "dummy");
    ...
    public String runModelTestOnServer(@QueryParam("testClassName") String testClassName,
        ...
        try {
            ...
            Method testMethod = testClass.getDeclaredMethod(testMethodName, IAMShieldSession.class);
    ...
    public void reinitializeProviderFactoryWithSystemPropertiesScope(@QueryParam("provider-type") String providerType, @QueryParam("provider-id") String providerId,
        ...
        ProviderFactory factory = session.getIAMShieldSessionFactory().getProviderFactory(providerClass, providerId);
    ...
    public void disableTruststoreSpi() {
        FileTruststoreProviderFactory factory = (FileTruststoreProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(TruststoreProvider.class);
    ...
    public void modifyTruststoreSpiHostnamePolicy(@QueryParam("hostnamePolicy") final HostnameVerificationPolicy hostnamePolicy) {
        FileTruststoreProviderFactory fact = (FileTruststoreProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(TruststoreProvider.class);
    ...
    public void addEventsToEmailEventListenerProvider(List<EventType> events) {
        if (events != null && !events.isEmpty()) {
            EmailEventListenerProviderFactory prov = (EmailEventListenerProviderFactory) session.getIAMShieldSessionFactory()

...
import static org.iamshield.testsuite.authentication.CustomTestingSamlArtifactResolverFactory.TYPE_CODE;
...
public class CustomTestingSamlArtifactResolver implements ArtifactResolver {
    ...
    @Override
    public ClientModel selectSourceClient(IAMShieldSession session, String artifact) {
        return null;
    }

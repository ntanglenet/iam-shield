...
import static org.iamshield.testsuite.IAMShieldServer.registerScriptProviders;
...
import org.iamshield.testsuite.UndertowRequestFilter;
import org.iamshield.testsuite.utils.tls.TLSUtils;
import org.iamshield.testsuite.utils.undertow.UndertowDeployerHelper;
import org.iamshield.testsuite.utils.undertow.UndertowWarClassLoader;
...
public class IAMShieldOnUndertow implements DeployableContainer<IAMShieldOnUndertowConfiguration> {

    protected final Logger log = Logger.getLogger(this.getClass());

    private IAMShieldUndertowJaxrsServer undertow;
    private IAMShieldOnUndertowConfiguration configuration;
    ...
    private DeploymentInfo createAuthServerDeploymentInfo() {
        ...
        // way accessing the factory in the UndertowRequestFilter via static reference to IAMShieldApplication does not work:
        // There are several IAMShieldApplication instances in the JVM with no classloader separation as in a full-blown server.
    ...
    @Override
    public Class<IAMShieldOnUndertowConfiguration> getConfigurationClass() {
        return IAMShieldOnUndertowConfiguration.class;
    }
    ...
    @Override
    public void setup(
            IAMShieldOnUndertowConfiguration undertowContainerConfiguration) {
    ...
    public void start() throws LifecycleException {
        ...
        IAMShieldServer.configureDataDirectory();
        ...
        if (undertow == null) {
            undertow = new IAMShieldUndertowJaxrsServer();
        }
    ...
    private static class IAMShieldUndertowJaxrsServer extends UndertowJaxrsServer {

        @Override
        public IAMShieldUndertowJaxrsServer start(Undertow.Builder builder) {
            try {

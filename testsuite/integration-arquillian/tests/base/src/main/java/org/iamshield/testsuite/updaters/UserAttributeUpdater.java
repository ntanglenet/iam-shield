...
import static org.iamshield.testsuite.updaters.ServerResourceUpdater.updateViaAddRemove;
...
public class UserAttributeUpdater extends ServerResourceUpdater<UserAttributeUpdater, UserResource, UserRepresentation> {
     ...
     * @return
     */
    public static UserAttributeUpdater forUserByUsername(IAMShield adminClient, String realm, String userName) {

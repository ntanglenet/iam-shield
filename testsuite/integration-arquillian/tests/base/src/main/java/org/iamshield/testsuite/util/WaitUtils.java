...
//                .until(invisibilityOfAllElements(Collections.singletonList(element)));
     ...
     * Because IAMShield's Admin Console is a single-page application, we need to
    ...
    public static void waitForBruteForceExecutors(IAMShieldTestingClient testingClient) {

...
import org.iamshield.testsuite.client.resources.TestApplicationResource;
import org.iamshield.testsuite.client.resources.TestExampleCompanyResource;
import org.iamshield.testsuite.client.resources.TestSamlApplicationResource;
import org.iamshield.testsuite.client.resources.TestingResource;
import org.iamshield.testsuite.runonserver.*;
 ...
 */
public class IAMShieldTestingClient implements AutoCloseable {

    private final ResteasyWebTarget target;
    private final ResteasyClient client;

    IAMShieldTestingClient(String serverUrl, ResteasyClient resteasyClient) {
    ...
    public static IAMShieldTestingClient getInstance(String serverUrl) {
        return new IAMShieldTestingClient(serverUrl, null);
    }

    public static IAMShieldTestingClient getInstance(String serverUrl, ResteasyClient resteasyClient) {
        return new IAMShieldTestingClient(serverUrl, resteasyClient);
    }
     ...
     * server-side or defined in @{@link org.iamshield.testsuite.arquillian.TestClassProvider#PERMITTED_PACKAGES}
     *
     * @return
     */

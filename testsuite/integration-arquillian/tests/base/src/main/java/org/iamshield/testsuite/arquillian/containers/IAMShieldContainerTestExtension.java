...
import org.iamshield.testsuite.arquillian.ModelTestExecutor;

/**
 * IAMShieldContainerTestExtension
 * 
 ...
 * @version $Revision: $
 */
public class IAMShieldContainerTestExtension implements LoadableExtension {
    @Override
    public void register(ExtensionBuilder builder) {
        registerOriginal(builder);
        
//      Overriden ContainerEventController
        builder.observer(IAMShieldContainerEventsController.class);
        
        // overriden ContainerDeployController
        builder.observer(IAMShieldContainerDeployController.class);
    }
...
//            .observer(LocalTestExecuter.class)
            ...
            .observer(IAMShieldContainerFeaturesController.class);
    }
}

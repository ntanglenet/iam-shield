...
public class MultipleContainersExtension implements LoadableExtension {
    ...
    public void register(ExtensionBuilder builder) {
        ...
        builder.service(DeployableContainer.class, IAMShieldQuarkusServerDeployableContainer.class)
                .service(DeployableContainer.class, IAMShieldQuarkusEmbeddedDeployableContainer.class)

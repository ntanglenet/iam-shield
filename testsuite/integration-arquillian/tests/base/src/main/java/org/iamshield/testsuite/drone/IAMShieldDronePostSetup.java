...
package org.iamshield.testsuite.drone;
 ...
 */
public class IAMShieldDronePostSetup {
    ...
    protected static final Logger log = org.jboss.logging.Logger.getLogger(IAMShieldDronePostSetup.class);

...
import org.iamshield.testsuite.arquillian.annotation.DisableFeatures;
import org.iamshield.testsuite.arquillian.annotation.EnableFeature;
import org.iamshield.testsuite.arquillian.annotation.EnableFeatures;
 ...
 * @author mhajas
 */
public class IAMShieldContainerFeaturesController {
    ...
    public enum FeatureAction {
        ENABLE(IAMShieldTestingClient::enableFeature),
        ...
        DISABLE(IAMShieldTestingClient::disableFeature),
        DISABLE_AND_RESET((c, f) -> {
            c.disableFeature(f);
            c.resetFeature(f);
        });

        private BiConsumer<IAMShieldTestingClient, Profile.Feature> featureConsumer;

        FeatureAction(BiConsumer<IAMShieldTestingClient, Profile.Feature> featureConsumer) {
            this.featureConsumer = featureConsumer;
        }

        public void accept(IAMShieldTestingClient testingClient, Profile.Feature feature) {

 ...
 * @author mhajas
 */
public class IAMShieldQuarkusConfiguration implements ContainerConfiguration {

    protected static final Logger log = Logger.getLogger(IAMShieldQuarkusConfiguration.class);
    ...
    public void validate() throws ConfigurationException {
        ...
        log.infof("IAMShield will listen for http on port: %d, for https on port: %d, and for management on port: %d\n", newPort, newHttpsPort, managementPort);
    }

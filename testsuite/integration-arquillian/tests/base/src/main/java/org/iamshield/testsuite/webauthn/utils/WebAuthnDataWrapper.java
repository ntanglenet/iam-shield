...
package org.iamshield.testsuite.webauthn.utils;
...
import static org.iamshield.models.credential.WebAuthnCredentialModel.createFromCredentialModel;
...
public class WebAuthnDataWrapper implements Serializable {
    ...
    public WebAuthnDataWrapper(IAMShieldSession session, String username, String credentialType) {

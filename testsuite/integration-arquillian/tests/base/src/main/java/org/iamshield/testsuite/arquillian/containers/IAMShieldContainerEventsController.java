 ...
 * @author mabartos
 */
public class IAMShieldContainerEventsController extends ContainerEventController {

    protected static final Logger log = Logger.getLogger(IAMShieldContainerEventsController.class);

...
import org.iamshield.testsuite.util.saml.StepWithCheckers;
...
import static org.iamshield.saml.common.constants.GeneralConstants.RELAY_STATE;
import static org.iamshield.testsuite.util.Matchers.statusCodeIsHC;
import static org.iamshield.testsuite.util.SamlUtils.getSamlDeploymentForClient;
            ...
            private HttpPost createSamlPostMessage(URI samlEndpoint, String relayState, Document samlRequest, String messageType, String privateKeyStr, String publicKeyStr, String certificateStr) {
                ...
                try {
                    ...
                    if (privateKeyStr != null && (publicKeyStr != null || certificateStr != null)) {
                        PrivateKey privateKey = org.iamshield.testsuite.util.KeyUtils.privateKeyFromString(privateKeyStr);
                        PublicKey publicKey = publicKeyStr != null? org.iamshield.testsuite.util.KeyUtils.publicKeyFromString(publicKeyStr) : null;
                        X509Certificate cert = org.iamshield.common.util.PemUtils.decodeCertificate(certificateStr);
                        if (publicKey == null) {
            ...
            public HttpUriRequest createSamlSignedResponse(URI samlEndpoint, String relayState, Document samlRequest, String realmPrivateKey, String realmPublicKey, String certificateStr) {
                ...
                try {
                    ...
                    if (realmPrivateKey != null && realmPublicKey != null) {
                        PrivateKey privateKey = org.iamshield.testsuite.util.KeyUtils.privateKeyFromString(realmPrivateKey);
                        PublicKey publicKey = org.iamshield.testsuite.util.KeyUtils.publicKeyFromString(realmPublicKey);
                        X509Certificate cert = org.iamshield.common.util.PemUtils.decodeCertificate(certificateStr);
                        binding
                                .signatureAlgorithm(SignatureAlgorithm.RSA_SHA256)
                                .signWith(KeyUtils.createKeyId(privateKey), privateKey, publicKey, cert)
        ...
        if (realmPublicKey != null) {
            ...
            try {
                KeyLocator locator = new KeyLocator() {
                    ...
                    private final Key key = org.iamshield.testsuite.util.KeyUtils.publicKeyFromString(realmPublicKey);

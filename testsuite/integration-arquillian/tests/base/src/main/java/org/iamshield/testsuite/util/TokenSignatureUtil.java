...
public class TokenSignatureUtil {
    ...
    public static void changeRealmTokenSignatureProvider(IAMShield adminClient, String toSigAlgName) {
        changeRealmTokenSignatureProvider(TEST_REALM_NAME, adminClient, toSigAlgName);
    }

    public static void changeRealmTokenSignatureProvider(String realm, IAMShield adminClient, String toSigAlgName) {
    ...
    public static boolean verifySignature(String sigAlgName, String token, IAMShield adminClient) throws Exception {
    ...
    public static void registerKeyProvider(String jwaAlgorithmName, IAMShield adminClient, TestContext testContext) {
        registerKeyProvider(TEST_REALM_NAME, jwaAlgorithmName, adminClient, testContext);
    }

    public static void registerKeyProvider(String realm, String jwaAlgorithmName, IAMShield adminClient, TestContext testContext) {
    ...
    private static void registerKeyProvider(String realm, String providerSpecificKey, String providerSpecificValue, String providerId, IAMShield adminClient, TestContext testContext) {
    ...
    private static ComponentRepresentation createKeyRep(String name, String providerId, IAMShield adminClient) {
    ...
    private static PublicKey getRealmPublicKey(String realm, String sigAlgName, IAMShield adminClient) {

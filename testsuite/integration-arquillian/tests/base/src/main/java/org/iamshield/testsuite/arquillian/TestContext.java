...
import static org.iamshield.testsuite.arquillian.AppServerTestEnricher.getAppServerQualifiers;
...
public final class TestContext {
    ...
    private IAMShieldTestingClient testingClient;
    ...
    public void setAdminClient(IAMShield adminClient) {
    ...
    public IAMShieldTestingClient getTestingClient() {
        if (testingClient == null) {
            String authServerContextRoot = suiteContext.getAuthServerInfo().getContextRoot().toString();
            testingClient = IAMShieldTestingClient.getInstance(authServerContextRoot + "/auth");
        }
        return testingClient;
    }

    public void setTestingClient(IAMShieldTestingClient testingClient) {

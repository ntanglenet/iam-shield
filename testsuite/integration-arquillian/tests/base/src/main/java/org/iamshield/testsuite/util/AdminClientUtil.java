...
import static org.iamshield.testsuite.utils.io.IOUtil.PROJECT_BUILD_DIRECTORY;
...
public class AdminClientUtil {
    ...
    public static IAMShield createAdminClient(boolean ignoreUnknownProperties, String authServerContextRoot) throws Exception {
    ...
    public static IAMShield createAdminClient(boolean ignoreUnknownProperties, String realmName, String username,
    ...
    public static IAMShield createAdminClient(boolean ignoreUnknownProperties, String authServerContextRoot, String realmName,
        ...
        return IAMShieldBuilder.builder()
    ...
    public static IAMShield createAdminClientWithClientCredentials(String realmName, String clientId, String clientSecret, String scope)
        throws CertificateException, NoSuchAlgorithmException, KeyStoreException, IOException, KeyManagementException {
    ...
    public static IAMShield createMTlsAdminClientWithClientCredentialsWithoutSecret(
    ...
    public static IAMShield createAdminClient() throws Exception {
        return createAdminClient(false, getAuthServerContextRoot());
    }

    public static IAMShield createAdminClient(boolean ignoreUnknownProperties) throws Exception {

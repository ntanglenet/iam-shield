package org.iamshield.testsuite.cli;

import org.iamshield.testsuite.cli.exec.AbstractExec;
import org.iamshield.testsuite.cli.exec.AbstractExecBuilder;
...
public class KcAdmExec extends AbstractExec {
    ...
    public static final String WORK_DIR = System.getProperty("user.dir") + "/target/containers/iamshield-client-tools";

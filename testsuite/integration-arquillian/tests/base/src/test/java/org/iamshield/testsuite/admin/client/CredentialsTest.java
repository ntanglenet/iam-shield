...
package org.iamshield.testsuite.admin.client;
...
public class CredentialsTest extends AbstractClientTest {
    ...
    public void testDownloadKeystore() throws Exception {
        ...
        String keyPem = IAMShieldModelUtils.getPemFromKey(key);
        String certPem = IAMShieldModelUtils.getPemFromCertificate((X509Certificate) cert);

...
import org.iamshield.testsuite.cluster.AuthenticationSessionFailoverClusterTest;
...
import org.iamshield.testsuite.util.UserActionTokenBuilder;
import org.iamshield.testsuite.util.MailUtils;
...
import static org.iamshield.authentication.requiredactions.VerifyEmail.EMAIL_RESEND_COOLDOWN_KEY_PREFIX;

/**
 * @author <a href="mailto:sthorger@redhat.com">Stian Thorgersen</a>
 */
public class RequiredActionEmailVerificationTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void verifyEmailFromAnotherAccountWhenUserIsAuthenticated() throws Exception {
        loginPage.open();
        loginPage.clickRegister();
        String username1 = IAMShieldModelUtils.generateId();
        ...
        loginPage.open();
        loginPage.clickRegister();
        String username2 = IAMShieldModelUtils.generateId();
    ...
    public void verifyEmailInvalidKeyInVerficationLink() throws IOException, MessagingException {
        ...
        verificationUrl = IAMShieldUriBuilder.fromUri(verificationUrl).replaceQueryParam(Constants.KEY, "foo").build().toString();

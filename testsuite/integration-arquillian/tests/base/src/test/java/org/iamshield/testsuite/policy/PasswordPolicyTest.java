...
package org.iamshield.testsuite.policy;
...
import org.iamshield.policy.BlacklistPasswordPolicyProvider;
import org.iamshield.policy.BlacklistPasswordPolicyProviderFactory;
import org.iamshield.policy.MaximumLengthPasswordPolicyProviderFactory;
 ...
 */
public class PasswordPolicyTest extends AbstractIAMShieldTest {
    ...
    public void testBlacklistPasswordPolicyDefaultPath() throws Exception {
        ...
        testingClient.server("passwordPolicy").run(session -> {
            ProviderFactory<PasswordPolicyProvider> passPolicyFact = session.getIAMShieldSessionFactory().getProviderFactory(

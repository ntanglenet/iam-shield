 ...
 */
public class OwnerReplacementTest extends AbstractIAMShieldTest {
    ...
    @Test
    @ModelTest
    public void componentsTest(IAMShieldSession session1) {
        doTest(session1,
    ...
    @Test
    @ModelTest
    public void requiredActionProvidersTest(IAMShieldSession session1) {
        doTest(session1,
    ...
    @Test
    @ModelTest
    public void authenticationFlowsTest(IAMShieldSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @Test
    @ModelTest
    public void authenticationExecutionsTest(IAMShieldSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @Test
    @ModelTest
    public void authenticationConfigsTest(IAMShieldSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
    ...
    @Test
    @ModelTest
    public void clientInitialAccessTest(IAMShieldSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @Test
    @ModelTest
    public void rolesTest(IAMShieldSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    @Test
    @ModelTest
    public void userSessionsTest(IAMShieldSession session1) {
        doTest(session1,
                // Get ID of some object from realm1
                ((session, realm1) -> {
    ...
    private void doTest(IAMShieldSession session1,
                               BiFunction<IAMShieldSession, RealmModel, String> realm1ObjectIdProducer,
                               TriConsumer<IAMShieldSession, RealmModel, String> testLookupRealm1ObjectInRealm2,
                               TetraConsumer<IAMShieldSession, RealmModel, RealmModel, String> updaterRealm1ObjectInRealm2,
                               TriConsumer<IAMShieldSession, RealmModel, String> testUpdateFailed,
                               TetraConsumer<IAMShieldSession, RealmModel, RealmModel, String> removeRealm1ObjectInRealm2,
                               TriConsumer<IAMShieldSession, RealmModel, String> testRemoveFailed
    ) {

        // Transaction 1 - Lookup object of realm1
        AtomicReference<String> realm1ObjectId = new AtomicReference<>();
        IAMShieldModelUtils.runJobInTransaction(session1.getIAMShieldSessionFactory(), (IAMShieldSession session) -> {

...
import org.iamshield.authentication.requiredactions.DeleteCredentialAction;
...
import org.iamshield.common.enums.AccountRestApiVersion;
...
import org.iamshield.representations.account.ClientRepresentation;
import org.iamshield.representations.account.ConsentRepresentation;
import org.iamshield.representations.account.ConsentScopeRepresentation;
import org.iamshield.representations.account.SessionRepresentation;
import org.iamshield.representations.idm.UserProfileAttributeMetadata;
import org.iamshield.representations.account.UserRepresentation;
...
import org.iamshield.services.resources.account.AccountCredentialResource;
...
import org.iamshield.testsuite.admin.authentication.AbstractAuthenticationTest;
...
import org.iamshield.testsuite.util.TokenUtil;
...
import static org.iamshield.testsuite.util.userprofile.UserProfileUtil.PERMISSIONS_ALL;
...
public class AccountRestServiceTest extends AbstractRestServiceTest {
    ...
    public void testUpdateProfileEmailChangeSetsEmailVerified() throws IOException {
        ...
        try {
            ...
            org.iamshield.representations.idm.UserRepresentation ur = userResource.toRepresentation();
    ...
    public void testRemoveCredentialWithNonOtpCredentialTriggeringNoEvent() throws IOException {
        ...
        org.iamshield.representations.idm.UserRepresentation userRep = UserBuilder.edit(user.toRepresentation())
    ...
    public void testCredentialsGetWithDisabledOtpRequiredAction() throws IOException {
        ...
        org.iamshield.representations.idm.UserRepresentation userRep = UserBuilder.edit(adminUserResource.toRepresentation())
    ...
    public void testAudience() throws Exception {
        ...
        org.iamshield.representations.idm.ClientRepresentation clientRep = testRealm().clients().findByClientId("custom-audience").get(0);

 ...
 */
package org.iamshield.testsuite.oauth.par;
...
public class ParWithDPoPTest extends AbstractClientPoliciesTest {
    ...
    private String generateRequestObject(String clientId, String dpopJkt) throws IOException {
        ...
        client.generateKeys(org.iamshield.crypto.Algorithm.RS256);
        client.registerOIDCRequest(encodedRequestObject, org.iamshield.crypto.Algorithm.RS256);

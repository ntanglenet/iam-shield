package org.iamshield.testsuite.cookies;
...
public class DefaultCookieProviderTest extends AbstractIAMShieldTest {

    private IAMShieldTestingClient testing;
    ...
    public void testCookieDefaultsWithInsecureContext() {
        IAMShieldTestingClient testingInsecure = IAMShieldTestingClient.getInstance("http://localtest.me:8180/auth");
    ...
    public void testSafariQuirks() {
        ...
        try (IAMShieldTestingClient testingClient = createTestingClient("http://localhost:8180/auth")) {
    ...
    private IAMShieldTestingClient createTestingClient(String serverUrl) {
        ResteasyClientBuilder restEasyClientBuilder = IAMShieldTestingClient.getRestEasyClientBuilder(serverUrl);
        ResteasyClient resteasyClient = restEasyClientBuilder.build();
        resteasyClient.register(filter);
        return IAMShieldTestingClient.getInstance(serverUrl, resteasyClient);
    }

...
import org.iamshield.testsuite.broker.AbstractInitializedBaseBrokerTest;
import org.iamshield.testsuite.broker.BrokerConfiguration;
import org.iamshield.testsuite.broker.BrokerTestConstants;
...
import static org.iamshield.broker.oidc.OAuth2IdentityProviderConfig.TOKEN_INTROSPECTION_URL;
import static org.iamshield.broker.oidc.OAuth2IdentityProviderConfig.TOKEN_ENDPOINT_URL;
import static org.iamshield.testsuite.broker.BrokerTestConstants.CLIENT_ID;
...
public class ExternalInternalTokenExchangeV2Test extends AbstractInitializedBaseBrokerTest {
    ...
    private static void setupRealm(IAMShieldSession session) {
    ...
    public void testSuccess_externalTokenIssuedToBrokerClient() throws Exception {
        ...
        org.iamshield.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client(brokerApp.getClientId(), brokerApp.getSecret()).doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
    ...
    public void testSuccess_brokerClientAsAudienceOfExternalToken() throws Exception {
        ...
        org.iamshield.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client("client-with-brokerapp-audience", "secret").doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
        assertThat(tokenResponse.getIdToken(), notNullValue());
    ...
    public void testSuccess_consumerRealmIssuerAsAudienceOfExternalToken() throws Exception {
        ...
        org.iamshield.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client("client-with-consumer-realm-issuer-audience", "secret").doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
        assertThat(tokenResponse.getIdToken(), notNullValue());
    ...
    public void testFailure_externalTokenIssuedToInvalidClient() throws Exception {
        ...
        org.iamshield.testsuite.util.oauth.AccessTokenResponse tokenResponse = oauth.realm(bc.providerRealmName()).client("client-without-valid-audience", "secret").doPasswordGrantRequest(bc.getUserLogin(), bc.getUserPassword());
        assertThat(tokenResponse.getIdToken(), notNullValue());

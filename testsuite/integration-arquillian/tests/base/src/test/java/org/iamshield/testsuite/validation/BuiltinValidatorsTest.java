...
public class BuiltinValidatorsTest extends AbstractIAMShieldTest {
    ...
    @Test
    @ModelTest
    public void testLengthValidator_ConfigValidation(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void testDoubleValidator_ConfigValidation(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void testIntegerValidator_ConfigValidation(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void testOptionsValidator_Config_Validation(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void testMultivaluedValidatorConfiguration(IAMShieldSession session) {
        // invalid min and max config values

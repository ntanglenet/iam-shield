...
public class ResourceServerManagementTest extends AbstractAuthorizationTest {
    ...
    public void testImportSettingsToDifferentClient() throws Exception {
        ...
        clientRep.setClientId(IAMShieldModelUtils.generateId());
        ...
        ClientRepresentation anotherClientRep = ClientBuilder.create().clientId(IAMShieldModelUtils.generateId()).secret("secret").authorizationServicesEnabled(true).serviceAccount().enabled(true).build();

...
package org.iamshield.testsuite.session;
...
import org.iamshield.models.sessions.infinispan.changes.sessions.AbstractLastSessionRefreshStore;
 ...
 */
public class LastSessionRefreshUnitTest extends AbstractIAMShieldTest {
    ...
    public static abstract class LastSessionRefreshServerTest implements RunOnServer {
        ...
        AbstractLastSessionRefreshStore createStoreInstance(IAMShieldSession session, long timerIntervalMs, int maxIntervalBetweenMessagesSeconds) {
            PersisterLastSessionRefreshStoreFactory factory = new PersisterLastSessionRefreshStoreFactory() {
                ...
                protected PersisterLastSessionRefreshStore createStoreInstance(int maxIntervalBetweenMessagesSeconds, int maxCount, boolean offline) {
                    return new PersisterLastSessionRefreshStore(maxIntervalBetweenMessagesSeconds, maxCount, offline) {
                        ...
                        @Override
                        protected void sendMessage(IAMShieldSession kcSession, Map<String, SessionData> refreshesToSend) {

...
import org.iamshield.jose.jws.AlgorithmType;
import org.iamshield.keys.Attributes;
import org.iamshield.keys.JavaKeystoreKeyProviderFactory;
 ...
 */
@EnableVault
public class JavaKeystoreKeyProviderTest extends AbstractIAMShieldTest {
    ...
    private void generateRSAExpiredInOneHourCertificateStore(KeystoreUtil.KeystoreFormat keystoreType) throws Exception {
        KeyPair keyPair = org.iamshield.common.util.KeyUtils.generateRsaKeyPair(2048);

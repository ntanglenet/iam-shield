...
import static org.iamshield.testsuite.admin.ApiUtil.findRealmRoleByName;
 ...
 */
public class OfflineTokenTest extends AbstractIAMShieldTest {
    ...
    public void offlineTokenAdminRESTAccess() throws Exception {
        ...
        try (IAMShield offlineTokenAdmin = IAMShield.getInstance(getAuthServerContextRoot() + "/auth",

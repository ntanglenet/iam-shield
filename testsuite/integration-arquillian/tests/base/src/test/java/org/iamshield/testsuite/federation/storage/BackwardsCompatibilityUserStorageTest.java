...
import org.iamshield.testsuite.federation.BackwardsCompatibilityUserStorageFactory;
import org.iamshield.testsuite.forms.BrowserFlowTest;
import org.iamshield.testsuite.pages.AppPage;
import org.iamshield.testsuite.pages.EnterRecoveryAuthnCodePage;
...
/**
 * Test that userStorage implementation created in previous version is still compatible with latest IAMShield version
 *
 * @author <a href="mailto:mposolda@redhat.com">Marek Posolda</a>
 */
public class BackwardsCompatibilityUserStorageTest extends AbstractTestRealmIAMShieldTest {
    ...
    void configureBrowserFlowWithRecoveryAuthnCodes(IAMShieldTestingClient testingClient, long delay) {
    ...
    private void assertUserHasOTPCredentialInUserStorage(boolean expectedUserHasOTP) {
        boolean hasUserOTP = testingClient.server().fetch(session -> {
            BackwardsCompatibilityUserStorageFactory storageFactory = (BackwardsCompatibilityUserStorageFactory) session.getIAMShieldSessionFactory()

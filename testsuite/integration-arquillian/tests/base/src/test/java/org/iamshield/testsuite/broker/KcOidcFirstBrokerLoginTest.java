...
import org.iamshield.testsuite.forms.RegisterWithUserProfileTest;
import org.iamshield.testsuite.forms.VerifyProfileTest;
...
import static org.iamshield.testsuite.util.userprofile.UserProfileUtil.ATTRIBUTE_DEPARTMENT;
import static org.iamshield.testsuite.util.userprofile.UserProfileUtil.PERMISSIONS_ADMIN_EDITABLE;
...
public class KcOidcFirstBrokerLoginTest extends AbstractFirstBrokerLoginTest {
    ...
    public void testRefreshTokenFetchExternalIdpTokenSuccess() {
        ...
        org.iamshield.testsuite.util.oauth.AccessTokenResponse internalTokens = oauth.doAccessTokenRequest(code);
        assertEquals(200, internalTokens.getStatusCode());

        org.iamshield.testsuite.util.oauth.AccessTokenResponse externalTokens = oauth.doFetchExternalIdpToken(bc.getIDPAlias(), internalTokens.getAccessToken());
        ...
        assertEquals(200, internalTokens.getStatusCode());
        org.iamshield.testsuite.util.oauth.AccessTokenResponse externalTokens2 = oauth.doFetchExternalIdpToken(bc.getIDPAlias(), internalTokens.getAccessToken());
    ...
    public void testRefreshTokenFetchExternalIdpTokenFailure() {
        ...
        assertEquals(200, internalTokens.getStatusCode());
        org.iamshield.testsuite.util.oauth.AccessTokenResponse error = oauth.doFetchExternalIdpToken(bc.getIDPAlias(), internalTokens.getAccessToken());

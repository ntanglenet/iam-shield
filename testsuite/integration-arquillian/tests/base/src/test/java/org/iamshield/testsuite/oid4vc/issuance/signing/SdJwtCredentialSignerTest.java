...
import org.iamshield.protocol.oid4vc.issuance.signing.SdJwtCredentialSigner;
...
import org.iamshield.sdjwt.SdJwtUtils;
...
public class SdJwtCredentialSignerTest extends OID4VCTest {
    ...
    public static void testSignSDJwtCredential(IAMShieldSession session, String signingKeyId, String overrideKeyId, String
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        if (testRealm.getComponents() != null) {
            testRealm.getComponents().add("org.iamshield.keys.KeyProvider", getRsaKeyProvider(rsaKey));
        } else {
            testRealm.setComponents(new MultivaluedHashMap<>(
                    Map.of("org.iamshield.keys.KeyProvider", List.of(getRsaKeyProvider(rsaKey)))));
        }
    }

 ...
 */
public class SimpleModelTest extends AbstractIAMShieldTest {
    ...
    @Test
    @ModelTest
    public void simpleModelTest(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void simpleModelTestWithNestedTransactions(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession session3) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession session4) -> {
    ...
    @ModelTest
    public void simpleModelTestWithAssertionError(IAMShieldSession session) {
    ...
    @ModelTest
    public void simpleModelTestWithOtherError(IAMShieldSession session) {

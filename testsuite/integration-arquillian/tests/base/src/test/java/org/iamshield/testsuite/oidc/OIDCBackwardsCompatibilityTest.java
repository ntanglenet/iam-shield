 ...
 */
public class OIDCBackwardsCompatibilityTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void testExcludeSessionStateParameter() {
        ...
        oauth.openLoginForm();
        org.iamshield.testsuite.Assert.assertEquals(AppPage.RequestType.AUTH_RESPONSE, appPage.getRequestType());

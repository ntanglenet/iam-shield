...
import org.iamshield.protocol.oidc.mappers.ClaimsParameterTokenMapper;
 ...
 */
public class OIDCAdvancedRequestParamsTest extends AbstractTestRealmIAMShieldTest {
    ...
    protected void afterAbstractIAMShieldTestRealmImport() {
        ...
        keys.getConfig().putSingle("algorithm", org.iamshield.crypto.Algorithm.RS256);
        ...
        keys.getConfig().putSingle(Attributes.KEY_USE, KeyUse.ENC.getSpecName());
        keys.getConfig().putSingle("algorithm", org.iamshield.crypto.Algorithm.PS256);

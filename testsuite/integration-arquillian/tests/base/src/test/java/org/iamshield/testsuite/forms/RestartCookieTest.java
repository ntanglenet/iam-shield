 ...
 */
public class RestartCookieTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void testRestartCookieBackwardsCompatible_Keycloak25() throws IOException {
        String oldRestartCookie = testingClient.server().fetchString((IAMShieldSession session) -> {

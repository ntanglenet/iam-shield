 ...
 */
public class ConcurrentTransactionsTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void persistClient(IAMShieldSession session) {
        ...
        try {
            IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionSetup) -> {
            ...
            IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession session1) -> {
                ...
                final IAMShieldSessionFactory sessionFactory = session1.getIAMShieldSessionFactory();
                ...
                Thread thread1 = new Thread(() -> {
                    IAMShieldModelUtils.runJobInTransaction(sessionFactory, session11 -> {
                        try {
                            IAMShieldSession currentSession = session11;
                ...
                Thread thread2 = new Thread(() -> {
                    IAMShieldModelUtils.runJobInTransaction(sessionFactory, session22 -> {
                        try {
                            IAMShieldSession currentSession = session22;
                            // Wait until transaction in both threads started
                            transactionsCounter.countDown();
            ...
            IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession session2) -> {
            ...
            IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), kcSession -> tearDownRealm(kcSession, "user1", "user2"));
        }
    }
    ...
    @Test
    @ModelTest
    public void removeUserAttribute(IAMShieldSession session) throws Exception {

        try {
            IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionSet) -> {
            ...
            IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession session2) -> {
                ...
                final IAMShieldSessionFactory sessionFactory = session2.getIAMShieldSessionFactory();
                ...
                Runnable runnable = () -> {
                    try {
                        IAMShieldModelUtils.runJobInTransaction(sessionFactory, session1 -> {
                            try {
                                // Read user attribute
    ...
    private void tearDownRealm(IAMShieldSession session, String user1, String user2) {
        IAMShieldSession currentSession = session;

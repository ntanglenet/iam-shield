 ...
 */
public class ClientRedirectTest extends AbstractTestRealmIAMShieldTest {
    ...
    /**
     * Integration test for {@link org.iamshield.services.resources.RealmsResource#getRedirect(String, String)}.
     *
     * @throws Exception
     */
    @Test
    ...
    public void testRedirectToDisabledClientRedirectURI() throws Exception {
        ...
        try {
            ...
            URI logout = IAMShieldUriBuilder.fromUri(suiteContext.getAuthServerInfo().getBrowserContextRoot().toURI())

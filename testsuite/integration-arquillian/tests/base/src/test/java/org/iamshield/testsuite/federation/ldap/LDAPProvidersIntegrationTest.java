...
public class LDAPProvidersIntegrationTest extends AbstractLDAPTest {
    ...
    public void testSyncRegistrationEmailRDNNoDefault() {
        testingClient.server().run(session -> {
            ...
            ComponentModel hardcodedMapperModel = IAMShieldModelUtils.createComponentModel("hardcodedAttr-description", ctx.getLdapModel().getId(), HardcodedLDAPAttributeMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
    ...
    public void testHardcodedRoleMapper() {
        testingClient.server().run(session -> {
            ...
            ComponentModel hardcodedMapperModel = IAMShieldModelUtils.createComponentModel("hardcoded role", ctx.getLdapModel().getId(),
    ...
    public void testHardcodedGroupMapper() {
        ...
        testingClient.server().run(session -> {
            ...
            ComponentModel hardcodedMapperModel = IAMShieldModelUtils.createComponentModel("hardcoded group",

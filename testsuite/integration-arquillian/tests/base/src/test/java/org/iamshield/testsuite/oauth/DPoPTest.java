...
import org.iamshield.jose.jwk.ECPublicJWK;
import org.iamshield.jose.jwk.JWK;
import org.iamshield.jose.jwk.JWKBuilder;
import org.iamshield.jose.jwk.RSAPublicJWK;
import org.iamshield.jose.jws.JWSHeader;
import org.iamshield.keys.AbstractEddsaKeyProviderFactory;
...
import org.iamshield.services.clientpolicy.executor.DPoPBindEnforcerExecutorFactory;
...
import org.iamshield.testsuite.broker.util.SimpleHttpDefault;
...
import org.iamshield.util.DPoPGenerator;
...
import static org.iamshield.OAuth2Constants.DPOP_HTTP_HEADER;
import static org.iamshield.OAuth2Constants.DPOP_JWT_HEADER_TYPE;
import static org.iamshield.OAuthErrorException.INVALID_TOKEN;
import static org.iamshield.services.util.DPoPUtil.DPOP_SCHEME;
import static org.iamshield.services.util.DPoPUtil.DPOP_TOKEN_TYPE;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createClientAccessTypeConditionConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createDPoPBindEnforcerExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createEcJwk;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createRsaJwk;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.generateEcdsaKey;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.generateSignedDPoPProof;

@EnableFeature(value = Profile.Feature.DPOP, skipRestart = true)
public class DPoPTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void beforeDPoPTest() throws Exception {
        ...
        jwsRsaHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.PS256, DPOP_JWT_HEADER_TYPE, jwkRsa.getKeyId(), jwkRsa);
        ...
        jwsEcHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.ES256, DPOP_JWT_HEADER_TYPE, jwkEc.getKeyId(), jwkEc);
    ...
    public void testDPoPProofByConfidentialClient_EdDSA() throws Exception {
        ...
        // Header
        JWSHeader jwsEdHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.valueOf(Algorithm.EdDSA), DPOP_JWT_HEADER_TYPE, jwkEd.getKeyId(), jwkEd);
    ...
    public void testDPoPProofWithoutJwk() throws Exception {
        JWSHeader jwsHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.ES256, DPOP_JWT_HEADER_TYPE, jwkEc.getKeyId(), null);
    ...
    public void testDPoPProofInvalidAlgorithm() throws Exception {
        JWSHeader jwsHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.none, DPOP_JWT_HEADER_TYPE, jwkEc.getKeyId(), jwkEc);
    ...
    public void testDPoPProofInvalidType() throws Exception {
        JWSHeader jwsEcHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.ES256, "jwt+dpop", jwkEc.getKeyId(), jwkEc);
    ...
    public void testDPoPProofInvalidSignature() throws Exception {
        testDPoPProofFailure(generateSignedDPoPProof(UUID.randomUUID().toString(), HttpMethod.POST, oauth.getEndpoints().getToken(), (long) Time.currentTime(),
                Algorithm.PS256, jwsEcHeader, rsaKeyPair.getPrivate(), null, new TestingDPoPGenerator()), "DPoP verification failure: org.iamshield.exceptions.TokenSignatureInvalidException: Invalid token signature");
    }
    ...
    public void testDPoPProofOnUserInfoWithMissingAcccessTokenHash() throws Exception {
        ...
        JWSHeader jwsRsaHeader1 = new JWSHeader(org.iamshield.jose.jws.Algorithm.PS256, DPOP_JWT_HEADER_TYPE, jwkRsa1.getKeyId(), jwkRsa1);
        // No ath
    ...
    public void testInvalidDPoPProofOnUserInfo() throws Exception {
        ...
        JWSHeader jwsRsaHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.PS256, DPOP_JWT_HEADER_TYPE, jwkRsa.getKeyId(), jwkRsa);
        // invalid "htu" claim
    ...
    public void testDPoPBindEnforcerExecutor() throws Exception {
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy("MyPolicy", "La Primera Plitica", Boolean.TRUE)
                        .addCondition(CliAccessTypeConditionFactory.PROVIDER_ID,
                                createClientAccessTypeConditionConfig(List.of(CliAccessTypeConditionFactory.TYPE_PUBLIC)))
        ...
        JWSHeader jwsEcHeader = new JWSHeader(org.iamshield.jose.jws.Algorithm.ES256, DPOP_JWT_HEADER_TYPE, jwkEc.getKeyId(), jwkEc);
        String dpopProofEcEncoded = generateSignedDPoPProof(UUID.randomUUID().toString(), HttpMethod.POST, oauth.getEndpoints().getToken(), (long) Time.currentTime(), Algorithm.ES256, jwsEcHeader, ecKeyPair.getPrivate(), null);
    ...
    public void testDPoPAdminRequestSuccess() throws Exception {
        ...
        try (IAMShield adminClientDPoP = AdminClientUtil.createAdminClient(false, ServerURLs.getAuthServerContextRoot(), REALM_NAME,

...
import static org.iamshield.authorization.model.Policy.FilterOption.OWNER;
...
import org.iamshield.authorization.client.resource.AuthorizationResource;
import org.iamshield.authorization.client.resource.PolicyResource;
import org.iamshield.authorization.client.resource.ProtectionResource;
...
public class UserManagedPermissionServiceTest extends AbstractResourceServerTest {
    ...
    private static void testRemovePolicyWhenOwnerDeleted(IAMShieldSession session) {
    ...
    private static void testRemovePoliciesOnResourceDelete(IAMShieldSession session) {
        RealmModel realm = session.realms().getRealmByName("authz-test");
        ClientModel client = realm.getClientByClientId("resource-server-test");
        AuthorizationProvider provider = session.getProvider(AuthorizationProvider.class);

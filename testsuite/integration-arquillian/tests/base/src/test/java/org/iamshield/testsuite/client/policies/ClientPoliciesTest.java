...
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createConsentRequiredExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createFullScopeDisabledExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createGrantTypeConditionConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createHolderOfKeyEnforceExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createIntentClientBindCheckExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createPKCEEnforceExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createRejectisResourceOwnerPasswordCredentialsGrantExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createRejectImplicitGrantExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createSecureClientAuthenticatorExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createSecureSigningAlgorithmForSignedJwtEnforceExecutorConfig;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createTestRaiseExeptionConditionConfig;
...
import org.iamshield.admin.client.resource.ProtocolMappersResource;
...
import org.iamshield.models.OAuth2DeviceConfig;
...
import org.iamshield.protocol.oidc.mappers.ClaimsParameterWithValueIdTokenMapper;
import org.iamshield.protocol.oidc.utils.OIDCResponseType;
import org.iamshield.representations.ClaimsRepresentation;
...
import org.iamshield.services.clientpolicy.condition.GrantTypeConditionFactory;
...
import org.iamshield.services.clientpolicy.executor.IntentClientBindCheckExecutorFactory;
import org.iamshield.services.clientpolicy.executor.PKCEEnforcerExecutorFactory;
import org.iamshield.services.clientpolicy.executor.RejectImplicitGrantExecutorFactory;
import org.iamshield.services.clientpolicy.executor.RejectRequestExecutorFactory;
import org.iamshield.services.clientpolicy.executor.RejectResourceOwnerPasswordCredentialsGrantExecutorFactory;
...
import org.iamshield.services.clientpolicy.executor.SuppressRefreshTokenRotationExecutorFactory;
...
import org.iamshield.testsuite.services.clientpolicy.condition.TestRaiseExceptionConditionFactory;
...
import org.iamshield.testsuite.util.oauth.ParResponse;
...
public class ClientPoliciesTest extends AbstractClientPoliciesTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        ClientRepresentation appPublic = ClientBuilder.create().id(IAMShieldModelUtils.generateId()).publicClient()
        ...
        userId = IAMShieldModelUtils.generateId();
    ...
    public void testNegativeLogicCondition() throws Exception {
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "La Premiere Politique", Boolean.TRUE)
                        .addCondition(AnyCliConditionFactory.PROVIDER_ID, createAnyClientConditionConfig())
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);
        ...
        try {
            ...
            updatePolicy((new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "La Premiere Politique", Boolean.TRUE)
                    .addCondition(AnyCliConditionFactory.PROVIDER_ID, createAnyClientConditionConfig(Boolean.TRUE))
                    .addProfile(PROFILE_NAME)
                    .toRepresentation());
            ...
            // update policies
            updatePolicy((new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "La Premiere Politique", Boolean.TRUE)
                    .addCondition(AnyCliConditionFactory.PROVIDER_ID, createAnyClientConditionConfig(Boolean.FALSE))
                    .addProfile(PROFILE_NAME)
                    .toRepresentation());
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "Het Eerste Beleid", Boolean.TRUE)
                        .addCondition(CliScopesConditionFactory.PROVIDER_ID,
                                createClientScopesConditionConfig(CliScopesConditionFactory.OPTIONAL, List.of("microprofile-jwt")))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);

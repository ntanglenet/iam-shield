 ...
 */
public class OAuthRedirectUriTest extends AbstractIAMShieldTest {
    ...
    public void afterAbstractIAMShieldTest() throws Exception {
        super.afterAbstractIAMShieldTest();
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        ClientBuilder installedAppCustomScheme = ClientBuilder.create().clientId("custom-scheme").name("custom-scheme")
                .redirectUris("android-app://org.iamshield.examples.cordova/https/keycloak-cordova-example.github.io/login")
                .secret("password");
    ...
    public void testWithCustomScheme() throws IOException {
        ...
        oauth.redirectUri("android-app://org.iamshield.examples.cordova/https/keycloak-cordova-example.github.io/login");
        oauth.openLoginForm();
        ...
        try {
            ...
            response.getStatus();
            assertThat(response.getFirstHeader("Location"), Matchers.startsWith("android-app://org.iamshield.examples.cordova/https/keycloak-cordova-example.github.io/login"));
        } finally {
            client.close();
        }
    }
    ...
    private void checkRedirectUri(String redirectUri, boolean expectValid, boolean checkCodeToToken) throws IOException {
        ...
        if (!expectValid) {
            ...
            if (!checkCodeToToken) {
                ...
                String browserUrlAfterRedirectFromKeycloak = IAMShieldUriBuilder.fromUri(driver.getCurrentUrl())

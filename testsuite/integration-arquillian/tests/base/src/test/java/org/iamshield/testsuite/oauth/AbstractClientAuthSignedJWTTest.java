...
import org.iamshield.admin.client.resource.ClientAttributeCertificateResource;
...
import org.iamshield.common.util.KeystoreUtil.KeystoreFormat;
import org.iamshield.constants.ServiceUrlConstants;
import org.iamshield.crypto.Algorithm;
import org.iamshield.crypto.ECDSAAlgorithm;
...
import org.iamshield.protocol.oidc.client.authentication.JWTClientCredentialsProvider;
import org.iamshield.representations.AccessToken;
import org.iamshield.representations.JsonWebToken;
import org.iamshield.representations.KeyStoreConfig;
...
public abstract class AbstractClientAuthSignedJWTTest extends AbstractIAMShieldTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        client1SAUserId = IAMShieldModelUtils.generateId();
    ...
    protected void testClientWithGeneratedKeys(String format, Integer keySize, Integer validity) throws Exception {
        ...
        assertCertificate(client, certOld,
                IAMShieldModelUtils.getPemFromCertificate(x509Cert));
    ...
    protected void testUploadKeystore(String keystoreFormat, String filePath, String keyAlias, String storePassword) throws Exception {
        ...
        if (keystoreFormat.equals(org.iamshield.services.resources.admin.ClientAttributeCertificateResource.PUBLIC_KEY_PEM)) {
        ...
        } else if (keystoreFormat.equals(org.iamshield.services.resources.admin.ClientAttributeCertificateResource.JSON_WEB_KEY_SET)) {
            ...
            PublicKey pk = IAMShieldModelUtils.getPublicKey(info.getPublicKey());
            Assert.assertNotNull(pk);
        } else if (keystoreFormat.equals(org.iamshield.services.resources.admin.ClientAttributeCertificateResource.CERTIFICATE_PEM)) {
            String pem = new String(Files.readAllBytes(keystoreFile.toPath()));
            ...
            keystoreIs.close();
            String pem = IAMShieldModelUtils.getPemFromCertificate((X509Certificate) keyStore.getCertificate(keyAlias));
            assertCertificate(client, certOld, pem);
        }
    }
    ...
    protected String getRealmInfoUrl() {
        ...
        return IAMShieldUriBuilder.fromUri(authServerBaseUrl).path(ServiceUrlConstants.REALM_INFO_PATH).build("test").toString();
    }
    ...
    protected class CustomJWTClientCredentialsProvider extends JWTClientCredentialsProvider {
        ...
        protected JsonWebToken createRequestToken(String clientId, String realmInfoUrl) {
            ...
            if (isClaimEnabled("id")) reqToken.id(IAMShieldModelUtils.generateId());

...
import org.iamshield.authentication.authenticators.broker.IdpAutoLinkAuthenticatorFactory;
...
import org.iamshield.broker.saml.mappers.UsernameTemplateMapper;
...
public class LDAPSamlIdPInitiatedVaryingLetterCaseTest extends AbstractLDAPTest {
    ...
    protected void afterImportTestRealm() {
        ...
        ComponentRepresentation ldap = testRealm().components().query(null, "org.iamshield.storage.UserStorageProvider").get(0);
        ...
        ldapMapper.setProviderType("org.iamshield.storage.ldap.mappers.LDAPStorageMapper");

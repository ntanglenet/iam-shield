...
public class LDAPGroupMapperSyncWithGroupsPathTest extends AbstractLDAPTest {
    ...
    public void before() {
        testingClient.server().run(session -> {
            ...
            GroupModel groupsPathGroup = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH);
    ...
    public void test01_syncWithGroupInheritance() {
        testingClient.server().run(session -> {
            ...
            GroupModel kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1");
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group11"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group12"));
            GroupModel kcGroup11 = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11");
            GroupModel kcGroup12 = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12");
            ...
            kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1");
            kcGroup12 = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12");
    ...
    public void test02_syncWithDropNonExistingGroups() throws Exception {
        testingClient.server().run(session -> {
            ...
            // Assert groups are imported to keycloak including their inheritance from LDAP
            GroupModel kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1");
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12"));
            ...
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/model1"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/model2"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/outside"));
            ...
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group11"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/group12"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/model1"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, LDAP_GROUPS_PATH + "/group1/model2"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/outside"));
        });
    }

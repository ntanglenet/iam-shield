 ...
 */
package org.iamshield.testsuite.securityprofile;
...
public class StrictSecurityProfileTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void testUpdatingGlobalPoliciesNotAllowed() throws Exception {
        ...
        clientPoliciesRep = getClientPolicies();
        org.iamshield.testsuite.Assert.assertEquals(origGlobalPolicies, clientPoliciesRep.getGlobalPolicies());
    }

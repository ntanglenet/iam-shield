...
import static org.iamshield.testsuite.broker.KcOidcBrokerConfiguration.CONSUMER_BROKER_APP_CLIENT_ID;
import static org.iamshield.testsuite.broker.KcOidcBrokerConfiguration.CONSUMER_BROKER_APP_SECRET;
...
public final class KcOidcBrokerTransientSessionsTest extends AbstractAdvancedBrokerTest {
    ...
    protected Iterable<IdentityProviderMapperRepresentation> createIdentityProviderMappers(IdentityProviderMapperSyncMode syncMode) {
        ...
        attrMapper1.setIdentityProviderMapper(ExternalIAMShieldRoleToRoleMapper.PROVIDER_ID);
        ...
        attrMapper2.setIdentityProviderMapper(ExternalIAMShieldRoleToRoleMapper.PROVIDER_ID);
    ...
    protected void createAdditionalMapperWithCustomSyncMode(IdentityProviderMapperSyncMode syncMode) {
        ...
        friendlyManagerMapper.setIdentityProviderMapper(ExternalIAMShieldRoleToRoleMapper.PROVIDER_ID);
    ...
    /**
     * Refers to in old test suite: org.iamshield.testsuite.broker.OIDCBrokerUserPropertyTest
     */
    @Test

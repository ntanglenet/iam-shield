...
import org.iamshield.protocol.oid4vc.issuance.JWTVCIssuerWellKnownProviderFactory;
import org.iamshield.protocol.oid4vc.model.JWTVCIssuerMetadata;
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        if (testRealm.getComponents() != null) {
            ...
            testRealm.setComponents(new MultivaluedHashMap<>(
                    Map.of("org.iamshield.keys.KeyProvider", List.of(getRsaKeyProvider(RSA_KEY))
                    )));
        }
    }
}

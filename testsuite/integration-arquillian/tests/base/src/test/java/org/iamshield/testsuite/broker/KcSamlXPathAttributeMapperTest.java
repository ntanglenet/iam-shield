...
import org.iamshield.broker.saml.mappers.XPathAttributeMapper;
 ...
 * extracting it using the {@link org.iamshield.saml.processing.core.parsers.saml.assertion.SAMLAttributeValueParser},
 * and parsing it using {@link XPathAttributeMapper}, finally ending up in a user attribute in the database.
 *
 * This contains only the happy path. Have a look at <code>org.iamshield.test.broker.saml.XPathAttributeMapperTest</code>

...
import org.iamshield.protocol.oidc.mappers.AudienceProtocolMapper;
import org.iamshield.protocol.oidc.mappers.GroupMembershipMapper;
import org.iamshield.protocol.oidc.mappers.HardcodedClaim;
import org.iamshield.protocol.oidc.mappers.HardcodedRole;
import org.iamshield.protocol.oidc.mappers.OIDCAttributeMapperHelper;
import org.iamshield.protocol.oidc.mappers.RoleNameMapper;
...
import org.iamshield.protocol.oidc.mappers.SessionStateMapper;
...
import org.iamshield.testsuite.util.ProtocolMapperUtil;
...
import static org.iamshield.protocol.ProtocolMapperUtils.USER_SESSION_NOTE;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.ACR;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.ACR_SCOPE;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.ADDRESS;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.ALLOWED_WEB_ORIGINS;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.AUDIENCE_RESOLVE;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.CLIENT_ROLES;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.EMAIL;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.EMAIL_VERIFIED;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.FAMILY_NAME;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.FULL_NAME;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.GIVEN_NAME;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.PROFILE_CLAIM;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.REALM_ROLES;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.ROLES_SCOPE;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.USERNAME;
import static org.iamshield.protocol.oidc.OIDCLoginProtocolFactory.WEB_ORIGINS_SCOPE;
import static org.iamshield.protocol.oidc.mappers.AbstractPairwiseSubMapper.PROVIDER_ID_SUFFIX;
import static org.iamshield.protocol.oidc.mappers.AudienceProtocolMapper.INCLUDED_CLIENT_AUDIENCE;
import static org.iamshield.protocol.oidc.mappers.HardcodedClaim.CLAIM_VALUE;
...
import static org.iamshield.protocol.oidc.mappers.OIDCAttributeMapperHelper.INCLUDE_IN_LIGHTWEIGHT_ACCESS_TOKEN;
import static org.iamshield.protocol.oidc.mappers.PairwiseSubMapperHelper.PAIRWISE_SUB_ALGORITHM_SALT;
import static org.iamshield.protocol.oidc.mappers.RoleNameMapper.NEW_ROLE_NAME;
import static org.iamshield.protocol.oidc.mappers.RoleNameMapper.ROLE_CONFIG;
...
public class LightWeightAccessTokenTest extends AbstractClientPoliciesTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        ClientRepresentation confApp = IAMShieldModelUtils.createClient(realm, RESOURCE_SERVER_CLIENT_ID);
    ...
    public void testAdminApiWithLightweightAccessTokenAndTransientSession() {
        ...
        ClientRepresentation transientClient = IAMShieldModelUtils.createClient(realmsResouce().realm("master").toRepresentation(), "transient_client");

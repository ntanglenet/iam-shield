...
import static org.iamshield.testsuite.util.ClientPoliciesUtil.createClientAttributesConditionConfig;
...
import org.iamshield.services.clientpolicy.condition.CliAttributesConditionFactory;
...
public class ClientPoliciesConditionTest extends AbstractClientPoliciesTest {
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "Het Eerste Beleid", Boolean.TRUE)
                        .addCondition(CliScopesConditionFactory.PROVIDER_ID,
                                createClientScopesConditionConfig(CliScopesConditionFactory.OPTIONAL, Arrays.asList("offline_access", "microprofile-jwt")))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);
    ...
    public void testClientScopesAnyCondition() throws Exception {
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "Het Eerste Beleid", Boolean.TRUE)
                        .addCondition(CliScopesConditionFactory.PROVIDER_ID,
                                createClientScopesConditionConfig(CliScopesConditionFactory.ANY, List.of("email", "microprofile-jwt")))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);
    ...
    public void testClientScopesConditionValidation() throws Exception {
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "test", Boolean.TRUE)
                        .addCondition(CliScopesConditionFactory.PROVIDER_ID,
                                createClientScopesConditionConfig(CliScopesConditionFactory.ANY, null))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "test", Boolean.TRUE)
                        .addCondition(CliScopesConditionFactory.PROVIDER_ID,
                                createClientScopesConditionConfig(CliScopesConditionFactory.ANY, List.of("fake-client-scope")))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
    ...
    public void testClientAttributesCondition() throws Exception {
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "Het Eerste Beleid", Boolean.TRUE)
                        .addCondition(CliAttributesConditionFactory.PROVIDER_ID,
        ...
        json = (new ClientPoliciesBuilder()).addPolicy(
                (new ClientPolicyBuilder()).createPolicy(POLICY_NAME, "La Primera Plitica", Boolean.TRUE)
                        .addCondition(CliAccessTypeConditionFactory.PROVIDER_ID,
                                createClientAccessTypeConditionConfig(List.of(CliAccessTypeConditionFactory.TYPE_CONFIDENTIAL)))
                        .addProfile(PROFILE_NAME)
                        .toRepresentation()
        ).toString();
        updatePolicies(json);

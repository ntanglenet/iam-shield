...
import static org.iamshield.common.Profile.Feature.DYNAMIC_SCOPES;
import static org.iamshield.testsuite.admin.ApiUtil.findClientByClientId;
import static org.iamshield.testsuite.util.oauth.OAuthClient.SERVER_ROOT;
...
public class LoginTest extends AbstractChangeImportedUserPasswordsTest {
    ...
    public void testAuthSessionIdCookieFormat(){
        ...
        Assert.assertTrue(IAMShieldModelUtils.isValidUUID(authSessionId));

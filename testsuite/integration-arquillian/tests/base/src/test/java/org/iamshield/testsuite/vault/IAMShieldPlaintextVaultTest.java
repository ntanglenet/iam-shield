...
public class IAMShieldPlaintextVaultTest extends AbstractIAMShieldVaultTest {
    ...
    public void testKeycloakPlaintextVault() {
        ...
        testingClient.server().run(new IAMShieldVaultServerTest("${vault.smtp_key}", "secure_master_smtp_secret"));
        testingClient.server("test").run(new IAMShieldVaultServerTest("${vault.smtp_key}", "secure_test_smtp_secret"));
    }

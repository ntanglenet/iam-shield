...
import org.iamshield.protocol.oidc.client.authentication.JWTClientSecretCredentialsProvider;
...
import static org.iamshield.testsuite.util.ClientPoliciesUtil.ClientPoliciesBuilder;
import static org.iamshield.testsuite.util.ClientPoliciesUtil.ClientPolicyBuilder;
...
public class FAPI1Test extends AbstractFAPITest {
    ...
    public void testFAPIAdvancedLoginWithPrivateKeyJWT() throws Exception {
        ...
        // Check HoK required
        String signedJwt = createSignedRequestToken("foo", privateKey, publicKey, org.iamshield.crypto.Algorithm.PS256);
        ...
        String signedJwt2 = createSignedRequestToken("foo", privateKey, publicKey, org.iamshield.crypto.Algorithm.PS256);

...
package org.iamshield.testsuite.organization.account;
...
import org.iamshield.admin.client.resource.OrganizationResource;
import org.iamshield.broker.provider.util.SimpleHttp.Response;
import org.iamshield.representations.account.LinkedAccountRepresentation;
import org.iamshield.representations.account.OrganizationRepresentation;
...
public class OrganizationAccountTest extends AbstractOrganizationTest {
    ...
    public void testGetOrganizations() throws Exception {
        ...
        org.iamshield.representations.idm.OrganizationRepresentation orgA = createOrganization("orga");
        testRealm().organizations().get(orgA.getId()).members().addMember(member.getId()).close();
        org.iamshield.representations.idm.OrganizationRepresentation orgB = createOrganization("orgb");

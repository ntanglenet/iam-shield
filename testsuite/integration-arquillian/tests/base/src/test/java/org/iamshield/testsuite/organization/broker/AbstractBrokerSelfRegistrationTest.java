...
package org.iamshield.testsuite.organization.broker;
...
import org.iamshield.admin.client.resource.OrganizationIdentityProviderResource;
import org.iamshield.admin.client.resource.OrganizationMemberResource;
...
public abstract class AbstractBrokerSelfRegistrationTest extends AbstractOrganizationTest {
    ...
    public void testFailUpdateEmailNotAssociatedOrganizationUsingAdminAPI() {
        ...
        member.setEmail(IAMShieldModelUtils.generateId() + "@user.org");

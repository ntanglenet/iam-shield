...
package org.iamshield.testsuite.organization.authz;
...
public class OrganizationAdminPermissionsTest extends AbstractOrganizationTest {
    ...
    public void testManageRealmRole() throws Exception {
        try (
                IAMShield manageRealmAdminClient = AdminClientUtil.createAdminClient(suiteContext.isAdapterCompatTesting(),
                        TEST_REALM_NAME, "realmAdmin", "password", Constants.ADMIN_CLI_CLIENT_ID, null);
                IAMShield userAdminClient = AdminClientUtil.createAdminClient(suiteContext.isAdapterCompatTesting(),

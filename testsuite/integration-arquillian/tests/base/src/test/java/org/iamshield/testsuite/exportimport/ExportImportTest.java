...
import org.iamshield.exportimport.dir.DirExportProvider;
import org.iamshield.exportimport.dir.DirExportProviderFactory;
...
import org.iamshield.testsuite.client.resources.TestingExportImportResource;
 ...
 */
public class ExportImportTest extends AbstractIAMShieldTest {
    ...
    @Override
    public void beforeAbstractIAMShieldTestRealmImport() {
    ...
    public void testExportUserProfileConfig() throws IOException {
        ...
        List<ComponentRepresentation> userProfileComponents = realmRes.components().query(TEST_REALM, "org.iamshield.userprofile.UserProfileProvider");

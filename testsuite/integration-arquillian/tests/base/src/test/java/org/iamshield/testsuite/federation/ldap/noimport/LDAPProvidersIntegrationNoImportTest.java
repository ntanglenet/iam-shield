...
package org.iamshield.testsuite.federation.ldap.noimport;
...
import org.iamshield.testsuite.federation.ldap.LDAPProvidersIntegrationTest;
import org.iamshield.testsuite.federation.ldap.LDAPTestAsserts;
import org.iamshield.testsuite.federation.ldap.LDAPTestContext;
...
public class LDAPProvidersIntegrationNoImportTest extends LDAPProvidersIntegrationTest {
    ...
    public void testFullNameMapperWriteOnly() {
        ComponentRepresentation firstNameMapperRep = testingClient.server().fetch(session -> {
            ...
            ComponentModel fullNameMapperModel = IAMShieldModelUtils.createComponentModel("full name", ldapModel.getId(), FullNameLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),

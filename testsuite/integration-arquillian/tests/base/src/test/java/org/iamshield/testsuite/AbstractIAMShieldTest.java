...
import org.iamshield.testsuite.arquillian.KcArquillian;
import org.iamshield.testsuite.arquillian.SuiteContext;
import org.iamshield.testsuite.arquillian.TestContext;
import org.iamshield.testsuite.auth.page.AuthRealm;
import org.iamshield.testsuite.auth.page.AuthServer;
import org.iamshield.testsuite.auth.page.AuthServerContextRoot;
import org.iamshield.testsuite.auth.page.WelcomePage;
import org.iamshield.testsuite.auth.page.login.OIDCLogin;
import org.iamshield.testsuite.auth.page.login.UpdatePassword;
...
import org.iamshield.testsuite.util.CryptoInitRule;
import org.iamshield.testsuite.util.DroneUtils;
import org.iamshield.testsuite.util.oauth.OAuthClient;
import org.iamshield.testsuite.util.TestCleanup;
import org.iamshield.testsuite.util.TestEventsLogger;
...
import static org.iamshield.testsuite.util.ServerURLs.AUTH_SERVER_HOST;
import static org.iamshield.testsuite.util.ServerURLs.AUTH_SERVER_PORT;
import static org.iamshield.testsuite.util.ServerURLs.AUTH_SERVER_SCHEME;
import static org.iamshield.testsuite.util.ServerURLs.AUTH_SERVER_SSL_REQUIRED;
import static org.iamshield.testsuite.util.ServerURLs.removeDefaultPorts;
import static org.iamshield.testsuite.util.URLUtils.navigateToUri;
...
public abstract class AbstractIAMShieldTest {
    ...
    protected IAMShieldTestingClient testingClient;
    ...
    public void beforeAbstractIAMShieldTest() throws Exception {
        ...
        beforeAbstractIAMShieldTestRealmImport();
        ...
        if (testContext.getTestRealmReps().isEmpty()) {
            ...
            afterAbstractIAMShieldTestRealmImport();
        }
     ...
     * In @Before block
     */
    protected void beforeAbstractIAMShieldTestRealmImport() throws Exception {
    }
     ...
     * In @After block
     */
    protected void postAfterAbstractIAMShield() throws Exception {
    }

    @After
    public void afterAbstractIAMShieldTest() throws Exception {
        if (resetTimeOffset) {
            resetTimeOffset();
        }
    ...
    public IAMShieldTestingClient getTestingClient() {
    ...
    public IAMShield getAdminClient() {
        return adminClient;
    }
    ...
    public URI getAuthServerRoot() {
        try {
            return IAMShieldUriBuilder.fromUri(suiteContext.getAuthServerInfo().getContextRoot().toURI()).path("/auth/").build();

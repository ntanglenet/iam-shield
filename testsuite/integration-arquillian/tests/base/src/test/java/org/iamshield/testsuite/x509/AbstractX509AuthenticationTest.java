...
package org.iamshield.testsuite.x509;
...
import org.iamshield.admin.client.resource.AuthenticationManagementResource;
import org.iamshield.admin.client.resource.UserProfileResource;
import org.iamshield.authentication.AuthenticationFlow;
import org.iamshield.authentication.authenticators.x509.ValidateX509CertificateUsernameFactory;
import org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel;
import org.iamshield.authentication.authenticators.x509.X509ClientCertificateAuthenticatorFactory;
import org.iamshield.common.util.Encode;
...
import org.iamshield.testsuite.pages.AbstractPage;
import org.iamshield.testsuite.pages.AppPage;
import org.iamshield.testsuite.pages.LoginPage;
import org.iamshield.testsuite.pages.x509.X509IdentityConfirmationPage;
import org.iamshield.testsuite.updaters.SetSystemProperty;
import org.iamshield.testsuite.util.AdminEventPaths;
import org.iamshield.testsuite.util.AssertAdminEvents;
import org.iamshield.testsuite.util.ClientBuilder;
import org.iamshield.testsuite.util.DroneUtils;
import org.iamshield.testsuite.util.HtmlUnitBrowser;
...
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.IdentityMapperType.USERNAME_EMAIL;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.IdentityMapperType.USER_ATTRIBUTE;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.ISSUERDN;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTALTNAME_EMAIL;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTALTNAME_OTHERNAME;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTDN;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTDN_CN;
import static org.iamshield.authentication.authenticators.x509.X509AuthenticatorConfigModel.MappingSourceType.SUBJECTDN_EMAIL;
import static org.iamshield.testsuite.drone.IAMShieldDronePostSetup.HTML_UNIT_SSL_KEYSTORE_PASSWORD_PROP;
import static org.iamshield.testsuite.drone.IAMShieldDronePostSetup.HTML_UNIT_SSL_KEYSTORE_PROP;
import static org.iamshield.testsuite.drone.IAMShieldDronePostSetup.HTML_UNIT_SSL_KEYSTORE_TYPE_PROP;
import static org.iamshield.testsuite.util.ServerURLs.AUTH_SERVER_SSL_REQUIRED;
import static org.iamshield.utils.StringUtil.isBlank;
 ...
 * @since 10/28/2016
 */
public abstract class AbstractX509AuthenticationTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        UserRepresentation user = UserBuilder.create()
                ...
                .enabled(true)
                .password("password")
                .addAttribute("x509_issuer_identity", "IAMShield Intermediate CA")
                .build();
    ...
    AuthenticationFlowRepresentation createFlow(AuthenticationFlowRepresentation flowRep) {
        ...
        try {
            org.iamshield.testsuite.Assert.assertEquals(201, response.getStatus());
        }
        finally {
            response.close();
        }

...
import static org.iamshield.common.Profile.Feature.ACCOUNT_API;
import static org.iamshield.testsuite.util.oauth.OAuthClient.APP_ROOT;
 ...
 */
public abstract class AbstractRestServiceTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        org.iamshield.representations.idm.ClientRepresentation inUseApp = ClientBuilder.create().clientId("in-use-client")
        ...
        org.iamshield.representations.idm.ClientRepresentation offlineApp = ClientBuilder.create().clientId("offline-client")
                .id(IAMShieldModelUtils.generateId())
                .name("Offline Client")
        ...
        org.iamshield.representations.idm.ClientRepresentation offlineApp2 = ClientBuilder.create().clientId("offline-client-without-base-url")
                .id(IAMShieldModelUtils.generateId())
        ...
        org.iamshield.representations.idm.ClientRepresentation alwaysDisplayApp = ClientBuilder.create().clientId("always-display-client")
                .id(IAMShieldModelUtils.generateId())

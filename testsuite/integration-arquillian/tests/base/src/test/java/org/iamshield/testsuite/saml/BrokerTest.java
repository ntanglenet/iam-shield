...
import org.iamshield.broker.saml.SAMLIdentityProviderFactory;
...
import org.iamshield.models.AuthenticationExecutionModel.Requirement;
...
import org.iamshield.saml.processing.core.parsers.saml.xmldsig.XmlDSigQNames;
import org.iamshield.saml.processing.core.parsers.util.HasQName;
...
import org.iamshield.testsuite.updaters.IdentityProviderCreator;
...
import org.iamshield.testsuite.util.saml.SamlBackchannelArtifactResolveReceiver;
...
import static org.iamshield.saml.SignatureAlgorithm.RSA_SHA1;
import static org.iamshield.testsuite.util.Matchers.isSamlStatusResponse;
import static org.iamshield.testsuite.util.SamlClient.Binding.POST;
import static org.iamshield.testsuite.util.SamlClient.Binding.REDIRECT;
    ...
    public void testNoNameIDAndPrincipalFromAttribute() throws IOException {
        ...
        try (IdentityProviderCreator idp = new IdentityProviderCreator(realm, rep)) {
            new SamlClientBuilder()
                    ...
                    .assertResponse(org.iamshield.testsuite.util.Matchers.statusCodeIsHC(200))
                    .execute();
        }
        ...
        try (IdentityProviderCreator idp = new IdentityProviderCreator(realm, addIdentityProvider("https://saml.idp/"))) {
            new SamlClientBuilder()
              ...
              .processSamlResponse(REDIRECT)
                ...
                .targetBinding(POST)
                .build()
              .assertResponse(org.iamshield.testsuite.util.Matchers.statusCodeIsHC(Status.OK))
              .execute();
        }
    }
    ...
    private void assertExpired(XMLGregorianCalendar notBefore, XMLGregorianCalendar notOnOrAfter, boolean shouldPass) throws Exception {
        ...
        try (IdentityProviderCreator idp = new IdentityProviderCreator(realm, addIdentityProvider("https://saml.idp/"))) {
            new SamlClientBuilder()
              ...
              .targetUri(getSamlBrokerUrl(REALM_NAME))
              .build()
              .assertResponse(org.iamshield.testsuite.util.Matchers.statusCodeIsHC(expectedStatus))
              .execute();
        }
    }
    ...
    public void testResolveArtifactBindingAsSp() {
        ...
        try (SamlBackchannelArtifactResolveReceiver samlBackchannelArtifactResolveReceiver = new SamlBackchannelArtifactResolveReceiver(
            ...
            try (IdentityProviderCreator idp = new IdentityProviderCreator(realm, rep)) {
                ...
                samlClientBuilder.assertResponse(org.iamshield.testsuite.util.Matchers.statusCodeIsHC(Status.OK));

...
import org.iamshield.representations.idm.SynchronizationResultRepresentation;
...
public class LDAPGroupMapperSyncTest extends AbstractLDAPTest {
    ...
    private void testSyncNoPreserveGroupInheritance() throws Exception {
        ...
        testingClient.server().run(session -> {
            ...
            GroupModel kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1");
            GroupModel kcGroup11 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group11");
            GroupModel kcGroup12 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group12");
    ...
    public void test03_syncWithGroupInheritance() throws Exception {
        testingClient.server().run(session -> {
            ...
            GroupModel kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1");
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group11"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group12"));
            GroupModel kcGroup11 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group11");
            GroupModel kcGroup12 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group12");
            ...
            kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1");
            kcGroup12 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group12");
    ...
    public void test04_syncWithDropNonExistingGroups() throws Exception {
        testingClient.server().run(session -> {
            ...
            // Assert groups are imported to keycloak including their inheritance from LDAP
            GroupModel kcGroup1 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1");
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group11"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group12"));
            ...
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group11"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group12"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/model1"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/model2"));
            ...
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group11"));
            Assert.assertNotNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/group12"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/model1"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1/model2"));
        });
    }
    ...
    public void test05_syncNoPreserveGroupInheritanceWithLazySync() throws Exception {
        ...
        testingClient.server().run(session -> {
            ...
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group1"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group11"));
            Assert.assertNull(IAMShieldModelUtils.findGroupByPath(session, realm, "/group12"));
            ...
            GroupModel group1 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group1");
            GroupModel group11 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group11");
            GroupModel group12 = IAMShieldModelUtils.findGroupByPath(session, realm, "/group12");
    ...
    public void test08_flatSynchWithBatchSizeLessThanNumberOfGroups() {
        ...
        testingClient.server().run(session -> {
            ...
            Stream.of("/group1", "/group11", "/group12").forEach(path -> {
                GroupModel kcGroup = IAMShieldModelUtils.findGroupByPath(session, realm, path);

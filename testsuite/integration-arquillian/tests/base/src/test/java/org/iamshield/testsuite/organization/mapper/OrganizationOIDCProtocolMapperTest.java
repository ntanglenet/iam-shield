...
package org.iamshield.testsuite.organization.mapper;
...
public class OrganizationOIDCProtocolMapperTest extends AbstractOrganizationTest {
    ...
    public void testOrganizationScopeMapsSpecificOrganization() {
        ...
        org.iamshield.testsuite.Assert.assertFalse(loginPage.isPasswordInputPresent());
        org.iamshield.testsuite.Assert.assertTrue(loginPage.isSocialButtonPresent(orgA.getAlias() + "-identity-provider"));
        org.iamshield.testsuite.Assert.assertFalse(loginPage.isSocialButtonPresent(orgB.getAlias() + "-identity-provider"));

...
import org.iamshield.authentication.authenticators.browser.SpnegoAuthenticatorFactory;
...
public abstract class AbstractKerberosTest extends AbstractAuthTest {
    ...
    protected IAMShieldSPNegoSchemeFactory spnegoSchemeFactory;
    ...
    public void beforeAbstractIAMShieldTest() throws Exception {
        ...
        spnegoSchemeFactory = new IAMShieldSPNegoSchemeFactory(getKerberosConfig());
        initHttpClient(true);
        removeAllUsers();

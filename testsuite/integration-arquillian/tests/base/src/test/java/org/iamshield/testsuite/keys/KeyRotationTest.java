...
package org.iamshield.testsuite.keys;
...
import org.iamshield.keys.GeneratedHmacKeyProviderFactory;
 ...
 */
public class KeyRotationTest extends AbstractIAMShieldTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        ClientRepresentation confApp = IAMShieldModelUtils.createClient(realm, "confidential-cli");
    ...
    private Map<String, String> createKeys(String priority) throws Exception {
        KeyPair keyPair = KeyUtils.generateRsaKeyPair(org.iamshield.testsuite.util.KeyUtils.getLowestSupportedRsaKeySize());
        ...
        org.iamshield.common.util.MultivaluedHashMap<String, String> config = new org.iamshield.common.util.MultivaluedHashMap<>();
        ...
        config = new org.iamshield.common.util.MultivaluedHashMap<>();

...
import org.iamshield.protocol.oid4vc.issuance.TimeProvider;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.CredentialBuilder;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.JwtCredentialBuilder;
import org.iamshield.protocol.oid4vc.issuance.OID4VCAuthorizationDetailsResponse;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.SdJwtCredentialBuilder;
...
import static org.iamshield.jose.jwe.JWEConstants.A128GCM;
...
import static org.iamshield.protocol.oid4vc.issuance.OID4VCIssuerEndpoint.CREDENTIAL_OFFER_URI_CODE_SCOPE;
import static org.iamshield.protocol.oid4vc.model.ProofType.JWT;
import static org.iamshield.testsuite.forms.PassThroughClientAuthenticator.clientId;
...
public abstract class OID4VCIssuerEndpointTest extends OID4VCTest {
    ...
    protected static String prepareSessionCode(IAMShieldSession session, AppAuthManager.BearerTokenAuthenticator authenticator, String note) {
    ...
    protected static OID4VCIssuerEndpoint prepareIssuerEndpoint(IAMShieldSession session,
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        ...
        testRealm.getComponents().add("org.iamshield.keys.KeyProvider", getKeyProvider());

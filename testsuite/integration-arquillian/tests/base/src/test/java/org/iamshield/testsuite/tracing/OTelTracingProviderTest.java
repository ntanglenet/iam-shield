...
package org.iamshield.testsuite.tracing;
...
import org.iamshield.testsuite.arquillian.annotation.AuthServerContainerExclude;
import org.iamshield.testsuite.arquillian.containers.AbstractQuarkusDeployableContainer;
import org.iamshield.tracing.NoopTracingProvider;
...
public class OTelTracingProviderTest extends AbstractTestRealmIAMShieldTest {
    ...
    void startContainer() {
        ...
        try {
            ...
            container.setAdditionalBuildArgs(List.of("--tracing-enabled=true", "--log-level=org.iamshield.quarkus.runtime.tracing:debug"));
    ...
    public void parentSpan() {
        runOnServer(tracing -> {
            ...
            assertThat(readableSpan.getAttribute(AttributeKey.stringKey("code.namespace")), is("org.iamshield.testsuite.rest.TestingResourceProvider"));

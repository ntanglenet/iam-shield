...
import org.iamshield.services.clientpolicy.condition.AcrCondition;
import org.iamshield.services.clientpolicy.condition.AcrConditionFactory;
import org.iamshield.services.clientpolicy.executor.AuthenticationFlowSelectorExecutor;
import org.iamshield.services.clientpolicy.executor.AuthenticationFlowSelectorExecutorFactory;
...
public class AcrAuthFlowTest extends AbstractOIDCScopeTest{
    ...
    private ClientScopeRepresentation createScope(){
        ...
        return new ClientScopeRepresentation(){{
            setId(IAMShieldModelUtils.generateId());
    ...
    private void setAcrClientPolicy(IAMShield adminClient, String realm, String acr, String alias) {
        setAcrClientPolicy(adminClient, realm, acr, alias, null);
    }

    public static void setAcrClientPolicy(IAMShield adminClient, String realm, String acr, String alias, Integer loa) {

...
import org.iamshield.protocol.oidc.grants.AuthorizationCodeGrantTypeFactory;
import org.iamshield.protocol.oidc.grants.RefreshTokenGrantTypeFactory;
import org.iamshield.protocol.oidc.grants.ciba.CibaGrantTypeFactory;
import org.iamshield.protocol.oidc.grants.device.DeviceGrantTypeFactory;
...
public class AssertEvents implements TestRule {
    ...
    private AbstractIAMShieldTest context;

    public AssertEvents(AbstractIAMShieldTest ctx) {
        context = ctx;
    }
...
//                .session((String) null);
    ...
    public class ExpectedEvent {
        ...
        /**
         * Assert the expected event was sent to the listener by IAMShield server. Returns this event.
         *

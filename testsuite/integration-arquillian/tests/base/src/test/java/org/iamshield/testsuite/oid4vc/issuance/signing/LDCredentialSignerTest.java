...
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.JwtCredentialBody;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.LDCredentialBody;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.LDCredentialBuilder;
import org.iamshield.protocol.oid4vc.issuance.signing.CredentialSignerException;
import org.iamshield.protocol.oid4vc.issuance.signing.LDCredentialSigner;
import org.iamshield.protocol.oid4vc.issuance.signing.vcdm.Ed255192018Suite;
import org.iamshield.protocol.oid4vc.model.CredentialBuildConfig;
...
import org.iamshield.protocol.oid4vc.model.vcdm.LdProof;
...
public class LDCredentialSignerTest extends OID4VCTest {
    ...
    public static void testSignLdCredential(
            IAMShieldSession session, String signingKeyId, Map<String, Object> claims,
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        if (testRealm.getComponents() != null) {
            testRealm.getComponents().add("org.iamshield.keys.KeyProvider", getEdDSAKeyProvider());
        } else {
            testRealm.setComponents(new MultivaluedHashMap<>(
                    Map.of("org.iamshield.keys.KeyProvider", List.of(getEdDSAKeyProvider()))));
        }
    }
}

...
import org.iamshield.authentication.authenticators.conditional.ConditionalClientScopeAuthenticatorFactory;
...
import static org.iamshield.models.utils.TimeBasedOTP.DEFAULT_INTERVAL_SECONDS;
...
public class KcOidcPostBrokerLoginTest extends AbstractInitializedBaseBrokerTest {
    ...
    static void configurePostBrokerLoginWithClientScopeConditionAndOTP(IAMShieldTestingClient testingClient, String consumerRealmName, String idpAlias, String clientScopeName, boolean negate) {

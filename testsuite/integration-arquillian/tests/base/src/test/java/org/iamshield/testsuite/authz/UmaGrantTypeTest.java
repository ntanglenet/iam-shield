...
public class UmaGrantTypeTest extends AbstractResourceServerTest {
    ...
    public void testObtainRptWithUpgradeWithUnauthorizedResourceFromRpt() throws Exception {
        ...
        ResourceRepresentation resourceA = addResource(IAMShieldModelUtils.generateId(), "ScopeA", "ScopeB", "ScopeC");
        ...
        ResourceRepresentation resourceB = addResource(IAMShieldModelUtils.generateId(), "ScopeA", "ScopeB", "ScopeC");
    ...
    public void testObtainRptOnlyAuthorizedScopes() throws Exception {
        ResourceRepresentation resourceA = addResource(IAMShieldModelUtils.generateId(), "READ", "WRITE");
        ScopePermissionRepresentation permissionA = new ScopePermissionRepresentation();

        permissionA.setName(IAMShieldModelUtils.generateId());
        ...
        permissionB.setName(IAMShieldModelUtils.generateId());

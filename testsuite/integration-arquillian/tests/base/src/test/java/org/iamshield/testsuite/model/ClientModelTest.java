...
import org.iamshield.protocol.oidc.mappers.AddressMapper;
 ...
 */
public class ClientModelTest extends AbstractIAMShieldTest {
    private ClientModel client;
    private String roleId;
    private String realmName="original";
    private IAMShieldSession currentSession;
    ...
    @Test
    @ModelTest
    public void testClientRoleRemovalAndClientScope(IAMShieldSession session) {
        // Client "from" has a role.  Assign this role to a scope to client "scoped".  Delete the role and make sure
        // cache gets cleared

        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientRoleRemove1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientRoleRemove2) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientRoleRemove3) -> {
    ...
    @Test
    @ModelTest
    public void testClientRoleRemovalAndClientScopeSameTx(IAMShieldSession session) {
        // Client "from" has a role.  Assign this role to a scope to client "scoped".  Delete the role and make sure
        // cache gets cleared

        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientRoleRemoveTx1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientRoleRemoveTx2) -> {
    ...
    @Test
    @ModelTest
    public void testRealmRoleRemovalAndClientScope(IAMShieldSession session) {
        // Client "from" has a role.  Assign this role to a scope to client "scoped".  Delete the role and make sure
        // cache gets cleared

        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionRealmRoleRemove1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionRealmRoleRemove2) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionRealmRoleRemove3) -> {
    ...
    @Test
    @ModelTest
    public void testCircularClientScopes(IAMShieldSession session) {

        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionCircuilarClient1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionCircuilarClient2) -> {
    ...
    @Test
    @ModelTest
    public void persist(IAMShieldSession session) {
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionPersist) -> {
    ...
    @Test
    @ModelTest
    public void json(IAMShieldSession session) {
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionJson) -> {
    ...
    @Test
    @ModelTest
    public void testAddApplicationWithId(IAMShieldSession session) {
        final String id = IAMShieldModelUtils.generateId();
        String newClientId = IAMShieldModelUtils.runJobInTransactionWithResult(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionAppWithId1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionAppWithId2) -> {
    ...
    @Test
    @ModelTest
    public void testClientScopesBinding(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientScopeBind1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientScopeBind2) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionClientScopeBind3) -> {
    ...
    @Test
    @ModelTest
    public void testDefaultDefaultClientScopes(IAMShieldSession session) {
        AtomicReference<ClientScopeModel> scope1Atomic = new AtomicReference<>();
        AtomicReference<ClientScopeModel> scope2Atomic = new AtomicReference<>();
        AtomicReference<ClientScopeModel> scope3Atomic = new AtomicReference<>();

        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionDefaultClientScope1) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionDefaultClientScope2) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionDefaultClientScope3) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionDefaultClientScope4) -> {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), session.getContext(), (IAMShieldSession sessionDefaultClientScope5) -> {

...
import org.iamshield.authentication.actiontoken.resetcred.ResetCredentialsActionToken;
...
import org.iamshield.testsuite.federation.kerberos.AbstractKerberosTest;
...
import org.iamshield.testsuite.util.KerberosUtils;
 ...
 */
public class ResetPasswordTest extends AbstractTestRealmIAMShieldTest {
    ...
    public void configureTestRealm(RealmRepresentation testRealm) {
        RealmBuilder.edit(testRealm)
                .client(org.iamshield.testsuite.util.ClientBuilder.create().clientId("client-user").serviceAccount());
    }
    ...
    private void resetPasswordInNewTab(UserRepresentation user, String clientId, String redirectUri) throws IOException {
        try (BrowserTabUtil browserTabUtil = BrowserTabUtil.getInstanceAndSetEnv(driver)) {
            ...
            if (driver instanceof HtmlUnitDriver) {
                ...
                IAMShieldUriBuilder builder = IAMShieldUriBuilder.fromUri(tab1Url);

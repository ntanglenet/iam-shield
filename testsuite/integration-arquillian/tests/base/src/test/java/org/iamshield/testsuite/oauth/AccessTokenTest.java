...
import org.iamshield.keys.GeneratedEddsaKeyProviderFactory;
...
import org.iamshield.testsuite.ActionURIUtils;
...
import static org.iamshield.testsuite.admin.ApiUtil.findUserByUsernameId;
import static org.iamshield.testsuite.util.oauth.OAuthClient.AUTH_SERVER_ROOT;
import static org.iamshield.testsuite.util.ProtocolMapperUtil.createRoleNameMapper;
import static org.iamshield.testsuite.util.ServerURLs.AUTH_SERVER_SSL_REQUIRED;

/**
 * @author <a href="mailto:sthorger@redhat.com">Stian Thorgersen</a>
 */
public class AccessTokenTest extends AbstractIAMShieldTest {
    ...
    private IDToken getIdToken(org.iamshield.representations.AccessTokenResponse tokenResponse) throws JWSInputException {
        JWSInput input = new JWSInput(tokenResponse.getIdToken());
        return input.readJsonContent(IDToken.class);
    }

    private AccessToken getAccessToken(org.iamshield.representations.AccessTokenResponse tokenResponse) throws JWSInputException {

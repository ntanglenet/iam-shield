 ...
 *
 */
package org.iamshield.testsuite.oauth.rar;
...
public abstract class AbstractRARParserTest extends AbstractTestRealmIAMShieldTest {
    ...
    /**
     * Fetch the {@link org.iamshield.rar.AuthorizationRequestContext} for the current Client session from the server

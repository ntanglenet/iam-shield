...
package org.iamshield.testsuite.vault;
...
public abstract class AbstractIAMShieldVaultTest extends AbstractIAMShieldTest {
    ...
    static class IAMShieldVaultServerTest implements RunOnServer {

        private String testKey;
        private String expectedSecret;

        public IAMShieldVaultServerTest(final String key, final String expectedSecret) {
            this.testKey = key;
    ...
    @NotNull
    private static VaultTranscriber getVaultTranscriber(IAMShieldSession session) throws RuntimeException {

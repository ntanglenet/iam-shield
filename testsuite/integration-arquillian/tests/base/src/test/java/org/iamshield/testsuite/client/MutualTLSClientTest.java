 ...
 */
public class MutualTLSClientTest extends AbstractTestRealmIAMShieldTest {
   ...
   public void configureTestRealm(RealmRepresentation testRealm) {
      ClientRepresentation properConfiguration = IAMShieldModelUtils.createClient(testRealm, CLIENT_ID);
      ...
      ClientRepresentation disabledConfiguration = IAMShieldModelUtils.createClient(testRealm, DISABLED_CLIENT_ID);
      ...
      ClientRepresentation exactSubjectDNConfiguration = IAMShieldModelUtils.createClient(testRealm, EXACT_SUBJECT_DN_CLIENT_ID);
      ...
      ClientRepresentation issuerSubjectDNConfiguration = IAMShieldModelUtils.createClient(testRealm, ISSUER_SUBJECT_DN_CLIENT_ID);
      ...
      ClientRepresentation obbSubjectDNConfiguration = IAMShieldModelUtils.createClient(testRealm, OBB_SUBJECT_DN_CLIENT_ID);

 ...
 */
public class IAMShieldSPNegoSchemeFactory extends SPNegoSchemeFactory {
    ...
    public IAMShieldSPNegoSchemeFactory(CommonKerberosConfig kerberosConfig) {
        super(true, false);
    ...
    public AuthScheme newInstance(HttpParams params) {
        return new IAMShieldSPNegoScheme(isStripPort(), isUseCanonicalHostname());
    }
    ...
    public class IAMShieldSPNegoScheme extends SPNegoScheme {

        public IAMShieldSPNegoScheme(boolean stripPort, boolean useCanonicalHostname) {

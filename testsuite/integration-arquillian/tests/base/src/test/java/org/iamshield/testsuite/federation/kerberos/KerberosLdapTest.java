...
import static org.iamshield.common.constants.KerberosConstants.KERBEROS_PRINCIPAL;
...
public class KerberosLdapTest extends AbstractKerberosSingleRealmTest {
    ...
    public void writableEditModeTest() throws Exception {
        ...
        org.iamshield.testsuite.Assert.assertEquals(302, spnegoResponse.getStatus());
        org.iamshield.testsuite.Assert.assertEquals(302, spnegoResponse.getStatus());

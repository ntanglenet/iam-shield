 ...
 */
public class UserConsentModelTest extends AbstractTestRealmIAMShieldTest {
    ...
    public static void setupEnv(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionEnv) -> {
            IAMShieldSession currentSession = sessionEnv;
    ...
    public void basicConsentTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionCT) -> {
            IAMShieldSession currentSession = sessionCT;
    ...
    public void getAllConsentTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionACT) -> {
            IAMShieldSession currentSession = sessionACT;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
    ...
    public void updateWithClientScopeRemovalTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession removalTestSession1) -> {
            IAMShieldSession currentSession = removalTestSession1;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession removalTestSession2) -> {
            IAMShieldSession currentSession = removalTestSession2;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
    ...
    public void revokeTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionRT1) -> {
            IAMShieldSession currentSession = sessionRT1;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionRT2) -> {
            IAMShieldSession currentSession = sessionRT2;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
    ...
    public void deleteUserTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionUT) -> {
            IAMShieldSession currentSession = sessionUT;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
    ...
    public void deleteClientScopeTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionST1) -> {
            IAMShieldSession currentSession = sessionST1;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionST2) -> {
            IAMShieldSession currentSession = sessionST2;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
    ...
    public void deleteClientTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionDCT1) -> {
            IAMShieldSession currentSession = sessionDCT1;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionDCT2) -> {
            IAMShieldSession currentSession = sessionDCT2;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
    ...
    public void deleteClientStorageTest(IAMShieldSession session) {
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionCST1) -> {
            IAMShieldSession currentSession = sessionCST1;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionCST2) -> {
            IAMShieldSession currentSession = sessionCST2;
            RealmModel realm = currentSession.realms().getRealm(realmId);
            currentSession.getContext().setRealm(realm);

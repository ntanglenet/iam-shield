...
import org.iamshield.testsuite.runonserver.FetchOnServerWrapper;
 ...
 */
public class OfflineTokenMigrationTest extends AbstractTestRealmIAMShieldTest {
    ...
    public interface OfflineTokenConverter extends Serializable, BiFunction<IAMShieldSession, String, String> {
    }
}

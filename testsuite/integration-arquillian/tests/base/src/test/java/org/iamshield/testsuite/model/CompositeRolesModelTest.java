 ...
 */
public class CompositeRolesModelTest extends AbstractTestRealmIAMShieldTest {
    @Rule
    ...
    @Test
    @ModelTest
    public void testNoClientID(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void testComposites(IAMShieldSession session) {

        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession session5) -> {

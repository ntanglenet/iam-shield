...
import static org.iamshield.models.Constants.CLIENT_DATA;
import static org.iamshield.testsuite.AssertEvents.DEFAULT_REDIRECT_URI;
...
public class MultipleTabsLoginTest extends AbstractChangeImportedUserPasswordsTest {
    ...
    public void testEmptyBaseUrl() throws Exception {
        try (BrowserTabUtil tabUtil = BrowserTabUtil.getInstanceAndSetEnv(driver)) {
            ...
            String clientUuid = IAMShieldModelUtils.generateId();

 ...
 */
package org.iamshield.testsuite.user.profile.config;

import static org.iamshield.userprofile.config.UPConfigUtils.readConfig;
import static org.iamshield.userprofile.config.UPConfigUtils.validate;
 ...
 *
 */
public class UPConfigParserTest extends AbstractTestRealmIAMShieldTest {
    ...
    public static void validateConfiguration_OK(IAMShieldSession session) throws IOException {
    ...
    public static void validateConfiguration_attributeNameErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();
        //we run this test without IAMShieldSession so validator configs are not validated here
    ...
    public static void validateConfiguration_attributePermissionsErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();
        //we run this test without IAMShieldSession so validator configs are not validated here
    ...
    public static void validateConfiguration_attributeRequirementsErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();
        //we run this test without IAMShieldSession so validator configs are not validated here
    ...
    private static void validateConfiguration_attributeValidationsErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();
    ...
    private static void validateConfiguration_attributeGroupConfigurationErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();
    ...
    private static void validateConfiguration_attributeGroupReferenceErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();
    ...
    private static void validateConfiguration_attributeAnnotationsErrors(IAMShieldSession session) throws IOException {
        UPConfig config = loadValidConfig();

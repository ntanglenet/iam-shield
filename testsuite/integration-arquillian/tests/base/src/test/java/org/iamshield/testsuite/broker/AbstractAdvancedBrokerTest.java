...
import org.iamshield.testsuite.util.TestAppHelper;
...
import static org.iamshield.testsuite.broker.BrokerRunOnServerUtil.configurePostBrokerLoginWithOTP;
import static org.iamshield.testsuite.broker.BrokerRunOnServerUtil.disablePostBrokerLoginFlow;
import static org.iamshield.testsuite.broker.BrokerRunOnServerUtil.grantReadTokenRole;
import static org.iamshield.testsuite.broker.BrokerRunOnServerUtil.revokeReadTokenRole;
...
import static org.iamshield.testsuite.broker.BrokerTestTools.waitForElementEnabled;
...
public abstract class AbstractAdvancedBrokerTest extends AbstractBrokerTest {
    ...
    /**
     * Refers to in old test suite: org.iamshield.testsuite.broker.AbstractIAMShieldIdentityProviderTest#testAccountManagementLinkIdentity
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.iamshield.testsuite.broker.AbstractIAMShieldIdentityProviderTest#testAccountManagementLinkedIdentityAlreadyExists
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.iamshield.testsuite.broker.AbstractIAMShieldIdentityProviderTest#testTokenStorageAndRetrievalByApplication
     */
    @Test
    public void testRetrieveToken() throws Exception {
        ...
        Client client = IAMShieldTestingClient.getRestEasyClientBuilder().register((ClientRequestFilter) request -> request.getHeaders().add(HttpHeaders.AUTHORIZATION, "Bearer " + accessToken.get())).build();
    ...
    /**
     * Refers to in old test suite: org.iamshield.testsuite.broker.AbstractIAMShieldIdentityProviderTest.testDisabledUser
     */
    @Test
    ...
    /**
     * Refers to in old testsuite: org.iamshield.testsuite.broker.PostBrokerFlowTest#testPostBrokerLoginWithOTP()
     */
    @Test
    ...
    /**
     * Refers to in old testsuite: org.iamshield.testsuite.broker.OIDCKeyCloakServerBrokerBasicTest#testLogoutWorksWithTokenTimeout()
     */
    @Test
    ...
    /**
     * Refers to in old test suite: org.iamshield.testsuite.broker.AbstractIAMShieldIdentityProviderTest#testWithLinkedFederationProvider
     */
    @Test

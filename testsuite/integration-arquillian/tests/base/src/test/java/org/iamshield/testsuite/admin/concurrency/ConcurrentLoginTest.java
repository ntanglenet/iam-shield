...
public class ConcurrentLoginTest extends AbstractConcurrencyTest {
    ...
    public void concurrentLoginSingleUserSingleClientRehash() throws Throwable {
        ...
        run(2, 10, (IAMShieldRunnable) (int threadIndex, IAMShield iamshield, RealmResource realm) -> {
            try (CloseableHttpClient httpClient = getHttpsAwareClient()) {
                createHttpClientContextForUser(httpClient, "test-user@localhost", "password");
            }
        });
    ...
    public void concurrentCodeReuseShouldFail() throws Throwable {
        ...
        for (int i=0 ; i<10 ; i++) {
            ...
            IAMShieldRunnable codeToTokenTask = new IAMShieldRunnable() {

                @Override
                public void run(int threadIndex, IAMShield iamshield, RealmResource realm) throws Throwable {
    ...
    public class LoginTask implements IAMShieldRunnable {
        ...
        public void run(int threadIndex, IAMShield iamshield, RealmResource realm) throws Throwable {
            ...
            String requestState = IAMShieldModelUtils.generateId();
            String requestNonce = IAMShieldModelUtils.generateId();

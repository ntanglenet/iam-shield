 ...
 */
public class UserStorageGracefulDegradationTest extends AbstractTestRealmIAMShieldTest implements Serializable {
    ...
    public void addUserStorageProvider() {
        ...
        testingClient.server().run(session -> {
            ...
            failingProvider.setId(IAMShieldModelUtils.generateId());
    ...
    @Test
    @ModelTest
    public void testGracefulDegradationOnSearchFailure(IAMShieldSession session) {
        RealmModel realm = session.realms().getRealm("test");
    ...
    @Test
    @ModelTest
    public void testGracefulDegradationWithSearchString(IAMShieldSession session) {
        RealmModel realm = session.realms().getRealm("test");
    ...
    @Test
    @ModelTest
    public void testGracefulDegradationOnCountFailure(IAMShieldSession session) {
        RealmModel realm = session.realms().getRealm("test");

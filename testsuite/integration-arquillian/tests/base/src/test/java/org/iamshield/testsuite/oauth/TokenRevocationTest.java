...
import static org.iamshield.testsuite.AssertEvents.isUUID;
 ...
 */
public class TokenRevocationTest extends AbstractIAMShieldTest {
    ...
    private void isAccessTokenDisabled(String accessTokenString, String clientId) throws IOException {
        ...
        try (IAMShield adminClient = IAMShield.getInstance(OAuthClient.AUTH_SERVER_ROOT, "test", "test-app", accessTokenString, AdminClientUtil.getSSLContextWithTruststore())) {
            try {

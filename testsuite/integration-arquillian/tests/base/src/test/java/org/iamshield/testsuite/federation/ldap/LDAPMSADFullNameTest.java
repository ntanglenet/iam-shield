...
public class LDAPMSADFullNameTest extends AbstractLDAPTest {
    ...
    protected void afterImportTestRealm() {
        testingClient.server().run(session -> {
            ...
            mapperModel = IAMShieldModelUtils.createComponentModel("fullNameWritable", ldapModel.getId(), FullNameLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
...
//    }
    ...
    private static void assertUser(IAMShieldSession session, LDAPTestContext ctx, UserModel user, String expectedUsername, String expectedFirstName, String expectedLastName, boolean expectedEnabled, String expectedDn) {
    ...
    private static void assertDnStartsWith(IAMShieldSession session, LDAPTestContext ctx, UserModel user, String expectedRDn) {

...
import static org.iamshield.protocol.oidc.OIDCLoginProtocol.LOGIN_HINT_PARAM;
import static org.iamshield.protocol.oidc.grants.ciba.CibaGrantType.AUTH_REQ_ID;
import static org.iamshield.protocol.oidc.grants.ciba.CibaGrantType.BINDING_MESSAGE;
...
public class FAPICIBATest extends AbstractFAPITest {
    ...
    public void testFAPICIBALoginWithPrivateKeyJWT() throws Exception {
        ...
        String signedJwt = createSignedRequestToken(clientId, privateKey, publicKey, org.iamshield.crypto.Algorithm.PS256);
        ...
        String signedJwt2 = createSignedRequestToken(clientId, privateKey, publicKey, org.iamshield.crypto.Algorithm.PS256);

...
import org.iamshield.testsuite.arquillian.undertow.lb.SimpleUndertowLoadBalancer;
import org.iamshield.testsuite.oidc.AbstractOIDCScopeTest;
...
import org.iamshield.testsuite.util.UserManager;
...
import static org.iamshield.protocol.oidc.OIDCConfigAttributes.CLIENT_SESSION_IDLE_TIMEOUT;
import static org.iamshield.protocol.oidc.OIDCConfigAttributes.CLIENT_SESSION_MAX_LIFESPAN;
...
import static org.iamshield.testsuite.arquillian.AuthServerTestEnricher.getHttpAuthServerContextRoot;

/**
 * @author <a href="mailto:sthorger@redhat.com">Stian Thorgersen</a>
 */
public class RefreshTokenTest extends AbstractIAMShieldTest {
    ...
    public void addTestRealms(List<RealmRepresentation> testRealms) {
        ...
        realmRepresentation.getClients().add(org.iamshield.testsuite.util.ClientBuilder.create()
    ...
    public void nullRefreshToken() {
        ...
        org.iamshield.representations.AccessTokenResponse tokenResponse = null;
        {
    ...
    public void testDoNotResolveUserSessionIfAuthenticationSessionIsInvalidated() {
        String realmName = IAMShieldModelUtils.generateId();
        ...
        try {
            ...
            realmResource.clients().create(org.iamshield.testsuite.util.ClientBuilder.create()
    ...
    public void testCheckSsl() {
        ...
        try {
            ...
            String refreshToken = null;
            {
                ...
                org.iamshield.representations.AccessTokenResponse tokenResponse = response.readEntity(org.iamshield.representations.AccessTokenResponse.class);

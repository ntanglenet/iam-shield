...
import org.iamshield.admin.client.resource.TimePoliciesResource;
import org.iamshield.admin.client.resource.TimePolicyResource;
...
public class TimePolicyManagementTest extends AbstractPolicyManagementTest {
    ...
    public void testInvalidDateFormat() {
        AuthorizationResource authorization = getClient().authorization();
        TimePolicyRepresentation representation = createRepresentation(IAMShieldModelUtils.generateId());

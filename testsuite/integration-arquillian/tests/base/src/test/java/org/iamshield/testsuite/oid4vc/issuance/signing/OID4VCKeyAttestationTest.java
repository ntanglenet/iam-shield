...
import org.iamshield.crypto.ECDSASignatureSignerContext;
...
import org.iamshield.protocol.oid4vc.issuance.VCIssuanceContext;
import org.iamshield.protocol.oid4vc.issuance.VCIssuerException;
import org.iamshield.protocol.oid4vc.issuance.keybinding.AttestationKeyResolver;
import org.iamshield.protocol.oid4vc.issuance.keybinding.AttestationProofValidator;
import org.iamshield.protocol.oid4vc.issuance.keybinding.AttestationProofValidatorFactory;
import org.iamshield.protocol.oid4vc.issuance.keybinding.AttestationValidatorUtil;
import org.iamshield.protocol.oid4vc.issuance.keybinding.JwtProofValidator;
import org.iamshield.protocol.oid4vc.issuance.keybinding.ProofValidator;
import org.iamshield.protocol.oid4vc.issuance.keybinding.StaticAttestationKeyResolver;
import org.iamshield.protocol.oid4vc.model.ISO18045ResistanceLevel;
import org.iamshield.protocol.oid4vc.model.KeyAttestationJwtBody;
import org.iamshield.protocol.oid4vc.model.KeyAttestationsRequired;
...
import static org.iamshield.protocol.oid4vc.model.ProofType.JWT;
...
public class OID4VCKeyAttestationTest extends OID4VCIssuerEndpointTest {
    ...
    private static void runAttestationWithValidResistanceLevels(IAMShieldSession session, String cNonce) {
        try {
    ...
    private static void runValidAttestationProofTest(IAMShieldSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
            KeyWrapper proofKey = getECKey("proofKey");
    ...
    private static void runInvalidAttestationProofTest(IAMShieldSession session) {
        KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runValidJwtProofWithKeyAttestationTest(IAMShieldSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
            KeyWrapper proofKey = getECKey("proofKey");
            JWK proofJwk = JWKBuilder.create().ec(proofKey.getPublicKey());
    ...
    private static void runInvalidJwtProofWithKeyAttestationTest(IAMShieldSession session) {
        KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runInvalidAttestationSignatureTest(IAMShieldSession session, String cNonce) {
        KeyWrapper attestationKey = getECKey("attestationKey");
        KeyWrapper proofKey = getECKey("proofKey");
        JWK proofJwk = JWKBuilder.create().ec(proofKey.getPublicKey());
    ...
    private static void runMissingRequiredAttestationClaimsTest(IAMShieldSession session) {
        KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runAttestationWithMultipleAttestedKeys(IAMShieldSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
    ...
    private static void runAttestationWithX5cCertificateChain(IAMShieldSession session, String cNonce) {
        try {
    ...
    private static void runAttestationWithInvalidResistanceLevels(IAMShieldSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");
            KeyWrapper proofKey = getECKey("proofKey");
    ...
    private static void runAttestationWithMissingAttestedKeys(IAMShieldSession session, String cNonce) {
        try {
            KeyWrapper attestationKey = getECKey("attestationKey");

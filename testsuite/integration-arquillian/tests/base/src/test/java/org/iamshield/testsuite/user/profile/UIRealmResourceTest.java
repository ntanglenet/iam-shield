...
import org.iamshield.admin.ui.rest.model.UIRealmRepresentation;
import org.iamshield.admin.ui.rest.model.UIRealmInfo;
 ...
 * @author rmartinc
 */
public class UIRealmResourceTest extends AbstractTestRealmIAMShieldTest {
    ...
    private static IAMShield iamshieldAdminClientViewUsers;
    private static IAMShield iamshieldAdminClientWithoutAdminRoles;
    ...
    public static void initHttpClients() {
        httpClient = IAMShield.getClientProvider().newRestEasyClient(null, null, true);

        iamshieldAdminClientViewUsers = IAMShieldBuilder.builder().serverUrl(getKeycloakServerUrl())
        ...
        iamshieldAdminClientWithoutAdminRoles = IAMShieldBuilder.builder().serverUrl(getKeycloakServerUrl())
                .realm(TEST_REALM_NAME)
    ...
    public static void closeHttpClients() {
        if (iamshieldAdminClientViewUsers != null) {
            iamshieldAdminClientViewUsers.close();
        }
        if (iamshieldAdminClientWithoutAdminRoles != null) {
            iamshieldAdminClientWithoutAdminRoles.close();
        }
        if (httpClient != null) {
            httpClient.close();
        }
    ...
    public void uiRealmInfoSucceedsWithAnyAdminRole() {
        final var response = getUiRealmInfo(iamshieldAdminClientViewUsers.tokenManager());
    ...
    public void uiRealmInfoFailsWhenNoAdminRoleIsAssigned() {
        final var response = getUiRealmInfo(iamshieldAdminClientWithoutAdminRoles.tokenManager());

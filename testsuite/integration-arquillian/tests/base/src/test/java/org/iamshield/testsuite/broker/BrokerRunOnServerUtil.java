...
final class BrokerRunOnServerUtil {
    ...
    static void configureBrokerFlowToReAuthenticationWithPasswordForm(IAMShieldTestingClient testingClient, String consumerRealmName, String idpAlias, String newFlowAlias) {
    ...
    static void configureBrokerFlowToReAuthenticationWithPasswordOrTotp(IAMShieldTestingClient testingClient, String consumerRealmName, String idpAlias, String newFlowAlias) {
        testingClient.server(consumerRealmName).run(session -> FlowUtil.inCurrentRealm(session).copyFirstBrokerLoginFlow(newFlowAlias));

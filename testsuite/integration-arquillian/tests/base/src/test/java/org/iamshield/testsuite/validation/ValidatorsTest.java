...
import static org.iamshield.validate.ValidatorConfig.configFromMap;
...
import org.iamshield.validate.SimpleValidator;
...
import org.iamshield.validate.Validator;
...
public class ValidatorsTest extends AbstractIAMShieldTest {
    ...
    @Test
    @ModelTest
    public void simpleValidationWithContext(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void simpleValidationFluent(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void simpleValidationLookup(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void simpleValidationError(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void forEachError(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void formatError(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void multipleValidations(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void multipleValidationsError(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigSimple(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void validateEmailValidator(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigMultipleOptions(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigMultipleOptionsInvalidValues(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void validateValidatorConfigViaValidatorFactory(IAMShieldSession session) {
    ...
    @Test
    @ModelTest
    public void nestedValidation(IAMShieldSession session) {

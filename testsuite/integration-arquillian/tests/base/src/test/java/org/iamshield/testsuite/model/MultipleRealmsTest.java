 ...
 */
public class MultipleRealmsTest extends AbstractTestRealmIAMShieldTest {

    private static final String REALM_ATTRIBUTE = "test-realm";

    public static void createObjects(IAMShieldSession session, RealmModel realm) {
    ...
    @Test
    @ModelTest
    public void testUsers(IAMShieldSession session) {
        AtomicReference<UserModel> r1user1Atomic = new AtomicReference<>();

        String[] res = IAMShieldModelUtils.runJobInTransactionWithResult(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionTestUser1) -> {
            IAMShieldSession currentSession = sessionTestUser1;

            RealmModel realm1 = currentSession.realms().createRealm(IAMShieldModelUtils.generateId(), "realm1");
            ...
            RealmModel realm2 = currentSession.realms().createRealm(IAMShieldModelUtils.generateId(), "realm2");
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionTestUser2) -> {
            IAMShieldSession currentSession = sessionTestUser2;
        ...
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionTestUser3) -> {
            IAMShieldSession currentSession = sessionTestUser3;
    ...
    @Test
    @ModelTest
    public void testGetById(IAMShieldSession session) {
        String[] res = IAMShieldModelUtils.runJobInTransactionWithResult(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionById) -> {
            IAMShieldSession currentSession = sessionById;
    ...
    private void removeRealm(IAMShieldSession session, String realmId) {
        IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), (IAMShieldSession sessionTestUser3) -> {

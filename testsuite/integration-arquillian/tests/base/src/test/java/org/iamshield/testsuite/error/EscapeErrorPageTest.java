...
public class EscapeErrorPageTest extends AbstractIAMShieldTest {
    ...
    private void checkMessage(String queryParam, String expected) {
        try {
            final URI uri = IAMShieldUriBuilder.fromUri(suiteContext.getAuthServerInfo().getContextRoot().toURI())

 ...
 * @author hmlnarik
 */
public class IAMShieldKeySamlExtensionGenerator implements SamlProtocolExtensionsAwareBuilder.NodeGenerator {
    ...
    public IAMShieldKeySamlExtensionGenerator(String keyId) {
        this.keyId = keyId;
    }

...
import org.iamshield.saml.processing.core.parsers.saml.metadata.SAMLMetadataQNames;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLAttributeQueryParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLSloRequestParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLSloResponseParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLArtifactResolveParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLArtifactResponseParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLResponseParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLAuthNRequestParser;
...
import org.iamshield.saml.common.parsers.AbstractParser;
import org.iamshield.saml.common.util.StaxParserUtil;
import org.iamshield.saml.processing.core.parsers.saml.assertion.SAMLAssertionParser;
import org.iamshield.saml.processing.core.parsers.saml.metadata.SAMLEntitiesDescriptorParser;
import org.iamshield.saml.processing.core.parsers.saml.metadata.SAMLEntityDescriptorParser;
import org.iamshield.saml.processing.core.parsers.saml.protocol.SAMLProtocolQNames;
...
import org.iamshield.saml.common.parsers.StaxParser;
import org.iamshield.saml.processing.core.parsers.saml.assertion.SAMLAssertionQNames;
import org.iamshield.saml.processing.core.parsers.saml.assertion.SAMLAuthnStatementParser;
import org.iamshield.saml.processing.core.parsers.saml.assertion.SAMLEncryptedAssertionParser;
...
public class SAMLParser extends AbstractParser {
    ...
    /**
     * @see {@link org.iamshield.saml.common.parsers.ParserNamespaceSupport#parse(XMLEventReader)}
     */
    @Override

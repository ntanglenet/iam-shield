...
import static org.iamshield.operator.testsuite.utils.CRAssert.assertKeycloakStatusDoesNotContainMessage;

@QuarkusTest
public class IAMShieldDistConfiguratorTest {

    final KeycloakDistConfigurator distConfig = new IAMShieldDistConfigurator();
    ...
    private void assertWarningStatusFirstClassFields(Keycloak keycloak, KeycloakDistConfigurator distConfig, boolean expectWarning, Collection<String> firstClassFields) {
        ...
        final KeycloakStatusAggregator statusBuilder = new IAMShieldStatusAggregator(1L);

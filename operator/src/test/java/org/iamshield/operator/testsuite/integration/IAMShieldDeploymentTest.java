...
package org.iamshield.operator.testsuite.integration;
...
import org.iamshield.operator.Config;
import org.iamshield.operator.Constants;
import org.iamshield.operator.controllers.KeycloakAdminSecretDependentResource;
import org.iamshield.operator.controllers.KeycloakDistConfigurator;
import org.iamshield.operator.controllers.KeycloakServiceDependentResource;
import org.iamshield.operator.crds.v2alpha1.deployment.Keycloak;
import org.iamshield.operator.crds.v2alpha1.deployment.KeycloakStatusCondition;
import org.iamshield.operator.crds.v2alpha1.deployment.ValueOrSecret;
import org.iamshield.operator.crds.v2alpha1.deployment.spec.BootstrapAdminSpec;
import org.iamshield.operator.crds.v2alpha1.deployment.spec.FeatureSpecBuilder;
import org.iamshield.operator.crds.v2alpha1.deployment.spec.HostnameSpecBuilder;
import org.iamshield.operator.testsuite.apiserver.DisabledIfApiServerTest;
import org.iamshield.operator.testsuite.unit.WatchedResourcesTest;
import org.iamshield.operator.testsuite.utils.CRAssert;
import org.iamshield.operator.testsuite.utils.K8sUtils;
...
import static org.iamshield.operator.testsuite.utils.CRAssert.assertKeycloakStatusCondition;
import static org.iamshield.operator.testsuite.utils.K8sUtils.deployKeycloak;
import static org.iamshield.operator.testsuite.utils.K8sUtils.disableHttps;
import static org.iamshield.operator.testsuite.utils.K8sUtils.enableHttp;
import static org.iamshield.operator.testsuite.utils.K8sUtils.getResourceFromFile;
import static org.iamshield.operator.testsuite.utils.K8sUtils.waitForKeycloakToBeReady;

@DisabledIfApiServerTest
@Tag(BaseOperatorTest.SLOW)
@QuarkusTest
public class IAMShieldDeploymentTest extends BaseOperatorTest {
    ...
    public void testBasicKeycloakDeploymentAndDeletion() {
        // CR
        Log.info("Creating new IAMShield CR example");

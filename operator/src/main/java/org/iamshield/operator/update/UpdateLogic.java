...
public interface UpdateLogic {
     ...
     * {@link StatefulSet}.
     * <p>
     * The method should use {@link org.iamshield.operator.ContextUtils#storeUpdateType(Context, UpdateType, String)} to store
     * its decision. If no prior {@link StatefulSet} is present, no decision is required and
     * {@link org.iamshield.operator.ContextUtils#storeUpdateType(Context, UpdateType, String)} must not be invoked.
     * <p>

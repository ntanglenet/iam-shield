...
public class IAMShieldAdminSecretDependentResource extends KubernetesDependentResource<Secret, Keycloak> implements Creator<Secret, Keycloak>, GarbageCollected<Keycloak> {
    ...
    public IAMShieldAdminSecretDependentResource() {
        super(Secret.class);
    }

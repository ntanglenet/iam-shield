...
public class IAMShieldDiscoveryServiceDependentResource extends CRUDKubernetesDependentResource<Service, Keycloak> {

    public IAMShieldDiscoveryServiceDependentResource() {
        super(Service.class);
    }

...
import org.iamshield.operator.crds.v2alpha1.realmimport.KeycloakRealmImportStatusBuilder;
...
public class IAMShieldRealmImportController implements Reconciler<KeycloakRealmImport> {
    ...
    public UpdateControl<KeycloakRealmImport> reconcile(KeycloakRealmImport realm, Context<KeycloakRealmImport> context) {
        ...
        var statusBuilder = new IAMShieldRealmImportStatusBuilder();
    ...
    public ErrorStatusUpdateControl<KeycloakRealmImport> updateErrorStatus(KeycloakRealmImport realm, Context<KeycloakRealmImport> context, Exception e) {
        ...
        KeycloakRealmImportStatus status = new IAMShieldRealmImportStatusBuilder()

...
import static org.iamshield.operator.Constants.KEYCLOAK_JGROUPS_DATA_PORT;
import static org.iamshield.operator.Constants.KEYCLOAK_JGROUPS_FD_PORT;
import static org.iamshield.operator.Constants.KEYCLOAK_JGROUPS_PROTOCOL;
import static org.iamshield.operator.Constants.KEYCLOAK_SERVICE_PROTOCOL;

@KubernetesDependent(
        informer = @Informer(labelSelector = Constants.DEFAULT_LABELS_AS_STRING)
)
public class IAMShieldNetworkPolicyDependentResource extends CRUDKubernetesDependentResource<NetworkPolicy, Keycloak> {

    private static final Logger LOG = Logger.getLogger(KeycloakNetworkPolicyDependentResource.class.getName());
    
    public IAMShieldNetworkPolicyDependentResource() {
    ...
    public NetworkPolicy desired(Keycloak primary, Context<Keycloak> context) {
        ...
        // see org.iamshield.quarkus.runtime.configuration.mappers.ManagementPropertyMappers.isManagementEnabled()

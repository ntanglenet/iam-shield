 ...
 */
public class IAMShieldStatusAggregator {
    private final KeycloakStatusCondition readyCondition = new IAMShieldStatusCondition();
    private final KeycloakStatusCondition hasErrorsCondition = new IAMShieldStatusCondition();
    private final KeycloakStatusCondition rollingUpdate = new IAMShieldStatusCondition();
    private final KeycloakStatusCondition updateType = new IAMShieldStatusCondition();
     ...
     */
    public IAMShieldStatusAggregator(Long generation) {
     ...
     * @param generation the observedGeneration for conditions
     */
    public IAMShieldStatusAggregator(KeycloakStatus current, Long generation) {
        if (current != null) { // 6.7 fabric8 no longer requires this null check
            statusBuilder = new IAMShieldStatusBuilder(current);
            ...
            statusBuilder = new IAMShieldStatusBuilder();
    ...
    public IAMShieldStatusAggregator addNotReadyMessage(String message) {
    ...
    public IAMShieldStatusAggregator addErrorMessage(String message) {
    ...
    public IAMShieldStatusAggregator addWarningMessage(String message) {
        errorMessages.add("warning: " + message);
        hasErrorsCondition.setObservedGeneration(observedGeneration);
        return this;
    }

    public IAMShieldStatusAggregator addRollingUpdateMessage(String message) {
     ...
     */
    public IAMShieldStatusAggregator apply(Consumer<KeycloakStatusBuilder> toApply) {

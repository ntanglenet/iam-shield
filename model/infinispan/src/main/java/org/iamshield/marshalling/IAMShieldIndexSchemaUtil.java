...
public class IAMShieldIndexSchemaUtil {
    ...
    private static void reindexCaches(RemoteCacheManager remoteCacheManager, String oldSchema, String newSchema, List<IndexedEntity> indexedEntities) {
        ...
        var oldPS = IAMShieldModelSchema.parseProtoSchema(oldSchema);
        var newPS = IAMShieldModelSchema.parseProtoSchema(newSchema);
    ...
    private static boolean isEntityChanged(FileDescriptor oldSchema, FileDescriptor newSchema, String entity) {
        var v1 = IAMShieldModelSchema.findEntity(oldSchema, entity);
        var v2 = IAMShieldModelSchema.findEntity(newSchema, entity);
        return v1.isPresent() && v2.isPresent() && IAMShieldIndexSchemaUtil.isIndexSchemaChanged(v1.get(), v2.get());
    }

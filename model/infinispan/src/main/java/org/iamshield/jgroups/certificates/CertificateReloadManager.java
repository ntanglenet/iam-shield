...
public class CertificateReloadManager implements Lifecycle {
    ...
    public CertificateReloadManager(IAMShieldSessionFactory sessionFactory) {
    ...
    public void rotateCertificate() {
        ...
        lock.lock();
        try (lock) {
            IAMShieldModelUtils.runJobInTransaction(sessionFactory, CertificateReloadManager::replaceCertificateInTransaction);
    ...
    public void reloadCertificate() {
        ...
        try (lock) {
            ...
            IAMShieldModelUtils.runJobInTransaction(sessionFactory, CertificateReloadManager::loadCertificateInTransaction);
        } catch (RuntimeException e) {
    ...
    private void scheduleNextRotation() {
        ...
        try (lock) {
            ...
            var delay = IAMShieldModelUtils.runJobInTransactionWithResult(sessionFactory, CertificateReloadManager::nextRotationDelay);
    ...
    private static void replaceCertificateInTransaction(IAMShieldSession session) {
        session.getProvider(JGroupsCertificateProvider.class).rotateCertificate();
    }

    private static void loadCertificateInTransaction(IAMShieldSession session) {
        session.getProvider(JGroupsCertificateProvider.class).reloadCertificate();
    }

    private static Duration nextRotationDelay(IAMShieldSession session) {

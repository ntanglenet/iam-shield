...
package org.iamshield.spi.infinispan.impl.remote;
...
import static org.iamshield.connections.infinispan.InfinispanConnectionProvider.skipSessionsCacheIfRequired;
import static org.iamshield.spi.infinispan.impl.Util.copyFromOption;
...
public class DefaultCacheRemoteConfigProviderFactory implements CacheRemoteConfigProviderFactory, CacheRemoteConfigProvider, EnvironmentDependentProviderFactory {
    ...
    @Override
    public CacheRemoteConfigProvider create(IAMShieldSession session) {
        lazyInit();
        return this;
    }
    ...
    private static SSLContext createSSLContext() {
        try {
            // uses the default Java Runtime TrustStore, or the one generated by Keycloak (see org.iamshield.truststore.TruststoreBuilder)

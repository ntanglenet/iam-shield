...
package org.iamshield.models.sessions.infinispan.util;
...
public class InfinispanKeyGenerator {
    ...
    public String generateKeyString(IAMShieldSession session, Cache<String, ?> cache) {
        return generateKey(session, cache, new StringKeyGenerator());
    }


    public UUID generateKeyUUID(IAMShieldSession session, Cache<UUID, ?> cache) {

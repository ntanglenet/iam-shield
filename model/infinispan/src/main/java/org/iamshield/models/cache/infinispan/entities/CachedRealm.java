...
import org.iamshield.common.util.ConcurrentMultivaluedHashMap;
...
import org.iamshield.models.RequiredCredentialModel;
...
public class CachedRealm extends AbstractExtendableRevisioned {
    ...
    public OAuth2DeviceConfig getOAuth2DeviceConfig(IAMShieldSession session, Supplier<RealmModel> modelSupplier) {
        return deviceConfig.get(session, modelSupplier);
    }

    public CibaConfig getCibaConfig(IAMShieldSession session, Supplier<RealmModel> modelSupplier) {
        return cibaConfig.get(session, modelSupplier);
    }

    public ParConfig getParConfig(IAMShieldSession session, Supplier<RealmModel> modelSupplier) {
    ...
    public List<String> getDefaultDefaultClientScopes(IAMShieldSession session, Supplier<RealmModel> modelSupplier) {
        return defaultDefaultClientScopes.get(session, modelSupplier);
    }

    public List<String> getOptionalDefaultClientScopes(IAMShieldSession session, Supplier<RealmModel> modelSupplier) {

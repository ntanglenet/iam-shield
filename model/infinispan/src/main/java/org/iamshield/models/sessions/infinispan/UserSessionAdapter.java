...
import org.iamshield.models.sessions.infinispan.changes.UserSessionUpdateTask;
...
public class UserSessionAdapter<T extends SessionRefreshStore & UserSessionProvider> implements UserSessionModel {
    ...
    public UserSessionAdapter(IAMShieldSession session, UserModel user, T provider,

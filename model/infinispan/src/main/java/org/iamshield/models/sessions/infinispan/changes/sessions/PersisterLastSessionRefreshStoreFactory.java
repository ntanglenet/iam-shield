...
public class PersisterLastSessionRefreshStoreFactory extends AbstractLastSessionRefreshStoreFactory {
    ...
    public PersisterLastSessionRefreshStore createAndInit(IAMShieldSession kcSession, boolean offline) {
    ...
    public PersisterLastSessionRefreshStore createAndInit(IAMShieldSession kcSession,

...
class RemoteInfinispanIAMShieldTransaction<K, V, R extends ConditionalRemover<K, V>> implements NonBlockingTransaction {
    ...
    RemoteInfinispanIAMShieldTransaction(RemoteCache<K, V> cache, R conditionalRemover) {

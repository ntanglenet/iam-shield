...
package org.iamshield.models.cache.infinispan.authorization.entities;
...
import org.iamshield.models.cache.infinispan.entities.AbstractRevisioned;
...
public class CachedPolicy extends AbstractRevisioned implements InResourceServer {
    ...
    public Map<String, String> getConfig(IAMShieldSession session, Supplier<Policy> policy) {
    ...
    public Set<String> getAssociatedPoliciesIds(IAMShieldSession session, Supplier<Policy> policy) {
        return this.associatedPoliciesIds.get(session, policy);
    }

    public Set<String> getResourcesIds(IAMShieldSession session, Supplier<Policy> policy) {
        return this.resourcesIds.get(session, policy);
    }

    public Set<String> getResourceNames(IAMShieldSession session, Supplier<Policy> policy) {
        return this.resourcesNames.get(session, policy);
    }

    public Set<String> getScopesIds(IAMShieldSession session, Supplier<Policy> policy) {

...
import static org.iamshield.organization.utils.Organizations.isReadOnlyOrganizationMember;
...
import org.iamshield.models.cache.infinispan.entities.CachedFederatedIdentityLinks;
import org.iamshield.models.cache.infinispan.entities.CachedUser;
import org.iamshield.models.cache.infinispan.entities.CachedUserConsent;
import org.iamshield.models.cache.infinispan.entities.CachedUserConsents;
import org.iamshield.models.cache.infinispan.entities.UserListQuery;
...
public class UserCacheSession implements UserCache, OnCreateComponent, OnUpdateComponent, UserProfileDecorator {
    ...
    public UserCacheSession(UserCacheManager cache, IAMShieldSession session) {
        this.cache = cache;
    ...
    private IAMShieldTransaction getTransaction() {

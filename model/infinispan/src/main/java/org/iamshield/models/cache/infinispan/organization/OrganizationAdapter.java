...
import org.iamshield.models.cache.infinispan.LazyModel;
...
public class OrganizationAdapter implements OrganizationModel {
    ...
    public OrganizationAdapter(IAMShieldSession session, CachedOrganization cached, Supplier<OrganizationProvider> delegate, InfinispanOrganizationProvider organizationCache) {

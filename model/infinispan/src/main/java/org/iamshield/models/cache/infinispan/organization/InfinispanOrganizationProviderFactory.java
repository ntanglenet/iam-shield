...
public class InfinispanOrganizationProviderFactory implements OrganizationProviderFactory {
    ...
    public void postInit(IAMShieldSessionFactory factory) {
        factory.register(e -> {
            if (e instanceof RealmModel.IdentityProviderUpdatedEvent event) {
                registerOrganizationInvalidation(event.getIAMShieldSession(), event.getUpdatedIdentityProvider());
            }
            if (e instanceof RealmModel.IdentityProviderRemovedEvent event) {
                registerOrganizationInvalidation(event.getIAMShieldSession(), event.getRemovedIdentityProvider());
            }
    ...
    private void registerOrganizationInvalidation(IAMShieldSession session, IdentityProviderModel idp) {

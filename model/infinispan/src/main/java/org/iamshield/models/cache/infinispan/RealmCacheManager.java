...
import org.iamshield.models.cache.infinispan.events.RealmCacheInvalidationEvent;
...
public class RealmCacheManager extends CacheManager {
     ...
     */
    public <T> T computeSerialized(IAMShieldSession session, String id, BiFunction<String, IAMShieldSession, T> compute) {

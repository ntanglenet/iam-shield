...
public class GroupAdapter implements GroupModel {
    ...
    public GroupAdapter(CachedGroup cached, RealmCacheSession cacheSession, IAMShieldSession keycloakSession, RealmModel realm) {
        this.cached = cached;
    ...
    public boolean escapeSlashesInGroupPath() {
        return IAMShieldModelUtils.escapeSlashesInGroupPath(keycloakSession);
    }

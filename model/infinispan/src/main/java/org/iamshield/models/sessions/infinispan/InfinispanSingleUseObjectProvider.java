...
public class InfinispanSingleUseObjectProvider implements SingleUseObjectProvider {
    ...
    private final InfinispanIAMShieldTransaction tx;

    public InfinispanSingleUseObjectProvider(IAMShieldSession session, BasicCache<String, SingleUseObjectValueEntity> singleUseObjectCache, boolean persistRevokedTokens, InfinispanIAMShieldTransaction tx) {

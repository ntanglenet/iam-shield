...
import org.iamshield.models.sessions.infinispan.changes.remote.updater.loginfailures.LoginFailuresUpdater;
...
import org.iamshield.models.sessions.infinispan.remote.transaction.LoginFailureChangeLogTransaction;
...
public class RemoteUserLoginFailureProviderFactory implements UserLoginFailureProviderFactory<RemoteUserLoginFailureProvider>, UpdaterFactory<LoginFailureKey, LoginFailureEntity, LoginFailuresUpdater>, EnvironmentDependentProviderFactory, RemoteChangeLogTransaction.SharedState<LoginFailureKey, LoginFailureEntity>, ServerInfoAwareProviderFactory {
    ...
    @Override
    public RemoteUserLoginFailureProvider create(IAMShieldSession session) {
    ...
    private LoginFailureChangeLogTransaction createAndEnlistTransaction(IAMShieldSession session) {

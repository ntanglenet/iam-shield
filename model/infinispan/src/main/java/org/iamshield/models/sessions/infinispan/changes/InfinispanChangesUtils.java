...
import org.iamshield.models.sessions.infinispan.CacheDecorators;
...
public class InfinispanChangesUtils {
    ...
    public static <K, V extends SessionEntity> CacheHolder<K, V> createWithCache(IAMShieldSession session,
                                                                                 String cacheName,

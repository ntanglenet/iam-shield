...
import org.iamshield.models.cache.infinispan.entities.InRealm;
...
public class CachedOrganization extends AbstractRevisioned implements InRealm {
    ...
    public MultivaluedHashMap<String, String> getAttributes(IAMShieldSession session, Supplier<OrganizationModel> organizationModel) {

...
package org.iamshield.models.sessions.infinispan.changes.sessions;
...
public abstract class AbstractLastSessionRefreshStore {
    ...
    public void putLastSessionRefresh(IAMShieldSession kcSession, String sessionId, String realmId, int lastSessionRefresh) {
    ...
    void checkSendingMessage(IAMShieldSession kcSession, int currentTime) {
     ...
     */
    protected abstract void sendMessage(IAMShieldSession kcSession, Map<String, SessionData> refreshesToSend);
}

...
public class CachedResource extends AbstractRevisioned implements InResourceServer {
    ...
    public Set<String> getUris(IAMShieldSession session, Supplier<Resource> source) {
    ...
    public Set<String> getScopesIds(IAMShieldSession session, Supplier<Resource> source) {
        return this.scopesIds.get(session, source);
    }

    public Map<String, List<String>> getAttributes(IAMShieldSession session, Supplier<Resource> source) {

 ...
 */
package org.iamshield.models.sessions.infinispan.remote.transaction;
...
import org.iamshield.models.sessions.infinispan.changes.remote.updater.Expiration;
import org.iamshield.models.sessions.infinispan.changes.remote.updater.Updater;
import org.iamshield.models.sessions.infinispan.changes.remote.updater.UpdaterFactory;
import org.iamshield.models.sessions.infinispan.transaction.DatabaseUpdate;
import org.iamshield.models.sessions.infinispan.transaction.NonBlockingTransaction;

/**
 * A {@link IAMShieldTransaction} implementation that keeps track of changes made to entities stored in a Infinispan
 * cache.
 *

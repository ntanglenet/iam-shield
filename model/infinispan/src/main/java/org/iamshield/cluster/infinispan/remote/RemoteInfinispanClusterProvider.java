...
package org.iamshield.cluster.infinispan.remote;
...
import org.iamshield.cluster.infinispan.TaskCallback;
import org.iamshield.common.util.Retry;

import static org.iamshield.cluster.infinispan.InfinispanClusterProvider.TASK_KEY_PREFIX;
import static org.iamshield.cluster.infinispan.remote.RemoteInfinispanClusterProviderFactory.putIfAbsentWithRetries;

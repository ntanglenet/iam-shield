...
public class InfinispanPublicKeyStorageProvider implements PublicKeyStorageProvider {
    ...
    public InfinispanPublicKeyStorageProvider(IAMShieldSession session, Cache<String, PublicKeysEntry> keys, Map<String, FutureTask<PublicKeysEntry>> tasksInProgress,
    ...
    protected IAMShieldTransaction getAfterTransaction() {

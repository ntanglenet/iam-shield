...
package org.iamshield.connections.infinispan.remote;
...
import org.iamshield.health.LoadBalancerCheckProvider;
import org.iamshield.health.LoadBalancerCheckProviderFactory;
...
public class RemoteLoadBalancerCheckProviderFactory implements LoadBalancerCheckProviderFactory, EnvironmentDependentProviderFactory {
    ...
    @Override
    public LoadBalancerCheckProvider create(IAMShieldSession session) {
        return provider;
    }

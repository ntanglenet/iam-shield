...
public abstract class AbstractUserAdapterFederatedStorage extends UserModelDefaultMethods {
    ...
    public AbstractUserAdapterFederatedStorage(IAMShieldSession session, RealmModel realm, ComponentModel storageProviderModel) {
    ...
    public abstract static class Streams extends AbstractUserAdapterFederatedStorage implements UserModel {
        ...
        public Streams(final IAMShieldSession session, final RealmModel realm, final ComponentModel storageProviderModel) {

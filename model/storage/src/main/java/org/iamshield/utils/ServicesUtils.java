...
public class ServicesUtils {
    ...
    public static <T, R> Function<? super T,? extends Stream<? extends R>> timeBound(IAMShieldSession session,
                                                                                     long timeout,
    ...
    public static <T, R> Function<? super T, R> timeBoundOne(IAMShieldSession session,
                                                                                     long timeout,
                                                                                     Function<T, R> func) {
        ExecutorService executor = session.getProvider(ExecutorsProvider.class).getExecutor("storage-provider-threads");
        return p -> {
    ...
    public static <T> Consumer<? super T> consumeWithTimeBound(IAMShieldSession session,
                                                             long timeout,
                                                             Consumer<T> func) {
        ExecutorService executor = session.getProvider(ExecutorsProvider.class).getExecutor("storage-provider-threads");
        return p -> {

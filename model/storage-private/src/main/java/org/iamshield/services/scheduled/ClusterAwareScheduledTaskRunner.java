...
public class ClusterAwareScheduledTaskRunner extends ScheduledTaskRunner {
    ...
    public ClusterAwareScheduledTaskRunner(IAMShieldSessionFactory sessionFactory, ScheduledTask task, long intervalMillis) {
        super(sessionFactory, task);
        this.intervalSecs = (int) (intervalMillis / 1000);
    }

    @Override
    protected void runTask(final IAMShieldSession session) {

...
public class ExportUtils {
    ...
    public static RealmRepresentation exportRealm(IAMShieldSession session, RealmModel realm, boolean includeUsers, boolean internal) {
        ExportOptions opts = new ExportOptions(includeUsers, true, true, false, false);
        return exportRealm(session, realm, opts, internal);
    }

    public static RealmRepresentation exportRealm(IAMShieldSession session, RealmModel realm, ExportOptions options, boolean internal) {
     ...
     */
    public static ClientRepresentation exportClient(IAMShieldSession session, ClientModel client) {
     ...
     */
    public static UserRepresentation exportUser(IAMShieldSession session, RealmModel realm, UserModel user, ExportOptions options, boolean internal) {
    ...
    public static void exportUsersToStream(IAMShieldSession session, RealmModel realm, List<UserModel> usersToExport, ObjectMapper mapper, OutputStream os) throws IOException {
        exportUsersToStream(session, realm, usersToExport, mapper, os, new ExportOptions());
    }

    public static void exportUsersToStream(IAMShieldSession session, RealmModel realm, List<UserModel> usersToExport, ObjectMapper mapper, OutputStream os, ExportOptions options) throws IOException {
    ...
    public static void exportFederatedUsersToStream(IAMShieldSession session, RealmModel realm, List<String> usersToExport, ObjectMapper mapper, OutputStream os) throws IOException {
        exportFederatedUsersToStream(session, realm, usersToExport, mapper, os, new ExportOptions());
    }

    public static void exportFederatedUsersToStream(IAMShieldSession session, RealmModel realm, List<String> usersToExport, ObjectMapper mapper, OutputStream os, ExportOptions options) throws IOException {
        JsonFactory factory = mapper.getFactory();
        JsonGenerator generator = factory.createGenerator(os, JsonEncoding.UTF8);
        try {
            if (mapper.isEnabled(SerializationFeature.INDENT_OUTPUT)) {
     ...
     * @return fully exported user representation
     */
    public static UserRepresentation exportFederatedUser(IAMShieldSession session, RealmModel realm, String id, ExportOptions options) {
    ...
    private static UserFederatedStorageProvider userFederatedStorage(IAMShieldSession session) {

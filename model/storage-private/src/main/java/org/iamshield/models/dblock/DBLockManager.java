...
package org.iamshield.models.dblock;
...
public class DBLockManager {
    ...
    public DBLockManager(IAMShieldSession session) {
    ...
    public DBLockProviderFactory getDBLockFactory() {
        return (DBLockProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(DBLockProvider.class);
    }
}

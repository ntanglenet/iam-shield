...
package org.iamshield.models.session;
...
public class PersistentUserSessionAdapter implements OfflineUserSessionModel {
    ...
    public PersistentUserSessionAdapter(IAMShieldSession session, PersistentUserSessionModel model, RealmModel realm, String userId, Map<String, AuthenticatedClientSessionModel> clientSessions) {

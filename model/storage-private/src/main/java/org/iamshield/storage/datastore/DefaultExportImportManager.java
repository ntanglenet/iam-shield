...
import org.iamshield.deployment.DeployedConfigurationsManager;
import org.iamshield.exportimport.ExportAdapter;
import org.iamshield.exportimport.ExportOptions;
import org.iamshield.exportimport.util.ExportUtils;
...
import org.iamshield.migration.migrators.MigrateTo8_0_0;
...
import org.iamshield.models.ParConfig;
...
import org.iamshield.models.ScopeContainerModel;
import org.iamshield.models.UserConsentModel;
import org.iamshield.models.UserModel;
import org.iamshield.models.WebAuthnPolicy;
import org.iamshield.models.WebAuthnPolicyPasswordlessDefaults;
import org.iamshield.models.WebAuthnPolicyTwoFactorDefaults;
import org.iamshield.models.utils.ComponentUtil;
...
import org.iamshield.representations.idm.ApplicationRepresentation;
import org.iamshield.representations.idm.AuthenticationExecutionExportRepresentation;
import org.iamshield.representations.idm.AuthenticationFlowRepresentation;
import org.iamshield.representations.idm.AuthenticatorConfigRepresentation;
import org.iamshield.representations.idm.ClaimRepresentation;
...
import org.iamshield.representations.idm.ClientTemplateRepresentation;
...
import org.iamshield.representations.idm.MemberRepresentation;
import org.iamshield.representations.idm.MembershipType;
import org.iamshield.representations.idm.OAuthClientRepresentation;
...
import org.iamshield.representations.idm.RequiredActionProviderRepresentation;
import org.iamshield.representations.idm.RoleRepresentation;
import org.iamshield.representations.idm.ScopeMappingRepresentation;
import org.iamshield.representations.idm.SocialLinkRepresentation;
import org.iamshield.representations.idm.UserConsentRepresentation;
import org.iamshield.representations.idm.UserFederationMapperRepresentation;
import org.iamshield.representations.idm.UserFederationProviderRepresentation;
...
import org.iamshield.validation.ValidationUtil;
...
import static org.iamshield.models.utils.DefaultRequiredActions.getDefaultRequiredActionCaseInsensitively;
import static org.iamshield.models.utils.ModelToRepresentation.stripRealmAttributesIncludedAsFields;
import static org.iamshield.models.utils.RepresentationToModel.createCredentials;
import static org.iamshield.models.utils.RepresentationToModel.createFederatedIdentities;
import static org.iamshield.models.utils.RepresentationToModel.createGroups;
import static org.iamshield.models.utils.RepresentationToModel.createRoleMappings;
import static org.iamshield.models.utils.RepresentationToModel.importGroup;
import static org.iamshield.models.utils.RepresentationToModel.importRoles;
import static org.iamshield.models.utils.StripSecretsUtils.stripSecrets;
...
public class DefaultExportImportManager implements ExportImportManager {
    ...
    public static class Batcher implements Consumer<IAMShieldSession> {
        private int count;

        @Override
        public void accept(IAMShieldSession session) {
    ...
    public DefaultExportImportManager(IAMShieldSession session) {
    ...
    public void importRealm(RealmRepresentation rep, RealmModel newRealm, Runnable userImport) {
        ...
        if (rep.getGroups() != null) {
            ...
            if (rep.getDefaultGroups() != null) {
                IAMShieldModelUtils.setDefaultGroups(session, newRealm, rep.getDefaultGroups().stream());
            }
        }
    ...
    private static Map<String, ClientModel> createClients(IAMShieldSession session, ModelVersion version, RealmRepresentation rep, RealmModel realm, Map<String, String> mappedFlows) {
    ...
    private static void importIdentityProviders(RealmRepresentation rep, RealmModel newRealm, IAMShieldSession session) {
    ...
    private static void importIdentityProviderMappers(RealmRepresentation rep, IAMShieldSession session) {
    ...
    private static ScopeContainerModel getScopeContainerHavingScope(RealmModel realm, ScopeMappingRepresentation scope) {
        if (scope.getClient() != null) {
            ...
            ClientScopeModel clientScope = IAMShieldModelUtils.getClientScopeByName(realm, scope.getClientScope());
            if (clientScope == null) {
            ...
            String templateName = IAMShieldModelUtils.convertClientScopeName(scope.getClientTemplate());
            ClientScopeModel clientTemplate = IAMShieldModelUtils.getClientScopeByName(realm, templateName);
    ...
    public static void renameRealm(RealmModel realm, String name) {
        ...
        masterApp.setClientId(IAMShieldModelUtils.getMasterRealmAdminManagementClientId(name));
        realm.setName(name);
    ...
    public void updateRealm(RealmRepresentation rep, RealmModel realm) {
        ...
        if (rep.getDefaultGroups() != null) {
            IAMShieldModelUtils.setDefaultGroups(session, realm, rep.getDefaultGroups().stream());
        }
    ...
    private static void convertDeprecatedApplications(IAMShieldSession session, RealmRepresentation realm) {
    ...
    public static void importUserFederationProvidersAndMappers(IAMShieldSession session, RealmRepresentation rep, RealmModel newRealm) {
        ...
        mapperConvertSet.put(LDAPConstants.LDAP_PROVIDER, "org.iamshield.storage.ldap.mappers.LDAPStorageMapper");
    ...
    public static Map<String, String> importAuthenticationFlows(IAMShieldSession session, RealmModel newRealm, RealmRepresentation rep) {
    ...
    private static AuthenticationExecutionModel toModel(IAMShieldSession session, RealmModel realm, AuthenticationFlowModel parentFlow, AuthenticationExecutionExportRepresentation rep) {
    ...
    public static void importRealmAuthorizationSettings(RealmRepresentation rep, RealmModel newRealm, IAMShieldSession session) {
        if (rep.getClients() != null) {
    ...
    public static void importFederatedUser(IAMShieldSession session, RealmModel newRealm, UserRepresentation userRep) {
        ...
        if (userRep.getGroups() != null) {
            for (String path : userRep.getGroups()) {
                GroupModel group = IAMShieldModelUtils.findGroupByPath(session, newRealm, path);
                if (group == null) {

...
package org.iamshield.migration;
...
public class MigrationModelManager {
    ...
    public static void migrate(IAMShieldSession session) {
        ((DefaultDatastoreProvider) session.getProvider(DatastoreProvider.class)).getMigrationManager().migrate();
    }

    public static void migrateImport(IAMShieldSession session, RealmModel realm, RealmRepresentation rep, boolean skipUserDependent) {

...
public class MigrateTo4_0_0 implements Migration {
    ...
    protected void migrateRealm(IAMShieldSession session, RealmModel realm, boolean json) {
        ...
        realm.getComponentsStream(realm.getId(), "org.iamshield.services.clientregistration.policy.ClientRegistrationPolicy")
        ...
        if (offlineAccessRole == null) {
            ...
            offlineAccessScope = IAMShieldModelUtils.getClientScopeByName(realm, OAuth2Constants.OFFLINE_ACCESS);

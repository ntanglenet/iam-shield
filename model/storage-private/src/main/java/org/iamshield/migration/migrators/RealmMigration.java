...
public abstract class RealmMigration implements Migration {
    ...
    @Override
    public void migrateImport(IAMShieldSession session, RealmModel realm, RealmRepresentation rep,
            boolean skipUserDependent) {
        migrateRealm(session, realm);
    }

    public abstract void migrateRealm(IAMShieldSession session, RealmModel realm);
}

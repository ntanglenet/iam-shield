...
public class ImportUtils {
    ...
    public static void importRealms(IAMShieldSession session, Collection<RealmRepresentation> realms, Strategy strategy) {
     ...
     */
    @Deprecated
    public static boolean importRealm(IAMShieldSession session, RealmRepresentation rep, Strategy strategy, boolean skipUserDependent) {
     ...
     * @return newly imported realm (or existing realm if ignoreExisting is true and realm of this name already exists)
     */
    public static boolean importRealm(IAMShieldSession session, RealmRepresentation rep, Strategy strategy, Runnable userImport) {
    ...
    public static void importUsersFromStream(IAMShieldSession session, String realmName, ObjectMapper mapper, InputStream is, boolean federated, Consumer<IAMShieldSession> onUserCreated) throws IOException {
        RealmProvider model = session.realms();

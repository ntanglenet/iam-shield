...
public abstract class MultipleStepsExportProvider<T extends MultipleStepsExportProvider<?>> implements ExportProvider {
    ...
    protected final IAMShieldSessionFactory factory;

    private String realmId;
    private int usersPerFile = 50;
    private UsersExportStrategy usersExportStrategy;

    public MultipleStepsExportProvider(IAMShieldSessionFactory factory) {
    ...
    protected void exportRealmImpl(final String realmName) {
        ...
        new ExportImportSessionTask() {
            ...
            private <U> void exportUsers(final String realmName, IAMShieldSession session, RealmModel realm, Stream<U> users, boolean federated)
                    throws IOException {
            ...
            private <U> void flushUsers(final String realmName, IAMShieldSession session, RealmModel realm,
    ...
    protected abstract void writeUsers(String fileName, IAMShieldSession session, RealmModel realm, List<UserModel> users) throws IOException;
    protected abstract void writeFederatedUsers(String fileName, IAMShieldSession session, RealmModel realm, List<String> users) throws IOException;

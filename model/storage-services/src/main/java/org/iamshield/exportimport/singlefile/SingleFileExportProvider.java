...
public class SingleFileExportProvider implements ExportProvider {
    ...
    public SingleFileExportProvider(IAMShieldSessionFactory factory) {
    ...
    private void exportRealm(IAMShieldSession session, final String realmName) throws IOException {

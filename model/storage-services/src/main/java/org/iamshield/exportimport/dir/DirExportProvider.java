...
import org.iamshield.exportimport.util.MultipleStepsExportProvider;
...
public class DirExportProvider extends MultipleStepsExportProvider<DirExportProvider> {
    ...
    public DirExportProvider(IAMShieldSessionFactory sessionFactory) {
    ...
    @Override
    protected void writeUsers(String fileName, IAMShieldSession session, RealmModel realm, List<UserModel> users) throws IOException {
        File file = new File(getRootDirectory(), fileName);
    ...
    @Override
    protected void writeFederatedUsers(String fileName, IAMShieldSession session, RealmModel realm, List<String> users) throws IOException {
        File file = new File(getRootDirectory(), fileName);
        FileOutputStream os = new FileOutputStream(file);

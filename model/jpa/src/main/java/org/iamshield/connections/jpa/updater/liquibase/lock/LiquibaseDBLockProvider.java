...
package org.iamshield.connections.jpa.updater.liquibase.lock;
...
public class LiquibaseDBLockProvider implements DBLockProvider {
    ...
    public LiquibaseDBLockProvider(LiquibaseDBLockProviderFactory factory, IAMShieldSession session) {
    ...
    private void lazyInit() {
        if (!initialized) {
            ...
            JpaConnectionProviderFactory jpaProviderFactory = (JpaConnectionProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(JpaConnectionProvider.class);

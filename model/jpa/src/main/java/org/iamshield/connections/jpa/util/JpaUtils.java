...
package org.iamshield.connections.jpa.util;
...
public class JpaUtils {
    ...
    public static EntityManagerFactory createEntityManagerFactory(IAMShieldSession session, String unitName, Map<String, Object> properties, boolean jta) {
     ...
     */
    public static List<Class<?>> getProvidedEntities(IAMShieldSession session) {

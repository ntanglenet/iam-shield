...
package org.iamshield.connections.jpa.updater.liquibase.conn;
...
import org.iamshield.connections.jpa.updater.liquibase.LiquibaseJpaUpdaterProvider;
...
public class DefaultLiquibaseConnectionProvider implements LiquibaseConnectionProviderFactory, LiquibaseConnectionProvider {
    ...
    @Override
    public LiquibaseConnectionProvider create(IAMShieldSession session) {
    ...
    @Override
    public IAMShieldLiquibase getLiquibase(Connection connection, String defaultSchema) throws LiquibaseException {
        ...
        return new IAMShieldLiquibase(changelog, resourceAccessor, database);
    }

    @Override
    public IAMShieldLiquibase getLiquibaseForCustomUpdate(Connection connection, String defaultSchema, String changelogLocation, ClassLoader classloader, String changelogTableName) throws LiquibaseException {
        Database database = DatabaseFactory.getInstance().findCorrectDatabaseImplementation(new JdbcConnection(connection));
        if (defaultSchema != null) {
            database.setDefaultSchemaName(defaultSchema);
        }
        ...
        return new IAMShieldLiquibase(changelogLocation, resourceAccessor, database);
    }

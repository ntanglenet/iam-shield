...
package org.iamshield.connections.jpa.updater.liquibase;
...
public class LiquibaseJpaUpdaterProvider implements JpaUpdaterProvider {
    ...
    public LiquibaseJpaUpdaterProvider(IAMShieldSession session) {
    ...
    protected void updateChangeSet(IAMShieldLiquibase liquibase, Writer exportWriter) throws LiquibaseException, SQLException {

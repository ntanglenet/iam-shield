...
import org.iamshield.events.EventStoreProviderFactory;
...
public class JpaEventStoreProviderFactory implements EventStoreProviderFactory, InvalidationHandler {
    ...
    @Override
    public EventStoreProvider create(IAMShieldSession session) {
    ...
    @Override
    public void invalidate(IAMShieldSession session, InvalidableObjectType type, Object... params) {

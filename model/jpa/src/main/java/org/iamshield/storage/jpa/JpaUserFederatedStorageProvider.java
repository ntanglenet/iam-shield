 ...
 */
package org.iamshield.storage.jpa;
...
import org.iamshield.credential.UserCredentialStore;
...
import org.iamshield.models.jpa.JpaUserCredentialStore;
...
import org.iamshield.storage.jpa.entity.BrokerLinkEntity;
import org.iamshield.storage.jpa.entity.FederatedUser;
import org.iamshield.storage.jpa.entity.FederatedUserAttributeEntity;
import org.iamshield.storage.jpa.entity.FederatedUserConsentClientScopeEntity;
import org.iamshield.storage.jpa.entity.FederatedUserConsentEntity;
import org.iamshield.storage.jpa.entity.FederatedUserCredentialEntity;
import org.iamshield.storage.jpa.entity.FederatedUserGroupMembershipEntity;
import org.iamshield.storage.jpa.entity.FederatedUserRequiredActionEntity;
import org.iamshield.storage.jpa.entity.FederatedUserRequiredActionEntity.Key;
import org.iamshield.storage.jpa.entity.FederatedUserRoleMappingEntity;
...
public class JpaUserFederatedStorageProvider implements
    ...
    public JpaUserFederatedStorageProvider(IAMShieldSession session, EntityManager em) {
    ...
    private void persistAttributeValue(RealmModel realm, String userId, String name, String value) {
        ...
        attr.setId(IAMShieldModelUtils.generateId());
        attr.setName(name);
        attr.setValue(value);
    ...
    public void addConsent(RealmModel realm, String userId, UserConsentModel consent) {
        ...
        consentEntity.setId(IAMShieldModelUtils.generateId());
    ...
    public CredentialModel createCredential(RealmModel realm, String userId, CredentialModel cred) {
        ...
        String id = cred.getId() == null ? IAMShieldModelUtils.generateId() : cred.getId();
        entity.setId(id);
        entity.setCreatedDate(cred.getCreatedDate());
        entity.setType(cred.getType());
        entity.setCredentialData(cred.getCredentialData());

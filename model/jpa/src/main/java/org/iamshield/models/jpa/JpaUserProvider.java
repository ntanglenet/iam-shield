...
import org.iamshield.models.jpa.entities.UserConsentClientScopeEntity;
import org.iamshield.models.jpa.entities.UserConsentEntity;
...
import org.iamshield.storage.jpa.JpaHashUtils;
...
import static org.iamshield.storage.jpa.JpaHashUtils.predicateForFilteringUsersByAttributes;
...
public class JpaUserProvider implements UserProvider, UserCredentialStore, JpaUserPartialEvaluationProvider {
    ...
    public JpaUserProvider(IAMShieldSession session, EntityManager em) {
    ...
    public UserModel addUser(RealmModel realm, String username) {
        return addUser(realm, IAMShieldModelUtils.generateId(), username.toLowerCase(), true, true);
    }
    ...
    private UserConsentModel toConsentModel(RealmModel realm, UserConsentEntity entity) {
        ...
        if (grantedClientScopeEntities != null) {
            for (UserConsentClientScopeEntity grantedClientScope : grantedClientScopeEntities) {
                ClientScopeModel grantedClientScopeModel = IAMShieldModelUtils.findClientScopeById(realm, client, grantedClientScope.getScopeId());

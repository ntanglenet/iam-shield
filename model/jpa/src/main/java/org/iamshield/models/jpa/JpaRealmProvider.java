...
import static org.iamshield.models.jpa.PaginationUtils.paginateQuery;
...
import org.iamshield.connections.jpa.util.JpaUtils;
...
import org.iamshield.models.GroupModel.GroupCreatedEvent;
import org.iamshield.models.GroupModel.GroupPathChangeEvent;
import org.iamshield.models.GroupModel.GroupUpdatedEvent;
import org.iamshield.models.GroupModel.Type;
...
import org.iamshield.models.delegate.ClientModelLazyDelegate;
import org.iamshield.models.jpa.entities.ClientAttributeEntity;
import org.iamshield.models.jpa.entities.ClientEntity;
import org.iamshield.models.jpa.entities.ClientScopeClientMappingEntity;
import org.iamshield.models.jpa.entities.ClientScopeEntity;
import org.iamshield.models.jpa.entities.GroupAttributeEntity;
import org.iamshield.models.jpa.entities.GroupEntity;
import org.iamshield.models.jpa.entities.RealmEntity;
import org.iamshield.models.jpa.entities.RealmLocalizationTextsEntity;
import org.iamshield.models.jpa.entities.RoleEntity;
...
public class JpaRealmProvider implements RealmProvider, ClientProvider, ClientScopeProvider, GroupProvider, RoleProvider, DeploymentStateProvider {
    ...
    public JpaRealmProvider(IAMShieldSession session, EntityManager em, Set<String> clientSearchableAttributes, Set<String> groupSearchableAttributes) {
    ...
    public RealmModel createRealm(String name) {
        return createRealm(IAMShieldModelUtils.generateId(), name);
    }
    ...
    public RealmModel createRealm(String id, String name) {
        ...
        session.getIAMShieldSessionFactory().publish(new RealmModel.RealmCreationEvent() {
            @Override
    ...
    public boolean removeRealm(String id) {
        ...
        session.getIAMShieldSessionFactory().publish(new RealmModel.RealmRemovedEvent() {
            @Override
    ...
    public RoleModel addRealmRole(RealmModel realm, String name) {
       return addRealmRole(realm, IAMShieldModelUtils.generateId(), name);
    ...
    public RoleModel addClientRole(ClientModel client, String name) {
        return addClientRole(client, IAMShieldModelUtils.generateId(), name);
    }
    ...
    public boolean removeRole(RoleModel role) {
        ...
        session.getIAMShieldSessionFactory().publish(roleRemovedEvent(role));
    ...
    public void moveGroup(RealmModel realm, GroupModel group, GroupModel toParent) {
        ...
        String newPath = IAMShieldModelUtils.buildGroupPath(group);
        String previousPath = IAMShieldModelUtils.buildGroupPath(group, previousParent);
    ...
    public ClientModel addClient(RealmModel realm, String clientId) {
        return addClient(realm, IAMShieldModelUtils.generateId(), clientId);
    }
    ...
    public ClientModel addClient(RealmModel realm, String id, String clientId) {
        ...
        session.getIAMShieldSessionFactory().publish((ClientModel.ClientCreationEvent) () -> resource);
        return resource;
    }
    ...
    public boolean removeClient(RealmModel realm, String id) {
        ...
        session.getIAMShieldSessionFactory().publish(new ClientModel.ClientRemovedEvent() {
            @Override
    ...
    public ClientScopeModel addClientScope(RealmModel realm, String id, String name) {
        ...
        entity.setId(id);
        name = IAMShieldModelUtils.convertClientScopeName(name);
        entity.setName(name);
        entity.setRealmId(realm.getId());
        em.persist(entity);

        ClientScopeModel clientScope = new ClientScopeAdapter(realm, em, session, entity);
        session.getIAMShieldSessionFactory().publish(new ClientScopeModel.ClientScopeCreatedEvent() {
    ...
    public boolean removeClientScope(RealmModel realm, String id) {
        ...
        session.getIAMShieldSessionFactory().publish(new ClientScopeModel.ClientScopeRemovedEvent() {
    ...
    public void addClientScopes(RealmModel realm, ClientModel client, Set<ClientScopeModel> clientScopes, boolean defaultScope) {
        List<String> acceptedClientProtocols = IAMShieldModelUtils.getAcceptedClientScopeProtocols(client);

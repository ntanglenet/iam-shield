...
import static org.iamshield.models.workflow.ResourceOperationType.USER_ADD;
import static org.iamshield.models.workflow.ResourceOperationType.USER_LOGIN;
...
public class UserSessionRefreshTimeWorkflowProvider extends AbstractUserWorkflowProvider {
    ...
    public UserSessionRefreshTimeWorkflowProvider(IAMShieldSession session, ComponentModel model) {
        super(session, model);
    }

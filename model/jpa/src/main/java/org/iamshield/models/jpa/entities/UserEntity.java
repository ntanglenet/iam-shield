...
package org.iamshield.models.jpa.entities;
...
public class UserEntity {
    ...
    protected String emailConstraint = IAMShieldModelUtils.generateId();
    ...
    public void setEmail(String email, boolean allowDuplicate) {
        this.email = email;
        this.emailConstraint = email == null || allowDuplicate ? IAMShieldModelUtils.generateId() : email;
    }

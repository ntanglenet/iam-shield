...
import org.iamshield.models.IdentityProviderShowInAccountConsole;
...
import org.iamshield.models.jpa.entities.IdentityProviderEntity;
import org.iamshield.models.jpa.entities.IdentityProviderMapperEntity;
import org.iamshield.models.utils.IAMShieldModelUtils;
import org.iamshield.utils.StringUtil;

import static org.iamshield.models.IdentityProviderModel.ALIAS;
import static org.iamshield.models.IdentityProviderModel.ALIAS_NOT_IN;
import static org.iamshield.models.IdentityProviderModel.AUTHENTICATE_BY_DEFAULT;
import static org.iamshield.models.IdentityProviderModel.DISPLAY_NAME;
import static org.iamshield.models.IdentityProviderModel.ENABLED;
import static org.iamshield.models.IdentityProviderModel.FIRST_BROKER_LOGIN_FLOW_ID;
import static org.iamshield.models.IdentityProviderModel.HIDE_ON_LOGIN;
import static org.iamshield.models.IdentityProviderModel.LINK_ONLY;
import static org.iamshield.models.IdentityProviderModel.ORGANIZATION_ID;
import static org.iamshield.models.IdentityProviderModel.ORGANIZATION_ID_NOT_NULL;
import static org.iamshield.models.IdentityProviderModel.POST_BROKER_LOGIN_FLOW_ID;
import static org.iamshield.models.IdentityProviderModel.SEARCH;
import static org.iamshield.models.IdentityProviderModel.SHOW_IN_ACCOUNT_CONSOLE;
...
public class JpaIdentityProviderStorageProvider implements IdentityProviderStorageProvider {
    ...
    public JpaIdentityProviderStorageProvider(IAMShieldSession session) {
    ...
    public IdentityProviderModel create(IdentityProviderModel identityProvider) {
        ...
        if (identityProvider.getInternalId() == null) {
            entity.setInternalId(IAMShieldModelUtils.generateId());
        } else {
    ...
    public void update(IdentityProviderModel identityProvider) {
        ...
        session.getIAMShieldSessionFactory().publish(new RealmModel.IdentityProviderUpdatedEvent() {
    ...
    public boolean remove(String alias) {
        ...
        if (entity != null) {
            ...
            RealmModel realm = this.getRealm();
            session.getIAMShieldSessionFactory().publish(new RealmModel.IdentityProviderRemovedEvent() {
    ...
    public IdentityProviderMapperModel createMapper(IdentityProviderMapperModel model) {
        ...
        entity.setId(model.getId() == null ? IAMShieldModelUtils.generateId() : model.getId());
    ...
    private IdentityProviderModel getModelFromProviderFactory(String providerId) {
        ...
        IdentityProviderFactory factory = (IdentityProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(IdentityProvider.class, providerId);
        if (factory == null) {
            factory = (IdentityProviderFactory) session.getIAMShieldSessionFactory().getProviderFactory(SocialIdentityProvider.class, providerId);
        }

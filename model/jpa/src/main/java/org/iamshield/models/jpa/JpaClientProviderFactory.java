...
import org.iamshield.models.ClientProviderFactory;
...
import static org.iamshield.models.jpa.JpaRealmProviderFactory.PROVIDER_ID;
import static org.iamshield.models.jpa.JpaRealmProviderFactory.PROVIDER_PRIORITY;
...
public class JpaClientProviderFactory implements ClientProviderFactory {
            ...
            factory.register(event -> {
                if (event instanceof RealmModel.RealmAttributeUpdateEvent attrUpdateEvent) {
                    if (Objects.equals(attrUpdateEvent.getAttributeName(), RealmAttributes.ADMIN_PERMISSIONS_ENABLED) && Boolean.parseBoolean(attrUpdateEvent.getAttributeValue())) {
                        IAMShieldSession keycloakSession = attrUpdateEvent.getIAMShieldSession();
    ...
    @Override
    public ClientProvider create(IAMShieldSession session) {

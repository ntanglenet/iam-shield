...
import org.iamshield.models.jpa.entities.ProtocolMapperEntity;
...
public class ClientAdapter implements ClientModel, JpaModel<ClientEntity> {
    ...
    public ClientAdapter(RealmModel realm, EntityManager em, IAMShieldSession session, ClientEntity entity) {
    ...
    public void setProtocol(String protocol) {
        if (!Objects.equals(entity.getProtocol(), protocol)) {
            ...
            session.getIAMShieldSessionFactory().publish((ClientModel.ClientProtocolUpdatedEvent) () -> ClientAdapter.this);
        }
    }
    ...
    public ProtocolMapperModel addProtocolMapper(ProtocolMapperModel model) {
        ...
        String id = model.getId() != null ? model.getId() : IAMShieldModelUtils.generateId();
    ...
    public void updateClient() {
        session.getIAMShieldSessionFactory().publish(new ClientModel.ClientUpdatedEvent() {

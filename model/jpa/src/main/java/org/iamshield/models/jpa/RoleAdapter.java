...
import org.iamshield.models.jpa.entities.RoleAttributeEntity;
...
public class RoleAdapter implements RoleModel, JpaModel<RoleEntity> {
    ...
    public RoleAdapter(IAMShieldSession session, RealmModel realm, EntityManager em, RoleEntity role) {
        this.em = em;
        this.realm = realm;
        this.role = role;

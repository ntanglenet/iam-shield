...
import org.iamshield.models.jpa.entities.GroupRoleMappingEntity;
...
public class GroupAdapter implements GroupModel , JpaModel<GroupEntity> {
    ...
    public GroupAdapter(IAMShieldSession session, RealmModel realm, EntityManager em, GroupEntity group) {
    ...
    public boolean escapeSlashesInGroupPath() {
        return IAMShieldModelUtils.escapeSlashesInGroupPath(session);
    }

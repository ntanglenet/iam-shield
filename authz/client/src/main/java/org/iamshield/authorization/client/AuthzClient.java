 ...
 */
package org.iamshield.authorization.client;

import static org.iamshield.constants.ServiceUrlConstants.AUTHZ_DISCOVERY_URL;
...
import org.iamshield.authorization.client.representation.ServerConfiguration;
...
import org.iamshield.authorization.client.util.Http;
import org.iamshield.authorization.client.util.TokenCallable;
...
public class AuthzClient {
    ...
    private AuthzClient(Configuration configuration) {
        ...
        configurationUrl = IAMShieldUriBuilder.fromUri(configurationUrl).clone().path(AUTHZ_DISCOVERY_URL).build(configuration.getRealm()).toString();

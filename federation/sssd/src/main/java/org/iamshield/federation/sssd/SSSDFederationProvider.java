...
package org.iamshield.federation.sssd;
...
import org.iamshield.federation.sssd.api.Sssd;
import org.iamshield.federation.sssd.api.Sssd.User;
import org.iamshield.federation.sssd.impl.PAMAuthenticator;
...
public class SSSDFederationProvider implements UserStorageProvider,
    ...
    public SSSDFederationProvider(IAMShieldSession session, UserStorageProviderModel model, SSSDFederationProviderFactory sssdFederationProviderFactory) {
    ...
    protected UserModel importUserToKeycloak(RealmModel realm, String username) {
        ...
        for (String s : sssd.getGroups()) {
            GroupModel group = IAMShieldModelUtils.findGroupByPath(session, realm, "/" + s);
            if (group == null) {

...
import org.iamshield.representations.idm.TestLdapConnectionRepresentation;
import org.iamshield.services.ServicesLogger;
import org.iamshield.storage.ldap.LDAPConfig;
import org.iamshield.representations.idm.LDAPCapabilityRepresentation;
import org.iamshield.storage.ldap.idm.model.LDAPDn;
import org.iamshield.storage.ldap.idm.store.ldap.LDAPContextManager;
import org.iamshield.storage.ldap.idm.store.ldap.LDAPIdentityStore;
import org.iamshield.storage.ldap.mappers.membership.group.GroupTreeResolver;
...
public class LDAPServerCapabilitiesManager {
    ...
    public static Set<LDAPCapabilityRepresentation> queryServerCapabilities(TestLdapConnectionRepresentation config, IAMShieldSession session,
                                                                            RealmModel realm) {
    ...
    public static void testLDAP(TestLdapConnectionRepresentation config, IAMShieldSession session, RealmModel realm) throws javax.naming.NamingException {

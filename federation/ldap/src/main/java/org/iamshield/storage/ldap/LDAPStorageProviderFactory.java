...
import org.iamshield.federation.kerberos.CommonKerberosConfig;
import org.iamshield.federation.kerberos.impl.KerberosServerSubjectAuthenticator;
import org.iamshield.federation.kerberos.impl.KerberosUsernamePasswordAuthenticator;
import org.iamshield.federation.kerberos.impl.SPNEGOAuthenticator;
...
import org.iamshield.storage.ldap.idm.query.internal.LDAPQueryConditionsBuilder;
import org.iamshield.storage.ldap.idm.store.ldap.LDAPIdentityStore;
import org.iamshield.storage.ldap.kerberos.LDAPProviderKerberosConfig;
import org.iamshield.storage.ldap.mappers.FullNameLDAPStorageMapper;
import org.iamshield.storage.ldap.mappers.FullNameLDAPStorageMapperFactory;
...
import org.iamshield.storage.ldap.mappers.KerberosPrincipalAttributeMapperFactory;
import org.iamshield.storage.ldap.mappers.LDAPConfigDecorator;
import org.iamshield.storage.ldap.mappers.LDAPMappersComparator;
import org.iamshield.storage.ldap.mappers.LDAPStorageMapper;
import org.iamshield.storage.ldap.mappers.UserAttributeLDAPStorageMapper;
import org.iamshield.storage.ldap.mappers.UserAttributeLDAPStorageMapperFactory;
import org.iamshield.storage.ldap.mappers.msad.MSADUserAccountControlStorageMapper;
import org.iamshield.storage.ldap.mappers.msad.MSADUserAccountControlStorageMapperFactory;
...
public class LDAPStorageProviderFactory implements UserStorageProviderFactory<LDAPStorageProvider>, ImportSynchronization {
    ...
    @Override
    public LDAPStorageProvider create(IAMShieldSession session, ComponentModel model) {
    ...
    protected Map<ComponentModel, LDAPConfigDecorator> getLDAPConfigDecorators(IAMShieldSession session, ComponentModel ldapModel) {
        ...
        return realm.getComponentsStream(ldapModel.getId(), LDAPStorageMapper.class.getName())
                .filter(mapperModel -> session.getIAMShieldSessionFactory()
                ...
                .collect(Collectors.toMap(Function.identity(), mapperModel ->
                        (LDAPConfigDecorator) session.getIAMShieldSessionFactory()
    ...
    public void validateConfiguration(IAMShieldSession session, RealmModel realm, ComponentModel config) throws ComponentValidationException {
        ...
        if (config.getId() == null) {
            ...
            config.setId(IAMShieldModelUtils.generateShortId());
        }
    }
    ...
    @Override
    public void onCreate(IAMShieldSession session, RealmModel realm, ComponentModel model) {
        ...
        mapperModel = IAMShieldModelUtils.createComponentModel("username", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName(),
        ...
        if (ldapConfig.getRdnLdapAttribute().equalsIgnoreCase(LDAPConstants.CN)) {
            ...
            if (usernameLdapAttribute.equalsIgnoreCase(LDAPConstants.CN)) {
                ...
                mapperModel = IAMShieldModelUtils.createComponentModel("first name", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
                ...
                if (editMode == UserStorageProvider.EditMode.WRITABLE) {
                    ...
                    mapperModel = IAMShieldModelUtils.createComponentModel("username-cn", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
                            UserAttributeLDAPStorageMapper.USER_MODEL_ATTRIBUTE, UserModel.USERNAME,
                    ...
                    mapperModel = IAMShieldModelUtils.createComponentModel("full name", model.getId(), FullNameLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
        ...
        mapperModel = IAMShieldModelUtils.createComponentModel("last name", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
        ...
        mapperModel = IAMShieldModelUtils.createComponentModel("email", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
        ...
        mapperModel = IAMShieldModelUtils.createComponentModel("creation date", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
        ...
        mapperModel = IAMShieldModelUtils.createComponentModel("modify date", model.getId(), UserAttributeLDAPStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
        ...
        if (activeDirectory) {
            mapperModel = IAMShieldModelUtils.createComponentModel("MSAD account controls", model.getId(), MSADUserAccountControlStorageMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
        ...
        if (kerberosConfig.getKerberosPrincipalAttribute() != null) {
            mapperModel = IAMShieldModelUtils.createComponentModel("Kerberos principal attribute mapper", model.getId(), KerberosPrincipalAttributeMapperFactory.PROVIDER_ID, LDAPStorageMapper.class.getName());
            realm.addComponentModel(mapperModel);
        }
        ...
        if (!activeDirectory && syncRegistrations && ldapConfig.useExtendedPasswordModifyOp()) {
            mapperModel = IAMShieldModelUtils.createComponentModel("random initial password", model.getId(), HardcodedLDAPAttributeMapperFactory.PROVIDER_ID,LDAPStorageMapper.class.getName(),
    ...
    @Override
    public void onUpdate(IAMShieldSession session, RealmModel realm, ComponentModel oldModel, ComponentModel newModel) {
    ...
    @Override
    public void preRemove(IAMShieldSession session, RealmModel realm, ComponentModel model) {
    ...
    protected void syncMappers(IAMShieldSessionFactory sessionFactory, final String realmId, final ComponentModel model) {
    ...
    protected SynchronizationResult syncImpl(IAMShieldSessionFactory sessionFactory, LDAPQuery userQuery, final String realmId, final ComponentModel fedModel) {
     ...
     * @return
     */
    private LDAPQuery createQuery(IAMShieldSessionFactory sessionFactory, final String realmId, final ComponentModel model) {
        class QueryHolder {
            LDAPQuery query;
        }
    ...
    protected SynchronizationResult importLdapUsers(IAMShieldSessionFactory sessionFactory, final String realmId, final ComponentModel fedModel, List<LDAPObject> ldapUsers) {
        final SynchronizationResult syncResult = new SynchronizationResult();

...
/**
 * A {@link InitialLdapContext} that binds instances of this class with the {@link IAMShieldSession} so that any resource
...
public final class SessionBoundInitialLdapContext extends InitialLdapContext {
    ...
    public SessionBoundInitialLdapContext(IAMShieldSession session, Hashtable<?, ?> environment, Control[] connCtls) throws NamingException {

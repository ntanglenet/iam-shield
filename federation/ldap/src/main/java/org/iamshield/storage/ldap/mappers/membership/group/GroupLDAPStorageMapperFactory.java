...
import org.iamshield.storage.ldap.mappers.AbstractLDAPStorageMapperFactory;
...
public class GroupLDAPStorageMapperFactory extends AbstractLDAPStorageMapperFactory {
    ...
    public void validateConfiguration(IAMShieldSession session, RealmModel realm, ComponentModel config) throws ComponentValidationException {
        ...
        if (!GroupMapperConfig.DEFAULT_LDAP_GROUPS_PATH.equals(group) && IAMShieldModelUtils.findGroupByPath(session, realm, group) == null) {

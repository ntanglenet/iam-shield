...
public class IpatuuraUserStorageProviderFactory implements UserStorageProviderFactory<IpatuuraUserStorageProvider>, EnvironmentDependentProviderFactory {
    ...
    @Override
    public void validateConfiguration(IAMShieldSession session, RealmModel realm, ComponentModel config)
    ...
    @Override
    public IpatuuraUserStorageProvider create(IAMShieldSession session, ComponentModel model) {

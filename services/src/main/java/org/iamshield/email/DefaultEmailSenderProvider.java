...
import org.iamshield.truststore.JSSETruststoreConfigurator;
...
public class DefaultEmailSenderProvider implements EmailSenderProvider {
    ...
    public DefaultEmailSenderProvider(IAMShieldSession session, Map<EmailAuthenticator.AuthenticatorType, EmailAuthenticator> authenticators) {

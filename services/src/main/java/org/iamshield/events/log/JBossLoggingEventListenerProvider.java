...
public class JBossLoggingEventListenerProvider implements EventListenerProvider {
    ...
    public JBossLoggingEventListenerProvider(IAMShieldSession session, Logger logger,
    ...
    private void setIAMShieldContext(StringBuilder sb) {

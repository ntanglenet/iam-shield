...
import static org.iamshield.models.workflow.WorkflowStep.PRIORITY_KEY;
...
public class SetUserAttributeStepProvider implements WorkflowStepProvider {
    ...
    public SetUserAttributeStepProvider(IAMShieldSession session, ComponentModel model) {

...
import org.iamshield.provider.ExceptionConverter;
 ...
 * @version $Revision: 1 $
 */
public class JtaTransactionWrapper implements IAMShieldTransaction {
    ...
    public JtaTransactionWrapper(IAMShieldSession session, TransactionManager tm) {
        this.tm = tm;
    ...
    public void handleException(Throwable e) {
        ...
        session.getIAMShieldSessionFactory().getProviderFactoriesStream(ExceptionConverter.class)

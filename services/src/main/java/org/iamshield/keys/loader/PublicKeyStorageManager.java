...
public class PublicKeyStorageManager {
    ...
    public static PublicKey getClientPublicKey(IAMShieldSession session, ClientModel client, JWSInput input) {
    ...
    public static KeyWrapper getClientPublicKeyWrapper(IAMShieldSession session, ClientModel client, JWSInput input) {
    ...
    public static KeyWrapper getClientPublicKeyWrapper(IAMShieldSession session, ClientModel client, JWK.Use keyUse, String algAlgorithm) {
        PublicKeyStorageProvider keyStorage = session.getProvider(PublicKeyStorageProvider.class);
    ...
    public static KeyWrapper getIdentityProviderKeyWrapper(IAMShieldSession session, RealmModel realm, OIDCIdentityProviderConfig idpConfig, JWSInput input) {

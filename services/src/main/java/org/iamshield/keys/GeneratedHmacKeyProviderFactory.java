...
public class GeneratedHmacKeyProviderFactory extends AbstractGeneratedSecretKeyProviderFactory<GeneratedHmacKeyProvider> {
    ...
    @Override
    public GeneratedHmacKeyProvider create(IAMShieldSession session, ComponentModel model) {
        return new GeneratedHmacKeyProvider(model);
    }

    @Override
    public boolean createFallbackKeys(IAMShieldSession session, KeyUse keyUse, String algorithm) {

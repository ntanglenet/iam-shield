...
public class DefaultAlternativeLookupProvider implements AlternativeLookupProvider {
    ...
    public IdentityProviderModel lookupIdentityProviderFromIssuer(IAMShieldSession session, String issuerUrl) {
    ...
    public ClientModel lookupClientFromClientAttributes(IAMShieldSession session, Map<String, String> attributes) {

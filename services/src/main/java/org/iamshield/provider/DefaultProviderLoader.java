...
import org.iamshield.theme.ThemeSpi;
...
public class DefaultProviderLoader implements ProviderLoader {
    ...
    private IAMShieldDeploymentInfo info;
    private ClassLoader classLoader;

    public DefaultProviderLoader(IAMShieldDeploymentInfo info, ClassLoader classLoader) {
        this.info = info;

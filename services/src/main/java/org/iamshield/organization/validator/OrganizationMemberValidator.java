...
package org.iamshield.organization.validator;
...
import static org.iamshield.validate.BuiltinValidators.emailValidator;
...
import org.iamshield.userprofile.AttributeContext;
import org.iamshield.userprofile.UserProfileAttributeValidationContext;
...
public class OrganizationMemberValidator extends AbstractSimpleValidator implements EnvironmentDependentProviderFactory {
    ...
    private static Set<String> resolveExpectedDomainsWhenReviewingFederatedUserProfile(OrganizationModel organization, AttributeContext attributeContext) {
        ...
        IAMShieldSession session = attributeContext.getSession();

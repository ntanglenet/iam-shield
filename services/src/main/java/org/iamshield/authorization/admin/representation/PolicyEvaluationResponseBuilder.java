 ...
 */
package org.iamshield.authorization.admin.representation;
...
import org.iamshield.authorization.admin.PolicyEvaluationService.EvaluationDecisionCollector;
...
import org.iamshield.representations.idm.authorization.PolicyEvaluationResponse.PolicyResultRepresentation;
...
public class PolicyEvaluationResponseBuilder {
    public static PolicyEvaluationResponse build(EvaluationDecisionCollector decision, ResourceServer resourceServer, AuthorizationProvider authorization, IAMShieldIdentity identity, PolicyEvaluationRequest request) {

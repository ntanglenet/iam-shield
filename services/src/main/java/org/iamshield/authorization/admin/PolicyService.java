...
import org.iamshield.authorization.policy.provider.PolicyProviderAdminService;
...
import org.iamshield.representations.idm.authorization.PolicyProviderRepresentation;
...
public class PolicyService {
    ...
    public Response create(String payload) {
        ...
        audit(representation, representation.getId(), OperationType.CREATE, authorization.getIAMShieldSession());
    ...
    private void audit(AbstractPolicyRepresentation resource, String id, OperationType operation, IAMShieldSession session) {
        if (id != null) {
    ...
    private void checkIfSupportedPolicyType(String type) throws BadRequestException {
        if (AdminPermissionsSchema.SCHEMA.isSupportedPolicyType(authorization.getIAMShieldSession(), resourceServer, type)) {
            return;
        }

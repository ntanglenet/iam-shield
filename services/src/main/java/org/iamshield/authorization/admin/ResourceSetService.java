...
import static org.iamshield.models.utils.RepresentationToModel.toModel;
...
public class ResourceSetService {
    ...
    public ResourceSetService(IAMShieldSession session, ResourceServer resourceServer, AuthorizationProvider authorization, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    public Response find(@QueryParam("_id") String id,
        ...
        if (owner != null && !"".equals(owner.trim())) {
            ...
            if (clientModel != null) {
                ...
                UserModel user = authorization.getIAMShieldSession().users().getUserByUsername(realm, owner);

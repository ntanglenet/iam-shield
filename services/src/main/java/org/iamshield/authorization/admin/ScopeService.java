...
public class ScopeService {
    ...
    public ScopeService(IAMShieldSession session, ResourceServer resourceServer, AuthorizationProvider authorization, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {

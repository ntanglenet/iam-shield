 ...
 */
package org.iamshield.authorization.protection.resource;
...
public class ResourceService {
    ...
    public ResourceService(IAMShieldSession session, ResourceServer resourceServer, Identity identity, ResourceSetService resourceManager) {

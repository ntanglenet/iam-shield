 ...
 */
package org.iamshield.authorization.protection.permission;
...
public class PermissionTicketService {
    ...
    private final IAMShieldIdentity identity;
    private final ResourceServer resourceServer;

    public PermissionTicketService(IAMShieldIdentity identity, ResourceServer resourceServer, AuthorizationProvider authorization) {
    ...
    public Response create(PermissionTicketRepresentation representation) {
        ...
        if(representation.getRequester() != null)
            user = this.authorization.getIAMShieldSession().users().getUserById(this.authorization.getRealm(), representation.getRequester());
        else 
            user = this.authorization.getIAMShieldSession().users().getUserByUsername(this.authorization.getRealm(), representation.getRequesterName());
    ...
    private String getUserId(String userIdOrName) {
        UserProvider userProvider = authorization.getIAMShieldSession().users();

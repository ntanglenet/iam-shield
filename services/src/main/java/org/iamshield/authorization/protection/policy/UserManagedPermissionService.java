 ...
 */
package org.iamshield.authorization.protection.policy;
...
import org.iamshield.authorization.admin.PermissionService;
import org.iamshield.authorization.admin.PolicyTypeResourceService;
...
public class UserManagedPermissionService {
    ...
    public UserManagedPermissionService(IAMShieldIdentity identity, ResourceServer resourceServer, AuthorizationProvider authorization, AdminEventBuilder eventBuilder) {

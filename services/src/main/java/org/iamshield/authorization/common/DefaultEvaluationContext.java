...
public class DefaultEvaluationContext implements EvaluationContext {
    ...
    public DefaultEvaluationContext(Identity identity, IAMShieldSession keycloakSession) {
        this(identity, null, keycloakSession);
    }

    public DefaultEvaluationContext(Identity identity, Map<String, List<String>> claims, IAMShieldSession keycloakSession) {
    ...
    protected Map<String, Collection<String>> getBaseAttributes() {
        ...
        if (IAMShieldIdentity.class.isInstance(identity)) {
            AccessToken accessToken = IAMShieldIdentity.class.cast(this.identity).getAccessToken();

...
package org.iamshield.truststore;
...
public class JSSETruststoreConfigurator {
    ...
    public JSSETruststoreConfigurator(IAMShieldSession session) {
        IAMShieldSessionFactory factory = session.getIAMShieldSessionFactory();

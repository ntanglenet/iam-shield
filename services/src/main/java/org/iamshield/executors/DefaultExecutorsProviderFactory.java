...
package org.iamshield.executors;
...
public class DefaultExecutorsProviderFactory implements ExecutorsProviderFactory {
    ...
    @Override
    public ExecutorsProvider create(IAMShieldSession session) {
    ...
    protected ExecutorService getExecutor(String taskType, IAMShieldSession session) {
    ...
    protected ExecutorService retrievePool(String taskType, IAMShieldSession session) {
        if (managed == null) {
            detectManaged();
        }
    ...
    protected ExecutorService getPoolManaged(String taskType, IAMShieldSession session) {
        try {
    ...
    protected ExecutorService createPoolEmbedded(String taskType, IAMShieldSession session) {
    ...
    protected ThreadFactory createThreadFactory(String taskType, IAMShieldSession session) {

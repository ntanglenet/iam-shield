...
import org.iamshield.protocol.oidc.grants.ciba.channel.AuthenticationChannelResponse.Status;
...
public class BackchannelAuthenticationCallbackEndpoint extends AbstractCibaEndpoint {
    ...
    public BackchannelAuthenticationCallbackEndpoint(IAMShieldSession session, EventBuilder event) {
        super(session, event);

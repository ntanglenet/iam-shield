...
public class AuthzEndpointQueryStringParser extends AuthzEndpointRequestParser {
    ...
    public AuthzEndpointQueryStringParser(IAMShieldSession keycloakSession, MultivaluedMap<String, String> requestParams, boolean isResponseTypeParameterRequired) {

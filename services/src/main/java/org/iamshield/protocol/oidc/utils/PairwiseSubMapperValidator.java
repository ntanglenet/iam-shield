...
public class PairwiseSubMapperValidator {
    ...
    public static void validate(IAMShieldSession session, ClientModel client, ProtocolMapperModel mapperModel) throws ProtocolMapperConfigException {
    ...
    public static void validate(IAMShieldSession session, String rootUrl, Set<String> redirectUris, String sectorIdentifierUri) throws ProtocolMapperConfigException {
    ...
    private static void validateSectorIdentifierUri(IAMShieldSession session, String rootUrl, Set<String> redirectUris, String sectorIdentifierUri) throws ProtocolMapperConfigException {
    ...
    private static Set<String> getSectorRedirects(IAMShieldSession session, String sectorIdentifierUri) throws ProtocolMapperConfigException {
        try {

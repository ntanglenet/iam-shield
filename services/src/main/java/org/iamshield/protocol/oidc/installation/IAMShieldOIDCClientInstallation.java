...
package org.iamshield.protocol.oidc.installation;
...
import org.iamshield.representations.adapters.config.PolicyEnforcerConfig;
 ...
 * @version $Revision: 1 $
 */
public class IAMShieldOIDCClientInstallation implements ClientInstallationProvider {

    @Override
    public Response generateInstallation(IAMShieldSession session, RealmModel realm, ClientModel client, URI baseUri) {
    ...
    public static Map<String, Object> getClientCredentialsAdapterConfig(IAMShieldSession session, ClientModel client) {
        String clientAuthenticator = client.getClientAuthenticatorType();
        ClientAuthenticatorFactory authenticator = (ClientAuthenticatorFactory) session.getIAMShieldSessionFactory().getProviderFactory(ClientAuthenticator.class, clientAuthenticator);
    ...
    @Override
    public ClientInstallationProvider create(IAMShieldSession session) {
        return this;
    }
    ...
    private void configureAuthorizationSettings(IAMShieldSession session, ClientModel client, ClientManager.InstallationAdapterConfig rep) {

...
import org.iamshield.protocol.oidc.rar.AuthorizationRequestParserProviderFactory;
import org.iamshield.protocol.oidc.rar.parsers.ClientScopeAuthorizationRequestParser;
...
public class ClientScopeAuthorizationRequestParserProviderFactory implements AuthorizationRequestParserProviderFactory {
    ...
    @Override
    public AuthorizationRequestParserProvider create(IAMShieldSession session) {

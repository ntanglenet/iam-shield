...
import org.iamshield.scripting.EvaluatableScriptAdapter;
import org.iamshield.scripting.ScriptCompilationException;
import org.iamshield.scripting.ScriptingProvider;

import java.util.List;

/**
 * OIDC {@link org.iamshield.protocol.ProtocolMapper} that uses a provided JavaScript fragment to compute the token claim value.
 *
...
public class ScriptBasedOIDCProtocolMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper,
  ...
  @Override
  protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, IAMShieldSession keycloakSession, ClientSessionContext clientSessionCtx) {
  ...
  protected void setClaim(AccessTokenResponse accessTokenResponse, ProtocolMapperModel mappingModel, UserSessionModel userSession,
          IAMShieldSession keycloakSession, ClientSessionContext clientSessionCtx) {
  ...
  private Object evaluateScript(Object tokenBinding, ProtocolMapperModel mappingModel, UserSessionModel userSession, IAMShieldSession keycloakSession) {
  ...
  @Override
  public void validateConfig(IAMShieldSession session, RealmModel realm, ProtocolMapperContainerModel client, ProtocolMapperModel mapperModel) throws ProtocolMapperConfigException {

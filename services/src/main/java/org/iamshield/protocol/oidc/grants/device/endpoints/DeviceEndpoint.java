...
package org.iamshield.protocol.oidc.grants.device.endpoints;
...
import org.iamshield.models.OAuth2DeviceUserCodeProvider;
...
import org.iamshield.protocol.oidc.grants.device.clientpolicy.context.DeviceAuthorizationRequestContext;
import org.iamshield.protocol.oidc.utils.AuthorizeClientUtil;
import org.iamshield.representations.OAuth2DeviceAuthorizationResponse;
...
import static org.iamshield.protocol.oidc.grants.device.DeviceGrantType.OAUTH2_DEVICE_USER_CODE;
...
public class DeviceEndpoint extends AuthorizationEndpointBase implements RealmResourceProvider {
    ...
    public DeviceEndpoint(IAMShieldSession session, EventBuilder event) {
        super(session, event);
    ...
    public static OAuth2DeviceCodeModel getDeviceByUserCode(IAMShieldSession session, RealmModel realm, String userCode) {
        SingleUseObjectProvider singleUseStore = session.singleUseObjects();

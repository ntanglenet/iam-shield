...
public class OAuth2CodeParser {
     ...
     */
    public static String persistCode(IAMShieldSession session, AuthenticatedClientSessionModel clientSession, OAuth2Code codeData) {
     ...
     * @return
     */
    public static ParseResult parseCode(IAMShieldSession session, String code, RealmModel realm, EventBuilder event) {

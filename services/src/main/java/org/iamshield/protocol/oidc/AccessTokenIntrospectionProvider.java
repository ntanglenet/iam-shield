...
public class AccessTokenIntrospectionProvider<T extends AccessToken> implements TokenIntrospectionProvider {
    ...
    public AccessTokenIntrospectionProvider(IAMShieldSession session) {
    ...
    public Response introspect(String tokenStr, EventBuilder eventBuilder) {
        ...
        try {
            ...
            if (accessToken != null) {
                boolean isJwtRequest = org.iamshield.utils.MediaType.APPLICATION_JWT.equals(session.getContext().getRequestHeaders().getHeaderString(HttpHeaders.ACCEPT));

...
import org.iamshield.protocol.oidc.OIDCProviderConfig;
 ...
 * {@value org.iamshield.protocol.oidc.OIDCProviderConfig#DEFAULT_ADDITIONAL_REQ_PARAMS_MAX_NUMBER} parameters with each
 * having a total size of {@value org.iamshield.protocol.oidc.OIDCProviderConfig#DEFAULT_ADDITIONAL_REQ_PARAMS_MAX_SIZE}.
...
public abstract class AuthzEndpointRequestParser {
    ...
    protected AuthzEndpointRequestParser(IAMShieldSession keycloakSession) {

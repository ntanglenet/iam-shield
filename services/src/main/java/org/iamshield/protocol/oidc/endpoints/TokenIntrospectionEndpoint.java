...
import org.iamshield.services.clientpolicy.context.TokenIntrospectContext;
...
public class TokenIntrospectionEndpoint {
    ...
    public TokenIntrospectionEndpoint(IAMShieldSession session, EventBuilder event) {
    ...
    @POST
    @NoCache
    @Produces({MediaType.APPLICATION_JSON, org.iamshield.utils.MediaType.APPLICATION_JWT})

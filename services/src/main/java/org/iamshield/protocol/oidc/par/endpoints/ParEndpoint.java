...
import org.iamshield.protocol.oidc.par.ParResponse;
import org.iamshield.protocol.oidc.par.clientpolicy.context.PushedAuthorizationRequestContext;
import org.iamshield.protocol.oidc.par.endpoints.request.ParEndpointRequestParserProcessor;
...
import static org.iamshield.protocol.oidc.OIDCLoginProtocol.REQUEST_URI_PARAM;
...
public class ParEndpoint extends AbstractParEndpoint {
    ...
    public ParEndpoint(IAMShieldSession session, EventBuilder event) {
        super(session, event);

...
public class AuthorizeClientUtil {
    ...
    public static ClientAuthResult authorizeClient(IAMShieldSession session, EventBuilder event, Cors cors) {
    ...
    public static AuthenticationProcessor getAuthenticationProcessor(IAMShieldSession session, EventBuilder event) {
    ...
    public static ClientAuthenticatorFactory findClientAuthenticatorForOIDCAuthMethod(IAMShieldSession session, String oidcAuthMethod) {

...
import static org.iamshield.protocol.oidc.mappers.OIDCAttributeMapperHelper.INCLUDE_IN_ID_TOKEN;
...
public abstract class AbstractOIDCProtocolMapper implements ProtocolMapper {
    ...
    public AccessToken transformUserInfoToken(AccessToken token, ProtocolMapperModel mappingModel, IAMShieldSession session,
    ...
    public static boolean getShouldUseLightweightToken(IAMShieldSession session) {
    ...
    public IDToken transformIDToken(IDToken token, ProtocolMapperModel mappingModel, IAMShieldSession session,
                                    UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
     ...
     * @param mappingModel
     * @param userSession
     * @deprecated override {@link #setClaim(IDToken, ProtocolMapperModel, UserSessionModel, IAMShieldSession, ClientSessionContext)} instead.
     */
    @Deprecated
     ...
     */
    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession, IAMShieldSession keycloakSession,
                            ClientSessionContext clientSessionCtx) {
     ...
     * @param clientSessionCtx
     */
    protected void setClaim(AccessTokenResponse accessTokenResponse, ProtocolMapperModel mappingModel, UserSessionModel userSession, IAMShieldSession keycloakSession,
                            ClientSessionContext clientSessionCtx) {

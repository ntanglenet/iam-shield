...
import static org.iamshield.protocol.oidc.par.endpoints.ParEndpoint.PAR_CREATED_TIME;
...
public class AuthzEndpointParParser extends AuthzEndpointRequestParser {
    ...
    public AuthzEndpointParParser(IAMShieldSession session, ClientModel client, String requestUri) {
        super(session);

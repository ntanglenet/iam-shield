...
public class IframeUtil {
    ...
    public static Response returnIframeFromResources(String fileName, String version, IAMShieldSession session) {
        return returnIframe(version, session, () -> IframeUtil.class.getResourceAsStream(fileName));
    }

    public static Response returnIframe(String version, IAMShieldSession session, Supplier<Object> responseEntityProvider) {

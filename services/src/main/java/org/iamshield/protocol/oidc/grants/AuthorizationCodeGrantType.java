...
import org.iamshield.protocol.oidc.rar.AuthorizationDetailsResponse;
...
import static org.iamshield.OAuth2Constants.AUTHORIZATION_DETAILS_PARAM;
import static org.iamshield.models.Constants.AUTHORIZATION_DETAILS_RESPONSE;
...
public class AuthorizationCodeGrantType extends OAuth2GrantTypeBase {
    ...
    public Response process(Context context) {
        ...
        if (redirectUriParam != null && redirectUriParam.contains("session_state=") && !redirectUri.contains("session_state=")) {
            redirectUriParam = IAMShieldUriBuilder.fromUri(redirectUriParam)

...
public class FrontChannelLogoutHandler {
    ...
    public static FrontChannelLogoutHandler current(IAMShieldSession session) {
        return (FrontChannelLogoutHandler) session.getAttribute(FrontChannelLogoutHandler.class.getName());
    }

    public static FrontChannelLogoutHandler currentOrCreate(IAMShieldSession session, AuthenticatedClientSessionModel clientSession) {
    ...
    private FrontChannelLogoutHandler(IAMShieldSession session, AuthenticatedClientSessionModel clientSession) {

...
import org.iamshield.crypto.HashProvider;
...
import org.iamshield.migration.migrators.MigrationUtils;
...
import org.iamshield.protocol.oidc.mappers.OIDCAccessTokenResponseMapper;
...
import org.iamshield.representations.AuthorizationDetailsJSONRepresentation;
...
import org.iamshield.representations.dpop.DPoP;
...
import static org.iamshield.OAuth2Constants.ORGANIZATION;
import static org.iamshield.models.light.LightweightUserAdapter.isLightweightUser;
import static org.iamshield.representations.IDToken.NONCE;
...
public class TokenManager {
    ...
    public TokenValidation validateToken(IAMShieldSession session, UriInfo uriInfo, ClientConnection connection, RealmModel realm,
    ...
    public static boolean isUserValid(IAMShieldSession session, RealmModel realm, AccessToken token, UserModel user) {
        if (user == null) {
     ...
     */
    public static UserModel lookupUserFromStatelessToken(IAMShieldSession session, RealmModel realm, AccessToken token) {
    ...
    public AccessTokenResponseBuilder refreshAccessToken(IAMShieldSession session, UriInfo uriInfo, ClientConnection connection, RealmModel realm, ClientModel authorizedClient,
    ...
    private Function<String, String> transformScopes(IAMShieldSession session, Set<String> requestedScopes) {
        return scope -> {
    ...
    private void validateTokenReuseForRefresh(IAMShieldSession session, RealmModel realm, RefreshToken refreshToken,
    ...
    public void validateTokenReuse(IAMShieldSession session, RealmModel realm, AccessToken refreshToken, AuthenticatedClientSessionModel clientSession, boolean refreshFlag) throws OAuthErrorException {
    ...
    public RefreshToken verifyRefreshToken(IAMShieldSession session, RealmModel realm, ClientModel client, HttpRequest request, String encodedRefreshToken, boolean checkExpiration) throws OAuthErrorException {
        try {
    ...
    public RefreshToken toRefreshToken(IAMShieldSession session, String encodedRefreshToken) throws JWSInputException, OAuthErrorException {
    ...
    public IDToken verifyIDToken(IAMShieldSession session, RealmModel realm, String encodedIDToken) throws OAuthErrorException {
    ...
    public IDToken verifyIDTokenSignature(IAMShieldSession session, String encodedIDToken) throws OAuthErrorException {
        IDToken idToken = session.tokens().decode(encodedIDToken, IDToken.class);
        if (idToken == null) {
    ...
    public AccessToken createClientAccessToken(IAMShieldSession session, RealmModel realm, ClientModel client, UserModel user, UserSessionModel userSession,
    ...
    public static ClientSessionContext attachAuthenticationSession(IAMShieldSession session, UserSessionModel userSession, AuthenticationSessionModel authSession) {
        return attachAuthenticationSession(session, userSession, authSession, false);
    }

    public static ClientSessionContext attachAuthenticationSession(IAMShieldSession session, UserSessionModel userSession,
    ...
    public static Stream<ClientScopeModel> getRequestedClientScopes(IAMShieldSession session, String scopeParam, ClientModel client, UserModel user) {
        if (client == null) {
            return Stream.of();
        }
    ...
    private static ClientScopeModel tryResolveDynamicClientScope(IAMShieldSession session, String scopeParam, UserModel user, String name) {
        if (Profile.isFeatureEnabled(Feature.ORGANIZATION)) {
     ...
     * @return
     */
    public static boolean isValidScope(IAMShieldSession session, String scopes, AuthorizationRequestContext authorizationRequestContext, ClientModel client, UserModel user) {
        if (scopes == null) {
            return true;
        }
    ...
    public static boolean isValidScope(IAMShieldSession session, String scopes, ClientModel client, UserModel user) {
    ...
    public static boolean verifyConsentStillAvailable(IAMShieldSession session, UserModel user, ClientModel client,
    ...
    public AccessToken transformAccessToken(IAMShieldSession session, AccessToken token,
    ...
    public AccessTokenResponse transformAccessTokenResponse(IAMShieldSession session, AccessTokenResponse accessTokenResponse,
            UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
    ...
    public AccessToken transformUserInfoAccessToken(IAMShieldSession session, AccessToken token,
                                                    UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
    ...
    public AccessToken transformIntrospectionAccessToken(IAMShieldSession session, AccessToken token,
                                                         UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
    ...
    public IDToken transformIDToken(IAMShieldSession session, IDToken token,
                                    UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
    ...
    protected AccessToken initToken(IAMShieldSession session, RealmModel realm, ClientModel client, UserModel user, UserSessionModel userSession,
        ...
        ClientScopeModel offlineAccessScope = IAMShieldModelUtils.getClientScopeByName(realm, OAuth2Constants.OFFLINE_ACCESS);
    ...
    public AccessTokenResponseBuilder responseBuilder(RealmModel realm, ClientModel client, EventBuilder event, IAMShieldSession session,
                                                      UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
    ...
    public class AccessTokenResponseBuilder {
        ...
        public AccessTokenResponseBuilder(RealmModel realm, ClientModel client, EventBuilder event, IAMShieldSession session,
                                          UserSessionModel userSession, ClientSessionContext clientSessionCtx) {
            this.realm = realm;
            this.client = client;
            this.event = event;
        ...
        public AccessTokenResponseBuilder generateRefreshToken() {
            ...
            if (realm.isRevokeRefreshToken()) {
                refreshToken.getOtherClaims().put(Constants.REUSE_ID, IAMShieldModelUtils.generateId());
            }
            return this;
        }
    ...
    public static class NotBeforeCheck implements TokenVerifier.Predicate<JsonWebToken> {
        ...
        public static NotBeforeCheck forModel(IAMShieldSession session, RealmModel realmModel, UserModel userModel) {
    ...
    public static class TokenRevocationCheck implements TokenVerifier.Predicate<JsonWebToken> {
        ...
        public TokenRevocationCheck(IAMShieldSession session) {
            this.session = session;
        }
    ...
    public LogoutTokenValidationContext verifyLogoutToken(IAMShieldSession session, String encodedLogoutToken) {
    ...
    private Stream<OIDCIdentityProvider> getOIDCIdentityProviders(LogoutToken logoutToken, IAMShieldSession session) {
        try {

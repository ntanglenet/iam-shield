...
import static org.iamshield.protocol.oidc.endpoints.IframeUtil.returnIframeFromResources;
...
public class ThirdPartyCookiesIframeEndpoint {
    ...
    public ThirdPartyCookiesIframeEndpoint(IAMShieldSession session) {

...
package org.iamshield.protocol.oidc.encode;
...
public class DefaultTokenContextEncoderProviderFactory implements TokenContextEncoderProviderFactory {
    ...
    private IAMShieldSessionFactory sessionFactory;
    ...
    @Override
    public TokenContextEncoderProvider create(IAMShieldSession session) {

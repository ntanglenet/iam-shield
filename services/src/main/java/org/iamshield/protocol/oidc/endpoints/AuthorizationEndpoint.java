...
import org.iamshield.protocol.oidc.endpoints.request.RequestUriType;
...
import org.iamshield.services.clientpolicy.context.PreAuthorizationRequestContext;
...
import static org.iamshield.protocol.oidc.par.endpoints.ParEndpoint.PAR_DPOP_PROOF_JKT;
...
public class AuthorizationEndpoint extends AuthorizationEndpointBase {
    ...
    public AuthorizationEndpoint(IAMShieldSession session, EventBuilder event) {
        super(session, event);

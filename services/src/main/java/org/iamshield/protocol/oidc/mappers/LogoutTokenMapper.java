...
public interface LogoutTokenMapper {
    ...
    LogoutToken transformLogoutToken(LogoutToken token, ProtocolMapperModel mappingModel, IAMShieldSession session, UserSessionModel userSession, ClientSessionContext clientSessionCtx);

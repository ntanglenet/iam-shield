...
import org.iamshield.protocol.oidc.grants.ciba.endpoints.request.BackchannelAuthenticationEndpointRequest;
import org.iamshield.protocol.oidc.grants.ciba.endpoints.request.BackchannelAuthenticationEndpointRequestParserProcessor;
import org.iamshield.protocol.oidc.grants.ciba.resolvers.CIBALoginUserResolver;
...
import static org.iamshield.protocol.oidc.OIDCLoginProtocol.ID_TOKEN_HINT;
...
public class BackchannelAuthenticationEndpoint extends AbstractCibaEndpoint {
    ...
    public BackchannelAuthenticationEndpoint(IAMShieldSession session, EventBuilder event) {
        super(session, event);

...
public class AuthzEndpointRequestObjectParser extends AuthzEndpointRequestParser {
    ...
    public AuthzEndpointRequestObjectParser(IAMShieldSession session, String requestObject, ClientModel client) {
        super(session);
    ...
    private BiConsumer<JOSE, ClientModel> createRequestObjectValidator(IAMShieldSession session) {

...
import org.iamshield.protocol.oidc.endpoints.LoginStatusIframeEndpoint;
import org.iamshield.protocol.oidc.endpoints.LogoutEndpoint;
import org.iamshield.protocol.oidc.endpoints.ThirdPartyCookiesIframeEndpoint;
import org.iamshield.protocol.oidc.endpoints.TokenEndpoint;
import org.iamshield.protocol.oidc.endpoints.TokenRevocationEndpoint;
import org.iamshield.protocol.oidc.endpoints.UserInfoEndpoint;
...
public class OIDCLoginProtocolService {
    ...
    public OIDCLoginProtocolService(IAMShieldSession session, EventBuilder event) {
    ...
    @GET
    @Path("certs")
    @Produces({MediaType.APPLICATION_JSON, org.iamshield.utils.MediaType.APPLICATION_JWKS})
    @NoCache
    public Response certs() {
        ...
        boolean isJwksRequest = org.iamshield.utils.MediaType.APPLICATION_JWKS.equals(this.headers.getHeaderString(HttpHeaders.ACCEPT));
        if (isJwksRequest) {
            responseBuilder.header(CONTENT_TYPE, org.iamshield.utils.MediaType.APPLICATION_JWKS);
        } else {

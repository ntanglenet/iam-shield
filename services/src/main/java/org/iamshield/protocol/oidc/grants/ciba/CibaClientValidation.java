...
import org.iamshield.validation.ValidationContext;
...
public class CibaClientValidation {
    ...
    private static boolean isSupportedBackchannelAuthenticationRequestSigningAlg(IAMShieldSession session, String alg) {

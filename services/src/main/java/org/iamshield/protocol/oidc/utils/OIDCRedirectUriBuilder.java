...
public abstract class OIDCRedirectUriBuilder {
    ...
    protected final IAMShieldUriBuilder uriBuilder;

    protected OIDCRedirectUriBuilder(IAMShieldUriBuilder uriBuilder) {
    ...
    public static OIDCRedirectUriBuilder fromUri(String baseUri, OIDCResponseMode responseMode, IAMShieldSession session, AuthenticatedClientSessionModel clientSession) {
        IAMShieldUriBuilder uriBuilder = IAMShieldUriBuilder.fromUri(baseUri);
    ...
    private static class QueryRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        protected QueryRedirectUriBuilder(IAMShieldUriBuilder uriBuilder) {
            super(uriBuilder);
        }
    ...
    private static class FragmentRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        protected FragmentRedirectUriBuilder(IAMShieldUriBuilder uriBuilder) {
            super(uriBuilder);
    ...
    private static class FormPostRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        protected FormPostRedirectUriBuilder(IAMShieldUriBuilder uriBuilder) {
            super(uriBuilder);
        }
    ...
    private static class JWTRedirectUriBuilder extends OIDCRedirectUriBuilder {
        ...
        public JWTRedirectUriBuilder(IAMShieldUriBuilder uriBuilder, OIDCResponseMode responseMode, IAMShieldSession session, AuthenticatedClientSessionModel clientSession) {
            super(uriBuilder);

...
import static org.iamshield.protocol.util.ClientCliInstallationUtil.quote;
...
public class IAMShieldOIDCJbossSubsystemClientCliInstallation implements ClientInstallationProvider {
    ...
    public Response generateInstallation(IAMShieldSession session, RealmModel realm, ClientModel client, URI baseUri) {
        ...
        if (IAMShieldOIDCClientInstallation.showVerifyTokenAudience(client)) {
        ...
        if (IAMShieldOIDCClientInstallation.showClientCredentialsAdapterConfig(client)) {
            Map<String, Object> adapterConfig = IAMShieldOIDCClientInstallation.getClientCredentialsAdapterConfig(session, client);

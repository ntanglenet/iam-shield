...
public class BackchannelAuthenticationEndpointRequestParserProcessor {
    ...
    public static BackchannelAuthenticationEndpointRequest parseRequest(EventBuilder event, IAMShieldSession session, ClientModel client, MultivaluedMap<String, String> requestParams, CibaConfig config) {
        try {

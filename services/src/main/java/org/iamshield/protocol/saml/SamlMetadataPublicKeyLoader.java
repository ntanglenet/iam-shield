...
public class SamlMetadataPublicKeyLoader extends SamlAbstractMetadataPublicKeyLoader {
    ...
    public SamlMetadataPublicKeyLoader(IAMShieldSession session, String metadataUrl) {
        this(session, metadataUrl, true);
    }

    public SamlMetadataPublicKeyLoader(IAMShieldSession session, String metadataUrl, boolean forIdP) {
        super(forIdP);

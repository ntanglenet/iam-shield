...
import static org.iamshield.protocol.saml.DefaultSamlArtifactResolverFactory.TYPE_CODE;
import static org.iamshield.protocol.saml.SamlConfigAttributes.SAML_ARTIFACT_BINDING_IDENTIFIER;
...
public class DefaultSamlArtifactResolver implements ArtifactResolver {
    ...
    @Override
    public ClientModel selectSourceClient(IAMShieldSession session, String artifact) throws ArtifactResolverProcessingException {

...
public class SamlProtocolUtils {
     ...
     */
    public static void verifyDocumentSignature(IAMShieldSession session, ClientModel client, Document document) throws VerificationException {
     ...
     * @throws VerificationException
     */
    public static PublicKey getEncryptionKey(IAMShieldSession session, ClientModel client) throws VerificationException {
     ...
     * @throws VerificationException
     */
    public static PublicKey getEncryptionKey(IAMShieldSession session, SamlClient samlClient) throws VerificationException {
    ...
    public static void setupEncryption(IAMShieldSession session, SamlClient samlClient, BaseSAML2BindingBuilder<?> bindingBuilder) throws VerificationException {
    ...
    public static KeyLocator createKeyLocatorForClient(IAMShieldSession session, ClientModel client, KeyUse use) throws VerificationException {
        return createKeyLocatorForClient(session, new SamlClient(client), use);
    }

    public static KeyLocator createKeyLocatorForClient(IAMShieldSession session, SamlClient samlClient, KeyUse use) throws VerificationException {

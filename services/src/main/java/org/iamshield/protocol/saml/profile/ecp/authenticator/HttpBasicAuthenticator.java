package org.iamshield.protocol.saml.profile.ecp.authenticator;
...
public class HttpBasicAuthenticator implements Authenticator {
    ...
    @Override
    public boolean configuredFor(final IAMShieldSession session, final RealmModel realm, final UserModel user) {
        return false;
    }

    @Override
    public void setRequiredActions(final IAMShieldSession session, final RealmModel realm, final UserModel user) {

...
public class RoleListMapper extends AbstractSAMLProtocolMapper implements SAMLRoleListMapper {
    ...
    @Override
    public void mapRoles(AttributeStatementType roleAttributeStatement, ProtocolMapperModel mappingModel, IAMShieldSession session, UserSessionModel userSession, ClientSessionContext clientSessionCtx) {

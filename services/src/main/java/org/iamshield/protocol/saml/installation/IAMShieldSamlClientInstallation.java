 ...
 * @version $Revision: 1 $
 */
public class IAMShieldSamlClientInstallation implements ClientInstallationProvider {
    ...
    public static void baseXml(IAMShieldSession session, RealmModel realm, ClientModel client, URI baseUri, SamlClient samlClient, StringBuilder buffer) {

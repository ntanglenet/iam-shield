...
package org.iamshield.protocol.saml.installation;
...
public class SamlSPDescriptorClientInstallation implements ClientInstallationProvider {
    ...
    @Override
    public Response generateInstallation(IAMShieldSession session, RealmModel realm, ClientModel client, URI serverBaseUri) {

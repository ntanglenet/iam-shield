 ...
 * @version $Revision: 1 $
 */
public class IAMShieldSamlSubsystemInstallation implements ClientInstallationProvider {
    ...
    public Response generateInstallation(IAMShieldSession session, RealmModel realm, ClientModel client, URI baseUri) {
        ...
        IAMShieldSamlClientInstallation.baseXml(session, realm, client, baseUri, samlClient, buffer);

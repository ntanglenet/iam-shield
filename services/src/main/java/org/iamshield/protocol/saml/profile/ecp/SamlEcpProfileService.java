...
package org.iamshield.protocol.saml.profile.ecp;
...
public class SamlEcpProfileService extends SamlService {
    ...
    public SamlEcpProfileService(IAMShieldSession session, EventBuilder event, DestinationValidator destinationValidator) {

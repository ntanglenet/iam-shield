...
package org.iamshield.protocol.oid4vc.issuance.mappers;
...
import org.iamshield.protocol.oid4vc.model.Role;
...
public class OID4VCTargetRoleMapper extends OID4VCMapper {
	...
	public OID4VCTargetRoleMapper(IAMShieldSession keycloakSession) {
	...
	@Override
	public ProtocolMapper create(IAMShieldSession session) {

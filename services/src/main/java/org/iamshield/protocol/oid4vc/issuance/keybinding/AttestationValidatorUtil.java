...
import org.iamshield.protocol.oid4vc.model.SupportedProofTypeData;
...
import static org.iamshield.services.clientpolicy.executor.FapiConstant.ALLOWED_ALGORITHMS;
...
public class AttestationValidatorUtil {
    ...
    public static KeyAttestationJwtBody validateAttestationJwt(
            ...
            IAMShieldSession keycloakSession,
    ...
    private static SignatureVerifierContext verifierFromX5CChain(
            List<String> x5cList,
            String alg,
            IAMShieldSession keycloakSession) throws VCIssuerException {
        ...
        try {
            ...
            for (String certBase64 : x5cList) {
                ...
                byte[] certBytes = org.iamshield.common.util.Base64.decode(certBase64);

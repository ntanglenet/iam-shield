...
package org.iamshield.protocol.oid4vc;
...
import org.iamshield.protocol.oid4vc.issuance.mappers.OID4VCSubjectIdMapper;
import org.iamshield.protocol.oid4vc.issuance.mappers.OID4VCTargetRoleMapper;
import org.iamshield.protocol.oid4vc.issuance.mappers.OID4VCUserAttributeMapper;
...
public class OID4VCLoginProtocolFactory implements LoginProtocolFactory, OID4VCEnvironmentProviderFactory {
	...
	@Override
	public Object createProtocolEndpoint(IAMShieldSession keycloakSession, EventBuilder event) {
	...
	public void createDefaultClientScopes(RealmModel newRealm, boolean addScopesToExistingClients) {
		...
		ClientScopeModel naturalPersonScope = IAMShieldModelUtils.getClientScopeByName(newRealm, "natural_person");

...
import org.iamshield.crypto.CryptoUtils;
...
import org.iamshield.jose.jwe.JWEConstants;
...
import org.iamshield.protocol.oidc.utils.JWKSServerUtils;
...
import static org.iamshield.crypto.KeyType.RSA;
import static org.iamshield.jose.jwk.RSAPublicJWK.RS256;
...
public class OID4VCIssuerWellKnownProvider implements WellKnownProvider {
    ...
    public OID4VCIssuerWellKnownProvider(IAMShieldSession keycloakSession) {
    ...
    public CredentialIssuer getIssuerMetadata() {
        IAMShieldContext context = keycloakSession.getContext();
    ...
    public Object getMetadataResponse(CredentialIssuer issuer, IAMShieldSession session) {
    ...
    private static String getDeferredCredentialEndpoint(IAMShieldContext context) {
        return getIssuer(context) + "/protocol/" + OID4VCLoginProtocolFactory.PROTOCOL_ID + "/deferred_credential";
    }

    private CredentialIssuer.BatchCredentialIssuance getBatchCredentialIssuance(IAMShieldSession session) {
     ...
     */
    public Optional<String> generateSignedMetadata(CredentialIssuer metadata, IAMShieldSession session) {
        RealmModel realm = session.getContext().getRealm();
    ...
    private String getSigningAlgorithm(RealmModel realm, IAMShieldSession session) {
     ...
     */
    public static CredentialResponseEncryptionMetadata getCredentialResponseEncryption(IAMShieldSession session) {
        RealmModel realm = session.getContext().getRealm();
     ...
     */
    public static CredentialRequestEncryptionMetadata getCredentialRequestEncryption(IAMShieldSession session) {
        RealmModel realm = session.getContext().getRealm();
     ...
     */
    public static List<String> getSupportedEncryptionAlgorithms(IAMShieldSession session) {
        RealmModel realm = session.getContext().getRealm();
        KeyManager keyManager = session.keys();
     ...
     */
    private static JSONWebKeySet buildJwks(IAMShieldSession session) {
        RealmModel realm = session.getContext().getRealm();
     ...
     */
    public static Map<String, SupportedCredentialConfiguration> getSupportedCredentials(IAMShieldSession keycloakSession) {
    ...
    public static SupportedCredentialConfiguration toSupportedCredentialConfiguration(IAMShieldSession keycloakSession,
     ...
     */
    public static String getIssuer(IAMShieldContext context) {
     ...
     */
    public static String getNonceEndpoint(IAMShieldContext context) {
     ...
     */
    public static String getCredentialsEndpoint(IAMShieldContext context) {
        return getIssuer(context) + "/protocol/" + OID4VCLoginProtocolFactory.PROTOCOL_ID + "/" + OID4VCIssuerEndpoint.CREDENTIAL_PATH;
    }

    public static List<String> getSupportedSignatureAlgorithms(IAMShieldSession session) {
        RealmModel realm = session.getContext().getRealm();
        KeyManager keyManager = session.keys();
     ...
     */
    public static List<String> getAuthorizationServers(IAMShieldSession session) {
     ...
     */
    public static List<String> getSupportedAsymmetricSignatureAlgorithms(IAMShieldSession session) {
     ...
     */
    private void addDeprecationHeadersIfOldRoute(IAMShieldSession session) {

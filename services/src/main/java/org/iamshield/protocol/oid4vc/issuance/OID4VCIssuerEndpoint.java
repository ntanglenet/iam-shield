...
import org.iamshield.jose.JOSEHeader;
import org.iamshield.jose.jwe.JWE;
import org.iamshield.jose.jwe.JWEException;
import org.iamshield.jose.jwe.JWEHeader;
...
import org.iamshield.models.oid4vci.CredentialScopeModel;
import org.iamshield.models.IAMShieldSession;
import org.iamshield.models.IAMShieldSessionFactory;
import org.iamshield.models.RealmModel;
import org.iamshield.models.UserSessionModel;
import org.iamshield.protocol.ProtocolMapper;
import org.iamshield.protocol.oid4vc.OID4VCLoginProtocolFactory;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.CredentialBody;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.CredentialBuilder;
import org.iamshield.protocol.oid4vc.issuance.credentialbuilder.CredentialBuilderFactory;
import org.iamshield.protocol.oid4vc.issuance.keybinding.CNonceHandler;
import org.iamshield.protocol.oid4vc.issuance.keybinding.JwtCNonceHandler;
import org.iamshield.protocol.oid4vc.issuance.keybinding.ProofValidator;
import org.iamshield.protocol.oid4vc.issuance.mappers.OID4VCMapper;
import org.iamshield.protocol.oid4vc.issuance.signing.CredentialSigner;
import org.iamshield.protocol.oid4vc.model.CredentialIssuer;
import org.iamshield.protocol.oid4vc.model.CredentialOfferURI;
import org.iamshield.protocol.oid4vc.model.CredentialRequest;
import org.iamshield.protocol.oid4vc.model.CredentialRequestEncryptionMetadata;
import org.iamshield.protocol.oid4vc.model.CredentialResponse;
import org.iamshield.protocol.oid4vc.model.CredentialResponseEncryption;
import org.iamshield.protocol.oid4vc.model.CredentialResponseEncryptionMetadata;
import org.iamshield.protocol.oid4vc.model.CredentialsOffer;
import org.iamshield.services.ErrorResponseException;
import org.iamshield.protocol.oid4vc.model.ErrorResponse;
import org.iamshield.protocol.oid4vc.model.ErrorType;
import org.iamshield.protocol.oid4vc.model.Format;
import org.iamshield.protocol.oid4vc.model.NonceResponse;
import org.iamshield.protocol.oid4vc.model.OfferUriType;
import org.iamshield.protocol.oid4vc.model.PreAuthorizedCode;
import org.iamshield.protocol.oid4vc.model.PreAuthorizedGrant;
import org.iamshield.protocol.oid4vc.model.ProofType;
import org.iamshield.protocol.oid4vc.model.Proofs;
import org.iamshield.protocol.oid4vc.model.SupportedCredentialConfiguration;
import org.iamshield.protocol.oid4vc.model.VerifiableCredential;
import org.iamshield.protocol.oid4vc.model.ClaimsDescription;
import org.iamshield.protocol.oid4vc.utils.ClaimsPathPointer;
import com.fasterxml.jackson.core.type.TypeReference;
import org.iamshield.protocol.oidc.grants.PreAuthorizedCodeGrantType;
import org.iamshield.protocol.oidc.grants.PreAuthorizedCodeGrantTypeFactory;
import org.iamshield.protocol.oidc.utils.OAuth2Code;
import org.iamshield.protocol.oidc.utils.OAuth2CodeParser;
import org.iamshield.representations.AccessToken;
import org.iamshield.saml.processing.api.util.DeflateUtil;
...
public class OID4VCIssuerEndpoint {
    ...
    public OID4VCIssuerEndpoint(IAMShieldSession session,
    ...
    public OID4VCIssuerEndpoint(IAMShieldSession keycloakSession) {
     ...
     */
    private Map<String, CredentialBuilder> loadCredentialBuilders(IAMShieldSession keycloakSession) {
        IAMShieldSessionFactory keycloakSessionFactory = keycloakSession.getIAMShieldSessionFactory();

...
package org.iamshield.protocol.oid4vc.issuance.signing;
...
import org.iamshield.protocol.oid4vc.issuance.signing.vcdm.LinkedDataCryptographicSuite;
...
public class LDCredentialSigner extends AbstractCredentialSigner<VerifiableCredential> {
    ...
    public LDCredentialSigner(IAMShieldSession keycloakSession, TimeProvider timeProvider) {

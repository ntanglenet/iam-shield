...
public class RestartLoginCookie implements Token {
    ...
    public static void setRestartCookie(IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    public static void expireRestartCookie(IAMShieldSession session) {
        session.getProvider(CookieProvider.class).expire(CookieType.AUTH_RESTART);
    }

    public static String getRestartCookie(IAMShieldSession session){
    ...
    public static AuthenticationSessionModel restartSession(IAMShieldSession session, RealmModel realm,
    ...
    private static RestartLoginCookie decryptAndDecode(IAMShieldSession session, String encodedToken) {
        try {
    ...
    private static String encodeAndEncrypt(IAMShieldSession session, RestartLoginCookie cookie) {
        try {

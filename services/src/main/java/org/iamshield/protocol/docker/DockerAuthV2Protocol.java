...
import org.iamshield.protocol.docker.mapper.DockerAuthV2AttributeMapper;
import org.iamshield.representations.docker.DockerResponse;
...
public class DockerAuthV2Protocol implements LoginProtocol {
    ...
    public DockerAuthV2Protocol(final IAMShieldSession session, final RealmModel realm, final UriInfo uriInfo, final HttpHeaders headers, final EventBuilder event) {
    ...
    @Override
    public LoginProtocol setSession(final IAMShieldSession session) {
        this.session = session;
        return this;
    }

...
public class ProtocolMapperUtils {
     ...
     *
     * @param session A IAMShieldSession
     * @return The builtin locale mapper.
     */
    public static ProtocolMapperModel findLocaleMapper(IAMShieldSession session) {
        return session.getIAMShieldSessionFactory().getProviderFactoriesStream(LoginProtocol.class)
    ...
    public static Stream<Entry<ProtocolMapperModel, ProtocolMapper>> getSortedProtocolMappers(IAMShieldSession session, ClientSessionContext ctx) {
        return getSortedProtocolMappers(session, ctx, entry -> true);
    }

    public static Stream<Entry<ProtocolMapperModel, ProtocolMapper>> getSortedProtocolMappers(IAMShieldSession session, ClientSessionContext ctx, Predicate<Entry<ProtocolMapperModel, ProtocolMapper>> filter) {
    ...
    public static boolean isEnabled(IAMShieldSession session, ProtocolMapperModel mapper) {
        return session.getIAMShieldSessionFactory().getProviderFactory(ProtocolMapper.class, mapper.getProtocolMapper()) != null;
    }
}

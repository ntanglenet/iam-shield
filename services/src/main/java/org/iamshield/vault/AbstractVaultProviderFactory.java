 ...
 * instances on {@link #create(IAMShieldSession)}.
 * <p/>
...
public abstract class AbstractVaultProviderFactory implements VaultProviderFactory {
    ...
    /**
     * Obtains the name of realm from the {@link IAMShieldSession}.
     *
     * @param session a reference to the {@link IAMShieldSession}.
     * @return the name of the realm.
     */
    protected String getRealmName(IAMShieldSession session) {

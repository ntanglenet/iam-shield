...
import org.iamshield.urls.HostnameProvider;
import org.iamshield.urls.UrlType;

import java.net.URI;
import java.util.Optional;

import static org.iamshield.common.util.UriUtils.checkUrl;
import static org.iamshield.urls.UrlType.FRONTEND;
...
public class HostnameV2Provider implements HostnameProvider {
    ...
    public HostnameV2Provider(IAMShieldSession session, String hostname, URI hostnameUrl, URI adminUrl, Boolean backchannelDynamic) {

...
import org.iamshield.models.credential.dto.WebAuthnCredentialPresentationData;
...
public class WebAuthnCredentialProvider implements CredentialProvider<WebAuthnCredentialModel>, CredentialInputValidator {
    ...
    public WebAuthnCredentialProvider(IAMShieldSession session, WebAuthnMetadataService metadataService, ObjectConverter objectConverter) {
    ...
    protected IAMShieldSession getIAMShieldSession() {
        return session;
    }
    @Override

 ...
 */
package org.iamshield.jose.jws;
...
import org.iamshield.protocol.oidc.mappers.LogoutTokenMapper;
...
public class DefaultTokenManager implements TokenManager {
    ...
    public DefaultTokenManager(IAMShieldSession session) {
    ...
    private <T> T verifyJWS(ClientModel client, Class<T> clazz, JWSInput jws) {
        try {
            ...
            if (signatureProvider == null) {
                if (jws.getHeader().getAlgorithm().equals(org.iamshield.jose.jws.Algorithm.none)) {

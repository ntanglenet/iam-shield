...
public class ServerAsymmetricSignatureSignerContext extends AsymmetricSignatureSignerContext {
    ...
    public ServerAsymmetricSignatureSignerContext(IAMShieldSession session, String algorithm) throws SignatureException {
    ...
    static KeyWrapper getKey(IAMShieldSession session, String algorithm) {

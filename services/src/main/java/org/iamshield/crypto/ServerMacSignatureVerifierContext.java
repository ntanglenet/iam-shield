...
public class ServerMacSignatureVerifierContext extends MacSignatureVerifierContext {
    ...
    public ServerMacSignatureVerifierContext(IAMShieldSession session, String kid, String algorithm) throws VerificationException {
    ...
    private static KeyWrapper getKey(IAMShieldSession session, String kid, String algorithm) throws VerificationException {

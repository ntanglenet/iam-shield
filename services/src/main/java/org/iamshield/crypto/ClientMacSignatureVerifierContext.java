...
public class ClientMacSignatureVerifierContext extends MacSignatureVerifierContext {
    ...
    public ClientMacSignatureVerifierContext(IAMShieldSession session, ClientModel client, String algorithm) throws VerificationException {
        super(getKey(session, client, algorithm));
    }

    private static KeyWrapper getKey(IAMShieldSession session, ClientModel client, String algorithm) throws VerificationException {

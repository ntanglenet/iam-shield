...
public class ServerMacSignatureSignerContext extends MacSignatureSignerContext {
    ...
    public ServerMacSignatureSignerContext(IAMShieldSession session, String algorithm) throws SignatureException {
    ...
    private static KeyWrapper getKey(IAMShieldSession session, String algorithm) {

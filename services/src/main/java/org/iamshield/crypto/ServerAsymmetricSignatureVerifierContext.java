...
public class ServerAsymmetricSignatureVerifierContext extends AsymmetricSignatureVerifierContext {
    ...
    public ServerAsymmetricSignatureVerifierContext(IAMShieldSession session, String kid, String algorithm) throws VerificationException {
    ...
    static KeyWrapper getKey(IAMShieldSession session, String kid, String algorithm) throws VerificationException {

...
public class OAuth2IdentityProviderFactory extends AbstractIdentityProviderFactory<OAuth2IdentityProvider> {
    ...
    @Override
    public OAuth2IdentityProvider create(IAMShieldSession session, IdentityProviderModel model) {
    ...
    @Override
    public Map<String, String> parseConfig(IAMShieldSession session, String rawConfig) {

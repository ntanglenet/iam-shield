 ...
 */
package org.iamshield.broker.oidc;
...
import org.iamshield.broker.provider.ExchangeExternalToken;
...
import org.iamshield.crypto.MacSignatureSignerContext;
...
import org.iamshield.protocol.oidc.AccessTokenIntrospectionProviderFactory;
...
import org.iamshield.protocol.oidc.endpoints.TokenIntrospectionEndpoint;
...
public abstract class AbstractOAuth2IdentityProvider<C extends OAuth2IdentityProviderConfig> extends AbstractIdentityProvider<C> implements ExchangeTokenToIdentityProviderToken, ExchangeExternalToken {
    ...
    public AbstractOAuth2IdentityProvider(IAMShieldSession session, C config) {
    ...
    protected SimpleHttp getRefreshTokenRequest(IAMShieldSession session, String refreshToken, String clientId, String clientSecret) {
    ...
    private OAuthResponse refreshToken(OAuthResponse previousResponse, IAMShieldSession session) throws IOException {

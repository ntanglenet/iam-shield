...
import org.iamshield.representations.adapters.action.AdminAction;
 ...
 * @version $Revision: 1 $
 */
public class IAMShieldOIDCIdentityProvider extends OIDCIdentityProvider {

    public IAMShieldOIDCIdentityProvider(IAMShieldSession session, OIDCIdentityProviderConfig config) {
    ...
    public Object callback(RealmModel realm, AuthenticationCallback callback, EventBuilder event) {
        return new IAMShieldEndpoint(callback, realm, event, this);
    }

    protected static class IAMShieldEndpoint extends OIDCEndpoint {

        private IAMShieldOIDCIdentityProvider provider;

        public IAMShieldEndpoint(AuthenticationCallback callback, RealmModel realm, EventBuilder event,
                IAMShieldOIDCIdentityProvider provider) {
        ...
        public Response backchannelLogout(String input) {
            ...
            if (action.getIAMShieldSessionIds() != null) {
                for (String sessionId : action.getIAMShieldSessionIds()) {

...
public abstract class AbstractJsonUserAttributeMapper extends AbstractIdentityProviderMapper {
	...
	protected static final Logger LOGGER_DUMP_USER_PROFILE = Logger.getLogger("org.iamshield.social.user_profile_dump");
	 ...
	 *
	 * @see #preprocessFederatedIdentity(IAMShieldSession, RealmModel, IdentityProviderMapperModel, BrokeredIdentityContext)

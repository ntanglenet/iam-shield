...
public class OIDCIdentityProviderFactory extends AbstractIdentityProviderFactory<OIDCIdentityProvider> {
    ...
    @Override
    public OIDCIdentityProvider create(IAMShieldSession session, IdentityProviderModel model) {
    ...
    protected static Map<String, String> parseOIDCConfig(IAMShieldSession session, String configString) {

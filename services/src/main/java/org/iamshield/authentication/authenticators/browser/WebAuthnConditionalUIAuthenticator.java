...
public class WebAuthnConditionalUIAuthenticator extends WebAuthnPasswordlessAuthenticator {
    ...
    public WebAuthnConditionalUIAuthenticator(IAMShieldSession session, Function<AuthenticationFlowContext, Response> errorChallenge) {
        super(session);
    ...
    static public boolean isPasskeysEnabled(IAMShieldSession session) {

...
import org.iamshield.authentication.AbstractFormAuthenticator;
...
import static org.iamshield.services.validation.Validation.FIELD_PASSWORD;
...
public abstract class AbstractUsernameFormAuthenticator extends AbstractFormAuthenticator {
    ...
    private UserModel getUserFromForm(AuthenticationFlowContext context, MultivaluedMap<String, String> inputData) {
        ...
        UserModel user = null;
        try {
            user = IAMShieldModelUtils.findUserByNameOrEmail(context.getSession(), context.getRealm(), username);

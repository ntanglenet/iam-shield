...
import org.iamshield.scripting.InvocableScriptAdapter;
import org.iamshield.scripting.ScriptExecutionException;
 ...
 * <li>{@code session} the active {@link IAMShieldSession}</li>
 * <li>{@code authenticationSession} the current {@link org.iamshield.sessions.AuthenticationSessionModel}</li>
 * <li>{@code httpRequest} the current {@link org.iamshield.http.HttpRequest}</li>
 ...
 * {@code
 *
 *   AuthenticationFlowError = Java.type("org.iamshield.authentication.AuthenticationFlowError");
 *

...
import org.iamshield.authentication.actiontoken.idpverifyemail.IdpVerifyAccountLinkActionToken;
...
public class IdpEmailVerificationAuthenticator extends AbstractIdpAuthenticator {
    ...
    private void sendVerifyEmail(IAMShieldSession session, AuthenticationFlowContext context, UserModel existingUser, BrokeredIdentityContext brokerContext) throws UriBuilderException, IllegalArgumentException {

...
import static org.iamshield.authentication.authenticators.browser.ConditionalOtpFormAuthenticator.OtpDecision.ABSTAIN;
import static org.iamshield.authentication.authenticators.browser.ConditionalOtpFormAuthenticator.OtpDecision.SHOW_OTP;
import static org.iamshield.authentication.authenticators.browser.ConditionalOtpFormAuthenticator.OtpDecision.SKIP_OTP;
import static org.iamshield.models.utils.IAMShieldModelUtils.getRoleFromString;
...
public class ConditionalOtpFormAuthenticator extends OTPFormAuthenticator {
    ...
    private boolean isOTPRequired(IAMShieldSession session, RealmModel realm, UserModel user) {

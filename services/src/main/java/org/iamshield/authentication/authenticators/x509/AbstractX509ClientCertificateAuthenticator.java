...
import org.iamshield.common.crypto.UserIdentityExtractor;
import org.iamshield.common.crypto.UserIdentityExtractorProvider;
...
import org.iamshield.crypto.HashException;
...
public abstract class AbstractX509ClientCertificateAuthenticator implements Authenticator {
    ...
    protected static class CertificateValidatorConfigBuilder {
        ...
        static CertificateValidator.CertificateValidatorBuilder fromConfig(IAMShieldSession session, X509AuthenticatorConfigModel config) throws Exception {
    ...
    public CertificateValidator.CertificateValidatorBuilder certificateValidationParameters(IAMShieldSession session, X509AuthenticatorConfigModel config) throws Exception {

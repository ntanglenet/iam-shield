...
import org.iamshield.credential.WebAuthnCredentialModelInput;
import org.iamshield.credential.WebAuthnCredentialProvider;
import org.iamshield.credential.WebAuthnCredentialProviderFactory;
import org.iamshield.events.Details;
import org.iamshield.events.Errors;
import org.iamshield.forms.login.LoginFormsProvider;
import org.iamshield.forms.login.freemarker.model.WebAuthnAuthenticatorsBean;
...
import static org.iamshield.WebAuthnConstants.AUTH_ERR_DETAIL_LABEL;
import static org.iamshield.WebAuthnConstants.AUTH_ERR_LABEL;
import static org.iamshield.services.messages.Messages.*;
...
public class WebAuthnAuthenticator implements Authenticator, CredentialValidator<WebAuthnCredentialProvider> {
    ...
    public WebAuthnAuthenticator(IAMShieldSession session) {
    ...
    public List<RequiredActionFactory> getRequiredActions(IAMShieldSession session) {
        return Collections.singletonList((WebAuthnRegisterFactory)session.getIAMShieldSessionFactory().getProviderFactory(RequiredActionProvider.class, WebAuthnRegisterFactory.PROVIDER_ID));
    }
    ...
    @Override
    public WebAuthnCredentialProvider getCredentialProvider(IAMShieldSession session) {

...
public class CredentialDeleteHelper {
     ...
     */
    public static CredentialModel removeCredential(IAMShieldSession session, UserModel user, String credentialId, Supplier<Integer> currentLoAProvider) {
    ...
    private static void checkIfCanBeRemoved(IAMShieldSession session, UserModel user, String credentialType, Supplier<Integer> currentLoAProvider) {
    ...
    private static void checkAuthenticatedLoASufficientForCredentialRemove(IAMShieldSession session, String credentialType, Supplier<Integer> currentLoAProvider) {
    ...
    private static int getRequestedLoaForCredential(IAMShieldSession session, RealmModel realm, String credentialType) {

...
import org.iamshield.authentication.authenticators.client.ClientAuthUtil;
...
import org.iamshield.protocol.RestartLoginCookie;
...
public class AuthenticationProcessor {
    ...
    public AuthenticationProcessor setSession(IAMShieldSession session) {
    ...
    public static String getClientData(IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    public class Result implements AuthenticationFlowContext, ClientAuthenticationFlowContext {
        ...
        public AuthenticationExecutionModel.Requirement getCategoryRequirementFromCurrentFlow(String authenticatorCategory) {
            return realm.getAuthenticationExecutionsStream(execution.getParentFlow())
                    .filter(e -> {
                        AuthenticatorFactory factory = (AuthenticatorFactory) getSession().getIAMShieldSessionFactory()
    ...
    public static AuthenticationSessionModel recreate(IAMShieldSession session, AuthenticationSessionModel authSession) {
        AuthenticationSessionManager authenticationSessionManager =  new AuthenticationSessionManager(session);
    ...
    public static AuthenticationSessionModel clone(IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    public static ClientSessionContext attachSession(AuthenticationSessionModel authSession, UserSessionModel userSession, IAMShieldSession session, RealmModel realm, ClientConnection connection, EventBuilder event) {

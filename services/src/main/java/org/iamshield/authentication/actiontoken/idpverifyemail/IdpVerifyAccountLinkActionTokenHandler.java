 ...
 */
package org.iamshield.authentication.actiontoken.idpverifyemail;
...
import org.iamshield.authentication.authenticators.broker.IdpEmailVerificationAuthenticator;
...
public class IdpVerifyAccountLinkActionTokenHandler extends AbstractActionTokenHandler<IdpVerifyAccountLinkActionToken> {
    ...
    public Response handleToken(IdpVerifyAccountLinkActionToken token, ActionTokenContext<IdpVerifyAccountLinkActionToken> tokenContext) {
        ...
        final IAMShieldSession session = tokenContext.getSession();
    ...
    private void setUserVerifiedSingleObject(IdpVerifyAccountLinkActionToken token, RealmModel realm, IAMShieldSession session, UserModel user) {
    ...
    public static boolean runIfUserVerified(IAMShieldSession session, UserModel user, IdentityProviderModel broker, Runnable runnable) {
        if (user == null) {
            return false;
        }
    ...
    private Response sendEmailAlreadyVerified(IAMShieldSession session, EventBuilder event, UserModel user) {

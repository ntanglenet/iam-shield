...
public class FormAuthenticationFlow implements AuthenticationFlow {
    ...
    public Response processAction(String actionExecution) {
        ...
        for (AuthenticationExecutionModel formActionExecution : formActionExecutions) {
            ...
            FormActionFactory factory = (FormActionFactory)processor.getSession().getIAMShieldSessionFactory().getProviderFactory(FormAction.class, formActionExecution.getAuthenticator());

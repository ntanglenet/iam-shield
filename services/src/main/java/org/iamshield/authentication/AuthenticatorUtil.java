...
import org.iamshield.authentication.actiontoken.DefaultActionToken;
...
import static org.iamshield.services.managers.AuthenticationManager.FORCED_REAUTHENTICATION;
import static org.iamshield.services.managers.AuthenticationManager.SSO_AUTH;
import static org.iamshield.services.managers.AuthenticationManager.PASSWORD_VALIDATED;
...
public class AuthenticatorUtil {
    ...
    private static void logoutOtherSessions(IAMShieldSession session, RealmModel realm, UserModel user,
    ...
    private static void backchannelLogout(IAMShieldSession session, RealmModel realm, ClientConnection conn, HttpRequest req, EventBuilder event, UserSessionModel s) {
     ...
     */
    public static Stream<CredentialProvider> getCredentialProviders(IAMShieldSession session) {

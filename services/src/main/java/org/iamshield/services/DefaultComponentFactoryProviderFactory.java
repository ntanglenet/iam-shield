...
import org.iamshield.component.ComponentModelScope;
...
public class DefaultComponentFactoryProviderFactory implements ComponentFactoryProviderFactory {
    ...
    public <T extends Provider> ProviderFactory<T> getProviderFactory(Class<T> clazz, String realmId, String componentId, Function<IAMShieldSessionFactory, ComponentModel> modelGetter) {
        ...
        if (modelGetter == null) {
            ...
            cm = IAMShieldModelUtils.getComponentModel(factory, realmId, componentId);
        } else {
    ...
    private void propagateInvalidation(IAMShieldSession session, ConcurrentMap<String, ProviderFactory> componentsMap, InvalidableObjectType type, Object[] ids) {

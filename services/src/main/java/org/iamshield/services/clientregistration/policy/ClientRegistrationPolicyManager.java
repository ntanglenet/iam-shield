...
public class ClientRegistrationPolicyManager {
    ...
    public static void triggerBeforeView(IAMShieldSession session, ClientRegistrationProvider provider, RegistrationAuth authType, ClientModel client) throws ClientRegistrationPolicyException {
    ...
    public static void triggerBeforeRemove(IAMShieldSession session, ClientRegistrationProvider provider, RegistrationAuth authType, ClientModel client) throws ClientRegistrationPolicyException {
    ...
    private static void triggerPolicies(IAMShieldSession session, ClientRegistrationProvider provider, RegistrationAuth authType,
    ...
    private static void runPolicy(ComponentModel policyModel, IAMShieldSession session, ClientRegistrationProvider provider,
                           String opDescription, ClientRegOperation op) throws ClientRegistrationPolicyException {

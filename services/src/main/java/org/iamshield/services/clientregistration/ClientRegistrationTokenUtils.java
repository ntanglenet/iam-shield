...
package org.iamshield.services.clientregistration;
...
import org.iamshield.protocol.oidc.TokenManager.TokenRevocationCheck;
...
public class ClientRegistrationTokenUtils {
    ...
    public static String updateTokenSignature(IAMShieldSession session, ClientRegistrationAuth auth) {
    ...
    public static String updateRegistrationAccessToken(IAMShieldSession session, ClientModel client, RegistrationAuth registrationAuth) {
        return updateRegistrationAccessToken(session, session.getContext().getRealm(), client, registrationAuth);
    }

    public static String updateRegistrationAccessToken(IAMShieldSession session, RealmModel realm, ClientModel client, RegistrationAuth registrationAuth) {
    ...
    public static String createInitialAccessToken(IAMShieldSession session, RealmModel realm, ClientInitialAccessModel model) {
    ...
    public static TokenVerification verifyToken(IAMShieldSession session, RealmModel realm, String token) {
        if (token == null) {
    ...
    private static String setupToken(JsonWebToken jwt, IAMShieldSession session, RealmModel realm, String id, String type, long expiration) {
    ...
    private static String getIssuer(IAMShieldSession session, RealmModel realm) {

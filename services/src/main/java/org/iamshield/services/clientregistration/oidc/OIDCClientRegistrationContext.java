...
import org.iamshield.services.clientregistration.AbstractClientRegistrationContext;
...
public class OIDCClientRegistrationContext extends AbstractClientRegistrationContext {
    ...
    public OIDCClientRegistrationContext(IAMShieldSession session, ClientRepresentation client, ClientRegistrationProvider provider, OIDCClientRepresentation oidcRep) {

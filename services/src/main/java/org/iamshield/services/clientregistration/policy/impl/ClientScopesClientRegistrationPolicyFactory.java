...
import org.iamshield.services.clientregistration.policy.AbstractClientRegistrationPolicyFactory;
...
public class ClientScopesClientRegistrationPolicyFactory extends AbstractClientRegistrationPolicyFactory {
    ...
    @Override
    public ClientRegistrationPolicy create(IAMShieldSession session, ComponentModel model) {
    ...
    private List<String> getClientScopes(IAMShieldSession session) {

...
public abstract class BrowserHistoryHelper {
    ...
    public abstract Response saveResponseAndRedirect(IAMShieldSession session, AuthenticationSessionModel authSession, Response response, boolean actionRequest, HttpRequest httpRequest);

    public abstract Response loadSavedResponse(IAMShieldSession session, AuthenticationSessionModel authSession);


    protected boolean shouldReplaceBrowserHistory(boolean actionRequest, IAMShieldSession session) {
        if (actionRequest) {
            return true;
        }
    ...
    private static class JavascriptHistoryReplace extends BrowserHistoryHelper {
        ...
        @Override
        public Response saveResponseAndRedirect(IAMShieldSession session, AuthenticationSessionModel authSession, Response response, boolean actionRequest, HttpRequest httpRequest) {
        ...
        @Override
        public Response loadSavedResponse(IAMShieldSession session, AuthenticationSessionModel authSession) {
            return null;
        }

...
public class MtlsHoKTokenUtil {
    ...
    public static AccessToken.Confirmation bindTokenWithClientCertificate(HttpRequest request, IAMShieldSession session) {
    ...
    public static boolean verifyTokenBindingWithClientCertificate(AccessToken token, HttpRequest request, IAMShieldSession session) {
        if (token == null) {
    ...
    private static X509Certificate[] getCertificateChain(HttpRequest request, IAMShieldSession session) {
        try {

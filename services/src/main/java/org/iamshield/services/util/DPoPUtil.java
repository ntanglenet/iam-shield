...
import org.iamshield.exceptions.TokenVerificationException;
...
import static org.iamshield.utils.StringUtil.isNotBlank;
...
public class DPoPUtil {
     ...
     */
    public static void handleDPoPHeader(IAMShieldSession keycloakSession,
                                        EventBuilder event,
                                        Cors cors,
    ...
    private static DPoP validateDPoP(IAMShieldSession session, URI uri, String method, String token, String accessToken, int lifetime, int clockSkew) throws VerificationException {
    ...
    public static void validateDPoPJkt(String dpopJkt, IAMShieldSession session, EventBuilder event, Cors cors) {
        if (dpopJkt == null) {
    ...
    public static List<String> getDPoPSupportedAlgorithms(IAMShieldSession session) {
    ...
    private static class DPoPReplayCheck implements TokenVerifier.Predicate<DPoP> {
        ...
        public DPoPReplayCheck(IAMShieldSession session, int lifetime) {
    ...
    private static class DPoPIsActiveCheck implements TokenVerifier.Predicate<DPoP> {
        ...
        public DPoPIsActiveCheck(IAMShieldSession session, int lifetime, int clockSkew) {
            this.lifetime = lifetime;
    ...
    public static class Validator {
        ...
        public Validator(IAMShieldSession session) {
            this.session = session;
        }

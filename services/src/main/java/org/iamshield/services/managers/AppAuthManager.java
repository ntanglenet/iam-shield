...
public class AppAuthManager extends AuthenticationManager {
    ...
    public static class BearerTokenAuthenticator {
        ...
        public BearerTokenAuthenticator(IAMShieldSession session) {
            this.session = session;
        }

        public BearerTokenAuthenticator setSession(IAMShieldSession session) {
            this.session = session;
            return this;
        }
        ...
        public AuthResult authenticate() {
            IAMShieldContext ctx = session.getContext();

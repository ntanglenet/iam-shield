...
import org.iamshield.Token;
import org.iamshield.TokenCategory;
import org.iamshield.broker.provider.IdentityBrokerException;
...
import org.iamshield.TokenVerifier.TokenTypeCheck;
...
import org.iamshield.authentication.RequiredActionContextResult;
import org.iamshield.authentication.RequiredActionFactory;
import org.iamshield.authentication.RequiredActionProvider;
import org.iamshield.authentication.authenticators.browser.AbstractUsernameFormAuthenticator;
...
import org.iamshield.jose.jws.crypto.HashUtils;
import org.iamshield.models.IAMShieldContext;
import org.iamshield.models.SingleUseObjectKeyModel;
...
import org.iamshield.models.DefaultActionTokenKey;
...
import org.iamshield.models.utils.SessionExpirationUtils;
import org.iamshield.models.utils.SessionTimeoutHelper;
import org.iamshield.models.utils.SystemClientUtil;
import org.iamshield.protocol.LoginProtocol;
import org.iamshield.protocol.LoginProtocol.Error;
import org.iamshield.protocol.oidc.BackchannelLogoutResponse;
...
import org.iamshield.services.clientpolicy.context.LogoutRequestContext;
...
import org.iamshield.services.util.UserSessionUtil;
...
import static org.iamshield.models.UserSessionModel.CORRESPONDING_SESSION_ID;
import static org.iamshield.protocol.oidc.grants.device.DeviceGrantType.isOAuth2DeviceVerificationFlow;
...
public class AuthenticationManager {
    ...
    public static boolean expireUserSessionCookie(IAMShieldSession session, UserSessionModel userSession, RealmModel realm, UriInfo uriInfo, HttpHeaders headers, ClientConnection connection) {
        try {
    ...
    public static void backchannelLogout(IAMShieldSession session, UserSessionModel userSession, boolean logoutBroker) {
        backchannelLogout(
                session,
    ...
    public static BackchannelLogoutResponse backchannelLogout(IAMShieldSession session, RealmModel realm,
    ...
    public static AuthenticationSessionModel createOrJoinLogoutSession(IAMShieldSession session, RealmModel realm,
        ...
        if (rootLogoutSession != null) {
            ...
            authSessionId = IAMShieldModelUtils.generateId();
        }
    ...
    private static BackchannelLogoutResponse backchannelLogoutAll(IAMShieldSession session, RealmModel realm,
     ...
     */
    private static Response backchannelLogoutClientSession(IAMShieldSession session, RealmModel realm,
    ...
    private static Response frontchannelLogoutClientSession(IAMShieldSession session, RealmModel realm,
      AuthenticatedClientSessionModel clientSession, AuthenticationSessionModel logoutAuthSession,
     ...
     * @param headers
     */
    public static void backchannelLogoutUserFromClient(IAMShieldSession session, RealmModel realm, UserModel user, ClientModel client, UriInfo uriInfo, HttpHeaders headers) {
    ...
    public static Response browserLogout(IAMShieldSession session,
                                         RealmModel realm,
    ...
    private static Response browserLogoutAllClients(UserSessionModel userSession, IAMShieldSession session, RealmModel realm, HttpHeaders headers, UriInfo uriInfo, AuthenticationSessionModel logoutAuthSession, EventBuilder event) {
    ...
    public static Response finishBrowserLogout(IAMShieldSession session, RealmModel realm, UserSessionModel userSession, UriInfo uriInfo, ClientConnection connection, HttpHeaders headers) {
        final AuthenticationSessionManager asm = new AuthenticationSessionManager(session);
        AuthenticationSessionModel logoutAuthSession = createOrJoinLogoutSession(session, realm, asm, userSession, true, false);
    ...
    public static void finishUnconfirmedUserSession(IAMShieldSession session, RealmModel realm, UserSessionModel userSessionModel) {
    ...
    public static IdentityCookieToken createIdentityToken(IAMShieldSession keycloakSession, RealmModel realm, UserModel user, UserSessionModel session, String issuer) {
    ...
    public static void createLoginCookie(IAMShieldSession keycloakSession, RealmModel realm, UserModel user, UserSessionModel session, UriInfo uriInfo, ClientConnection connection) {
    ...
    public static void createRememberMeCookie(String username, UriInfo uriInfo, IAMShieldSession session) {
    ...
    public static String getRememberMeUsername(IAMShieldSession session) {
    ...
    public static void expireIdentityCookie(IAMShieldSession session) {
    ...
    public static void expireRememberMeCookie(IAMShieldSession session) {
        session.getProvider(CookieProvider.class).expire(CookieType.LOGIN_HINT);
    }

    public static void expireAuthSessionCookie(IAMShieldSession session) {
    ...
    public AuthResult authenticateIdentityCookie(IAMShieldSession session, RealmModel realm) {
        return authenticateIdentityCookie(session, realm, true);
    }

    public static AuthResult authenticateIdentityCookie(IAMShieldSession session, RealmModel realm, boolean checkActive) {
        String tokenString = session.getProvider(CookieProvider.class).get(CookieType.IDENTITY);
    ...
    public static Response redirectAfterSuccessfulFlow(IAMShieldSession session, RealmModel realm, UserSessionModel userSession,
     ...
     */
    public static boolean compareSessionIdWithSessionCookie(IAMShieldSession session, String sessionId) {
    ...
    public static Response nextActionAfterAuthentication(IAMShieldSession session, AuthenticationSessionModel authSession,
    ...
    private static Response nextActionAfterAuthentication(IAMShieldSession session, AuthenticationSessionModel authSession,
                                                  ClientConnection clientConnection,
                                                  HttpRequest request, UriInfo uriInfo, EventBuilder event,
    ...
    public static Response redirectToRequiredActions(IAMShieldSession session, RealmModel realm, AuthenticationSessionModel authSession, UriInfo uriInfo, String requiredAction) {
    ...
    public static Response finishedRequiredActions(IAMShieldSession session, AuthenticationSessionModel authSession, UserSessionModel userSession,
    ...
    public static String nextRequiredAction(final IAMShieldSession session, final AuthenticationSessionModel authSession,
    ...
    private static UserConsentModel getEffectiveGrantedConsent(IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    private static Response actionRequired(final IAMShieldSession session, final AuthenticationSessionModel authSession,
    ...
    private static List<AuthorizationDetails> getClientScopesToApproveOnConsentScreen(UserConsentModel grantedConsent, IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    private static Stream<AuthorizationDetails> getClientScopeModelStream(IAMShieldSession session) {
        ...
        return authSession.getClientScopes().stream()
                .map(scopeId -> IAMShieldModelUtils.findClientScopeById(authSession.getRealm(), authSession.getClient(), scopeId))
                .map(AuthorizationDetails::new);
    }


    public static void setClientScopesInSession(IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    protected static Response executionActions(IAMShieldSession session, AuthenticationSessionModel authSession,
    ...
    private static Response executeAction(IAMShieldSession session, AuthenticationSessionModel authSession, RequiredActionProviderModel model,
                                          HttpRequest request, EventBuilder event, RealmModel realm, UserModel user, boolean kcActionExecution,
                                          Set<String> ignoredActions) {
        RequiredActionFactory factory = (RequiredActionFactory) session.getIAMShieldSessionFactory()
    ...
    public static void evaluateRequiredActionTriggers(final IAMShieldSession session, final AuthenticationSessionModel authSession,
                                                      final HttpRequest request, final EventBuilder event,
                                                      final RealmModel realm, final UserModel user) {
        evaluateRequiredActionTriggers(session, authSession, request, event, realm, user, new HashSet<>());
    }

    private static void evaluateRequiredActionTriggers(final IAMShieldSession session, final AuthenticationSessionModel authSession,
                                                      final HttpRequest request, final EventBuilder event,
    ...
    private static void evaluateRequiredAction(final IAMShieldSession session, final AuthenticationSessionModel authSession,
    ...
    private static RequiredActionFactory toRequiredActionFactory(IAMShieldSession session, RequiredActionProviderModel model, RealmModel realm) {
        RequiredActionFactory factory = (RequiredActionFactory) session.getIAMShieldSessionFactory()
                .getProviderFactory(RequiredActionProvider.class, model.getProviderId());
        if (factory == null) {
    ...
    public static AuthResult verifyIdentityToken(IAMShieldSession session, RealmModel realm, UriInfo uriInfo, ClientConnection connection, boolean checkActive, boolean checkTokenType,
        ...
        try {
            ...
            Consumer<UserSessionModel> invalidUserSessionCallback = (userSession) -> {
                ...
                IAMShieldModelUtils.runJobInTransaction(session.getIAMShieldSessionFactory(), context, newSession -> {
    ...
    public static void resolveLightweightAccessTokenRoles(IAMShieldSession session, AccessToken accessToken, RealmModel realm) {
    ...
    public static void logSuccess(IAMShieldSession session, AuthenticationSessionModel authSession) {
    ...
    public static UserModel lookupUserForBruteForceLog(IAMShieldSession session, RealmModel realm, AuthenticationSessionModel authenticationSession) {
        UserModel user = authenticationSession.getAuthenticatedUser();
        if (user != null) return user;

        String username = authenticationSession.getAuthNote(AbstractUsernameFormAuthenticator.ATTEMPTED_USERNAME);
        if (username != null) {
            return IAMShieldModelUtils.findUserByNameOrEmail(session, realm, username);
        }
    ...
    public static String getRequestedScopes(IAMShieldSession session) {
        return getRequestedScopes(session, session.getContext().getClient());
    }

    public static String getRequestedScopes(IAMShieldSession session, ClientModel client) {
        IAMShieldContext context = session.getContext();

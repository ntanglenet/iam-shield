...
import org.iamshield.models.utils.SessionExpiration;
...
public class AuthenticationSessionManager {
    ...
    public AuthenticationSessionManager(IAMShieldSession session) {
    ...
    AuthSessionId decodeAuthSessionId(String encodedAuthSessionId) {
        ...
        if (!IAMShieldModelUtils.isValidUUID(decodedAuthSessionId)) {

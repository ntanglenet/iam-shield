...
public class UserSessionCrossDCManager {
    ...
    public UserSessionCrossDCManager(IAMShieldSession session) {
    ...
    /**
     * @deprecated To be removed in Keycloak 27+. Use
     * {@link UserSessionUtil#getUserSessionWithImpersonatorClient(IAMShieldSession, RealmModel, String, boolean, String)}
     */
    @Deprecated(since = "26", forRemoval = true)

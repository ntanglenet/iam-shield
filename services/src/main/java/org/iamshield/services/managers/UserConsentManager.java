...
public class UserConsentManager {
     ...
     */
    public static boolean revokeConsentToClient(IAMShieldSession session, ClientModel client, UserModel user) {
     ...
     */
    public static void addConsent(IAMShieldSession session, RealmModel realm, UserModel user, UserConsentModel consent) {
     ...
     */
    public static UserConsentModel getConsentByClient(IAMShieldSession session, RealmModel realm, UserModel user, String clientInternalId) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
     ...
     */
    public static Stream<UserConsentModel> getConsentsStream(IAMShieldSession session, RealmModel realm, UserModel user) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
     ...
     */
    public static void updateConsent(IAMShieldSession session, RealmModel realm, UserModel user, UserConsentModel consent) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;
     ...
     */
    public static boolean revokeConsentForClient(IAMShieldSession session, RealmModel realm, UserModel user, String clientInternalId) {
        if (isLightweightUser(user)) {
            LightweightUserAdapter lua = (LightweightUserAdapter) user;

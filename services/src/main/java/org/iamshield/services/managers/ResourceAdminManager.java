...
public class ResourceAdminManager {
    ...
    public ResourceAdminManager(IAMShieldSession session) {
        this.session = session;
    }

    public static String resolveUri(IAMShieldSession session, String rootUrl, String uri) {
        return ResolveRelative.resolveRelativeUri(session, rootUrl, uri);

   }

    public static String getManagementUrl(IAMShieldSession session, ClientModel client) {
    ...
    private List<String> getAllManagementUrls(ClientModel client) {
        ...
        IAMShieldUriBuilder uriBuilder = IAMShieldUriBuilder.fromUri(baseMgmtUrl);
    ...
    public static String getBackchannelLogoutUrl(IAMShieldSession session, ClientModel client) {

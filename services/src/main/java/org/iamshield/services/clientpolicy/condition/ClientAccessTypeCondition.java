...
public class ClientAccessTypeCondition extends AbstractClientPolicyConditionProvider<ClientAccessTypeCondition.Configuration> {
    ...
    public ClientAccessTypeCondition(IAMShieldSession session) {
        super(session);
    }
    ...
    public String getProviderId() {
        return CliAccessTypeConditionFactory.PROVIDER_ID;
    }
    ...
    private String getClientAccessType(boolean isPublicClient, boolean isBearerOnly) {
        if (isPublicClient) return CliAccessTypeConditionFactory.TYPE_PUBLIC;
        if (isBearerOnly) return CliAccessTypeConditionFactory.TYPE_BEARERONLY;
        else return CliAccessTypeConditionFactory.TYPE_CONFIDENTIAL;
    }

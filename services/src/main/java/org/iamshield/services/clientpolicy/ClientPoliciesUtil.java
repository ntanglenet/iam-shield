...
package org.iamshield.services.clientpolicy;
...
import org.iamshield.component.JsonConfigComponentModel;
...
import org.iamshield.services.clientpolicy.executor.ClientPolicyExecutorProvider;
...
public class ClientPoliciesUtil {
    ...
    public static List<ClientProfileRepresentation> readGlobalClientProfilesRepresentation(IAMShieldSession session, String name) throws ClientPolicyException {
        if (name == null) {
    ...
    public static List<ClientPolicyRepresentation> readGlobalClientPoliciesRepresentation(IAMShieldSession session, String name,
     ...
     * not return null.
     */
    static ClientProfilesRepresentation getClientProfilesRepresentation(IAMShieldSession session, RealmModel realm) throws ClientPolicyException {
     ...
     */
    static ClientProfile getClientProfileModel(IAMShieldSession session, RealmModel realm, ClientProfilesRepresentation profilesRep, List<ClientProfileRepresentation> globalClientProfiles, String profileName) throws ClientPolicyException {
    ...
    private static ClientPolicyExecutorProvider getExecutorProvider(IAMShieldSession session, RealmModel realm, String providerId, JsonNode config) {
     ...
     * not return null.
     */
    static List<ClientProfileRepresentation> getValidatedGlobalClientProfilesRepresentation(IAMShieldSession session, InputStream is) throws ClientPolicyException {
     ...
     * not return null.
     */
    static List<ClientPolicyRepresentation> getValidatedGlobalClientPoliciesRepresentation(IAMShieldSession session, InputStream is, List<ClientProfileRepresentation> profiles) throws ClientPolicyException {
     ...
     * not return null.
     */
    static ClientProfilesRepresentation getValidatedClientProfilesForUpdate(IAMShieldSession session, RealmModel realm,
     ...
     * not return null.
     */
    private static boolean isValidExecutor(IAMShieldSession session, ClientPolicyExecutorRepresentation executorRep) {
     ...
     * not return null.
     */
    static ClientPoliciesRepresentation getClientPoliciesRepresentation(IAMShieldSession session, RealmModel realm) throws ClientPolicyException {
    ...
    static List<ClientProfileRepresentation> getGlobalClientProfiles(IAMShieldSession session) {
    ...
    static List<ClientPolicyRepresentation> getGlobalClientPolicies(IAMShieldSession session) {
        SecurityProfileProvider securityProfile = session.getProvider(SecurityProfileProvider.class);
     ...
     * not return null.
     */
    static List<ClientPolicy> getEnabledClientPolicies(IAMShieldSession session, RealmModel realm) {
    ...
    private static ClientPolicyConditionProvider getConditionProvider(IAMShieldSession session, RealmModel realm, String providerId, JsonNode config) {
     ...
     */
    static private List<ClientPolicyRepresentation> validatePolicies(IAMShieldSession session, List<ClientPolicyRepresentation> proposedPoliciesRepList,
     ...
     */
    static ClientPoliciesRepresentation getValidatedClientPoliciesForUpdate(IAMShieldSession session, RealmModel realm,
     ...
     * not return null.
     */
    private static boolean isValidCondition(IAMShieldSession session, String conditionProviderId) {
    ...
    private static void validateConditionConfig(IAMShieldSession session, ClientPolicyConditionRepresentation conditionRep) throws ClientPolicyException {
        CliPolicyConditionProviFactory factory = getClientPolicyConditionFactory(session, conditionRep.getConditionProviderId());
        try {
    ...
    private static CliPolicyConditionProviFactory getClientPolicyConditionFactory(IAMShieldSession session, String providerId) {
        ...
        return (CliPolicyConditionProviFactory) f;
    }

 ...
 */
public class AuthenticationFlowSelectorExecutorFactory implements ClientPolicyExectrProviFactory {
    ...
    @Override
    public AuthenticationFlowSelectorExecutor create(IAMShieldSession session) {

...
import org.iamshield.protocol.oidc.endpoints.request.AuthzEndpointRequestObjectParser;
import org.iamshield.protocol.oidc.endpoints.request.AuthzEndpointRequestParser;
...
public class SecureParContentsExecutor implements ClientPolicyExecutorProvider<ClientPolicyExecutorConfigurationRepresentation> {
    ...
    public SecureParContentsExecutor(IAMShieldSession session) {

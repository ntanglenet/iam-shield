...
import static org.iamshield.services.clientpolicy.executor.ClientSecretRotationExecutorFactory.DEFAULT_SECRET_EXPIRATION_PERIOD;
import static org.iamshield.services.clientpolicy.executor.ClientSecretRotationExecutorFactory.DEFAULT_SECRET_REMAINING_ROTATION_PERIOD;
import static org.iamshield.services.clientpolicy.executor.ClientSecretRotationExecutorFactory.DEFAULT_SECRET_ROTATED_EXPIRATION_PERIOD;
...
public class ClientSecretRotationExecutor implements
    ...
    public ClientSecretRotationExecutor(IAMShieldSession session) {
    ...
    private void rotateSecret(ClientCRUDContext crudContext,
        ...
        if (crudContext instanceof ClientSecretRotationContext) {
            ...
            IAMShieldModelUtils.generateSecret(crudContext.getTargetClient());
            updateClientConfigProperties(clientConfigWrapper);
        }

...
import org.iamshield.protocol.oidc.TokenExchangeContext;
import org.iamshield.protocol.oidc.endpoints.request.AuthorizationEndpointRequest;
import org.iamshield.protocol.oidc.grants.ciba.channel.CIBAAuthenticationRequest;
import org.iamshield.protocol.oidc.grants.ciba.clientpolicy.context.BackchannelAuthenticationRequestContext;
import org.iamshield.protocol.oidc.grants.ciba.clientpolicy.context.BackchannelTokenRequestContext;
import org.iamshield.protocol.oidc.grants.ciba.clientpolicy.context.BackchannelTokenResponseContext;
...
import org.iamshield.services.clientpolicy.context.AuthorizationRequestContext;
import org.iamshield.services.clientpolicy.context.ServiceAccountTokenRequestContext;
import org.iamshield.services.clientpolicy.context.ServiceAccountTokenResponseContext;
import org.iamshield.services.clientpolicy.context.TokenExchangeRequestContext;
import org.iamshield.services.clientpolicy.context.TokenRequestContext;
import org.iamshield.services.clientpolicy.context.TokenResponseContext;
...
public class ClientScopesCondition extends AbstractClientPolicyConditionProvider<ClientScopesCondition.Configuration> {
    ...
    public ClientScopesCondition(IAMShieldSession session) {
        super(session);
    }
    ...
    public String getProviderId() {
        return CliScopesConditionFactory.PROVIDER_ID;
    }
    ...
    private boolean isScopeMatched(String explicitScopes, ClientModel client) {
        ...
        switch (configuration.getType()) {
            case CliScopesConditionFactory.DEFAULT:
                expectedScopes.retainAll(defaultScopes);
                return !expectedScopes.isEmpty();

            case CliScopesConditionFactory.OPTIONAL:
            ...
            case CliScopesConditionFactory.ANY:
                explicitSpecifiedScopes.retainAll(expectedScopes);
                explicitSpecifiedScopes.retainAll(optionalScopes);
                expectedScopes.retainAll(defaultScopes);

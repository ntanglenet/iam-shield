 ...
 */
public class CliScopesConditionFactory extends AbstractCliPolicyConditionProviFactory {
    ...
    @Override
    public void validateConfiguration(IAMShieldSession session, RealmModel realm, ClientPolicyConditionRepresentation conditionRepresentation) throws ClientPolicyException {

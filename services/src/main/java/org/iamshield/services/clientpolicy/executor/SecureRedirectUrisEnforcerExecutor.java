...
import org.iamshield.services.clientpolicy.executor.SecureRedirectUrisEnforcerExecutorFactory.UriType;
...
public class SecureRedirectUrisEnforcerExecutor implements ClientPolicyExecutorProvider<SecureRedirectUrisEnforcerExecutor.Configuration> {
    ...
    public SecureRedirectUrisEnforcerExecutor(IAMShieldSession session) {

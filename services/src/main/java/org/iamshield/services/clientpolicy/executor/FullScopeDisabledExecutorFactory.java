 ...
 */
public class FullScopeDisabledExecutorFactory implements ClientPolicyExectrProviFactory {
    ...
    @Override
    public FullScopeDisabledExecutor create(IAMShieldSession session) {

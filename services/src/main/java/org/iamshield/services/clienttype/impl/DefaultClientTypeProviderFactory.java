...
package org.iamshield.services.clienttype.impl;
...
import org.iamshield.client.clienttype.ClientTypeProviderFactory;
...
public class DefaultClientTypeProviderFactory implements ClientTypeProviderFactory, EnvironmentDependentProviderFactory {
    ...
    @Override
    public ClientTypeProvider create(IAMShieldSession session) {

...
public class AttackDetectionResource {
    ...
    public AttackDetectionResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.ATTACK_DETECTION)
    ...
    private boolean isUserDisabledOrLockedByBruteForce(IAMShieldSession session, RealmModel realm, UserModel user) {

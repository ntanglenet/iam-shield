...
import static org.iamshield.utils.StreamsUtil.throwIfEmpty;
...
public class RealmsAdminResource {
    ...
    public RealmsAdminResource(IAMShieldSession session, AdminAuth auth, TokenManager tokenManager) {

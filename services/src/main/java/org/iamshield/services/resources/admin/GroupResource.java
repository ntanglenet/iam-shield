...
public class GroupResource {
    ...
    public GroupResource(RealmModel realm, GroupModel group, IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
        this.realm = realm;
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.GROUPS)
    @Operation()
    ...
    public static void updateGroup(GroupRepresentation rep, GroupModel model, RealmModel realm, IAMShieldSession session) {
        String newName = rep.getName();
        if (newName != null) {
            String existingName = model.getName();
            if (!newName.equals(existingName)) {
                String previousPath = IAMShieldModelUtils.buildGroupPath(model);

                model.setName(newName);

                String newPath = IAMShieldModelUtils.buildGroupPath(model);

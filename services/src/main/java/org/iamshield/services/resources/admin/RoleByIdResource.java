...
public class RoleByIdResource extends RoleResource {
    ...
    public RoleByIdResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.ROLES_BY_ID)

...
import static org.iamshield.utils.CredentialHelper.createUserStorageCredentialRepresentation;
...
public class AccountCredentialResource {
    ...
    public AccountCredentialResource(IAMShieldSession session, UserModel user, Auth auth, EventBuilder event) {

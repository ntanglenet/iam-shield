...
public class ClientScopeEvaluateScopeMappingsResource {
    ...
    public ClientScopeEvaluateScopeMappingsResource(IAMShieldSession session, RoleContainerModel roleContainer, AdminPermissionEvaluator auth, ClientModel client,
                                                    String scopeParam) {
    ...
    private Stream<RoleModel> getGrantedRoles(IAMShieldSession session) {

...
public class AdminConsole {
    ...
    public AdminConsole(IAMShieldSession session) {
    ...
    public Response getMainPage() throws IOException, FreeMarkerException {
        ...
        if (!adminUriInfo.getRequestUri().getPath().endsWith("/")) {
            ...
            if (theme == null) {
                final var minimalHtml = "<!doctype html><html><head><meta charset=\"utf-8\"><title>Admin Console</title></head><body><h1>Theme not available</h1><p>The ADMIN theme could not be loaded. Verify the configured admin theme exists or remove the invalid theme configuration. Falling back to minimal page.</p></body></html>";
            ...
            map.put("resourceCommonUrl", Urls.themeRoot(adminBaseUri).getPath() + "/common/iamshield");

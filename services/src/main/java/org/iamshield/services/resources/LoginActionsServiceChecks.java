...
import org.iamshield.sessions.CommonClientSessionModel.Action;
...
public class LoginActionsServiceChecks {
     ...
     */
    public static void checkIsUserValid(IAMShieldSession session, RealmModel realm, String userId, Consumer<UserModel> userSetter, EventBuilder event) throws VerificationException {
     ...
     */
    public static void checkIsClientValid(IAMShieldSession session, ClientModel client) throws VerificationException {
        if (client == null) {

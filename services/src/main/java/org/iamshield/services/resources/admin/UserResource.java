...
import org.iamshield.authentication.actiontoken.execactions.ExecuteActionsActionToken;
import org.iamshield.authentication.actiontoken.verifyemail.VerifyEmailActionToken;
import org.iamshield.authentication.requiredactions.util.RequiredActionsValidator;
...
public class UserResource {
    ...
    public UserResource(IAMShieldSession session, UserModel user, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.USERS)
    ...
    public static Response validateUserProfile(UserProfile profile, IAMShieldSession session, AdminAuth adminAuth) {
        try {
            profile.validate();
    ...
    public static void updateUserFromRep(UserProfile profile, UserModel user, UserRepresentation rep, IAMShieldSession session, boolean isUpdateExistingUser) {
        ...
        if (reqActions != null) {
            session.getIAMShieldSessionFactory()

...
public class ClientInitialAccessResource {
    ...
    public ClientInitialAccessResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.CLIENT_INITIAL_ACCESS)

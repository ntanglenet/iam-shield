...
import org.iamshield.representations.idm.PublishedRealmRepresentation;
...
public class PublicRealmResource {
    ...
    public PublicRealmResource(IAMShieldSession session) {
    ...
    public static PublishedRealmRepresentation realmRep(IAMShieldSession session, RealmModel realm, UriInfo uriInfo) {

...
import org.iamshield.representations.idm.AuthenticatorConfigInfoRepresentation;
...
import org.iamshield.representations.idm.RequiredActionConfigInfoRepresentation;
import org.iamshield.representations.idm.RequiredActionConfigRepresentation;
...
public class AuthenticationManagementResource {
    ...
    public AuthenticationManagementResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.AUTHENTICATION_MANAGEMENT)
    ...
    public Stream<Map<String, Object>> getFormProviders() {
        ...
        return buildProviderMetadata(session.getIAMShieldSessionFactory().getProviderFactoriesStream(FormAuthenticator.class));
    }
    ...
    public Stream<Map<String, Object>> getAuthenticatorProviders() {
        ...
        return buildProviderMetadata(session.getIAMShieldSessionFactory().getProviderFactoriesStream(Authenticator.class));
    }
    ...
    public Stream<Map<String, Object>> getClientAuthenticatorProviders() {
        ...
        Stream<ProviderFactory> factories =  session.getIAMShieldSessionFactory().getProviderFactoriesStream(ClientAuthenticator.class);
    ...
    public Stream<Map<String, Object>> getFormActionProviders() {
        ...
        return buildProviderMetadata(session.getIAMShieldSessionFactory().getProviderFactoriesStream(FormAction.class));
    }
    ...
    public void deleteFlow(@Parameter(description = "Flow id") @PathParam("id") String id) {
        ...
        IAMShieldModelUtils.deepDeleteAuthenticationFlow(session, realm, flow,
    ...
    public static AuthenticationFlowModel copyFlow(IAMShieldSession session, RealmModel realm, AuthenticationFlowModel flow, String newName) {
    ...
    public static void copy(IAMShieldSession session, RealmModel realm, String newName, AuthenticationFlowModel from, AuthenticationFlowModel to) {
    ...
    private ProviderFactory getProviderFactory(AuthenticationFlowModel parentFlow, String provider) {
        ...
        if (parentFlow.getProviderId().equals(AuthenticationFlow.CLIENT_FLOW)) {
            f = session.getIAMShieldSessionFactory().getProviderFactory(ClientAuthenticator.class, provider);
        } else if (parentFlow.getProviderId().equals(AuthenticationFlow.FORM_FLOW)) {
            f = session.getIAMShieldSessionFactory().getProviderFactory(FormAction.class, provider);
        } else {
            f = session.getIAMShieldSessionFactory().getProviderFactory(Authenticator.class, provider);
        }
        if (f == null) {
    ...
    public void removeExecution(@Parameter(description = "Execution id") @PathParam("executionId") String execution) {
        ...
        IAMShieldModelUtils.deepDeleteAuthenticationExecutor(session, realm, model,
                () -> {}, // allow deleting even with missing references
                () -> {
                    throw new BadRequestException("It is illegal to remove execution from a built in flow");
                }
    ...
    public Stream<Map<String, String>> getUnregisteredRequiredActions() {
        ...
        return session.getIAMShieldSessionFactory().getProviderFactoriesStream(RequiredActionProvider.class)
    ...
    public void registerRequiredAction(@Parameter(description = "JSON containing 'providerId', and 'name' attributes.") Map<String, String> data) {
        ...
        if (providerId == null || session.getIAMShieldSessionFactory().getProviderFactory(RequiredActionProvider.class, providerId) == null) {
    ...
    public Map<String, List<ConfigPropertyRepresentation>> getPerClientConfigDescription() {
        ...
        return session.getIAMShieldSessionFactory().getProviderFactoriesStream(ClientAuthenticator.class)

...
import org.iamshield.common.util.MimeTypeUtil;
...
public class WelcomeResource {
    ...
    private Response createWelcomePage(String successMessage, String errorMessage) {
        try {
            ...
            String commonPath = themeProperties.getProperty("common", "common/iamshield");
    ...
    public static boolean isLocal(IAMShieldSession session) {

...
public class ComponentResource {
    ...
    public ComponentResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @NoCache
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.COMPONENT)
    @Operation()
    ...
    public Stream<ComponentTypeRepresentation> getSubcomponentConfig(@PathParam("id") String parentId, @QueryParam("type") String subtype) {
        ...
        return session.getIAMShieldSessionFactory().getProviderFactoriesStream(providerClass)

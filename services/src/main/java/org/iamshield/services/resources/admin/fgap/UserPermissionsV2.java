...
import org.iamshield.services.resources.admin.fgap.ModelRecord.UserModelRecord;

class UserPermissionsV2 extends UserPermissions {

    private final FineGrainedAdminPermissionEvaluator eval;

    UserPermissionsV2(IAMShieldSession session, AuthorizationProvider authz, MgmtPermissionsV2 root) {

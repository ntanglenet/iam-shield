...
import static org.iamshield.authorization.fgap.AdminPermissionsSchema.CLIENTS_RESOURCE_TYPE;
...
import org.iamshield.services.resources.admin.fgap.ModelRecord.ClientModelRecord;
...
class ClientPermissionsV2 extends ClientPermissions {
    ...
    ClientPermissionsV2(IAMShieldSession session, RealmModel realm, AuthorizationProvider authz, MgmtPermissionsV2 root) {

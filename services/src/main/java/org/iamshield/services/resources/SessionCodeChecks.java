...
import static org.iamshield.services.managers.AuthenticationManager.authenticateIdentityCookie;
...
public class SessionCodeChecks {
    ...
    public SessionCodeChecks(RealmModel realm, UriInfo uriInfo, HttpRequest request, ClientConnection clientConnection, IAMShieldSession session, EventBuilder event,

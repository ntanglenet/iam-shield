...
/**
 * Class of constants relating to the OpenAPI annotations in IAMShield and the IAMShield Admin REST API
 */
public class IAMShieldOpenAPI {

    private IAMShieldOpenAPI() { }

...
import org.iamshield.forms.login.freemarker.DetachedInfoStateChecker;
import org.iamshield.forms.login.freemarker.DetachedInfoStateCookie;
...
import org.iamshield.authentication.ExplainedVerificationException;
...
import org.iamshield.authentication.actiontoken.ActionTokenHandler;
import org.iamshield.models.DefaultActionTokenKey;
import org.iamshield.authentication.actiontoken.ExplainedTokenVerificationException;
import org.iamshield.authentication.actiontoken.resetcred.ResetCredentialsActionTokenHandler;
import org.iamshield.authentication.authenticators.broker.AbstractIdpAuthenticator;
import org.iamshield.authentication.authenticators.broker.util.PostBrokerLoginConstants;
...
import org.iamshield.common.util.TriFunction;
...
import org.iamshield.exceptions.TokenNotActiveException;
...
import org.iamshield.protocol.oidc.grants.device.DeviceGrantType;
...
import org.iamshield.services.util.AuthenticationFlowURLHelper;
import org.iamshield.services.util.BrowserHistoryHelper;
import org.iamshield.services.util.CacheControlUtil;
import org.iamshield.services.util.LocaleUtil;
...
import static org.iamshield.authentication.actiontoken.DefaultActionToken.ACTION_TOKEN_BASIC_CHECKS;
...
public class LoginActionsService {
    ...
    public LoginActionsService(IAMShieldSession session, EventBuilder event) {
    ...
    protected <T extends JsonWebToken & SingleUseObjectKeyModel> Response handleActionToken(String tokenString, String execution, String clientId, String tabId, String clientData, 
        ...
        IAMShieldContext sessionContext = session.getContext();
    ...
    public static Response redirectToAfterBrokerLoginEndpoint(IAMShieldSession session, RealmModel realm, UriInfo uriInfo, AuthenticationSessionModel authSession, boolean firstBrokerLogin) {
    ...
    public Response processConsent() {
        ...
        for (String clientScopeId : authSession.getClientScopes()) {
            ClientScopeModel clientScope = IAMShieldModelUtils.findClientScopeById(realm, client, clientScopeId);
            if (clientScope != null) {
    ...
    private Response processRequireAction(final String authSessionId, final String code, String action, String clientId, String tabId, String clientData) {
        ...
        RequiredActionFactory factory = (RequiredActionFactory)session.getIAMShieldSessionFactory().getProviderFactory(RequiredActionProvider.class, getDefaultRequiredActionCaseInsensitively(action));
        if (factory == null) {

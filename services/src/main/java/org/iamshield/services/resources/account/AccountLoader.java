...
import org.iamshield.protocol.oidc.AccessTokenIntrospectionProvider;
import org.iamshield.protocol.oidc.AccessTokenIntrospectionProviderFactory;
import org.iamshield.protocol.oidc.TokenIntrospectionProvider;
...
public class AccountLoader {
    ...
    public AccountLoader(IAMShieldSession session, EventBuilder event) {
    ...
    private Theme getTheme(IAMShieldSession session) {
        try {

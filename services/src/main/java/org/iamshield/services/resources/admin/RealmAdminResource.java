...
import org.iamshield.KeyPairVerifier;
...
import org.iamshield.email.EmailAuthenticator;
...
import org.iamshield.exportimport.ClientDescriptionConverterFactory;
...
import org.iamshield.models.ModelIllegalStateException;
...
import org.iamshield.organization.admin.resource.OrganizationsResource;
import org.iamshield.partialimport.PartialImportResult;
import org.iamshield.partialimport.PartialImportResults;
import org.iamshield.workflow.admin.resource.WorkflowsResource;
import org.iamshield.representations.adapters.action.GlobalRequestResult;
...
import org.iamshield.representations.idm.ManagementPermissionReference;
...
import org.iamshield.services.util.DateUtil;
...
import org.iamshield.utils.GroupUtils;
...
import static org.iamshield.util.JsonSerialization.readValue;
...
public class RealmAdminResource {
    ...
    public RealmAdminResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    public ClientRepresentation convertClientDescription(String description) {
        ...
        return session.getIAMShieldSessionFactory().getProviderFactoriesStream(ClientDescriptionConverter.class)
    ...
    public Response updateRealm(final RealmRepresentation rep) {
        ...
        try {
            ...
            // This populates the map in DefaultIAMShieldContext to be used when treating the event
            ...
            throw ErrorResponse.error(e.getMessage(), Status.BAD_REQUEST);
        } catch (org.iamshield.services.ErrorResponseException e) {
            throw e;
        } catch (Exception e) {
            logger.error(e.getMessage(), e);
    ...
    public Response partialImport(InputStream requestBody) {
        ...
        try {
            return Response.ok(
                    IAMShieldModelUtils.runJobInTransactionWithResult(session.getIAMShieldSessionFactory(), session.getContext(), kcSession -> {
    ...
    private static PartialImportResults getPartialImportResults(InputStream requestBody, IAMShieldSession kcSession, RealmModel kcRealm, AdminEventBuilder adminEventClone) {

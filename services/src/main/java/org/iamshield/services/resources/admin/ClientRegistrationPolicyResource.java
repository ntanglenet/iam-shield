...
import org.iamshield.services.clientregistration.policy.ClientRegistrationPolicyFactory;
...
public class ClientRegistrationPolicyResource {
    ...
    public ClientRegistrationPolicyResource(IAMShieldSession session, AdminPermissionEvaluator auth, AdminEventBuilder adminEvent) {
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.CLIENT_REGISTRATION_POLICY)
    ...
    public Stream<ComponentTypeRepresentation> getProviders() {
        ...
        return session.getIAMShieldSessionFactory().getProviderFactoriesStream(ClientRegistrationPolicy.class)

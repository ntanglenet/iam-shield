...
import org.iamshield.representations.account.AccountLinkUriRepresentation;
import org.iamshield.representations.account.LinkedAccountRepresentation;
...
import org.iamshield.utils.BrokerUtil;
import org.iamshield.utils.StreamsUtil;

import static org.iamshield.models.Constants.ACCOUNT_CONSOLE_CLIENT_ID;
...
public class LinkedAccountsResource {
    ...
    public LinkedAccountsResource(IAMShieldSession session,
                                  HttpRequest request,
                                  Auth auth,
                                  EventBuilder event,
                                  UserModel user) {
        ...
        this.socialIds = session.getIAMShieldSessionFactory().getProviderFactoriesStream(SocialIdentityProvider.class)
    ...
    private LinkedAccountRepresentation toLinkedAccount(IdentityProviderModel provider, String fedIdentity, Set<IdentityProviderShowInAccountConsole> includedShowInAccountConsoleValues) {
        ...
        rep.setDisplayName(IAMShieldModelUtils.getIdentityProviderDisplayName(session, provider));
    ...
    @Deprecated
    public List<LinkedAccountRepresentation> getLinkedAccounts(IAMShieldSession session, RealmModel realm, UserModel user) {
    ...
    private LinkedAccountRepresentation toLinkedAccountRepresentation(IdentityProviderModel provider, Stream<FederatedIdentityModel> identities) {
        ...
        String displayName = IAMShieldModelUtils.getIdentityProviderDisplayName(session, provider);

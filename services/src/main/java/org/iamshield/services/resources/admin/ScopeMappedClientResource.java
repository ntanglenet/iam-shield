...
public class ScopeMappedClientResource {
    ...
    public ScopeMappedClientResource(RealmModel realm, AdminPermissionEvaluator auth, ScopeContainerModel scopeContainer, IAMShieldSession session, ClientModel scopedClient, AdminEventBuilder adminEvent,
    ...
    @NoCache
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.SCOPE_MAPPINGS)
    ...
    public Stream<RoleRepresentation> getClientScopeMappings() {
        ...
        return IAMShieldModelUtils.getClientScopeMappingsStream(scopedClient, scopeContainer)
    ...
    public void deleteClientScopeMapping(List<RoleRepresentation> roles) {
        ...
        if (roles == null) {
            roles = IAMShieldModelUtils.getClientScopeMappingsStream(scopedClient, scopeContainer)

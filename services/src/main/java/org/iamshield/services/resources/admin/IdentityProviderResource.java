...
import org.iamshield.representations.idm.IdentityProviderMapperTypeRepresentation;
...
public class IdentityProviderResource {
    ...
    public IdentityProviderResource(AdminPermissionEvaluator auth, RealmModel realm, IAMShieldSession session, IdentityProviderModel identityProviderModel, AdminEventBuilder adminEvent) {
        this.realm = realm;
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.IDENTITY_PROVIDERS)
    ...
    private void updateIdpFromRep(IdentityProviderRepresentation providerRep, RealmModel realm, IAMShieldSession session) {
    ...
    private static void updateUsersAfterProviderAliasChange(Stream<UserModel> users, String oldProviderId, String newProviderId, RealmModel realm, IAMShieldSession session) {
        users.forEach(user -> {

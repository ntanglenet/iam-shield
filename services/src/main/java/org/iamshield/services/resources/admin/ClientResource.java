...
import org.iamshield.authorization.admin.AuthorizationService;
...
import org.iamshield.services.clientpolicy.context.AdminClientUnregisterContext;
...
import org.iamshield.services.clientpolicy.context.AdminClientViewContext;
import org.iamshield.services.clientpolicy.context.ClientSecretRotationContext;
import org.iamshield.services.clientregistration.ClientRegistrationTokenUtils;
...
public class ClientResource {
    ...
    public ClientResource(RealmModel realm, AdminPermissionEvaluator auth, ClientModel clientModel, IAMShieldSession session, AdminEventBuilder adminEvent) {
        this.realm = realm;
        this.auth = auth;
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.CLIENTS)
    ...
    public CredentialRepresentation regenerateSecret() {
        try{
            ...
            String secret = IAMShieldModelUtils.generateSecret(client);
    ...
    private void updateClientFromRep(ClientRepresentation rep, ClientModel client, IAMShieldSession session) throws ModelDuplicateException {

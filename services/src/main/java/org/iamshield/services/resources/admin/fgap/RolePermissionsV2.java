...
import static org.iamshield.authorization.fgap.AdminPermissionsSchema.ROLES_RESOURCE_TYPE;
...
import org.iamshield.services.resources.admin.fgap.ModelRecord.RoleModelRecord;

class RolePermissionsV2 extends RolePermissions {

    private final FineGrainedAdminPermissionEvaluator eval;

    RolePermissionsV2(IAMShieldSession session, RealmModel realm, AuthorizationProvider authz, MgmtPermissions root) {

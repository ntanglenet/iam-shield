...
import org.iamshield.models.RoleMapperModel;
...
public class ClientRoleMappingsResource {
    ...
    public ClientRoleMappingsResource(UriInfo uriInfo, IAMShieldSession session, RealmModel realm, AdminPermissionEvaluator auth,
    ...
    @NoCache
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.CLIENT_ROLE_MAPPINGS)

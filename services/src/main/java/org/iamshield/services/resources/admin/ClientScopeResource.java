...
public class ClientScopeResource {
    ...
    public ClientScopeResource(RealmModel realm, AdminPermissionEvaluator auth, ClientScopeModel clientScope, IAMShieldSession session, AdminEventBuilder adminEvent) {
        this.realm = realm;
        this.auth = auth;
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.CLIENT_SCOPES)
    ...
    public Response update(final ClientScopeRepresentation rep) {
        ...
        try {
            LoginProtocolFactory loginProtocolFactory = //
                    (LoginProtocolFactory) session.getIAMShieldSessionFactory().getProviderFactory(LoginProtocol.class,
    ...
    public static void validateClientScopeProtocol(IAMShieldSession session, String protocol)
            throws ErrorResponseException {

...
import static org.iamshield.protocol.ProtocolMapperUtils.isEnabled;
...
public class ProtocolMappersResource {
    ...
    public ProtocolMappersResource(IAMShieldSession session, ProtocolMapperContainerModel client, AdminPermissionEvaluator auth,
    ...
    @Tag(name = IAMShieldOpenAPI.Admin.Tags.PROTOCOL_MAPPERS)
    ...
    private ProtocolMapperRepresentation toEffectiveProtocolMapperRep(ProtocolMapperModel model) {
        ProtocolMapper mapper = (ProtocolMapper) session.getIAMShieldSessionFactory().getProviderFactory(ProtocolMapper.class, model.getProtocolMapper());
        if (mapper == null) {

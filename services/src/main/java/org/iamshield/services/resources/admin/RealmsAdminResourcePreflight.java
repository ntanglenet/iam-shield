...
public class RealmsAdminResourcePreflight extends RealmsAdminResource {
    ...
    public RealmsAdminResourcePreflight(IAMShieldSession session, AdminAuth auth, TokenManager tokenManager) {
        super(session, auth, tokenManager);
    }

    public RealmsAdminResourcePreflight(IAMShieldSession session, AdminAuth auth, TokenManager tokenManager, HttpRequest request) {
        super(session, auth, tokenManager);

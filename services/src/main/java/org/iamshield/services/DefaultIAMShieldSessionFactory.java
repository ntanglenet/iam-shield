...
import org.iamshield.component.ComponentFactoryProvider;
...
import org.iamshield.provider.ProviderManagerDeployer;
...
import org.iamshield.theme.ThemeManagerFactory;

public abstract class DefaultIAMShieldSessionFactory implements IAMShieldSessionFactory, ProviderManagerDeployer {

    private static final Logger logger = Logger.getLogger(DefaultIAMShieldSessionFactory.class);
    ...
    public void init() {
        ...
        ProviderManager pm = new ProviderManager(IAMShieldDeploymentInfo.create().services(), getClass().getClassLoader(), Config.scope().getArray("providers"));
    ...
    @Override
    public <T extends Provider> ProviderFactory<T> getProviderFactory(Class<T> clazz, String realmId, String componentId, Function<IAMShieldSessionFactory, ComponentModel> modelGetter) {
    ...
    @Override
    public void invalidate(IAMShieldSession session, InvalidableObjectType type, Object... ids) {

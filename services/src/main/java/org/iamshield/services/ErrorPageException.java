...
public class ErrorPageException extends WebApplicationException {
    ...
    public ErrorPageException(IAMShieldSession session, Response.Status status, String errorMessage, Object... parameters) {
        super(errorMessage, ErrorPage.error(session, null, status, errorMessage, parameters));
    }

    public ErrorPageException(IAMShieldSession session, AuthenticationSessionModel authSession, Response.Status status, String errorMessage, Object... parameters) {

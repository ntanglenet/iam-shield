package org.iamshield.services.x509;
...
import org.iamshield.truststore.TruststoreProviderFactory;
...
public class NginxProxySslClientCertificateLookupFactory extends AbstractClientCertificateFromHttpHeadersLookupFactory {
     ...
     */
    private void loadKeycloakTrustStore(IAMShieldSession kcSession) {
        ...
        synchronized (this) {
            ...
            IAMShieldSessionFactory factory = kcSession.getIAMShieldSessionFactory();

...
package org.iamshield.timer.basic;
...
public class BasicTimerProvider implements TimerProvider {
    ...
    public BasicTimerProvider(IAMShieldSession session, Timer timer, int transactionTimeout, BasicTimerProviderFactory factory) {
    ...
    public void scheduleTask(ScheduledTask scheduledTask, long intervalMillis, String taskName) {
        ScheduledTaskRunner scheduledTaskRunner = new ScheduledTaskRunner(session.getIAMShieldSessionFactory(), scheduledTask, transactionTimeout);

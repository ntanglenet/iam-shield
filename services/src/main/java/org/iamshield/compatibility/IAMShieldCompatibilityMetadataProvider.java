 ...
 */
public class IAMShieldCompatibilityMetadataProvider implements CompatibilityMetadataProvider {
    ...
    public IAMShieldCompatibilityMetadataProvider() {
        this(Version.VERSION);
    }

    public IAMShieldCompatibilityMetadataProvider(String version) {
        this.version = version;
    }

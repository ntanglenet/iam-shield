...
public class DefaultFreeMarkerProvider implements FreeMarkerProvider {
    ...
    private final IAMShieldSanitizerMethod kcSanitizeMethod;

    public DefaultFreeMarkerProvider(ConcurrentHashMap<String, Template> cache, IAMShieldSanitizerMethod kcSanitizeMethod) {
        this.cache = cache;

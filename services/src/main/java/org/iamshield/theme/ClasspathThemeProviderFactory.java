...
public class ClasspathThemeProviderFactory implements ThemeProviderFactory {
    ...
    public static final String IAMSHIELD_THEMES_JSON = "META-INF/iamshield-themes.json";
    ...
    public ClasspathThemeProviderFactory(String id, ClassLoader classLoader) {
        this.id = id;
        loadThemes(classLoader, classLoader.getResourceAsStream(IAMSHIELD_THEMES_JSON));
    }
    ...
    @Override
    public ThemeProvider create(IAMShieldSession session) {

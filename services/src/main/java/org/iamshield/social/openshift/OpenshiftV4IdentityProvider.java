...
import org.iamshield.broker.oidc.AbstractOAuth2IdentityProvider;
...
public class OpenshiftV4IdentityProvider extends AbstractOAuth2IdentityProvider<OpenshiftV4IdentityProviderConfig> implements SocialIdentityProvider<OpenshiftV4IdentityProviderConfig> {
    ...
    public OpenshiftV4IdentityProvider(IAMShieldSession session, OpenshiftV4IdentityProviderConfig config) {
    ...
    Map<String, Object> getAuthJson(IAMShieldSession session, String baseUrl) {
        try {
    ...
    InputStream getOauthMetadataInputStream(IAMShieldSession session, String baseUrl) throws IOException {

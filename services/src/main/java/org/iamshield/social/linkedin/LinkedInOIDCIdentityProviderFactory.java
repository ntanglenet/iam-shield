...
public class LinkedInOIDCIdentityProviderFactory extends AbstractIdentityProviderFactory<LinkedInOIDCIdentityProvider> implements SocialIdentityProviderFactory<LinkedInOIDCIdentityProvider> {
    ...
    @Override
    public LinkedInOIDCIdentityProvider create(IAMShieldSession session, IdentityProviderModel model) {
    ...
    private static OIDCConfigurationRepresentation getWellKnownMetadata(IAMShieldSession session) {

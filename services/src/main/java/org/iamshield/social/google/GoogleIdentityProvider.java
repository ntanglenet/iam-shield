 ...
 */
package org.iamshield.social.google;
...
public class GoogleIdentityProvider extends OIDCIdentityProvider implements SocialIdentityProvider<OIDCIdentityProviderConfig> {
    ...
    public GoogleIdentityProvider(IAMShieldSession session, GoogleIdentityProviderConfig config) {
    ...
    protected String getUserInfoUrl() {
        ...
        if (((GoogleIdentityProviderConfig)getConfig()).isUserIp()) {
            ...
            if (connection != null && connection.getRemoteAddr() != null) {
                uri = IAMShieldUriBuilder.fromUri(super.getUserInfoUrl()).queryParam("userIp", connection.getRemoteAddr()).build().toString();
            }

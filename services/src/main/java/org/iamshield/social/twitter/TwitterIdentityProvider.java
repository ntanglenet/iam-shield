 ...
 */
package org.iamshield.social.twitter;
...
public class TwitterIdentityProvider extends AbstractIdentityProvider<OAuth2IdentityProviderConfig> implements
    ...
    public TwitterIdentityProvider(IAMShieldSession session, OAuth2IdentityProviderConfig config) {
    ...
    protected static class Endpoint {
        ...
        public Endpoint(IAMShieldSession session, AuthenticationCallback callback, EventBuilder event, TwitterIdentityProvider provider) {

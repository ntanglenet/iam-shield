...
import org.iamshield.userprofile.AttributeValidatorMetadata;
...
public abstract class AbstractUserProfileBean {
     ...
     */
    protected void init(IAMShieldSession session, boolean writeableOnly) {
    ...
    /**
     * Create UserProfile instance of the relevant type. Is called from {@link #init(IAMShieldSession, boolean)}.
     * 

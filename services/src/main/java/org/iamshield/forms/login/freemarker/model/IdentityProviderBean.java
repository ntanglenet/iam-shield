...
import org.iamshield.models.OrderedModel;
...
public class IdentityProviderBean {
    ...
    public IdentityProviderBean(IAMShieldSession session, RealmModel realm, URI baseURI, AuthenticationFlowContext context) {
    ...
    protected IdentityProvider createIdentityProvider(RealmModel realm, URI baseURI, IdentityProviderModel identityProvider) {
        ...
        String displayName = IAMShieldModelUtils.getIdentityProviderDisplayName(session, identityProvider);
     ...
     */
    protected String getExistingIDP(IAMShieldSession session, AuthenticationFlowContext context) {
     ...
     */
    protected Set<String> getLinkedBrokerAliases(IAMShieldSession session, RealmModel realm, AuthenticationFlowContext context) {

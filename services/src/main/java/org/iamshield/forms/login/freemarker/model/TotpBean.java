...
import org.iamshield.utils.TotpUtils;
...
public class TotpBean {
    ...
    public TotpBean(IAMShieldSession session, RealmModel realm, UserModel user, UriBuilder uriBuilder) {
        this(session, realm, user, uriBuilder, null);
    }

    public TotpBean(IAMShieldSession session, RealmModel realm, UserModel user, UriBuilder uriBuilder, String secret) {

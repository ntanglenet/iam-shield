...
public final class CRLUtils {
     ...
     */
    public static void check(X509Certificate[] certs, X509CRL crl, IAMShieldSession session) throws GeneralSecurityException {
    ...
    private static X509Certificate findCRLSignatureCertificateInTruststore(IAMShieldSession session, X509Certificate[] certs, X509CRL crl) throws GeneralSecurityException {

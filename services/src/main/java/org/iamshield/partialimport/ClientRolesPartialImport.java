...
public class ClientRolesPartialImport {
    ...
    public boolean exists(RealmModel realm, IAMShieldSession session, String clientId, RoleRepresentation roleRep) {
    ...
    public void prepare(PartialImportRepresentation partialImportRep, RealmModel realm, IAMShieldSession session) {

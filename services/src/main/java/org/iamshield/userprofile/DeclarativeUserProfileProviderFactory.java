...
package org.iamshield.userprofile;
...
import org.iamshield.authentication.requiredactions.TermsAndConditions;
import org.iamshield.authentication.requiredactions.UpdateEmail;
import org.iamshield.common.Profile;
import org.iamshield.common.Profile.Feature;
import org.iamshield.component.AmphibianProviderFactory;
...
import org.iamshield.organization.validator.OrganizationMemberValidator;
...
import org.iamshield.userprofile.validator.BlankAttributeValidator;
import org.iamshield.userprofile.validator.BrokeringFederatedUsernameHasValueValidator;
import org.iamshield.userprofile.validator.DuplicateEmailValidator;
import org.iamshield.userprofile.validator.DuplicateUsernameValidator;
import org.iamshield.userprofile.validator.EmailExistsAsUsernameValidator;
import org.iamshield.userprofile.validator.ReadOnlyAttributeUnchangedValidator;
import org.iamshield.userprofile.validator.RegistrationEmailAsUsernameEmailValueValidator;
import org.iamshield.userprofile.validator.RegistrationEmailAsUsernameUsernameValueValidator;
import org.iamshield.userprofile.validator.RegistrationUsernameExistsValidator;
import org.iamshield.userprofile.validator.UsernameHasValueValidator;
import org.iamshield.userprofile.validator.UsernameMutationValidator;
import org.iamshield.validate.ValidatorConfig;
import org.iamshield.validate.validators.EmailValidator;

import static java.util.Optional.ofNullable;
import static org.iamshield.common.util.ObjectUtil.isBlank;
import static org.iamshield.userprofile.DefaultAttributes.READ_ONLY_ATTRIBUTE_KEY;
import static org.iamshield.userprofile.UserProfileContext.ACCOUNT;
import static org.iamshield.userprofile.UserProfileContext.IDP_REVIEW;
import static org.iamshield.userprofile.UserProfileContext.REGISTRATION;
import static org.iamshield.userprofile.UserProfileContext.UPDATE_EMAIL;
import static org.iamshield.userprofile.UserProfileContext.UPDATE_PROFILE;
import static org.iamshield.userprofile.UserProfileContext.USER_API;
...
public class DeclarativeUserProfileProviderFactory implements UserProfileProviderFactory, AmphibianProviderFactory<UserProfileProvider> {
    ...
    private static boolean editUsernameCondition(AttributeContext c) {
        IAMShieldSession session = c.getSession();
    ...
    @Override
    public DeclarativeUserProfileProvider create(IAMShieldSession session) {

 ...
 */
package org.iamshield.userprofile.config;

import static org.iamshield.common.util.ObjectUtil.isBlank;
import static org.iamshield.userprofile.UserProfileUtil.isRootAttribute;
...
import org.iamshield.validate.Validators;
...
public class UPConfigUtils {
     ...
     * <p>
     * Configuration is not validated, use {@link #validate(IAMShieldSession, UPConfig)} to validate it and get list of errors.
     *
     ...
     */
    public static List<String> validate(IAMShieldSession session, UPConfig config) {
    ...
    private static List<String> validateAttributes(IAMShieldSession session, UPConfig config) {
     ...
     */
    private static void validateAttribute(IAMShieldSession session, UPAttribute attributeConfig, Set<String> groups, List<String> errors, Set<String> attNamesCache) {
    ...
    private static void validateDefaultValue(IAMShieldSession session, UPAttribute attributeConfig, List<String> errors) {
    ...
    private static void validateScopes(Set<String> scopes, String propertyName, String attributeName, List<String> errors, IAMShieldSession session) {
        if (scopes == null) {
            return;
        }
     ...
     * @param errors to add error message in if something is invalid
     */
    private static void validateValidationConfig(IAMShieldSession session, String validator, Map<String, Object> validatorConfig, String attributeName, List<String> errors) {

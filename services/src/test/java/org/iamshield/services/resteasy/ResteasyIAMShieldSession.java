...
public class ResteasyIAMShieldSession extends DefaultIAMShieldSession {

    public ResteasyIAMShieldSession(DefaultIAMShieldSessionFactory factory) {
        super(factory);
    }

    @Override
    protected DefaultIAMShieldContext createIAMShieldContext(IAMShieldSession session) {
        return new ResteasyIAMShieldContext(session);
    }
